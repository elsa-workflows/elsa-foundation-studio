import ct, { memo as Se, forwardRef as kr, useRef as ie, useEffect as ee, useCallback as ue, useContext as ho, useMemo as de, useState as U, createContext as Zi, useLayoutEffect as ff, createElement as Si, useId as Oc, lazy as hf, Suspense as pf } from "react";
...
var qs;
function wf() {
  return qs || (qs = 1, ii.exports = xf()), ii.exports;
}
var i = wf();
function Ee(e) {
...
function Of() {
  return new qe(this._enter || this._groups.map(Uc), this._parents);
}
function rr(e, t) {
...
function Kf(e, t) {
  ...
  for (var s = r.length, a = new Array(s), c = new Array(s), u = new Array(s), l = 0; l < s; ++l) {
    var d = o[l], f = r[l], h = f.length, p = Uf(e.call(d, d && d.__data__, l, o)), y = p.length, v = c[l] = new Array(y), x = a[l] = new Array(y), m = u[l] = new Array(h);
    n(d, f, v, x, m, p, t);
    for (var k = 0, g = 0, N, b; k < y; ++k)
      if (N = v[k]) {
        for (k >= g && (g = k + 1); !(b = x[g]) && ++g < y; ) ;
        N._next = b || null;
      }
  }
  return a = new qe(a, o), a._enter = c, a._exit = u, a;
}
function Uf(e) {
  return typeof e == "object" && "length" in e ? e : Array.from(e);
}
function Xf() {
  return new qe(this._exit || this._groups.map(Uc), this._parents);
}
function qf(e, t, n) {
...
function un(e, t) {
  return e.style.getPropertyValue(t) || Xc(e).getComputedStyle(e, null).getPropertyValue(t);
}
function gh(e) {
  return function() {
    delete this[e];
...
function po() {
  return new qe([[document.documentElement]], Qc);
}
function ep() {
  return this;
}
qe.prototype = po.prototype = {
  constructor: qe,
  select: Ef,
  selectAll: _f,
  selectChild: $f,
...
function Xe(e) {
  return typeof e == "string" ? new qe([[document.querySelector(e)]], [document.documentElement]) : new qe([[e]], Qc);
}
function tp(e) {
  let t;
...
function nl() {
  ...
  function h(N) {
    N.on("mousedown.drag", p).filter(o).on("touchstart.drag", x).on("touchmove.drag", m, np).on("touchend.drag touchcancel.drag", k).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function p(N, b) {
    if (!(d || !e.call(this, N, b))) {
      var E = g(this, t.call(this, N, b), N, b, "mouse");
      E && (Xe(N.view).on("mousemove.drag", y, eo).on("mouseup.drag", v, eo), el(N.view), si(N), l = !1, c = N.clientX, u = N.clientY, E("start", N));
    }
  }
  function y(N) {
    if (an(N), !l) {
      var b = N.clientX - c, E = N.clientY - u;
      l = b * b + E * E > f;
    }
    r.mouse("drag", N);
  }
  function v(N) {
    Xe(N.view).on("mousemove.drag mouseup.drag", null), tl(N.view, l), an(N), r.mouse("end", N);
  }
  function x(N, b) {
    if (e.call(this, N, b)) {
      var E = N.changedTouches, S = t.call(this, N, b), _ = E.length, M, W;
      for (M = 0; M < _; ++M)
        (W = g(this, S, N, b, E[M].identifier, E[M])) && (si(N), W("start", N, E[M]));
    }
  }
  function m(N) {
    var b = N.changedTouches, E = b.length, S, _;
    for (S = 0; S < E; ++S)
      (_ = r[b[S].identifier]) && (an(N), _("drag", N, b[S]));
  }
  function k(N) {
    var b = N.changedTouches, E = b.length, S, _;
    for (d && clearTimeout(d), d = setTimeout(function() {
      ...
      (_ = r[b[S].identifier]) && (si(N), _("end", N, b[S]));
  }
  function g(N, b, E, S, _, M) {
    var W = s.copy(), D = et(M || E, b), T, R, j;
    if ((j = n.call(N, new Ei("beforestart", {
      sourceEvent: E,
      target: h,
      identifier: _,
      active: a,
      ...
      return T = j.x - D[0] || 0, R = j.y - D[1] || 0, function A(I, $, z) {
        var P = D, B;
        switch (I) {
          case "start":
            r[_] = A, B = a++;
  ...
  return h.filter = function(N) {
    return arguments.length ? (e = typeof N == "function" ? N : Lo(!!N), h) : e;
  }, h.container = function(N) {
    return arguments.length ? (t = typeof N == "function" ? N : Lo(N), h) : t;
  }, h.subject = function(N) {
    return arguments.length ? (n = typeof N == "function" ? N : Lo(N), h) : n;
  }, h.touchable = function(N) {
    return arguments.length ? (o = typeof N == "function" ? N : Lo(!!N), h) : o;
  }, h.on = function() {
...
const Yo = (function e(t, n, o) {
  function r(s, a) {
    ...
    if (v < Tp)
      ...
      var k = Math.sqrt(v), g = (h * h - l * l + o * v) / (2 * l * n * k), N = (h * h - l * l - o * v) / (2 * h * n * k), b = Math.log(Math.sqrt(g * g + 1) - g), E = Math.log(Math.sqrt(N * N + 1) - N);
      m = (E - b) / t, x = function(S) {
        var _ = S * m, M = sa(b), W = l / (n * k) * (M * Pp(t * _ + b) - $p(b));
        return [
          c + W * p,
          u + W * y,
          l * M / sa(t * _ + b)
...
var dn = 0, Xn = 0, Vn = 0, ll = 1e3, cr, qn, lr = 0, Ht = 0, Ir = 0, oo = typeof performance == "object" && performance.now ? performance : Date, ul = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function ts() {
...
ur.prototype = dl.prototype = {
  ...
  restart: function(e, t, n) {
    ...
    n = (n == null ? ts() : +n) + (t == null ? 0 : +t), !this._next && qn !== this && (qn ? qn._next = this : cr = this, qn = this), this._call = e, this._time = n, _i();
  },
  stop: function() {
...
function _i(e) {
  if (!dn) {
    ...
    var t = e - Ht;
    t > 24 ? (e < 1 / 0 && (Xn = setTimeout(aa, e - oo.now() - Ir)), Vn && (Vn = clearInterval(Vn))) : (Vn || (lr = oo.now(), Vn = setInterval(Rp, ll)), dn = 1, ul(aa));
  }
}
function ca(e, t, n) {
  var o = new ur();
...
function Qp(e, t) {
  ...
  return this.attrTween(e, typeof t == "function" ? (n.local ? Jp : Gp)(n, o, os(this, "attr." + e, t)) : t == null ? (n.local ? qp : Xp)(n) : (n.local ? Zp : Yp)(n, o, t));
}
function ey(e, t) {
  return function(n) {
...
function ml() {
  var e = qy, t = Yy, n = Jy, o = Zy, r = Gy, s = [0, 1 / 0], a = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], c = 250, u = Yo, l = Er("start", "zoom", "end"), d, f, h, p = 500, y = 150, v = 0, x = 10;
  function m(j) {
    j.property("__zoom", da).on("wheel.zoom", _, { passive: !1 }).on("mousedown.zoom", M).on("dblclick.zoom", W).filter(r).on("touchstart.zoom", D).on("touchmove.zoom", T).on("touchend.zoom touchcancel.zoom", R).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  m.transform = function(j, A, I, $) {
    var z = j.selection ? j.selection() : j;
    z.property("__zoom", da), j !== z ? b(j, A, I, $) : z.interrupt().each(function() {
      E(this, arguments).event($).start().zoom(null, typeof A == "function" ? A.apply(this, arguments) : A).end();
    });
  }, m.scaleBy = function(j, A, I, $) {
    m.scaleTo(j, function() {
      var z = this.__zoom.k, P = typeof A == "function" ? A.apply(this, arguments) : A;
      return z * P;
    }, I, $);
  }, m.scaleTo = function(j, A, I, $) {
    m.transform(j, function() {
      var z = t.apply(this, arguments), P = this.__zoom, B = I == null ? N(z) : typeof I == "function" ? I.apply(this, arguments) : I, K = P.invert(B), O = typeof A == "function" ? A.apply(this, arguments) : A;
      return n(g(k(P, O), B, K), z, a);
    }, I, $);
  }, m.translateBy = function(j, A, I, $) {
    m.transform(j, function() {
  ...
  }, m.translateTo = function(j, A, I, $, z) {
    m.transform(j, function() {
  ...
  function k(j, A) {
    return A = Math.max(s[0], Math.min(s[1], A)), A === j.k ? j : new pt(A, j.x, j.y);
  }
  function g(j, A, I) {
    var $ = A[0] - I[0] * j.k, z = A[1] - I[1] * j.k;
    return $ === j.x && z === j.y ? j : new pt(j.k, $, z);
  }
  function N(j) {
  ...
  function b(j, A, I, $) {
    j.on("start.zoom", function() {
      ...
      var z = this, P = arguments, B = E(z, P).event($), K = t.apply(z, P), O = I == null ? N(K) : typeof I == "function" ? I.apply(z, P) : I, Z = Math.max(K[1][0] - K[0][0], K[1][1] - K[0][1]), X = z.__zoom, oe = typeof A == "function" ? A.apply(z, P) : A, se = u(X.invert(O).concat(Z / X.k), oe.invert(O).concat(Z / oe.k));
      return function(G) {
        if (G === 1) G = oe;
        else {
          var V = se(G), Y = Z / V[2];
  ...
  function _(j, ...A) {
    ...
    var I = E(this, A).event(j), $ = this.__zoom, z = Math.max(s[0], Math.min(s[1], $.k * Math.pow(2, o.apply(this, arguments)))), P = et(j);
    if (I.wheel)
    ...
    On(j), I.wheel = setTimeout(B, y), I.zoom("mouse", n(g(k($, z), I.mouse[0], I.mouse[1]), I.extent, a));
    function B() {
      I.wheel = null, I.end();
    }
  }
  function M(j, ...A) {
    ...
    var I = j.currentTarget, $ = E(this, A, !0).event(j), z = Xe(j.view).on("mousemove.zoom", O, !0).on("mouseup.zoom", Z, !0), P = et(j, I), B = j.clientX, K = j.clientY;
    el(j.view), li(j), $.mouse = [P, this.__zoom.invert(P)], Jo(this), $.start();
    function O(X) {
      if (On(X), !$.moved) {
        var oe = X.clientX - B, se = X.clientY - K;
        $.moved = oe * oe + se * se > v;
      }
      $.event(X).zoom("mouse", n(g($.that.__zoom, $.mouse[0] = et(X, I), $.mouse[1]), $.extent, a));
    }
    function Z(X) {
      z.on("mousemove.zoom mouseup.zoom", null), tl(X.view, $.moved), On(X), $.event(X).end();
    }
  }
  function W(j, ...A) {
    if (e.apply(this, arguments)) {
      var I = this.__zoom, $ = et(j.changedTouches ? j.changedTouches[0] : j, this), z = I.invert($), P = I.k * (j.shiftKey ? 0.5 : 2), B = n(g(k(I, P), $, z), t.apply(this, A), a);
      On(j), c > 0 ? Xe(this).transition().duration(c).call(b, B, $, j) : Xe(this).call(m.transform, B, $, j);
    }
  }
  function D(j, ...A) {
    if (e.apply(this, arguments)) {
      var I = j.touches, $ = I.length, z = E(this, A, j.changedTouches.length === $).event(j), P, B, K, O;
      for (li(j), B = 0; B < $; ++B)
  ...
  function T(j, ...A) {
    if (this.__zooming) {
      var I = E(this, A).event(j), $ = j.changedTouches, z = $.length, P, B, K, O;
      for (On(j), P = 0; P < z; ++P)
  ...
  function R(j, ...A) {
    if (this.__zooming) {
      var I = E(this, A).event(j), $ = j.changedTouches, z = $.length, P, B;
      for (li(j), h && clearTimeout(h), h = setTimeout(function() {
        h = null;
      }, p), P = 0; P < z; ++P)
  ...
  return m.wheelDelta = function(j) {
    return arguments.length ? (o = typeof j == "function" ? j : Ho(+j), m) : o;
  }, m.filter = function(j) {
    return arguments.length ? (e = typeof j == "function" ? j : Ho(!!j), m) : e;
  }, m.touchable = function(j) {
    return arguments.length ? (r = typeof j == "function" ? j : Ho(!!j), m) : r;
  }, m.extent = function(j) {
    return arguments.length ? (t = typeof j == "function" ? j : Ho([[+j[0][0], +j[0][1]], [+j[1][0], +j[1][1]]]), m) : t;
  }, m.scaleExtent = function(j) {
    return arguments.length ? (s[0] = +j[0], s[1] = +j[1], m) : [s[0], s[1]];
    ...
    return arguments.length ? (v = (j = +j) * j, m) : Math.sqrt(v);
  }, m.tapDistance = function(j) {
    return arguments.length ? (x = +j, m) : x;
  }, m;
}
const Ye = {
...
function gg({ source: e, sourcePosition: t = ne.Bottom, target: n, targetPosition: o = ne.Top, center: r, offset: s, stepPosition: a }) {
  ...
  let y = [], v, x;
  const m = { x: 0, y: 0 }, k = { x: 0, y: 0 }, [, , g, N] = $l({
    sourceX: e.x,
    sourceY: e.y,
    targetX: n.x,
    targetY: n.y
  ...
  if (c[h] * u[h] === -1) {
    ...
    if (h === "x" ? y = c.x === p ? M : _ : y = c.y === p ? _ : M, t === o) {
      ...
      if (j <= s) {
        const A = Math.min(s - 1, s - j);
        c[h] === p ? m[h] = (l[h] > e[h] ? -1 : 1) * A : k[h] = (d[h] > n[h] ? -1 : 1) * A;
      }
    }
    if (t !== o) {
      const j = h === "x" ? "y" : "x", A = c[h] === u[j], I = l[j] > d[j], $ = l[j] < d[j];
  ...
  const b = { x: l.x + m.x, y: l.y + m.y }, E = { x: d.x + k.x, y: d.y + k.y };
  return [[
    e,
...
function Eg(e, t, n, o, r, s, a) {
  ...
  for (const p of e.values()) {
    ...
    if (!!(v.width && v.height && (x || !y.internals.handleBounds || p.force))) {
      ...
      y.parentId && y.extent === "parent" ? N = Sl(N, v, t.get(y.parentId)) : g && (N = Wt(N, g, v));
      const b = {
        ...y,
        measured: v,
        internals: {
          ...
          positionAbsolute: N,
          handleBounds: {
            source: ga("source", p.nodeElement, k, f, y.id),
            target: ga("target", p.nodeElement, k, f, y.id)
          }
        }
      };
      t.set(y.id, b), y.parentId && fs(b, t, n, { nodeOrigin: r, zIndexMode: a }), u = !0, x && (l.push({
        id: y.id,
        type: "dimensions",
        dimensions: v
...
function _g({ onNodeMouseDown: e, getStoreItems: t, onDragStart: n, onDrag: o, onDragStop: r }) {
  ...
  function x({ noDragClassName: k, handleSelector: g, domNode: N, isSelectable: b, nodeId: E, nodeClickDistance: S = 0 }) {
    h = Xe(N);
    function _({ x: T, y: R }) {
      const { nodeLookup: j, nodeExtent: A, snapGrid: I, snapToGrid: $, nodeOrigin: z, onNodeDrag: P, onSelectionDrag: B, onError: K, updateNodePositions: O } = t();
      s = { x: T, y: R };
      let Z = !1;
      const X = c.size > 1, oe = X && A ? Ti(mo(c)) : null, se = X && $ ? Ag({
        dragItems: c,
        snapGrid: I,
        x: T,
        y: R
    ...
    async function M() {
      if (!d)
        return;
      const { transform: T, panBy: R, autoPanSpeed: j, autoPanOnNodeDrag: A } = t();
      if (!A) {
    ...
    function W(T) {
      const { nodeLookup: R, multiSelectionActive: j, nodesDraggable: A, transform: I, snapGrid: $, snapToGrid: z, selectNodesOnDrag: P, onNodeDragStart: B, onSelectionDragStart: K, unselectNodesAndEdges: O } = t();
      f = !0, (!P || !b) && !j && E && (R.get(E)?.selected || O()), b && P && E && e?.(E);
      const Z = Gn(T.sourceEvent, { transform: I, snapGrid: $, snapToGrid: z, containerBounds: d });
      if (s = Z, c = Ig(R, A, Z, E), c.size > 0 && (n || B || !E && K)) {
        const [X, oe] = ui({
          nodeId: E,
          dragItems: c,
          nodeLookup: R
    ...
    const D = nl().clickDistance(S).on("start", (T) => {
      const { domNode: R, nodeDragThreshold: j, transform: A, snapGrid: I, snapToGrid: $ } = t();
      d = R?.getBoundingClientRect() || null, p = !1, y = !1, v = T.sourceEvent, j === 0 && W(T), s = Gn(T.sourceEvent, { transform: A, snapGrid: I, snapToGrid: $, containerBounds: d }), l = ot(T.sourceEvent, d);
    }).on("drag", (T) => {
      const { autoPanOnNodeDrag: R, transform: j, snapGrid: A, snapToGrid: I, nodeDragThreshold: $, nodeLookup: z } = t(), P = Gn(T.sourceEvent, { transform: j, snapGrid: A, snapToGrid: I, containerBounds: d });
      ...
      if (u = !1, f = !1, cancelAnimationFrame(a), c.size > 0) {
        const { nodeLookup: R, updateNodePositions: j, onNodeDragStop: A, onSelectionDragStop: I } = t();
        if (y && (j(c, !1), y = !1), r || A || !E && I) {
          const [$, z] = ui({
            nodeId: E,
            dragItems: c,
            nodeLookup: R,
      ...
      const R = T.target;
      return !T.button && (!k || !Sa(R, `.${k}`, N)) && (!g || Sa(R, g, N));
    });
    h.call(D);
  }
  function m() {
...
const Bl = () => !0;
function Pg(e, { connectionMode: t, connectionRadius: n, handleId: o, nodeId: r, edgeUpdaterType: s, isTarget: a, domNode: c, nodeLookup: u, lib: l, autoPanOnConnect: d, flowId: f, panBy: h, cancelConnection: p, onConnectStart: y, onConnect: v, onConnectEnd: x, isValidConnection: m = Bl, onReconnectEnd: k, updateConnection: g, getTransform: N, getFromHandle: b, autoPanSpeed: E, dragThreshold: S = 1, handleDomNode: _ }) {
  const M = Al(e.target);
  let W = 0, D;
  const { x: T, y: R } = ot(e), j = Wl(s, _), A = c?.getBoundingClientRect();
  let I = !1;
  if (!A || !j)
    return;
  const $ = Hl(r, j, o, u, t);
  ...
  function V() {
    I = !0, g(G), y?.(e, { nodeId: r, handleId: o, handleType: j });
  }
  S === 0 && V();
  function Y(ce) {
    if (!I) {
    ...
    const J = N();
    z = ot(ce, A), D = Tg(vn(z, J, !1, [1, 1]), n, u, X), P || (Z(), P = !0);
    const te = Fl(ce, {
      handle: D,
      connectionMode: t,
      fromNodeId: r,
...
function Fl(e, { handle: t, connectionMode: n, fromNodeId: o, fromHandleId: r, fromType: s, doc: a, lib: c, flowId: u, isValidConnection: l = Bl, nodeLookup: d }) {
  ...
  if (x) {
    const k = Wl(void 0, x), g = x.getAttribute("data-nodeid"), N = x.getAttribute("data-handleid"), b = x.classList.contains("connectable"), E = x.classList.contains("connectableend");
    if (!g || !k)
      return m;
    const S = {
      source: f ? g : o,
    ...
    m.connection = S;
    const M = b && E && (n === fn.Strict ? f && k === "source" || !f && k === "target" : g !== o || N !== r);
    m.isValid = M && l(S), m.toHandle = Hl(g, k, N, d, n, !0);
  }
  return m;
}
const zi = {
  ...
  function s({ translateExtent: c, width: u, height: l, zoomStep: d = 1, pannable: f = !0, zoomable: h = !0, inversePan: p = !1 }) {
    const y = (g) => {
      if (g.sourceEvent.type !== "wheel" || !t)
        return;
      const N = n(), b = g.sourceEvent.ctrlKey && ao() ? 10 : 1, E = -g.sourceEvent.deltaY * (g.sourceEvent.deltaMode === 1 ? 0.05 : g.sourceEvent.deltaMode ? 1 : 2e-3) * d, S = N[2] * Math.pow(2, E * b);
      t.scaleTo(S);
    };
    let v = [0, 0];
    const x = (g) => {
      ...
      v = b;
      const S = o() * Math.max(N[2], Math.log(N[2])) * (p ? -1 : 1), _ = {
        x: N[0] - E[0] * S,
        y: N[1] - E[1] * S
      }, M = [
        [0, 0],
...
function Rg({ zoomPanValues: e, noWheelClassName: t, d3Selection: n, d3Zoom: o, panOnScrollMode: r, panOnScrollSpeed: s, zoomOnPinch: a, onPanZoomStart: c, onPanZoom: u, onPanZoomEnd: l }) {
  return (d) => {
    ...
    if (d.ctrlKey && a) {
      const x = et(d), m = Ul(d), k = f * Math.pow(2, m);
      o.scaleTo(n, k, x, d);
      return;
    }
...
function Fg({ domNode: e, minZoom: t, maxZoom: n, translateExtent: o, viewport: r, onPanZoom: s, onPanZoomStart: a, onPanZoomEnd: c, onDraggingChange: u }) {
  const l = {
    ...
    isPanScrolling: !1
  }, d = e.getBoundingClientRect(), f = ml().scaleExtent([t, n]).translateExtent(o), h = Xe(e).call(f);
  k({
    x: r.x,
    y: r.y,
    zoom: hn(r.zoom, t, n)
  ...
  async function k(D, T, R) {
    const j = di(D), A = f?.constrain()(j, T, R);
...
function Ug(e, t, n, o, r, s, a, c) {
  let { affectsX: u, affectsY: l } = t;
  const { isHorizontal: d, isVertical: f } = t, h = d && f, { xSnapped: p, ySnapped: y } = n, { minWidth: v, maxWidth: x, minHeight: m, maxHeight: k } = o, { x: g, y: N, width: b, height: E, aspectRatio: S } = e;
  let _ = Math.floor(d ? p - e.pointerX : 0), M = Math.floor(f ? y - e.pointerY : 0);
  const W = b + (u ? -_ : _), D = E + (l ? -M : M), T = -s[0] * b, R = -s[1] * E;
  let j = Bo(W, v, x), A = Bo(D, m, k);
  if (a) {
    let z = 0, P = 0;
    u && _ < 0 ? z = wt(g + _ + T, a[0][0]) : !u && _ > 0 && (z = vt(g + W + T, a[1][0])), l && M < 0 ? P = wt(N + M + R, a[0][1]) : !l && M > 0 && (P = vt(N + D + R, a[1][1])), j = Math.max(j, z), A = Math.max(A, P);
  }
  if (c) {
    let z = 0, P = 0;
    u && _ > 0 ? z = vt(g + _, c[0][0]) : !u && _ < 0 && (z = wt(g + W, c[1][0])), l && M > 0 ? P = vt(N + M, c[0][1]) : !l && M < 0 && (P = wt(N + D, c[1][1])), j = Math.max(j, z), A = Math.max(A, P);
  }
  if (r) {
    if (d) {
      const z = Bo(W / S, m, k) * S;
      if (j = Math.max(j, z), a) {
        let P = 0;
        !u && !l || u && !l && h ? P = vt(N + R + W / S, a[1][1]) * S : P = wt(N + R + (u ? _ : -_) / S, a[0][1]) * S, j = Math.max(j, P);
      }
      if (c) {
        let P = 0;
        !u && !l || u && !l && h ? P = wt(N + W / S, c[1][1]) * S : P = vt(N + (u ? _ : -_) / S, c[0][1]) * S, j = Math.max(j, P);
      }
    }
    if (f) {
  ...
  M = M + (M < 0 ? A : -A), _ = _ + (_ < 0 ? j : -j), r && (h ? W > D * S ? M = (Ea(u, l) ? -_ : _) / S : _ = (Ea(u, l) ? -M : M) * S : d ? (M = _ / S, l = u) : (_ = M * S, u = l));
  const I = u ? g + _ : g, $ = l ? N + M : N;
  return {
    width: b + (u ? -_ : _),
    height: E + (l ? -M : M),
    x: s[0] * _ * (u ? -1 : 1) + I,
...
const Xl = { width: 0, height: 0, x: 0, y: 0 }, Xg = {
  ...Xl,
  pointerX: 0,
  pointerY: 0,
  aspectRatio: 1
...
function Yg({ domNode: e, nodeId: t, getStoreItems: n, onChange: o, onEnd: r }) {
  ...
  function c({ controlPosition: l, boundaries: d, keepAspectRatio: f, resizeDirection: h, onResizeStart: p, onResize: y, onResizeEnd: v, shouldResize: x }) {
    ...
    let g, N = null, b = [], E, S, _, M = !1;
    const W = nl().on("start", (D) => {
      const { nodeLookup: T, transform: R, snapGrid: j, snapToGrid: A, nodeOrigin: I, paneDomNode: $ } = n();
      if (g = T.get(t), !g)
        return;
      ...
      }, E = void 0, S = Bt(g.extent) ? g.extent : void 0, g.parentId && (g.extent === "parent" || g.expandParent) && (E = T.get(g.parentId)), E && g.extent === "parent" && (S = [
        [0, 0],
        [E.measured.width, E.measured.height]
      ]), b = [], _ = void 0;
      for (const [B, K] of T)
        if (K.parentId === t && (b.push({
          id: B,
          position: { ...K.position },
          extent: K.extent
      ...
      const { transform: T, snapGrid: R, snapToGrid: j, nodeOrigin: A } = n(), I = Gn(D.sourceEvent, {
        transform: T,
        snapGrid: R,
        snapToGrid: j,
        containerBounds: N
      ...
      if (!g)
        return;
      const { x: z, y: P, width: B, height: K } = m, O = {}, Z = g.origin ?? A, { width: X, height: oe, x: se, y: G } = Ug(k, a.controlDirection, I, a.boundaries, a.keepAspectRatio, Z, S, _), V = X !== B, Y = oe !== K, ae = se !== z && V, ce = G !== P && Y;
      if (!ae && !ce && !V && !Y)
        return;
      if ((ae || ce || Z[0] === 1 || Z[1] === 1) && (O.x = ae ? se : m.x, O.y = ce ? G : m.y, m.x = O.x, m.y = O.y, b.length > 0)) {
        const H = se - z, Q = G - P;
        for (const ye of b)
          ye.position = {
            x: ye.position.x - H + Z[0] * (X - B),
            y: ye.position.y - Q + Z[1] * (oe - K)
          }, $.push(ye);
      }
      if ((V || Y) && (O.width = V && (!a.resizeDirection || a.resizeDirection === "horizontal") ? X : m.width, O.height = Y && (!a.resizeDirection || a.resizeDirection === "vertical") ? oe : m.height, m.width = O.width, m.height = O.height), E && g.expandParent) {
    ...
    y = c(
      function() {
        function m(E) {
          ...
          if (S = N, o(g, E)) return S;
          var _ = h(E);
          return p !== void 0 && p(S, _) ? (g = E, S) : (g = E, N = _);
        }
        var k = !1, g, N, b = f === void 0 ? null : f;
        return [
          function() {
            return m(d());
          },
...
function co(e = null, t = { target: Va, actInsideInputWithModifier: !0 }) {
  const [n, o] = U(!1), r = ie(!1), s = ie(/* @__PURE__ */ new Set([])), [a, c] = de(() => {
    if (e !== null) {
...
function Ka(e) {
  const [t, n] = U(BigInt(0)), [o] = U(() => $m(() => n((r) => r + BigInt(1))));
  return Tm(() => {
    const r = o.get();
  ...
  const e = Am(), t = je(), n = zm(), o = pe(Lm), r = de(() => {
    ...
    return {
      ...
      deleteElements: async ({ nodes: f = [], edges: h = [] }) => {
        const { nodes: p, edges: y, onNodesDelete: v, onEdgesDelete: x, triggerNodeChanges: m, triggerEdgeChanges: k, onDelete: g, onBeforeDelete: N } = t.getState(), { nodes: b, edges: E } = await rg({
          nodesToRemove: f,
          edgesToRemove: h,
          nodes: p,
          edges: y,
          onBeforeDelete: N
        }), S = E.length > 0, _ = b.length > 0;
        if (S) {
          const M = E.map(Ba);
          x?.(E), k(M);
        }
        ...
        return (_ || S) && g?.({ nodes: b, edges: E }), { deletedNodes: b, deletedEdges: E };
      },
      /**
      ...
      getIntersectingNodes: (f, h = !0, p) => {
        ...
        return v ? (p || t.getState().nodes).filter((m) => {
          ...
          if (k && !y && (m.id === f.id || !k.internals.positionAbsolute))
            return !1;
          const g = pn(x ? m : k), N = so(g, v);
          return h && N > 0 || N >= g.width * g.height || N >= v.width * v.height;
        }) : [];
      },
...
const Ua = (e) => e.selected, Rm = typeof window < "u" ? window : void 0;
function Vm({ deleteKeyCode: e, multiSelectionKeyCode: t }) {
  ...
  ee(() => {
    if (r) {
      ...
      o({ nodes: c.filter(Ua), edges: a.filter(Ua) }), n.setState({ nodesSelectionActive: !1 });
    }
  }, [r]), ee(() => {
...
function Wm({ onPaneContextMenu: e, zoomOnScroll: t = !0, zoomOnPinch: n = !0, panOnScroll: o = !1, panOnScrollSpeed: r = 0.5, panOnScrollMode: s = Lt.Free, zoomOnDoubleClick: a = !0, panOnDrag: c = !0, defaultViewport: u, translateExtent: l, minZoom: d, maxZoom: f, zoomActivationKeyCode: h, preventScrolling: p = !0, children: y, noWheelClassName: v, noPanClassName: x, onViewportChange: m, isControlledViewport: k, paneClickDistance: g, selectionOnDrag: N }) {
  const b = je(), E = ie(null), { userSelectionActive: S, lib: _, connectionInProgress: M } = pe(Hm, Ne), W = co(h), D = ie();
  Om(E);
  const T = ue((R) => {
    m?.({ x: R[0], y: R[1], zoom: R[2] }), k || b.setState({ transform: R });
  }, [m, k]);
  return ee(() => {
    if (E.current) {
      D.current = Fg({
        ...
        translateExtent: l,
        viewport: u,
        onDraggingChange: (I) => b.setState(($) => $.paneDragging === I ? $ : { paneDragging: I }),
        onPanZoomStart: (I, $) => {
          const { onViewportChangeStart: z, onMoveStart: P } = b.getState();
          P?.(I, $), z?.($);
        },
        onPanZoom: (I, $) => {
          const { onViewportChange: z, onMove: P } = b.getState();
          P?.(I, $), z?.($);
        },
        onPanZoomEnd: (I, $) => {
          const { onViewportChangeEnd: z, onMoveEnd: P } = b.getState();
          P?.(I, $), z?.($);
        }
      });
      const { x: R, y: j, zoom: A } = D.current.getViewport();
      return b.setState({
        panZoom: D.current,
        transform: [R, j, A],
...
function Um({ isSelecting: e, selectionKeyPressed: t, selectionMode: n = io.Full, panOnDrag: o, autoPanOnSelection: r, paneClickDistance: s, selectionOnDrag: a, onSelectionStart: c, onSelectionEnd: u, onPaneClick: l, onPaneContextMenu: d, onPaneScroll: f, onPaneMouseEnter: h, onPaneMouseMove: p, onPaneMouseLeave: y, children: v }) {
  const x = ie(0), m = je(), { userSelectionActive: k, elementsSelectable: g, dragging: N, connectionInProgress: b, panBy: E, autoPanSpeed: S } = pe(Km, Ne), _ = g && (e || k), M = ie(null), W = ie(), D = ie(/* @__PURE__ */ new Set()), T = ie(/* @__PURE__ */ new Set()), R = ie(!1), j = ie({ x: 0, y: 0 }), A = ie(!1), I = (V) => {
    if (R.current || b) {
      R.current = !1;
      return;
    }
  ...
  function O() {
    if (!r || !W.current)
      return;
    const [V, Y] = ss(j.current, W.current, S);
    E({ x: V, y: Y }).then((ae) => {
      if (!R.current || !ae) {
        x.current = requestAnimationFrame(O);
        return;
      }
      const { x: ce, y: J } = j.current;
  ...
  return i.jsxs("div", { className: Ee(["react-flow__pane", { draggable: G, dragging: N, selection: e }]), onClick: _ ? void 0 : xi(I, M), onContextMenu: xi($, M), onWheel: xi(z, M), onPointerEnter: _ ? void 0 : h, onPointerMove: _ ? X : p, onPointerUp: _ ? oe : void 0, onPointerCancel: _ ? se : void 0, onPointerDownCapture: _ ? B : void 0, onClickCapture: _ ? P : void 0, onPointerLeave: y, ref: M, style: zr, children: [v, i.jsx(Fm, {})] });
}
...
function au() {
  ...
  return ue((n) => {
    ...
    for (const [, m] of l) {
      ...
      r && (k = xo(k, s));
      const { position: g, positionAbsolute: N } = jl({
        nodeId: m.id,
        nextPosition: k,
        nodeLookup: l,
        nodeExtent: o,
      ...
      m.position = g, m.internals.positionAbsolute = N, f.set(m.id, m);
    }
    u(f);
  }, []);
}
const ys = Zi(null), qm = ys.Provider;
ys.Consumer;
const cu = () => ho(ys), Ym = (e) => ({
...
function Gm({ type: e = "source", position: t = ne.Top, isValidConnection: n, isConnectable: o = !0, isConnectableStart: r = !0, isConnectableEnd: s = !0, id: a, onConnect: c, children: u, className: l, onMouseDown: d, onTouchStart: f, ...h }, p) {
  const y = a || null, v = e === "target", x = je(), m = cu(), { connectOnClick: k, noPanClassName: g, rfId: N } = pe(Ym, Ne), { connectingFrom: b, connectingTo: E, clickConnecting: S, isPossibleEndHandle: _, connectionInProcess: M, clickConnectionInProcess: W, valid: D } = pe(Zm(m, y, e), Ne);
  ...
  const T = (A) => {
    ...
    const { onClickConnectStart: I, onClickConnectEnd: $, connectionClickStartHandle: z, connectionMode: P, isValidConnection: B, lib: K, rfId: O, nodeLookup: Z, connection: X } = x.getState();
    if (!m || !z && !r)
      return;
    if (!z) {
  ...
  return i.jsx("div", { "data-handleid": y, "data-nodeid": m, "data-handlepos": t, "data-id": `${N}-${m}-${y}-${e}`, className: Ee([
    "react-flow__handle",
  ...
  ]), onMouseDown: R, onTouchStart: R, onClick: k ? j : void 0, ref: p, ...h, children: u });
}
const mn = Se(ru(Gm));
...
const qa = typeof window < "u" ? window : void 0, ix = (e) => ({ nodesSelectionActive: e.nodesSelectionActive, userSelectionActive: e.userSelectionActive });
function lu({ children: e, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: s, onPaneScroll: a, paneClickDistance: c, deleteKeyCode: u, selectionKeyCode: l, selectionOnDrag: d, selectionMode: f, onSelectionStart: h, onSelectionEnd: p, multiSelectionKeyCode: y, panActivationKeyCode: v, zoomActivationKeyCode: x, elementsSelectable: m, zoomOnScroll: k, zoomOnPinch: g, panOnScroll: N, panOnScrollSpeed: b, panOnScrollMode: E, zoomOnDoubleClick: S, panOnDrag: _, autoPanOnSelection: M, defaultViewport: W, translateExtent: D, minZoom: T, maxZoom: R, preventScrolling: j, onSelectionContextMenu: A, noWheelClassName: I, noPanClassName: $, disableKeyboardA11y: z, onViewportChange: P, isControlledViewport: B }) {
  const { nodesSelectionActive: K, userSelectionActive: O } = pe(ix, Ne), Z = co(l, { target: qa }), X = co(v, { target: qa }), oe = X || _, se = X || N, G = d && oe !== !0, V = Z || O || G;
  return Vm({ deleteKeyCode: u, multiSelectionKeyCode: y }), i.jsx(Wm, { onPaneContextMenu: s, elementsSelectable: m, zoomOnScroll: k, zoomOnPinch: g, panOnScroll: se, panOnScrollSpeed: b, panOnScrollMode: E, zoomOnDoubleClick: S, panOnDrag: !Z && oe, defaultViewport: W, translateExtent: D, minZoom: T, maxZoom: R, zoomActivationKeyCode: x, preventScrolling: j, noWheelClassName: I, noPanClassName: $, onViewportChange: P, isControlledViewport: B, paneClickDistance: c, selectionOnDrag: G, children: i.jsxs(Um, { onSelectionStart: h, onSelectionEnd: p, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: s, onPaneScroll: a, panOnDrag: oe, autoPanOnSelection: M, isSelecting: !!V, selectionMode: f, selectionKeyPressed: Z, paneClickDistance: c, selectionOnDrag: G, children: [e, K && i.jsx(rx, { onSelectionContextMenu: A, noPanClassName: $, disableKeyboardA11y: z })] }) });
}
...
function ux() {
  const e = pe(lx), [t] = U(() => typeof ResizeObserver > "u" ? null : new ResizeObserver((n) => {
...
function fx({ id: e, onClick: t, onMouseEnter: n, onMouseMove: o, onMouseLeave: r, onContextMenu: s, onDoubleClick: a, nodesDraggable: c, elementsSelectable: u, nodesConnectable: l, nodesFocusable: d, resizeObserver: f, noDragClassName: h, noPanClassName: p, disableKeyboardA11y: y, rfId: v, nodeTypes: x, nodeClickDistance: m, onError: k }) {
  const { node: g, internals: N, isParent: b } = pe((V) => {
  ...
  let E = g.type || "default", S = x?.[E] || Xa[E];
  S === void 0 && (k?.("003", Ye.error003(E)), E = "default", S = x?.default || Xa.default);
  const _ = !!(g.draggable || c && typeof g.draggable > "u"), M = !!(g.selectable || u && typeof g.selectable > "u"), W = !!(g.connectable || l && typeof g.connectable > "u"), D = !!(g.focusable || d && typeof g.focusable > "u"), T = je(), R = Cl(g), j = dx({ node: g, nodeType: E, hasDimensions: R, resizeObserver: f }), A = su({
    nodeRef: j,
    disabled: g.hidden || !_,
    noDragClassName: h,
  ...
  if (g.hidden)
    return null;
  const $ = gt(g), z = nx(g), P = M || _ || t || n || o || r, B = n ? (V) => n(V, { ...N.userNode }) : void 0, K = o ? (V) => o(V, { ...N.userNode }) : void 0, O = r ? (V) => r(V, { ...N.userNode }) : void 0, Z = s ? (V) => s(V, { ...N.userNode }) : void 0, X = a ? (V) => a(V, { ...N.userNode }) : void 0, oe = (V) => {
  ...
  return i.jsx("div", { className: Ee([
    ...
    ...g.style,
    ...z
  }, "data-id": e, "data-testid": `rf__node-${e}`, onMouseEnter: B, onMouseMove: K, onMouseLeave: O, onContextMenu: Z, onClick: oe, onDoubleClick: X, onKeyDown: D ? se : void 0, tabIndex: D ? 0 : void 0, onFocus: D ? G : void 0, role: g.ariaRole ?? (D ? "group" : void 0), "aria-roledescription": "node", "aria-describedby": y ? void 0 : `${Zl}-${v}`, "aria-label": g.ariaLabel, ...g.domAttributes, children: i.jsx(qm, { value: e, children: i.jsx(S, { id: e, data: g.data, type: E, positionAbsoluteX: N.positionAbsolute.x, positionAbsoluteY: N.positionAbsolute.y, selected: g.selected ?? !1, selectable: M, draggable: _, deletable: g.deletable ?? !0, isConnectable: W, sourcePosition: g.sourcePosition, targetPosition: g.targetPosition, dragging: A, dragHandle: g.dragHandle, zIndex: N.z, parentId: g.parentId, ...$ }) }) });
}
var hx = Se(fx);
const px = (e) => ({
...
function fu({ x: e, y: t, label: n, labelStyle: o, labelShowBg: r = !0, labelBgStyle: s, labelBgPadding: a = [2, 4], labelBgBorderRadius: c = 2, children: u, className: l, ...d }) {
  const [f, h] = U({ x: 1, y: 0, width: 0, height: 0 }), p = Ee(["react-flow__edge-textwrapper", l]), y = ie(null);
  return ee(() => {
    if (y.current) {
...
function pu(e) {
  return Se(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: s, sourcePosition: a, targetPosition: c, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: y, markerEnd: v, markerStart: x, interactionWidth: m }) => {
    ...
    return i.jsx(wo, { id: b, path: k, labelX: g, labelY: N, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: y, markerEnd: v, markerStart: x, interactionWidth: m });
  });
}
...
function gu(e) {
  return Se(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: s, label: a, labelStyle: c, labelShowBg: u, labelBgStyle: l, labelBgPadding: d, labelBgBorderRadius: f, style: h, sourcePosition: p = ne.Bottom, targetPosition: y = ne.Top, markerEnd: v, markerStart: x, pathOptions: m, interactionWidth: k }) => {
    ...
    return i.jsx(wo, { id: E, path: g, labelX: N, labelY: b, label: a, labelStyle: c, labelShowBg: u, labelBgStyle: l, labelBgPadding: d, labelBgBorderRadius: f, style: h, markerEnd: v, markerStart: x, interactionWidth: k });
  });
}
...
function ju(e) {
  return Se(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: s, sourcePosition: a = ne.Bottom, targetPosition: c = ne.Top, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: y, markerEnd: v, markerStart: x, pathOptions: m, interactionWidth: k }) => {
    ...
    return i.jsx(wo, { id: E, path: g, labelX: N, labelY: b, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: y, markerEnd: v, markerStart: x, interactionWidth: k });
  });
}
...
function Ax({ isReconnectable: e, reconnectRadius: t, edge: n, sourceX: o, sourceY: r, targetX: s, targetY: a, sourcePosition: c, targetPosition: u, onReconnect: l, onReconnectStart: d, onReconnectEnd: f, setReconnecting: h, setUpdateHover: p }) {
  const y = je(), v = (N, b) => {
    if (N.button !== 0)
      return;
    const { autoPanOnConnect: E, domNode: S, connectionMode: _, connectionRadius: M, lib: W, onConnectStart: D, cancelConnection: T, nodeLookup: R, rfId: j, panBy: A, updateConnection: I } = y.getState(), $ = b.type === "target", z = (K, O) => {
      h(!1), f?.(K, n, b.type, O);
    }, P = (K) => l?.(n, K), B = (K, O) => {
      h(!0), d?.(N, n, b.type), D?.(K, O);
    };
    zi.onPointerDown(N.nativeEvent, {
      autoPanOnConnect: E,
      connectionMode: _,
      connectionRadius: M,
      domNode: S,
  ...
  }, x = (N) => v(N, { nodeId: n.target, id: n.targetHandle ?? null, type: "target" }), m = (N) => v(N, { nodeId: n.source, id: n.sourceHandle ?? null, type: "source" }), k = () => p(!0), g = () => p(!1);
  return i.jsxs(i.Fragment, { children: [(e === !0 || e === "source") && i.jsx(ec, { position: c, centerX: o, centerY: r, radius: t, onMouseDown: x, onMouseEnter: k, onMouseOut: g, type: "source" }), (e === !0 || e === "target") && i.jsx(ec, { position: u, centerX: s, centerY: a, radius: t, onMouseDown: m, onMouseEnter: k, onMouseOut: g, type: "target" })] });
}
function _x({ id: e, edgesFocusable: t, edgesReconnectable: n, elementsSelectable: o, onClick: r, onDoubleClick: s, onContextMenu: a, onMouseEnter: c, onMouseMove: u, onMouseLeave: l, reconnectRadius: d, onReconnect: f, onReconnectStart: h, onReconnectEnd: p, rfId: y, edgeTypes: v, noPanClassName: x, onError: m, disableKeyboardA11y: k }) {
  let g = pe((J) => J.edgeLookup.get(e));
  const N = pe((J) => J.defaultEdgeOptions);
  g = N ? { ...N, ...g } : g;
  let b = g.type || "default", E = v?.[b] || Ga[b];
  E === void 0 && (m?.("011", Ye.error011(b)), b = "default", E = v?.default || Ga.default);
  const S = !!(g.focusable || t && typeof g.focusable > "u"), _ = typeof f < "u" && (g.reconnectable || n && typeof g.reconnectable > "u"), M = !!(g.selectable || o && typeof g.selectable > "u"), W = ie(null), [D, T] = U(!1), [R, j] = U(!1), A = je(), { zIndex: I, sourceX: $, sourceY: z, targetX: P, targetY: B, sourcePosition: K, targetPosition: O } = pe(ue((J) => {
  ...
  }, [g.source, g.target, g.sourceHandle, g.targetHandle, g.selected, g.zIndex]), Ne), Z = de(() => g.markerStart ? `url('#${$i(g.markerStart, y)}')` : void 0, [g.markerStart, y]), X = de(() => g.markerEnd ? `url('#${$i(g.markerEnd, y)}')` : void 0, [g.markerEnd, y]);
...
function ku({ defaultMarkerColor: e, onlyRenderVisibleElements: t, rfId: n, edgeTypes: o, noPanClassName: r, onReconnect: s, onEdgeContextMenu: a, onEdgeMouseEnter: c, onEdgeMouseMove: u, onEdgeMouseLeave: l, onEdgeClick: d, reconnectRadius: f, onEdgeDoubleClick: h, onReconnectStart: p, onReconnectEnd: y, disableKeyboardA11y: v }) {
  const { edgesFocusable: x, edgesReconnectable: m, elementsSelectable: k, onError: g } = pe(Mx, Ne), N = gx(t);
  return i.jsxs("div", { className: "react-flow__edges", children: [i.jsx(bx, { defaultColor: e, rfId: n }), N.map((b) => i.jsx(Dx, { id: b, edgesFocusable: x, edgesReconnectable: m, elementsSelectable: k, noPanClassName: r, onReconnect: s, onContextMenu: a, onMouseEnter: c, onMouseMove: u, onMouseLeave: l, onClick: d, reconnectRadius: f, onDoubleClick: h, onReconnectStart: p, onReconnectEnd: y, rfId: n, onError: g, edgeTypes: o, disableKeyboardA11y: v }, b))] });
}
...
const Ux = Se(Cu), Xx = El(), nc = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, width: r, height: s, fitView: a, fitViewOptions: c, minZoom: u = 0.5, maxZoom: l = 2, nodeOrigin: d, nodeExtent: f, zIndexMode: h = "basic" } = {}) => {
...
}, qx = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, width: r, height: s, fitView: a, fitViewOptions: c, minZoom: u, maxZoom: l, nodeOrigin: d, nodeExtent: f, zIndexMode: h }) => am((p, y) => {
  async function v() {
    const { nodeLookup: x, panZoom: m, fitViewOptions: k, fitViewResolver: g, width: N, height: b, minZoom: E, maxZoom: S } = y();
    m && (await og({
      nodes: x,
      width: N,
      height: b,
  ...
  return {
    ...
    setNodes: (x) => {
      const { nodeLookup: m, parentLookup: k, nodeOrigin: g, elevateNodesOnSelect: N, fitViewQueued: b, zIndexMode: E, nodesSelectionActive: S } = y(), { nodesInitialized: _, hasSelectedNodes: M } = Pi(x, m, k, {
        nodeOrigin: g,
        nodeExtent: f,
    ...
    updateNodeInternals: (x) => {
      const { triggerNodeChanges: m, nodeLookup: k, parentLookup: g, domNode: N, nodeOrigin: b, nodeExtent: E, debug: S, fitViewQueued: _, zIndexMode: M } = y(), { changes: W, updatedInternals: D } = Eg(x, k, g, N, b, E, M);
      D && (Ng(k, g, { nodeOrigin: b, nodeExtent: E, zIndexMode: M }), _ ? (v(), p({ fitViewQueued: !1, fitViewOptions: void 0 })) : p({}), W?.length > 0 && (S && console.log("React Flow: trigger node changes", W), m?.(W)));
    },
    updateNodePositions: (x, m = !1) => {
      const k = [];
      let g = [];
      const { nodeLookup: N, triggerNodeChanges: b, connection: E, updateConnection: S, onNodesChangeMiddlewareMap: _ } = y();
      for (const [M, W] of x) {
        ...
        if (D && E.inProgress && E.fromNode.id === D.id) {
          const j = Ft(D, E.fromHandle, ne.Left, !0);
          S({ ...E, from: j });
        }
        T && D.parentId && k.push({
          id: M,
      ...
      if (k.length > 0) {
        const { parentLookup: M, nodeOrigin: W } = y(), D = hs(k, N, M, W);
        g.push(...D);
      }
    ...
    triggerNodeChanges: (x) => {
      const { onNodesChange: m, setNodes: k, nodes: g, hasDefaultNodes: N, debug: b } = y();
      if (x?.length) {
        if (N) {
          const E = eu(x, g);
          k(E);
    ...
    triggerEdgeChanges: (x) => {
      const { onEdgesChange: m, setEdges: k, edges: g, hasDefaultEdges: N, debug: b } = y();
      if (x?.length) {
        if (N) {
          const E = tu(x, g);
          k(E);
    ...
    addSelectedNodes: (x) => {
      const { multiSelectionActive: m, edgeLookup: k, nodeLookup: g, triggerNodeChanges: N, triggerEdgeChanges: b } = y();
      if (m) {
        const E = x.map((S) => $t(S, !0));
        N(E);
        return;
      }
      N(sn(g, /* @__PURE__ */ new Set([...x]), !0)), b(sn(k));
    },
    addSelectedEdges: (x) => {
      const { multiSelectionActive: m, edgeLookup: k, nodeLookup: g, triggerNodeChanges: N, triggerEdgeChanges: b } = y();
      if (m) {
      ...
      b(sn(k, /* @__PURE__ */ new Set([...x]))), N(sn(g, /* @__PURE__ */ new Set(), !0));
    },
    unselectNodesAndEdges: ({ nodes: x, edges: m } = {}) => {
      const { edges: k, nodes: g, nodeLookup: N, triggerNodeChanges: b, triggerEdgeChanges: E } = y(), S = x || g, _ = m || k, M = [];
      for (const D of S) {
        if (!D.selected)
          continue;
        const T = N.get(D.id);
    ...
    resetSelectedElements: () => {
      const { edges: x, nodes: m, triggerNodeChanges: k, triggerEdgeChanges: g, elementsSelectable: N } = y();
      if (!N)
        return;
      const b = m.reduce((S, _) => _.selected ? [...S, $t(_.id, !1)] : S, []), E = x.reduce((S, _) => _.selected ? [...S, $t(_.id, !1)] : S, []);
      k(b), g(E);
    },
    setNodeExtent: (x) => {
      const { nodes: m, nodeLookup: k, parentLookup: g, nodeOrigin: N, elevateNodesOnSelect: b, nodeExtent: E, zIndexMode: S } = y();
      x[0][0] === E[0][0] && x[0][1] === E[0][1] && x[1][0] === E[1][0] && x[1][1] === E[1][1] || (Pi(m, k, g, {
        nodeOrigin: N,
        nodeExtent: x,
    ...
    panBy: (x) => {
      const { transform: m, width: k, height: g, panZoom: N, translateExtent: b } = y();
      return Cg({ delta: x, panZoom: N, transform: m, translateExtent: b, width: k, height: g });
    },
    setCenter: async (x, m, k) => {
      const { width: g, height: N, maxZoom: b, panZoom: E } = y();
      if (!E)
        return !1;
      const S = typeof k?.zoom < "u" ? k.zoom : b;
...
function Jx({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, className: r, nodeTypes: s, edgeTypes: a, onNodeClick: c, onEdgeClick: u, onInit: l, onMove: d, onMoveStart: f, onMoveEnd: h, onConnect: p, onConnectStart: y, onConnectEnd: v, onClickConnectStart: x, onClickConnectEnd: m, onNodeMouseEnter: k, onNodeMouseMove: g, onNodeMouseLeave: N, onNodeContextMenu: b, onNodeDoubleClick: E, onNodeDragStart: S, onNodeDrag: _, onNodeDragStop: M, onNodesDelete: W, onEdgesDelete: D, onDelete: T, onSelectionChange: R, onSelectionDragStart: j, onSelectionDrag: A, onSelectionDragStop: I, onSelectionContextMenu: $, onSelectionStart: z, onSelectionEnd: P, onBeforeDelete: B, connectionMode: K, connectionLineType: O = bt.Bezier, connectionLineStyle: Z, connectionLineComponent: X, connectionLineContainerStyle: oe, deleteKeyCode: se = "Backspace", selectionKeyCode: G = "Shift", selectionOnDrag: V = !1, selectionMode: Y = io.Full, panActivationKeyCode: ae = "Space", multiSelectionKeyCode: ce = ao() ? "Meta" : "Control", zoomActivationKeyCode: J = ao() ? "Meta" : "Control", snapToGrid: te, snapGrid: fe, onlyRenderVisibleElements: H = !1, selectNodesOnDrag: Q, nodesDraggable: ye, autoPanOnNodeFocus: ve, nodesConnectable: ke, nodesFocusable: Te, nodeOrigin: Ie = Jl, edgesFocusable: Oe, edgesReconnectable: be, elementsSelectable: He = !0, defaultViewport: We = Sm, minZoom: Ge = 0.5, maxZoom: Je = 2, translateExtent: Qe = ro, preventScrolling: Ct = !0, nodeExtent: qt, defaultMarkerColor: Ze = "#b1b1b7", zoomOnScroll: Yt = !0, zoomOnPinch: jn = !0, panOnScroll: Sn = !1, panOnScrollSpeed: So = 0.5, panOnScrollMode: kn = Lt.Free, zoomOnDoubleClick: Be = !0, panOnDrag: ut = !0, onPaneClick: dt, onPaneMouseEnter: Zt, onPaneMouseMove: Br, onPaneMouseLeave: En, onPaneScroll: Gt, onPaneContextMenu: mt, paneClickDistance: It = 1, nodeClickDistance: At = 0, children: ze, onReconnect: Cn, onReconnectStart: ko, onReconnectEnd: Fe, onEdgeContextMenu: Eo, onEdgeDoubleClick: we, onEdgeMouseEnter: Ke, onEdgeMouseMove: Jt, onEdgeMouseLeave: Co, reconnectRadius: ge = 10, onNodesChange: _t, onEdgesChange: Io, noDragClassName: In = "nodrag", noWheelClassName: An = "nowheel", noPanClassName: _e = "nopan", fitView: xt, fitViewOptions: ft, connectOnClick: Fr, attributionPosition: Ao, proOptions: _o, defaultEdgeOptions: _n, elevateNodesOnSelect: Kr = !0, elevateEdgesOnSelect: Dn = !1, disableKeyboardA11y: Dt = !1, autoPanOnConnect: $e, autoPanOnNodeDrag: Mn, autoPanOnSelection: Tn = !0, autoPanSpeed: $n, connectionRadius: Qt, isValidConnection: Ur, onError: Xr, style: qr, id: Do, nodeDragThreshold: Mo, connectionDragThreshold: To, viewport: $o, onViewportChange: Yr, width: Pn, height: Zr, colorMode: Gr = "light", debug: Jr, onScroll: Mt, ariaLabelConfig: en, zIndexMode: tn = "basic", ...zn }, Qr) {
  const Ln = Do || "1", ei = Im(Gr), ti = ue((Po) => {
    Po.currentTarget.scrollTo({ top: 0, left: 0, behavior: "instant" }), Mt?.(Po);
  }, [Mt]);
  return i.jsx("div", { "data-testid": "rf__wrapper", ...zn, onScroll: ti, style: { ...qr, ...Gx }, ref: Qr, className: Ee(["react-flow", r, ei]), id: Do, role: "application", children: i.jsxs(Zx, { nodes: e, edges: t, width: Pn, height: Zr, fitView: xt, fitViewOptions: ft, minZoom: Ge, maxZoom: Je, nodeOrigin: Ie, nodeExtent: qt, zIndexMode: tn, children: [i.jsx(Cm, { nodes: e, edges: t, defaultNodes: n, defaultEdges: o, onConnect: p, onConnectStart: y, onConnectEnd: v, onClickConnectStart: x, onClickConnectEnd: m, nodesDraggable: ye, autoPanOnNodeFocus: ve, nodesConnectable: ke, nodesFocusable: Te, edgesFocusable: Oe, edgesReconnectable: be, elementsSelectable: He, elevateNodesOnSelect: Kr, elevateEdgesOnSelect: Dn, minZoom: Ge, maxZoom: Je, nodeExtent: qt, onNodesChange: _t, onEdgesChange: Io, snapToGrid: te, snapGrid: fe, connectionMode: K, translateExtent: Qe, connectOnClick: Fr, defaultEdgeOptions: _n, fitView: xt, fitViewOptions: ft, onNodesDelete: W, onEdgesDelete: D, onDelete: T, onNodeDragStart: S, onNodeDrag: _, onNodeDragStop: M, onSelectionDrag: A, onSelectionDragStart: j, onSelectionDragStop: I, onMove: d, onMoveStart: f, onMoveEnd: h, noPanClassName: _e, nodeOrigin: Ie, rfId: Ln, autoPanOnConnect: $e, autoPanOnNodeDrag: Mn, autoPanSpeed: $n, onError: Xr, connectionRadius: Qt, isValidConnection: Ur, selectNodesOnDrag: Q, nodeDragThreshold: Mo, connectionDragThreshold: To, onBeforeDelete: B, debug: Jr, ariaLabelConfig: en, zIndexMode: tn }), i.jsx(Ux, { onInit: l, onNodeClick: c, onEdgeClick: u, onNodeMouseEnter: k, onNodeMouseMove: g, onNodeMouseLeave: N, onNodeContextMenu: b, onNodeDoubleClick: E, nodeTypes: s, edgeTypes: a, connectionLineType: O, connectionLineStyle: Z, connectionLineComponent: X, connectionLineContainerStyle: oe, selectionKeyCode: G, selectionOnDrag: V, selectionMode: Y, deleteKeyCode: se, multiSelectionKeyCode: ce, panActivationKeyCode: ae, zoomActivationKeyCode: J, onlyRenderVisibleElements: H, defaultViewport: We, translateExtent: Qe, minZoom: Ge, maxZoom: Je, preventScrolling: Ct, zoomOnScroll: Yt, zoomOnPinch: jn, zoomOnDoubleClick: Be, panOnScroll: Sn, panOnScrollSpeed: So, panOnScrollMode: kn, panOnDrag: ut, autoPanOnSelection: Tn, onPaneClick: dt, onPaneMouseEnter: Zt, onPaneMouseMove: Br, onPaneMouseLeave: En, onPaneScroll: Gt, onPaneContextMenu: mt, paneClickDistance: It, nodeClickDistance: At, onSelectionContextMenu: $, onSelectionStart: z, onSelectionEnd: P, onReconnect: Cn, onReconnectStart: ko, onReconnectEnd: Fe, onEdgeContextMenu: Eo, onEdgeDoubleClick: we, onEdgeMouseEnter: Ke, onEdgeMouseMove: Jt, onEdgeMouseLeave: Co, reconnectRadius: ge, defaultMarkerColor: Ze, noDragClassName: In, noWheelClassName: An, noPanClassName: _e, rfId: Ln, disableKeyboardA11y: Dt, nodeExtent: qt, viewport: $o, onViewportChange: Yr }), i.jsx(jm, { onSelectionChange: R }), ze, i.jsx(xm, { proOptions: _o, position: Ao }), i.jsx(mm, { rfId: Ln, disableKeyboardA11y: Dt })] }) });
}
var Iu = ru(Jx);
...
function Au({
  ...
  const f = ie(null), { transform: h, patternId: p } = pe(rw, Ne), y = o || ow[t], v = t === jt.Dots, x = t === jt.Cross, m = Array.isArray(n) ? n : [n, n], k = [m[0] * h[2] || 1, m[1] * h[2] || 1], g = y * h[2], N = Array.isArray(s) ? s : [s, s], b = x ? [g, g] : k, E = [
    N[0] * h[2] || 1 + b[0] / 2,
    N[1] * h[2] || 1 + b[1] / 2
  ], S = `${p}${e || ""}`;
  ...
  }, ref: f, "data-testid": "rf__background", children: [i.jsx("pattern", { id: S, x: h[0] % k[0], y: h[1] % k[1], width: k[0], height: k[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${E[0]},-${E[1]})`, children: v ? i.jsx(nw, { radius: g / 2, className: d }) : i.jsx(tw, { dimensions: b, lineWidth: r, variant: t, className: d }) }), i.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${S})` })] });
}
...
function Du({ style: e, showZoom: t = !0, showFitView: n = !0, showInteractive: o = !0, fitViewOptions: r, onZoomIn: s, onZoomOut: a, onFitView: c, onInteractiveChange: u, className: l, children: d, position: f = "bottom-left", orientation: h = "vertical", "aria-label": p }) {
  const y = je(), { isInteractive: v, minZoomReached: x, maxZoomReached: m, ariaLabelConfig: k } = pe(uw, Ne), { zoomIn: g, zoomOut: N, fitView: b } = ps(), E = () => {
    g(), s?.();
  }, S = () => {
    N(), a?.();
  }, _ = () => {
  ...
  return i.jsxs(Pr, { className: Ee(["react-flow__controls", W, l]), position: f, style: e, "data-testid": "rf__controls", "aria-label": p ?? k["controls.ariaLabel"], children: [t && i.jsxs(i.Fragment, { children: [i.jsx(Ko, { onClick: E, className: "react-flow__controls-zoomin", title: k["controls.zoomIn.ariaLabel"], "aria-label": k["controls.zoomIn.ariaLabel"], disabled: m, children: i.jsx(iw, {}) }), i.jsx(Ko, { onClick: S, className: "react-flow__controls-zoomout", title: k["controls.zoomOut.ariaLabel"], "aria-label": k["controls.zoomOut.ariaLabel"], disabled: x, children: i.jsx(sw, {}) })] }), n && i.jsx(Ko, { className: "react-flow__controls-fitview", onClick: _, title: k["controls.fitView.ariaLabel"], "aria-label": k["controls.fitView.ariaLabel"], children: i.jsx(aw, {}) }), o && i.jsx(Ko, { className: "react-flow__controls-interactive", onClick: M, title: k["controls.interactive.ariaLabel"], "aria-label": k["controls.interactive.ariaLabel"], children: v ? i.jsx(lw, {}) : i.jsx(cw, {}) }), d] });
}
...
function yw({ id: e, nodeColorFunc: t, nodeStrokeColorFunc: n, nodeClassNameFunc: o, nodeBorderRadius: r, nodeStrokeWidth: s, shapeRendering: a, NodeComponent: c, onClick: u }) {
  const { node: l, x: d, y: f, width: h, height: p } = pe((y) => {
    ...
    const x = v.internals.userNode, { x: m, y: k } = v.internals.positionAbsolute, { width: g, height: N } = gt(x);
    return {
      node: x,
      x: m,
      y: k,
...
function Tu({
  ...
  const b = je(), E = ie(null), { boundingRect: S, viewBB: _, rfId: M, panZoom: W, translateExtent: D, flowWidth: T, flowHeight: R, ariaLabelConfig: j } = pe(bw, Ne), A = e?.width ?? xw, I = e?.height ?? ww, $ = S.width / A, z = S.height / I, P = Math.max($, z), B = P * A, K = P * I, O = N * P, Z = S.x - (B - S.width) / 2 - O, X = S.y - (K - S.height) / 2 - O, oe = B + O * 2, se = K + O * 2, G = `${Nw}-${M}`, V = ie(0), Y = ie();
  V.current = P, ee(() => {
    if (E.current && W)
      return Y.current = zg({
        domNode: E.current,
  ...
  const ae = p ? (te) => {
    ...
    const H = b.getState().nodeLookup.get(fe).internals.userNode;
    y(te, H);
  }, []) : void 0, J = m ?? j["minimap.ariaLabel"];
  ...
  }, className: Ee(["react-flow__minimap", t]), "data-testid": "rf__minimap", children: i.jsxs("svg", { width: A, height: I, viewBox: `${Z} ${X} ${oe} ${se}`, className: "react-flow__minimap-svg", role: "img", "aria-labelledby": G, ref: E, onClick: ae, children: [J && i.jsx("title", { id: G, children: J }), i.jsx(mw, { onClick: ce, nodeColor: o, nodeStrokeColor: n, nodeBorderRadius: s, nodeClassName: r, nodeStrokeWidth: a, nodeComponent: c }), i.jsx("path", { className: "react-flow__minimap-mask", d: `M${Z - O},${X - O}h${oe + O * 2}v${se + O * 2}h${-oe - O * 2}z
...
function kw({ nodeId: e, position: t, variant: n = gn.Handle, className: o, style: r = void 0, children: s, color: a, minWidth: c = 10, minHeight: u = 10, maxWidth: l = Number.MAX_VALUE, maxHeight: d = Number.MAX_VALUE, keepAspectRatio: f = !1, resizeDirection: h, autoScale: p = !0, shouldResize: y, onResizeStart: v, onResize: x, onResizeEnd: m }) {
  const k = cu(), g = typeof e == "string" ? e : k, N = je(), b = ie(null), E = n === gn.Handle, S = pe(ue(jw(E && p), [E, p]), Ne), _ = ie(null), M = t ?? Sw[n];
  ee(() => {
    if (!(!b.current || !g))
      return _.current || (_.current = Yg({
        ...
        nodeId: g,
        getStoreItems: () => {
          const { nodeLookup: D, transform: T, snapGrid: R, snapToGrid: j, nodeOrigin: A, domNode: I } = N.getState();
          return {
            nodeLookup: D,
            transform: T,
            snapGrid: R,
        ...
        onChange: (D, T) => {
          const { triggerNodeChanges: R, nodeLookup: j, parentLookup: A, nodeOrigin: I } = N.getState(), $ = [], z = { x: D.x, y: D.y }, P = j.get(g);
            ...
            const B = P.origin ?? I, K = D.width ?? P.measured.width ?? 0, O = D.height ?? P.measured.height ?? 0, Z = {
              ...
              rect: {
                ...
                ...Il({
                  x: D.x ?? P.position.x,
                  y: D.y ?? P.position.y
                }, { width: K, height: O }, P.parentId, j, B)
              }
            }, X = hs([Z], j, A, I);
  ...
  const W = M.split("-");
  return i.jsx("div", { className: Ee(["react-flow__resize-control", "nodrag", ...W, n, o]), ref: b, style: {
    ...r,
    scale: S,
...
function Bw(e) {
  ...
  for (const [r, s] of Object.entries(e))
    Ww.has(r) || (Yw(s) ? t.push({
      referenceKey: Kw(r),
      value: { value: Xw(s.expression), expressionType: s.expression.type || "Literal" }
    }) : n[r] = s);
...
function Xw(e) {
  return (e.type || "Literal") === "Variable" && Kt(e.value) ? e.value : qw(e.value);
}
function qw(e) {
...
function q0(e, t, n) {
  const o = de(() => V0(t), [t]), [r, s] = U(() => bi("loading"));
  return ee(() => {
    if (!t) {
      s(bi("unavailable"));
      return;
    ...
    let a = !1;
    return s((c) => ({ ...c, status: "loading" })), X0(e, t, n).then(
      (c) => {
        a || s({ ...c, status: "ready" });
      },
      () => {
...
function Vv({
  ...
  const u = t.isReadOnly === !0, l = { activity: e, expressionDescriptors: r, readOnly: u }, d = Ki(n, t, l), f = d?.component, h = t.isWrapped !== !1 ? pd(e, t) : null, p = h?.expression.type ?? "Literal", y = Iv(e, t), v = p.toLowerCase() === "literal", x = h && v && !Mv(t) ? _v(t.typeName) : null, m = x ? Ki(n, t, { ...l, scope: "collection" }) : void 0, k = h ? {
    activity: e,
    descriptor: t,
    expressionDescriptors: r,
    readOnly: u,
    surface: "inline",
    syntax: p
  } : null, g = k ? xd(o, k) : null, N = g?.surfaces.inline, b = g && k ? wd(g, k, y) : [], E = !!(h && Uv(t, d?.id)), S = !!(h && Xv(t, d?.id)), [_, M] = U(!1), W = (j) => {
    const A = h ? Ev(h, j) : j;
    c(yc(e, t, A));
  }, D = (j) => {
    h && c(yc(e, t, Cv(h, j)));
...
function Ov({
  ...
  const c = Tv(n), u = Pv(e, t), l = { ...r, scope: "element" }, d = Ki(o, u, l)?.component, f = e.displayName || e.name, h = (N, b) => a(c.map((E, S) => S === N ? b : E)), [p, y] = U(null), [v, x] = U(null), [m, k] = U(null), g = () => {
    y(null), x(null), k(null);
  };
  return /* @__PURE__ */ i.jsxs("div", { className: "wf-collection-editor", children: [
    c.length === 0 ? /* @__PURE__ */ i.jsx("p", { className: "wf-collection-empty", children: "No items yet." }) : /* @__PURE__ */ i.jsx("ul", { className: "wf-collection-items", children: c.map((N, b) => /* @__PURE__ */ i.jsxs(
      "li",
      {
        className: [
          "wf-collection-item",
          p === b ? "wf-collection-item--dragging" : "",
          v === b && p !== b ? "wf-collection-item--drop-target" : ""
        ].filter(Boolean).join(" "),
        draggable: !s && m === b,
        onDragStart: () => y(b),
        onDragOver: (E) => {
          s || p === null || (E.preventDefault(), v !== b && x(b));
        },
        onDrop: (E) => {
          E.preventDefault(), p !== null && p !== b && a(Ni(c, p, b)), g();
        },
        onDragEnd: g,
        children: [
          /* @__PURE__ */ i.jsx(
          ...
          /* @__PURE__ */ i.jsx("div", { className: "wf-collection-item-editor", children: Wi(d, u, N, s, l, (E) => h(b, E)) }),
...
function Hv({
  ...
  const d = Oc(), f = e.displayName || e.name, h = {
    ...
    surface: "expanded",
    syntax: n
  }, p = xd(s, h), y = p?.surfaces.expanded, v = p ? wd(p, h, t) : [], x = y ? null : Fv(s, h);
  return ee(() => {
    const m = (k) => {
      k.key === "Escape" && l();
    };
...
function Bi({
  ...
  const [a, c] = U(!1), u = Oc(), l = n.find((f) => f.type === t), d = [
...
function fb({ draft: e, onApply: t }) {
  const n = de(() => Yv(e), [e]), [o, r] = U(n), [s, a] = U(n), [c, u] = U(null);
  ee(() => {
    r(n), a(n), u(null);
  }, [n]);
...
function Nb({ activities: e, activityCatalog: t, selectedEvidenceId: n = null, onSelectEvidence: o }) {
  ...
  return s.length === 0 ? /* @__PURE__ */ i.jsx("div", { className: "wf-empty wf-timeline-empty", children: "No activity executions recorded yet." }) : /* @__PURE__ */ i.jsx("ol", { className: "wf-timeline", "aria-label": "Execution timeline", children: s.map((a) => {
    const c = r.get(a.activityType), u = xr(c), l = c ? Ae(c) : Sr(a.activityType) ?? a.activityType, d = Sr(a.activityType) ?? a.activityType, f = kb(a.startedAt ?? a.scheduledAt), h = bd(a.startedAt, a.completedAt);
...
function Eb({ context: e }) {
  const t = W0(e), n = B0(e), o = F0(e), r = t.data ?? null, s = n.data ?? null, a = t.isLoading || n.isLoading, c = o.isPending, [u, l] = U(() => hc(r)), [d, f] = U(""), [h, p] = U(null);
  ee(() => {
    l(hc(r));
  }, [r]);
  ...
  }, [y, d]), k = new Set(u.activityTypes), g = new Set(u.sets), N = y.filter((T) => Rt(T.state) === "BlockedByHostBaseline").length, b = y.filter((T) => Rt(T.state) === "HiddenByManagementSettings").length, E = o.error ?? t.error ?? n.error, S = E instanceof Error ? E.message : E ? "Activity availability could not be loaded." : null, _ = (T) => l((R) => ({ ...R, mode: T })), M = (T) => l((R) => ({ ...R, activityTypes: pc(R.activityTypes, T) })), W = (T) => l((R) => ({ ...R, sets: pc(R.sets, T) })), D = () => {
    p(null), o.mutate(
      {
    ...
    /* @__PURE__ */ i.jsxs("div", { className: "availability-body", children: [
      ...
      /* @__PURE__ */ i.jsxs("section", { className: "availability-section availability-section-grow", children: [
        ...
        /* @__PURE__ */ i.jsxs("div", { className: "availability-activity-list", children: [
          ...
          m.map((T) => {
            const j = Rt(T.state) === "BlockedByHostBaseline", A = T.activityTypeKey ?? T.activityDefinitionId ?? "";
            return /* @__PURE__ */ i.jsxs("label", { className: `availability-activity-option ${j ? "disabled" : ""}`, children: [
              /* @__PURE__ */ i.jsx(
                "input",
                {
                  type: "checkbox",
...
function Ib(e, t, n) {
  ...
  const o = zb(e), r = kd(o.state.rootActivity), s = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), c = [];
...
function Db(e, t, n) {
  ...
  const r = Ut(t.sourceActivityId ?? t.sourceId ?? t.from, n), s = Ut(t.targetActivityId ?? t.targetId ?? t.to, n);
...
function Mb(e, t, n) {
  ...
  const s = Le(t.connectionId), a = Ut(t.sourceActivityId ?? t.sourceId ?? t.from, n), c = Ut(t.targetActivityId ?? t.targetId ?? t.to, n);
...
function Zb({ context: e, ai: t, onOpen: n }) {
  const [o, r] = U(""), [s, a] = U("active"), [c, u] = U(1), [l, d] = U(Hb), [f, h] = U("loading"), [p, y] = U(""), [v, x] = U(""), [m, k] = U([]), [g, N] = U(0), [b, E] = U(() => /* @__PURE__ */ new Set()), [S, _] = U(null), [M, W] = U(!1), [D, T] = U([]), [R, j] = U("idle"), A = ie(null), I = de(() => m.map((H) => H.id), [m]), $ = Xt(t, "weaver.workflows.suggest-create-metadata"), z = Xt(t, "weaver.workflows.explain-definition"), P = I.filter((H) => b.has(H)).length, B = I.length > 0 && P === I.length, K = ue(async () => {
    h("loading"), y("");
    try {
      ...
      k(Q ? H.definitions : u1(H.definitions, c, l)), N(ye), h("ready");
    } catch (H) {
  ...
  const O = ue(async () => {
    if (!(R === "loading" || R === "ready")) {
      ...
      try {
        const H = await bs(e);
        T(H.activities ?? []), j("ready");
      } catch (H) {
        j("failed"), y(H instanceof Error ? H.message : String(H));
      }
    }
  }, [R, e]), Z = () => {
  ...
  return /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
    ...
    b.size > 0 ? /* @__PURE__ */ i.jsxs("div", { className: "wf-selection-bar", "aria-live": "polite", children: [
      /* @__PURE__ */ i.jsxs("span", { children: [
        b.size,
        " selected"
      ] }),
...
function Jb({ context: e, ai: t, definitionFilter: n, onDefinitionFilterChange: o }) {
  const [r, s] = U("loading"), [a, c] = U(""), [u, l] = U(""), [d, f] = U(null), [h, p] = U([]), y = n?.trim().toLowerCase() ?? "", v = de(
    () => y ? h.filter((S) => m1(S, y)) : h,
    [y, h]
  ), x = de(
    ...
    [h]
  ), m = Xt(t, "weaver.workflows.explain-executable"), k = ue(async () => {
    s("loading"), c("");
    try {
      ...
      v.map((S) => /* @__PURE__ */ i.jsxs("div", { className: "wf-grid-row", role: "row", children: [
        /* @__PURE__ */ i.jsxs("span", { className: "wf-artifact-cell", children: [
          /* @__PURE__ */ i.jsxs("span", { className: "wf-cell-line", children: [
            ...
            /* @__PURE__ */ i.jsx(ln, { value: S.artifactId, ariaLabel: `Copy artifact ID ${S.artifactId}`, copiedLabel: "artifact ID", onCopied: b, onCopyFailed: E })
          ] }),
          /* @__PURE__ */ i.jsxs("span", { className: "wf-cell-line wf-cell-line-muted", children: [
            ...
            /* @__PURE__ */ i.jsx(ln, { value: S.artifactHash, ariaLabel: `Copy artifact hash ${S.artifactHash}`, copiedLabel: "artifact hash", onCopied: b, onCopyFailed: E })
          ] })
        ] }),
        /* @__PURE__ */ i.jsxs("span", { className: "wf-cell-line wf-version-cell", children: [
          /* @__PURE__ */ i.jsx("span", { children: S.artifactVersion }),
          /* @__PURE__ */ i.jsx(ln, { value: S.artifactVersion, ariaLabel: `Copy artifact version ${S.artifactVersion}`, copiedLabel: "artifact version", onCopied: b, onCopyFailed: E })
        ] }),
        /* @__PURE__ */ i.jsx(Qb, { executable: S, onCopied: b, onCopyFailed: E }),
        ...
        /* @__PURE__ */ i.jsxs("span", { className: "wf-row-actions", children: [
          ...
          m ? /* @__PURE__ */ i.jsxs("button", { type: "button", onClick: () => N(S), children: [
            /* @__PURE__ */ i.jsx(St, { size: 13 }),
            " Explain"
          ] }) : null
        ] })
...
function e1({ context: e, ai: t, definitionId: n, publishedArtifactId: o }) {
  const [r, s] = U("loading"), [a, c] = U(""), [u, l] = U(""), [d, f] = U(null), [h, p] = U([]), y = Xt(t, "weaver.workflows.explain-executable"), v = ue(async () => {
    s("loading"), c("");
    try {
      const b = await ud(e);
      p(b.filter((E) => x1(E, n)).sort(w1)), s("ready");
    } catch (b) {
      c(b instanceof Error ? b.message : String(b)), p([]), s("failed");
    }
  }, [e, n]);
  ee(() => {
    v();
  ...
  const x = async (b) => {
    l(""), f(null), c("");
    try {
      const E = await ld(e, b.artifactId);
      f({ artifactId: b.artifactId, workflowExecutionId: Ld(E) }), l(`Started ${b.artifactId}`);
    } catch (E) {
      c(E instanceof Error ? E.message : String(E));
    }
  }, m = (b) => {
    y && kt(t, y, b) && (c(""), f(null), l(`Sent ${b.artifactId} to Weaver`));
  }, k = () => {
  ...
  return /* @__PURE__ */ i.jsxs("div", { className: "wf-artifacts-panel", children: [
    ...
    r === "ready" && h.length > 0 ? /* @__PURE__ */ i.jsx("div", { className: "wf-artifact-list", role: "list", "aria-label": "Workflow artifacts", children: h.map((b) => /* @__PURE__ */ i.jsxs("article", { className: "wf-artifact-card", role: "listitem", "data-active": b.artifactId === o ? "true" : void 0, children: [
      /* @__PURE__ */ i.jsxs("div", { className: "wf-artifact-card-heading", children: [
        /* @__PURE__ */ i.jsxs("div", { children: [
          ...
          b.artifactId === o ? /* @__PURE__ */ i.jsx("span", { className: "wf-chip", children: "Latest publish" }) : null
        ] }),
        /* @__PURE__ */ i.jsx("span", { children: rt(b.publishedAt ?? b.createdAt) })
      ] }),
      /* @__PURE__ */ i.jsxs("div", { className: "wf-artifact-card-values", children: [
        /* @__PURE__ */ i.jsxs("span", { className: "wf-cell-line", children: [
          /* @__PURE__ */ i.jsx("code", { title: b.artifactId, children: b.artifactId }),
          /* @__PURE__ */ i.jsx(ln, { value: b.artifactId, ariaLabel: `Copy artifact ID ${b.artifactId}`, copiedLabel: "artifact ID", onCopied: g, onCopyFailed: N })
        ] }),
        /* @__PURE__ */ i.jsxs("span", { className: "wf-cell-line wf-cell-line-muted", children: [
          /* @__PURE__ */ i.jsx("code", { title: b.artifactHash, children: b.artifactHash }),
          /* @__PURE__ */ i.jsx(ln, { value: b.artifactHash, ariaLabel: `Copy artifact hash ${b.artifactHash}`, copiedLabel: "artifact hash", onCopied: g, onCopyFailed: N })
        ] })
      ] }),
      /* @__PURE__ */ i.jsxs("dl", { children: [
        ...
        /* @__PURE__ */ i.jsxs("div", { children: [
          ...
          /* @__PURE__ */ i.jsx("dd", { children: Pd(b) })
        ] })
      ] }),
      /* @__PURE__ */ i.jsxs("div", { className: "wf-row-actions", children: [
        ...
        y ? /* @__PURE__ */ i.jsxs("button", { type: "button", onClick: () => m(b), children: [
          /* @__PURE__ */ i.jsx(St, { size: 13 }),
          " Explain"
        ] }) : null
      ] })
...
function t1({ context: e }) {
  const [t, n] = U("loading"), [o, r] = U(""), [s, a] = U(""), [c, u] = U(""), [l, d] = U([]), f = ue(async () => {
    n("loading"), r("");
    try {
      const p = await rv(e, {
        status: s || void 0,
...
function n1({ context: e, ai: t, workflowExecutionId: n }) {
  const [o, r] = U("loading"), [s, a] = U(""), [c, u] = U(null), [l, d] = U(null), f = Xt(t, "weaver.workflows.explain-instance"), h = ue(async () => {
    if (!n) {
...
function k1({
  ...
  const [c, u] = U(null), [l, d] = U(null), [f, h] = U([]), [p, y] = U([]), [v, x] = U(null), [m, k] = U(er), [g, N] = U("loading"), [b, E] = U([]), [S, _] = U([]), [M, W] = U([]), [D, T] = U(null), [R, j] = U(null), [A, I] = U(null), [$, z] = U(null), [P, B] = U(""), [K, O] = U(""), [Z, X] = U("idle"), [oe, se] = U(null), [G, V] = U(!1), [Y, ae] = U(null), [ce, J] = U(() => /* @__PURE__ */ new Set()), [te, fe] = U(""), [H, Q] = U(() => $c(kc, Wb, Hn, Wn)), [ye, ve] = U(() => $c(Ec, Bb, Bn, Fn)), [ke, Te] = U(() => Pc(Cc, !1)), [Ie, Oe] = U(() => Pc(Ic, !1)), [be, He] = U(S1), [We, Ge] = U("activities"), [Je, Qe] = U("inspector"), [Ct, qt] = U("designer"), Ze = ie(null), Yt = ie(null), jn = ie(""), Sn = ie(0), So = ie(Promise.resolve()), kn = ie(/* @__PURE__ */ new Map()), Be = ie(mc()), ut = ie(null), dt = ie(""), Zt = ie(!1), [Br, En] = U(0), Gt = ie(null), mt = ie(null), It = ie(!1), At = l?.state.rootActivity ?? null, ze = de(() => new Map(f.map((w) => [w.activityVersionId, w])), [f]), Cn = ue(
    (w) => jv([w.activityVersionId, w.activityTypeKey], v),
    [v]
  ), ko = de(() => N1(p), [p]), Fe = de(() => Fu(At, b), [At, b]), Eo = ws(Fe, Fe ? ze.get(Fe.activityVersionId) : void 0), we = !!Fe && Eo === "unsupported", Ke = de(() => we ? null : Jn(At, b), [At, b, we]), Jt = de(() => Yi(f), [f]), Co = de(() => {
    ...
    [Cn, ze, ge]
  ), In = ge ? Ve(ge) : [], An = q0(e, l?.state, R), _e = Eo === "flowchart" && Ke?.slot.mode === "flowchart", xt = !At || !we, ft = Z !== "idle", Fr = !!l?.state.rootActivity && !ft, Ao = Xt(n, "weaver.workflows.find-draft-risks"), _o = Xt(n, "weaver.workflows.propose-update");
  ee(() => {
    if (!(!c || !l))
    ...
    const w = (L) => {
      ...
      const q = F.batch.workflowDefinitionId;
      if (q && q !== "active-draft" && q !== c.definition.id) {
        F.respond({ ok: !1, message: `Batch targets workflow '${q}', but '${c.definition.id}' is active.` });
        return;
      }
      try {
        const le = Un(l), re = Ib(l, F.batch, f), me = `weaver-batch-${Date.now()}`;
        kn.current.set(me, le), d(re.draft), E([]), j(re.finalActivityIds.at(-1) ?? null), ae(null), se(null), O(re.summary), B(""), F.respond({ ok: !0, result: { ...re, undoToken: me } });
      } catch (le) {
      ...
      const q = kn.current.get(F.undoToken);
      if (!q) {
        F.respond({ ok: !1, message: "The Weaver batch undo point is no longer available." });
        return;
      }
      kn.current.delete(F.undoToken), d(q), E([]), j(null), ae(null), se(null), O("Restored workflow draft before Weaver batch."), B(""), F.respond({ ok: !0, summary: "Restored workflow draft before Weaver batch." });
    };
  ...
  const _n = ue(async () => {
    B(""), N("loading");
    const [w, C, L, F, q] = await Promise.all([
      U0(e, t),
      bs(e),
      cv(e).then(
    ...
    u(w), jn.current = le ? Ue(le) : "", Be.current = mc(), ut.current = le ? Un(le) : null, dt.current = le ? Ue(le) : "", Zt.current = !1, En(0), d(le), h(C.activities ?? []), y(L.descriptors), x(q), k(F.descriptors.length > 0 ? F.descriptors : er), N(L.ok ? "ready" : "failed"), E([]), j(null);
  }, [e, t]);
  ee(() => {
  ...
  const Kr = (w) => {
    ...
    if (!Ke) {
      ...
      d((q) => {
        ...
        const le = q.state.rootActivity, re = Vi(L, [], [le]), me = C ? [
          ...q.layout.filter((xe) => xe.nodeId !== le.nodeId),
          {
            nodeId: le.nodeId,
            x: Math.round(C.x),
            y: Math.round(C.y)
      ...
      }), j(l.state.rootActivity.nodeId), B(""), O(`Wrapped root in ${Ae(w)}`);
      return;
    }
    d((F) => {
      if (!F?.state.rootActivity) return F;
      const q = Jn(F.state.rootActivity, b);
      if (!q) return F;
      const le = Vi(F.state.rootActivity, b, [...q.slot.activities, L]), re = C ? [
  ...
  }, [l?.state.rootActivity, b, we, Ke]), Dt = ue((w, C) => {
    const L = Oi(w, Rc(w)), F = {
      id: L.nodeId,
      type: "workflowActivity",
      position: C,
    ...
    we || d((F) => {
      if (!F) return F;
      const q = t0(F.layout, w), le = F.state.rootActivity;
      if (!le) return { ...F, layout: q };
      const re = Jn(le, b);
      if (!re) return { ...F, layout: q };
    ...
    const F = S.find((De) => De.id === C.source), q = S.find((De) => De.id === C.target), le = F && q ? T1(F, q) : F ? Vc(F) : L, re = Dt(w, le), xe = [...S.map((De) => De.selected ? { ...De, selected: !1 } : De), re.node], Tt = u0(M, C, re.node.id);
    _(xe), W(Tt), j(re.node.id), $e(xe, Tt, [re.activityNode]);
  ...
  ee(() => {
    const w = (L) => {
      ...
      const q = Ze.current.getBoundingClientRect();
      L.clientX >= q.left && L.clientX <= q.right && L.clientY >= q.top && L.clientY <= q.bottom && (It.current = !0, window.setTimeout(() => {
        It.current = !1;
  ...
  const Ur = (w, C) => {
    ...
    const L = async () => {
      const q = ++Sn.current, le = Ue(w);
      B("");
      try {
        const re = await ev(e, w), me = Ue(re);
        return jn.current = me, d((xe) => !xe || xe.id !== re.id ? xe : Ue(xe) === le ? re : { ...xe, validationErrors: re.validationErrors }), q === Sn.current && O(C), re;
      } catch (re) {
        throw q === Sn.current && (O(""), B(re instanceof Error ? re.message : String(re))), re;
      }
  ...
  ee(() => {
    ...
    const C = window.setTimeout(() => {
      const L = ut.current;
      L && (Be.current = xc(Be.current, L), En((F) => F + 1)), ut.current = Un(l), dt.current = w;
    }, Vb);
    return () => window.clearTimeout(C);
  }, [l]);
  const Zr = ue(() => {
    ...
    Gv(qv(l, w), w), O("Exported workflow as JSON.");
  }, [l, c]), Gr = ue((w) => {
    d((C) => C && { ...C, state: w(C.state) });
  }, []), Jr = ue((w) => {
    if (!l) return "No draft is loaded.";
    const C = Zv(w, l);
    return C.ok ? (d(C.draft), j(null), E([]), O("Applied workflow JSON."), null) : C.error;
  }, [l]), Mt = ue(() => {
    if (!l) return;
    const w = Ue(l);
    if (w === dt.current) return;
    const C = ut.current;
    C && (Be.current = xc(Be.current, C)), ut.current = Un(l), dt.current = w;
  }, [l]), en = ue((w) => {
    Zt.current = !0, ut.current = Un(w), dt.current = Ue(w), d(w), j(null), E([]), En((C) => C + 1);
  }, []), tn = ue(() => {
    if (!l) return;
    Mt();
    ...
    const w = !!l && !!ut.current && Ue(l) !== dt.current;
    return {
  ...
  const ei = async () => {
    ...
    $e(S, M);
  }, Ud = !we && S.length > 0, Xd = ue(() => {
    if (we || S.length === 0) return;
    const w = Ke?.slot.mode === "sequence" ? "sequence" : "flowchart", C = eb(S, M, w), L = S.map((F) => {
      const q = C.get(F.id);
      return q ? { ...F, position: q } : F;
    });
    _(L), $e(L, M), window.requestAnimationFrame(() => D?.fitView({ padding: 0.2 })), O("Rearranged the canvas.");
  }, [M, S, Ke, we, $e, D]), qd = (w, C) => {
    ...
    const C = new Set(w.map((q) => q.id)), L = S.filter((q) => !C.has(q.id)), F = M.filter((q) => !C.has(q.source) && !C.has(q.target));
    _(L), W(F), R && C.has(R) && j(null), $e(L, F);
  }, Jd = (w) => {
    if (we || w.length === 0) return;
    ...
    if (C.kind === "fromEmpty") {
      const q = Dt(w, L), re = [...S.map((me) => me.selected ? { ...me, selected: !1 } : me), q.node];
      _(re), j(q.node.id), $e(re, M, [q.activityNode]);
      return;
    }
    if (C.kind === "fromPort") {
      const q = S.find((De) => De.id === C.sourceNodeId), le = q ? Vc(q) : L, re = Dt(w, le), xe = [...S.map((De) => De.selected ? { ...De, selected: !1 } : De), re.node], Tt = [...M, wr(C.sourceNodeId, re.node.id, C.sourceHandleId ?? "Done")];
      _(xe), W(Tt), j(re.node.id), $e(xe, Tt, [re.activityNode]);
      return;
    }
    const F = M.find((q) => q.id === C.edgeId);
    F && $n(w, F, L);
  }, ef = de(() => ({
    highlightedEdgeId: $,
    deleteEdge: Ts,
    ...
    E((F) => [...F, { ownerNodeId: w.nodeId, slotId: C, label: L }]), j(null);
  }, Ps = ue((w) => {
    d((C) => {
    ...
    if (!C) return;
    const L = Gw(C, w, (F) => {
      const q = ze.get(F.activityVersionId);
      return q ? Ae(q) : F.nodeId;
    });
    L && (qt("designer"), E(L), j(w), Oe(!1));
    ...
    const L = C.clientX, F = w === "palette" ? H : ye, q = w === "palette" ? Hn : Bn, le = w === "palette" ? Wn : Fn;
    document.body.classList.add("wf-side-panel-resizing");
    const re = (xe) => {
      const Tt = w === "palette" ? xe.clientX - L : L - xe.clientX, De = nr(F + Tt, q, le);
    ...
    C.key === "ArrowLeft" ? (C.preventDefault(), Rs(w, w === "palette" ? -Uo : Uo)) : C.key === "ArrowRight" ? (C.preventDefault(), Rs(w, w === "palette" ? Uo : -Uo)) : C.key === "Home" ? (C.preventDefault(), w === "palette" ? Q(Hn) : ve(Bn)) : C.key === "End" && (C.preventDefault(), w === "palette" ? Q(Wn) : ve(Fn));
  };
  if (!c || !l)
  ...
  const rf = [
  ...
  }, Hs = !ke && be !== "inspector", Ws = !Ie && be !== "palette", zo = oe?.draftSignature === Ue(l) ? oe.view : null, Bs = zo && K.startsWith("Test run") ? "" : K, af = (w) => {
    ...
    },
    {
      ...
      render: () => /* @__PURE__ */ i.jsx(M1, { testRun: zo, onOpenRun: af })
    },
    {
      id: "artifacts",
      title: "Artifacts",
  ...
  ].sort(zc), Ks = oi.find((w) => w.id === We) ?? oi[0], Us = ri.find((w) => w.id === Je) ?? ri[0], lf = [
      ...
      /* @__PURE__ */ i.jsx("div", { className: "wf-palette-list", role: "tree", "aria-label": "Available activities", children: Co.length === 0 ? /* @__PURE__ */ i.jsx("p", { className: "wf-muted wf-palette-empty", children: "No matching activities." }) : Co.map((C) => {
        ...
        return /* @__PURE__ */ i.jsxs("div", { className: "wf-palette-category", children: [
          ...
          L ? /* @__PURE__ */ i.jsx("div", { className: "wf-palette-activities", role: "group", children: C.activities.map((F) => {
            const q = F.description?.trim(), le = q ? `wf-palette-description-${F.activityVersionId}` : void 0, re = Ae(F), me = xr(F);
            return /* @__PURE__ */ i.jsxs(
              "button",
              {
                type: "button",
                ...
                "aria-describedby": le,
                onClick: () => Do(F),
                onDragStart: (xe) => Ur(xe, F),
                onDragEnd: (xe) => Xr(xe, F),
                onPointerDown: (xe) => qr(xe, F),
                children: [
                  ...
                  /* @__PURE__ */ i.jsxs("span", { className: "wf-palette-activity-text", children: [
                    ...
                    q ? /* @__PURE__ */ i.jsx("small", { id: le, children: q }) : null
                  ] }),
      ...
      /* @__PURE__ */ i.jsxs("main", { className: "wf-canvas-shell", children: [
        ...
        Ct === "code" ? /* @__PURE__ */ i.jsx(fb, { draft: l, onApply: Jr }) : Ct === "properties" ? /* @__PURE__ */ i.jsx(gb, { details: c, draft: l, context: e, onStateChange: Gr }) : /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
          /* @__PURE__ */ i.jsxs("div", { className: "wf-breadcrumb", children: [
            ...
            b.map((w, C) => /* @__PURE__ */ i.jsxs(ct.Fragment, { children: [
              /* @__PURE__ */ i.jsx(on, { size: 13 }),
              /* @__PURE__ */ i.jsx("button", { type: "button", onClick: () => {
                E(b.slice(0, C + 1)), j(null);
              }, children: w.label })
          ...
          /* @__PURE__ */ i.jsx(_1, { draft: l, onRepair: nf })
        ] })
      ] }),
...
function E1({ data: e, selected: t }) {
  const n = e, o = n.runtime, r = !n.suppressFlowPorts, s = r ? n.sourcePorts.length > 0 ? n.sourcePorts : [{ name: "Done", displayName: "Done" }] : [], a = C1(n), u = ct.useContext(Dd)?.({ activityVersionId: n.activityVersionId, activityTypeKey: n.activityTypeKey }) ?? null;
  return /* @__PURE__ */ i.jsxs(
    "div",
    {
...
function I1(e) {
  const {
    ...
    label: d,
    labelStyle: f
  } = e, h = ct.useContext(_d), [p, y] = U(!1), [v, x, m] = hr({ sourceX: n, sourceY: o, targetX: r, targetY: s, sourcePosition: a, targetPosition: c }), k = h?.highlightedEdgeId === t;
  return /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
    /* @__PURE__ */ i.jsx(
      wo,
      {
...
function A1({ clientX: e, clientY: t, activities: n, onPick: o, onClose: r }) {
  const [s, a] = U(""), [c, u] = U(0), l = ie(null), d = ie(null), f = de(() => {
    const k = s.trim().toLowerCase(), g = n.filter(g1);
    return k ? g.filter((N) => Ae(N).toLowerCase().includes(k) || N.activityTypeKey.toLowerCase().includes(k) || (N.category ?? "").toLowerCase().includes(k) || (N.description ?? "").toLowerCase().includes(k)) : g;
  }, [n, s]), h = de(() => Yi(f), [f]), p = de(() => h.flatMap((k) => k.activities), [h]);
  ee(() => {
