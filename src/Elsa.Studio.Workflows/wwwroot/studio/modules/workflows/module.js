import Ke, { useMemo as re, useState as K, useEffect as ee, memo as Ee, forwardRef as cl, useRef as se, useCallback as ae, useContext as Jn, createContext as is, useLayoutEffect as Pf, lazy as Mf, Suspense as Rf, useReducer as Lf, useId as ll } from "react";
import { Boxes as Qn, Zap as zf, Play as Jt, Terminal as Vf, ListTree as rs, GitBranch as ul, ListChecks as Of, Save as os, EyeOff as uo, Shield as Gs, AlertTriangle as Mn, SlidersHorizontal as ss, Activity as dl, Search as fr, X as as, DatabaseZap as Js, ShieldCheck as Hf, Check as ln, Plus as Qt, Trash2 as Rn, ChevronRight as kt, AlertCircle as bt, Wrench as Wf, Copy as Ff, Sparkles as ft, RotateCcw as cs, ChevronDown as fl, GripVertical as pl, Maximize2 as Ln, ChevronUp as Bf, Repeat2 as Kf, Package as hl, Undo2 as Xf, Redo2 as qf, Network as Yf, Download as Uf, ChevronLeft as zn, Minimize2 as Do, Workflow as gl, Code2 as Zf } from "lucide-react";
import { useQuery as pr, useQueryClient as ml, useMutation as yl } from "@tanstack/react-query";
...
function us(e) {
  ...
  return Vn(n) ? { alias: typeof n.typeName == "string" ? n.typeName : "", collectionKind: na(e) ? "Array" : "Single" } : { alias: typeof t == "string" ? t : "", collectionKind: na(e) ? "Array" : "Single" };
}
function na(e) {
...
function gp(e, t) {
  return wl(e, t).replace(/StorageDriver$/, "");
}
function Vn(e) {
...
const mp = ["name", "Name"], ds = ["name", "Name"], yp = ["storageDriverType", "StorageDriverType"], vl = ["referenceKey", "ReferenceKey"], xp = /* @__PURE__ */ new Set(["nodeId", "activityVersionId", "inputs", "outputs", "structure"]);
function ei(e) {
  return bl(e, jp);
}
function gr(e) {
...
function bl(e, t) {
  if (!e) return e;
  const n = { ...e };
  return e.rootActivity && (n.rootActivity = To(e.rootActivity, t)), Array.isArray(e.variables) && (n.variables = zi(e.variables, $o)), Array.isArray(e.inputs) && (n.inputs = zi(e.inputs, $o)), Array.isArray(e.outputs) && (n.outputs = zi(e.outputs, (i) => jl(i, !1))), n;
}
function To(e, t) {
  ...
  return Array.isArray(i.payload.variables) && i.payload.variables.length > 0 && (s.variables = zi(i.payload.variables, $o), r = !0), r ? { ...n, structure: { ...i, payload: s } } : n;
}
function zi(e, t) {
...
function jl(e, t) {
  const n = vp(e, wp);
  return ut(e, vl).trim() || (n.referenceKey = hr()), n.type = us(e), t && (n.storageDriverType = bp(e.storageDriverType ?? e.StorageDriverType)), n;
}
function vp(e, t) {
  const n = new Set(t), i = {};
...
const ti = "elsa.sequence.structure", un = "elsa.flowchart.structure";
function Nl(e, t, n) {
  if (!e) return null;
  let i = e;
  for (const r of t) {
...
function Ip(e, t, n = (r) => r.nodeId, i) {
  if (!e) return null;
...
function $e(e, t) {
  ...
  const s = Qp(n), a = Sn(i.activities);
  return a ? [{
    ...
    mode: s,
    activities: a
  }] : Object.entries(i).filter(([, c]) => Sn(c) || Qi(c)).map(([c, u]) => ({
    id: `${n.kind}:${c}`,
    label: nh(c),
    property: c,
    cardinality: Sn(u) ? "many" : "single",
    mode: "generic",
    activities: Sn(u) ?? (Qi(u) ? [u] : [])
  }));
}
function fs(e) {
...
function Mp(e, t) {
  if (t.labelProperty && t.collectionItemLabel) {
    const n = e.map((i, r) => ot(i) && Kt(i[t.labelProperty]) === t.collectionItemLabel ? r : -1).filter((i) => i >= 0);
...
function Al(e, t) {
  if (e?.structure?.kind === un || Wp(t)) return "flowchart";
  if (e?.structure?.kind === ti || Fp(t)) return "sequence";
  if (e) {
    const n = $e(e, t)[0];
...
function Yp(e, t, n) {
  const i = Ji(t.source, n, t.sourceHandle ?? "Done", void 0), r = Ji(n, t.target, "Done", t.targetHandle ?? void 0);
...
function Qp(e) {
  return e.kind === ti ? "sequence" : e.kind === un ? "flowchart" : "generic";
}
function eh(e) {
  return e.kind === ti || e.kind === un, "Activities";
}
function th(e, t) {
...
const er = "workflow", ih = /* @__PURE__ */ new Set([ti, un]);
function rh(e, t) {
...
function Rl(e) {
  ...
  return Array.isArray(t) ? t.filter(Vn) : [];
}
function oh(e, t) {
  return e.structure ? {
    ...e,
...
const je = "/_elsa/workflow-management", lh = "/publishing", xt = {
...
async function yh(e, t) {
  ...
  return n.draft ? { ...n, draft: { ...n.draft, state: gr(n.draft.state) } } : n;
}
...
function wh(e, t, n, i) {
  const r = re(() => ah(t, i), [i, t]), [s, a] = K(() => po("loading"));
  return ee(() => {
    if (!t) {
      a(po("unavailable"));
      return;
...
async function kh(e, t) {
  const n = await e.http.putJson(
    ...
    { state: ei(t.state), layout: t.layout }
  );
  return { ...n, state: gr(n.state) };
}
...
async function Rh(e) {
  return e.http.getJson(`${je}/runtime-diagnostics/settings`);
}
async function Lh(e, t) {
  return e.http.putJson(`${je}/runtime-diagnostics/settings`, t);
}
async function zh(e) {
  const t = await yr(e, [
...
function Jh(e) {
  return [...e?.items ?? []].filter(Gh).filter((t) => t.activityTypeKey && t.activityDefinitionId).sort((t, n) => Wn(t).localeCompare(Wn(n)));
}
function Qh(e) {
...
function fg(e, t) {
  return t.isWrapped === !1 ? lg(e, t) : Yl(e, t).expression.value;
}
function Ul(e, t) {
  return vg(e) ? {
...
function xr(e) {
  switch (e) {
    case "flowchart":
      return /* @__PURE__ */ o.jsx(ul, { size: 15 });
    case "sequence":
    ...
    default:
      return /* @__PURE__ */ o.jsx(Qn, { size: 15 });
  }
}
function ba(e) {
  return `${e.activityTypeKey ?? ""}|${e.activityDefinitionId ?? ""}`;
...
function Zl({ icon: e }) {
  return /* @__PURE__ */ o.jsx("span", { className: "wf-activity-icon", "data-icon": e, "aria-hidden": "true", children: xr(e) });
}
function kg({ context: e }) {
  const t = dh(e), n = fh(e), i = uh(e), r = ph(e), s = t.data ?? null, a = n.data ?? null, c = t.isLoading || n.isLoading, u = r.isPending, [l, d] = K(() => Mo(s)), [f, p] = K(""), [h, m] = K(!1), [w, x] = K(null), [v, b] = K(null);
  ee(() => {
    d(Mo(s));
  }, [s]);
  const g = re(() => Jh(a), [a]), y = re(() => Qh(a), [a]), N = re(() => a?.sets ?? [], [a]), j = re(
    () => ng(g, N, l),
    [g, N, l]
  ), S = (O) => j.get(Cn(O)) ?? { enabled: !0, lockedBy: null }, I = re(() => {
    ...
    return O;
  }, [i.data]), _ = (O) => I.get(O.activityTypeKey ?? ""), M = re(() => {
    const O = f.trim().toLowerCase(), q = h ? g.filter((J) => !(j.get(Cn(J))?.enabled ?? !0)) : g;
    return O ? q.filter((J) => [
      Wn(J),
      ga(J),
      ma(J),
  ...
  }, [g, f, h, j]), k = re(() => eg(M), [M]), $ = v ? g.find((O) => ba(O) === v) ?? null : null, z = g.filter(Kl).length, C = g.filter((O) => _t(O.state) === "HiddenByManagementSettings").length, A = re(() => ig(l, s), [l, s]), E = r.error ?? t.error ?? n.error, D = E instanceof Error ? E.message : E ? "Activity availability could not be loaded." : null, P = (O) => {
    x(null), d(O);
    ...
    /* @__PURE__ */ o.jsxs("div", { className: "availability-body", children: [
                ...
                /* @__PURE__ */ o.jsxs("div", { className: "availability-group-header", children: [
                  ...
                  q.length > 0 && /* @__PURE__ */ o.jsx(
                    "input",
                    {
                      ...
                      disabled: c || u,
                      onChange: () => W(q.map(Cn), !Z)
                    }
                  )
                ] }),
                O.entries.map((X) => {
                  const de = Cn(X), le = ba(X), te = _t(X.state), ie = S(X), fe = ie.lockedBy !== null, V = fn(_(X)), ne = Wn(X), ge = ga(X), ye = ma(X), Ie = v === le;
                  return /* @__PURE__ */ o.jsxs("div", { className: `availability-activity-row${Ie ? " selected" : ""}${fe ? " disabled" : ""}`, children: [
                    ...
                    te !== "Available" && /* @__PURE__ */ o.jsx("em", { className: `availability-state ${Fl(X.state)}`, children: Hn(X.state) }),
                    /* @__PURE__ */ o.jsx(
                      "input",
                      {
                        type: "checkbox",
                        ...
                        checked: ie.enabled,
                        disabled: c || u || fe,
                        onChange: (Te) => F(de, Te.target.checked)
                      }
                    )
                  ] }, le);
                })
      ...
      y.length > 0 && /* @__PURE__ */ o.jsxs("section", { className: "availability-section", children: [
        ...
        /* @__PURE__ */ o.jsx("div", { className: "availability-unresolved-list", children: y.map((O) => /* @__PURE__ */ o.jsxs("span", { children: [
          ...
          /* @__PURE__ */ o.jsx("em", { children: Hn(O.state) })
...
function Eg({
  ...
  const i = Wn(e), r = e.description?.trim() || t?.description?.trim(), s = re(() => ya(t?.inputs), [t]), a = re(() => ya(t?.outputs), [t]), c = re(() => JSON.stringify({ diagnostic: e, catalog: t }, null, 2), [e, t]), u = [
  ...
  return /* @__PURE__ */ o.jsxs("aside", { className: "availability-details", "aria-label": `${i} details`, children: [
    ...
    /* @__PURE__ */ o.jsxs("div", { className: "availability-details-body", children: [
      /* @__PURE__ */ o.jsxs("p", { className: "availability-details-status", children: [
        /* @__PURE__ */ o.jsx("em", { className: `availability-state ${Fl(e.state)}`, children: Hn(e.state) }),
...
const Gl = ["Off", "Metadata", "DiagnosticSnapshot", "Payload"], Na = new Map(Gl.map((e, t) => [e, t])), Ig = [
...
function Ag({ context: e }) {
  ...
  const f = n.error ?? t.error, p = f instanceof Error ? f.message : f ? "Runtime diagnostics settings could not be loaded." : null, h = i?.hostPolicy.limitationReasons ?? [], m = i?.effective.limitationReasons ?? [], w = re(() => Gl.filter((g) => _g(g, i)), [i]), x = (g) => u((y) => ({ ...y, defaultLevel: g })), v = (g, y) => u((N) => {
    ...
    /* @__PURE__ */ o.jsxs("div", { className: "runtime-diagnostics-body", children: [
      ...
      /* @__PURE__ */ o.jsxs("section", { className: "runtime-diagnostics-section runtime-diagnostics-section-grow", children: [
        ...
        /* @__PURE__ */ o.jsx("div", { className: "runtime-diagnostics-subjects", children: Ig.map((g) => {
          const y = c.subjectOverrides[g.id] ?? "inherit", N = i ? Dg(i, g.id) : null;
            ...
            /* @__PURE__ */ o.jsxs("span", { className: "runtime-diagnostics-subject-controls", children: [
              ...
              /* @__PURE__ */ o.jsxs(
                "select",
                {
                  value: y,
                  disabled: r || s || !a,
                  onChange: (j) => v(g.id, j.target.value),
                  children: [
                    /* @__PURE__ */ o.jsx("option", { value: "inherit", children: "Inherit default" }),
                    w.map((j) => /* @__PURE__ */ o.jsx("option", { value: j, children: kn(j) }, j))
                  ]
                }
              )
            ] })
...
function Tg({
  ...
  return /* @__PURE__ */ o.jsx("div", { className: "runtime-diagnostics-levels", role: "group", "aria-label": "Default runtime diagnostics level", children: t.map((r) => /* @__PURE__ */ o.jsxs(
    "button",
    {
      ...
      onClick: () => i(r),
      children: [
        /* @__PURE__ */ o.jsx("strong", { children: kn(r) }),
        /* @__PURE__ */ o.jsx("em", { children: $g(r) })
      ]
    },
    r
  )) });
...
function Bg(e) {
  typeof e == "function" ? e = Fg(e) : e = Ql(e);
...
function Yg(e) {
  return this.select(e == null ? qg : Xg(typeof e == "function" ? e : tu(e)));
}
...
function Jg(e) {
  return this.selectAll(e == null ? Zg : Gg(typeof e == "function" ? e : tu(e)));
}
function Qg(e) {
...
function em() {
  return new Xe(this._enter || this._groups.map(nu), this._parents);
}
function tr(e, t) {
...
function nm(e, t, n, i, r, s) {
  for (var a = 0, c, u = t.length, l = s.length; a < l; ++a)
    (c = t[a]) ? (c.__data__ = s[a], i[a] = c) : n[a] = new tr(e, s[a]);
  for (; a < u; ++a)
    (c = t[a]) && (r[a] = c);
}
function im(e, t, n, i, r, s, a) {
  ...
  for (c = 0; c < f; ++c)
    h = a.call(e, s[c], c, s) + "", (u = l.get(h)) ? (i[c] = u, u.__data__ = s[c], l.delete(h)) : n[c] = new tr(e, s[c]);
  for (c = 0; c < d; ++c)
...
function om(e, t) {
  ...
  for (var s = r.length, a = new Array(s), c = new Array(s), u = new Array(s), l = 0; l < s; ++l) {
    var d = i[l], f = r[l], p = f.length, h = sm(e.call(d, d && d.__data__, l, i)), m = h.length, w = c[l] = new Array(m), x = a[l] = new Array(m), v = u[l] = new Array(p);
    n(d, f, w, x, v, h, t);
...
function am() {
  return new Xe(this._exit || this._groups.map(nu), this._parents);
}
function cm(e, t, n) {
...
function Am(e, t, n) {
  return arguments.length > 1 ? this.each((t == null ? km : typeof t == "function" ? Im : Em)(e, t, n ?? "")) : en(this.node(), e);
}
function en(e, t) {
...
function $m(e, t) {
  return arguments.length > 1 ? this.each((t == null ? _m : typeof t == "function" ? Tm : Dm)(e, t)) : this.node()[e];
}
function ru(e) {
...
function Jm(e, t) {
  var n = typeof e == "function" ? e : Jl(e), i = t == null ? Gm : typeof t == "function" ? t : xs(t);
  return this.select(function() {
...
function ni() {
  return new Xe([[document.documentElement]], lu);
}
function hy() {
  return this;
}
Xe.prototype = ni.prototype = {
  constructor: Xe,
  select: Og,
  selectAll: Bg,
  selectChild: Yg,
...
function Fe(e) {
  return typeof e == "string" ? new Xe([[document.querySelector(e)]], [document.documentElement]) : new Xe([[e]], lu);
}
function gy(e) {
  let t;
...
const my = { passive: !1 }, Fn = { capture: !0, passive: !1 };
function mo(e) {
...
function uu(e) {
  var t = e.document.documentElement, n = Fe(e).on("dragstart.drag", Zt, Fn);
  "onselectstart" in t ? n.on("selectstart.drag", Zt, Fn) : (t.__noselect = t.style.MozUserSelect, t.style.MozUserSelect = "none");
}
function du(e, t) {
  var n = e.document.documentElement, i = Fe(e).on("dragstart.drag", null);
  t && (i.on("click.drag", Zt, Fn), setTimeout(function() {
...
function fu() {
  var e = yy, t = xy, n = wy, i = vy, r = {}, s = wr("start", "drag", "end"), a = 0, c, u, l, d, f = 0;
  function p(y) {
    y.on("mousedown.drag", h).filter(i).on("touchstart.drag", x).on("touchmove.drag", v, my).on("touchend.drag touchcancel.drag", b).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function h(y, N) {
    if (!(d || !e.call(this, y, N))) {
      var j = g(this, t.call(this, y, N), y, N, "mouse");
      j && (Fe(y.view).on("mousemove.drag", m, Fn).on("mouseup.drag", w, Fn), uu(y.view), mo(y), l = !1, c = y.clientX, u = y.clientY, j("start", y));
    }
  }
  function m(y) {
    if (Zt(y), !l) {
  ...
  function w(y) {
    Fe(y.view).on("mousemove.drag mouseup.drag", null), du(y.view, l), Zt(y), r.mouse("end", y);
  }
  function x(y, N) {
    if (e.call(this, y, N)) {
  ...
  function v(y) {
    ...
    for (S = 0; S < j; ++S)
      (I = r[N[S].identifier]) && (Zt(y), I("drag", y, N[S]));
  }
  function b(y) {
    var N = y.changedTouches, j = N.length, S, I;
  ...
  return p.filter = function(y) {
    return arguments.length ? (e = typeof y == "function" ? y : Ei(!!y), p) : e;
  }, p.container = function(y) {
    return arguments.length ? (t = typeof y == "function" ? y : Ei(y), p) : t;
  }, p.subject = function(y) {
    return arguments.length ? (n = typeof y == "function" ? y : Ei(y), p) : n;
  }, p.touchable = function(y) {
    return arguments.length ? (i = typeof y == "function" ? y : Ei(!!y), p) : i;
  }, p.on = function() {
...
var Bn = 0.7, nr = 1 / Bn, Gt = "\\s*([+-]?\\d+)\\s*", Kn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", it = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", by = /^#([0-9a-f]{3,8})$/, jy = new RegExp(`^rgb\\(${Gt},${Gt},${Gt}\\)$`), Ny = new RegExp(`^rgb\\(${it},${it},${it}\\)$`), Sy = new RegExp(`^rgba\\(${Gt},${Gt},${Gt},${Kn}\\)$`), Cy = new RegExp(`^rgba\\(${it},${it},${it},${Kn}\\)$`), ky = new RegExp(`^hsl\\(${Kn},${it},${it}\\)$`), Ey = new RegExp(`^hsla\\(${Kn},${it},${it},${Kn}\\)$`), Ea = {
  aliceblue: 15792383,
...
function Tt(e) {
  var t, n;
  return e = (e + "").trim().toLowerCase(), (t = by.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? _a(t) : n === 3 ? new ze(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? Ii(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? Ii(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = jy.exec(e)) ? new ze(t[1], t[2], t[3], 1) : (t = Ny.exec(e)) ? new ze(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = Sy.exec(e)) ? Ii(t[1], t[2], t[3], t[4]) : (t = Cy.exec(e)) ? Ii(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = ky.exec(e)) ? $a(t[1], t[2] / 100, t[3] / 100, 1) : (t = Ey.exec(e)) ? $a(t[1], t[2] / 100, t[3] / 100, t[4]) : Ea.hasOwnProperty(e) ? _a(Ea[e]) : e === "transparent" ? new ze(NaN, NaN, NaN, 0) : null;
}
function _a(e) {
...
function _y(e) {
  return e instanceof ii || (e = Tt(e)), e ? (e = e.rgb(), new ze(e.r, e.g, e.b, e.opacity)) : new ze();
}
function zo(e, t, n, i) {
...
vs(ze, zo, pu(ii, {
  brighter(e) {
    return e = e == null ? nr : Math.pow(nr, e), new ze(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  darker(e) {
    return e = e == null ? Bn : Math.pow(Bn, e), new ze(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new ze(Et(this.r), Et(this.g), Et(this.b), ir(this.opacity));
  },
  displayable() {
...
function hu(e) {
  ...
  if (e instanceof ii || (e = Tt(e)), !e) return new Je();
  if (e instanceof Je) return e;
  e = e.rgb();
  var t = e.r / 255, n = e.g / 255, i = e.b / 255, r = Math.min(t, n, i), s = Math.max(t, n, i), a = NaN, c = s - r, u = (s + r) / 2;
  return c ? (t === s ? a = (n - i) / c + (n < i) * 6 : n === s ? a = (i - t) / c + 2 : a = (t - n) / c + 4, c /= u < 0.5 ? s + r : 2 - s - r, a *= 60) : c = u > 0 && u < 1 ? 0 : a, new Je(a, c, u, e.opacity);
}
function Ty(e, t, n, i) {
  return arguments.length === 1 ? hu(e) : new Je(e, t, n, i ?? 1);
}
function Je(e, t, n, i) {
...
vs(Je, Ty, pu(ii, {
  ...
  darker(e) {
    return e = e == null ? Bn : Math.pow(Bn, e), new Je(this.h, this.s, this.l * e, this.opacity);
  },
  rgb() {
  ...
  clamp() {
    return new Je(Pa(this.h), Ai(this.s), Ai(this.l), ir(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = ir(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${Pa(this.h)}, ${Ai(this.s) * 100}%, ${Ai(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function Pa(e) {
...
function My(e) {
  return (e = +e) == 1 ? gu : function(t, n) {
    return n - t ? Py(t, n, e) : bs(isNaN(t) ? n : t);
  };
}
function gu(e, t) {
  var n = t - e;
  return n ? $y(e, n) : bs(isNaN(e) ? t : e);
}
...
function $n(e, t) {
  var n = typeof t, i;
  return t == null || n === "boolean" ? bs(t) : (n === "number" ? nt : n === "string" ? (i = Tt(t)) ? (t = i, rr) : mu : t instanceof Tt ? rr : t instanceof Date ? Vy : Ly(t) ? Ry : Array.isArray(t) ? zy : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Oy : nt)(e, t);
}
...
function By(e) {
  return e == null || (_i || (_i = document.createElementNS("http://www.w3.org/2000/svg", "g")), _i.setAttribute("transform", e), !(e = _i.transform.baseVal.consolidate())) ? Oo : (e = e.matrix, yu(e.a, e.b, e.c, e.d, e.e, e.f));
}
function xu(e, t, n, i) {
  function r(l) {
  ...
  function s(l, d, f, p, h, m) {
    if (l !== f || d !== p) {
      ...
      m.push({ i: w - 4, x: nt(l, f) }, { i: w - 2, x: nt(d, p) });
  ...
  return function(l, d) {
    ...
    return l = e(l), d = e(d), s(l.translateX, l.translateY, d.translateX, d.translateY, f, p), a(l.rotate, d.rotate, f, p), c(l.skewX, d.skewX, f, p), u(l.scaleX, l.scaleY, d.scaleX, d.scaleY, f, p), l = d = null, function(h) {
      for (var m = -1, w = p.length, x; ++m < w; ) f[(x = p[m]).i] = x.x(h);
      return f.join("");
    };
  };
}
var Ky = xu(Fy, "px, ", "px)", "deg)"), Xy = xu(By, ", ", ")", ")"), qy = 1e-12;
function Ra(e) {
...
const Fi = (function e(t, n, i) {
  function r(s, a) {
    var c = s[0], u = s[1], l = s[2], d = a[0], f = a[1], p = a[2], h = d - c, m = f - u, w = h * h + m * m, x, v;
    if (w < qy)
      v = Math.log(p / l) / t, x = function(S) {
        return [
          c + S * h,
          u + S * m,
          l * Math.exp(t * S * v)
      ...
      v = (j - N) / t, x = function(S) {
        var I = S * v, _ = Ra(N), M = l / (n * b) * (_ * Uy(t * I + N) - Yy(N));
        return [
          c + M * h,
          u + M * m,
          l * _ / Ra(t * I + N)
    ...
    return x.duration = v * 1e3 * t / Math.SQRT2, x;
  }
...
var tn = 0, En = 0, bn = 0, wu = 1e3, or, In, sr = 0, $t = 0, br = 0, Xn = typeof performance == "object" && performance.now ? performance : Date, vu = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function js() {
  return $t || (vu(Zy), $t = Xn.now() + br);
}
function Zy() {
  $t = 0;
}
...
ar.prototype = bu.prototype = {
  constructor: ar,
  restart: function(e, t, n) {
    if (typeof e != "function") throw new TypeError("callback is not a function");
    n = (n == null ? js() : +n) + (t == null ? 0 : +t), !this._next && In !== this && (In ? In._next = this : or = this, In = this), this._call = e, this._time = n, Ho();
  },
  stop: function() {
...
function Qy() {
  for (var e, t = or, n, i = 1 / 0; t; )
    t._call ? (i > t._time && (i = t._time), e = t, t = t._next) : (n = t._next, t._next = null, t = e ? e._next = n : or = n);
  In = e, Ho(i);
}
function Ho(e) {
  if (!tn) {
    ...
    var t = e - $t;
    t > 24 ? (e < 1 / 0 && (En = setTimeout(La, e - Xn.now() - br)), bn && (bn = clearInterval(bn))) : (bn || (sr = Xn.now(), bn = setInterval(Jy, wu)), tn = 1, vu(La));
  }
}
function za(e, t, n) {
  var i = new ar();
...
var ex = wr("start", "end", "cancel", "interrupt"), tx = [], ju = 0, Va = 1, Wo = 2, Bi = 3, Oa = 4, Fo = 5, Ki = 6;
  ...
  function a(l) {
    ...
    for (d in i)
      if (h = i[d], h.name === n.name) {
        if (h.state === Bi) return za(a);
        h.state === Oa ? (h.state = Ki, h.timer.stop(), h.on.call("interrupt", e, e.__data__, h.index, h.group), delete i[d]) : +d < t && (h.state = Ki, h.timer.stop(), h.on.call("cancel", e, e.__data__, h.index, h.group), delete i[d]);
      }
    if (za(function() {
      n.state === Bi && (n.state = Oa, n.timer.restart(c, n.delay, n.time), c(l));
    }), n.state = Wo, n.on.call("start", e, e.__data__, n.index, n.group), n.state === Wo) {
      for (n.state = Bi, r = new Array(p = n.tween.length), d = 0, f = -1; d < p; ++d)
...
function Xi(e, t) {
  ...
  if (n) {
    ...
    for (a in n) {
      ...
      r = i.state > Wo && i.state < Fo, i.state = Ki, i.timer.stop(), i.on.call(r ? "interrupt" : "cancel", e, e.__data__, i.index, i.group), delete n[a];
    }
...
function sx(e, t) {
  ...
  if (e += "", arguments.length < 2) {
    for (var i = tt(this.node(), n).tween, r = 0, s = i.length, a; r < s; ++r)
      if ((a = i[r]).name === e)
        return a.value;
    return null;
  }
...
function Ss(e, t, n) {
  ...
  return e.each(function() {
    ...
    return tt(r, i).value[t];
  };
}
function Nu(e, t) {
  var n;
  return (typeof t == "number" ? nt : t instanceof Tt ? rr : (n = Tt(t)) ? (t = n, rr) : mu)(e, t);
}
function ax(e) {
  return function() {
    this.removeAttribute(e);
...
function px(e, t) {
  var n = vr(e), i = n === "transform" ? Xy : Nu;
  return this.attrTween(e, typeof t == "function" ? (n.local ? fx : dx)(n, i, Ss(this, "attr." + e, t)) : t == null ? (n.local ? cx : ax)(n) : (n.local ? ux : lx)(n, i, t));
}
function hx(e, t) {
  return function(n) {
...
function bx(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? wx : vx)(t, e)) : tt(this.node(), t).delay;
}
function jx(e, t) {
  return function() {
...
function Sx(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? jx : Nx)(t, e)) : tt(this.node(), t).duration;
}
function Cx(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function kx(e) {
  var t = this._id;
  return arguments.length ? this.each(Cx(t, e)) : tt(this.node(), t).ease;
}
function Ex(e, t) {
  return function() {
    var n = t.apply(this, arguments);
...
function $x(e, t) {
  var n = this._id;
  return arguments.length < 2 ? tt(this.node(), n).on.on(e) : this.each(Tx(n, e, t));
}
function Px(e) {
  return function() {
...
function Rx(e) {
  ...
  for (var i = this._groups, r = i.length, s = new Array(r), a = 0; a < r; ++a)
    for (var c = i[a], u = c.length, l = s[a] = new Array(u), d, f, p = 0; p < u; ++p)
      (d = c[p]) && (f = e.call(d, d.__data__, p, c)) && ("__data__" in d && (f.__data__ = d.__data__), l[p] = f, jr(l[p], t, n, p, l, tt(d, n)));
...
function Lx(e) {
  ...
  for (var i = this._groups, r = i.length, s = [], a = [], c = 0; c < r; ++c)
    for (var u = i[c], l = u.length, d, f = 0; f < l; ++f)
      if (d = u[f]) {
        for (var p = e.call(d, d.__data__, f, u), h, m = tt(d, n), w = 0, x = p.length; w < x; ++w)
          (h = p[w]) && jr(h, t, n, w, p, m);
        s.push(p), a.push(d);
      }
  return new pt(s, a, t, n);
}
var zx = ni.prototype.constructor;
function Vx() {
...
function Bx(e, t, n) {
  var i = (e += "") == "transform" ? Ky : Nu;
  return t == null ? this.styleTween(e, Ox(e, i)).on("end.style." + e, Su(e)) : typeof t == "function" ? this.styleTween(e, Wx(e, i, Ss(this, "style." + e, t))).each(Fx(this._id, e)) : this.styleTween(e, Hx(e, i, t), n).on("end.style." + e, null);
}
function Kx(e, t, n) {
  return function(i) {
...
function Zx(e) {
  return this.tween("text", typeof e == "function" ? Ux(Ss(this, "text", e)) : Yx(e == null ? "" : e + ""));
}
function Gx(e) {
  return function(t) {
...
function sw(e) {
  var t, n;
  e instanceof pt ? (t = e._id, e = e._name) : (t = Cu(), (n = rw).time = js(), e = e == null ? null : e + "");
  for (var i = this._groups, r = i.length, s = 0; s < r; ++s)
    for (var a = i[s], c = a.length, u, l = 0; l < c; ++l)
      (u = a[l]) && jr(u, e, t, l, a, n || ow(u, t));
  return new pt(i, this._parents, e, t);
}
ni.prototype.interrupt = ix;
ni.prototype.transition = sw;
const Di = (e) => () => e;
function aw(e, {
  sourceEvent: t,
  target: n,
...
function Eu() {
  var e = cw, t = lw, n = fw, i = uw, r = dw, s = [0, 1 / 0], a = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], c = 250, u = Fi, l = wr("start", "zoom", "end"), d, f, p, h = 500, m = 150, w = 0, x = 10;
  function v(C) {
  ...
  }, v.translateBy = function(C, A, E, D) {
    v.transform(C, function() {
  ...
  function I(C, ...A) {
    ...
    var E = j(this, A).event(C), D = this.__zoom, P = Math.max(s[0], Math.min(s[1], D.k * Math.pow(2, i.apply(this, arguments)))), T = Ge(C);
    if (E.wheel)
      (E.mouse[0][0] !== T[0] || E.mouse[0][1] !== T[1]) && (E.mouse[1] = D.invert(E.mouse[0] = T)), clearTimeout(E.wheel);
    else {
      if (D.k === P) return;
      E.mouse = [T, D.invert(T)], Xi(this), E.start();
    }
    jn(C), E.wheel = setTimeout(F, m), E.zoom("mouse", n(g(b(D, P), E.mouse[0], E.mouse[1]), E.extent, a));
    function F() {
      E.wheel = null, E.end();
    }
  }
  function _(C, ...A) {
    ...
    var E = C.currentTarget, D = j(this, A, !0).event(C), P = Fe(C.view).on("mousemove.zoom", H, !0).on("mouseup.zoom", U, !0), T = Ge(C, E), F = C.clientX, W = C.clientY;
    uu(C.view), wo(C), D.mouse = [T, this.__zoom.invert(T)], Xi(this), D.start();
    function H(O) {
      if (jn(O), !D.moved) {
        var q = O.clientX - F, J = O.clientY - W;
        D.moved = q * q + J * J > w;
      }
      D.event(O).zoom("mouse", n(g(D.that.__zoom, D.mouse[0] = Ge(O, E), D.mouse[1]), D.extent, a));
    }
    function U(O) {
      P.on("mousemove.zoom mouseup.zoom", null), du(O.view, D.moved), jn(O), D.event(O).end();
    }
  }
  function M(C, ...A) {
    if (e.apply(this, arguments)) {
      var E = this.__zoom, D = Ge(C.changedTouches ? C.changedTouches[0] : C, this), P = E.invert(D), T = E.k * (C.shiftKey ? 0.5 : 2), F = n(g(b(E, T), D, P), t.apply(this, A), a);
      jn(C), c > 0 ? Fe(this).transition().duration(c).call(N, F, D, C) : Fe(this).call(v.transform, F, D, C);
    }
  }
  function k(C, ...A) {
    if (e.apply(this, arguments)) {
      ...
      for (wo(C), F = 0; F < D; ++F)
        W = E[F], H = Ge(W, this), H = [H, this.__zoom.invert(H), W.identifier], P.touch0 ? !P.touch1 && P.touch0[2] !== H[2] && (P.touch1 = H, P.taps = 0) : (P.touch0 = H, T = !0, P.taps = 1 + !!d);
  ...
  function $(C, ...A) {
    if (this.__zooming) {
      ...
      for (jn(C), T = 0; T < P; ++T)
        F = D[T], W = Ge(F, this), E.touch0 && E.touch0[2] === F.identifier ? E.touch0[0] = W : E.touch1 && E.touch1[2] === F.identifier && (E.touch1[0] = W);
  ...
  function z(C, ...A) {
    if (this.__zooming) {
      ...
      else if (E.end(), E.taps === 2 && (F = Ge(F, this), Math.hypot(f[0] - F[0], f[1] - F[1]) < x)) {
  ...
  return v.wheelDelta = function(C) {
    return arguments.length ? (i = typeof C == "function" ? C : Di(+C), v) : i;
  }, v.filter = function(C) {
    return arguments.length ? (e = typeof C == "function" ? C : Di(!!C), v) : e;
  }, v.touchable = function(C) {
    return arguments.length ? (r = typeof C == "function" ? C : Di(!!C), v) : r;
  }, v.extent = function(C) {
    return arguments.length ? (t = typeof C == "function" ? C : Di([[+C[0][0], +C[0][1]], [+C[1][0], +C[1][1]]]), v) : t;
  }, v.scaleExtent = function(C) {
    return arguments.length ? (s[0] = +C[0], s[1] = +C[1], v) : [s[0], s[1]];
  }, v.translateExtent = function(C) {
    return arguments.length ? (a[0][0] = +C[0][0], a[1][0] = +C[1][0], a[0][1] = +C[0][1], a[1][1] = +C[1][1], v) : [[a[0][0], a[0][1]], [a[1][0], a[1][1]]];
  }, v.constrain = function(C) {
    return arguments.length ? (n = C, v) : n;
  }, v.duration = function(C) {
    return arguments.length ? (c = +C, v) : c;
  }, v.interpolate = function(C) {
    return arguments.length ? (u = C, v) : u;
  }, v.on = function() {
    var C = l.on.apply(l, arguments);
    return C === l ? v : C;
  }, v.clickDistance = function(C) {
    return arguments.length ? (w = (C = +C) * C, v) : Math.sqrt(w);
  }, v.tapDistance = function(C) {
    return arguments.length ? (x = +C, v) : x;
  }, v;
}
const qe = {
...
const Tu = (e) => "id" in e && "source" in e && "target" in e, pw = (e) => "id" in e && "position" in e && !("source" in e) && !("target" in e), Cs = (e) => "id" in e && "internals" in e && !("source" in e) && !("target" in e), ri = (e, t = [0, 0]) => {
  ...
  const n = e.reduce((i, r) => {
    ...
    const c = a ? lr(a, t.nodeOrigin) : { x: 0, y: 0, x2: 0, y2: 0 };
    return Sr(i, c);
  ...
  return e.forEach((r) => {
    (t.filter === void 0 || t.filter(r)) && (n = Sr(n, lr(r)), i = !0);
  ...
  for (const l of e.values()) {
    ...
    if (a && !f || p)
      continue;
    const h = d.width ?? l.width ?? l.initialWidth ?? null, m = d.height ?? l.height ?? l.initialHeight ?? null, w = Un(c, on(l)), x = (h ?? 0) * (m ?? 0), v = s && w > 0;
    (!l.internals.handleBounds || v || w >= x || l.dragging) && u.push(l);
  }
  return u;
}, gw = (e, t) => {
...
async function yw({ nodes: e, width: t, height: n, panZoom: i, minZoom: r, maxZoom: s }, a) {
  if (e.size === 0)
    return !0;
  const c = mw(e, a), u = oi(c), l = Is(u, t, n, a?.minZoom ?? r, a?.maxZoom ?? s, a?.padding ?? 0.1);
...
const rn = (e, t = 0, n = 1) => Math.min(Math.max(e, t), n), Pt = (e = { x: 0, y: 0 }, t, n) => ({
...
const Fa = (e, t, n) => e < t ? rn(Math.abs(e - t), 1, t) / t : e > n ? -rn(Math.abs(e - n), 1, t) / t : 0, Es = (e, t, n = 15, i = 40) => {
  ...
  const { x: n, y: i } = Cs(e) ? e.internals.positionAbsolute : ri(e, t);
  return {
    x: n,
    y: i,
...
}, Ba = (e) => Qe(e.width) && Qe(e.height) && Qe(e.x) && Qe(e.y), Qe = (e) => !isNaN(e) && isFinite(e), Ru = (e, t) => (n, i) => {
}, si = (e, t = [1, 1]) => ({
...
const Is = (e, t, n, i, r, s) => {
  const a = ww(s, t, n), c = (t - a.x) / e.width, u = (n - a.y) / e.height, l = Math.min(c, u), d = rn(l, i, r), f = e.x + e.width / 2, p = e.y + e.height / 2, h = t / 2 - f * d, m = n / 2 - p * d, w = vw(e, h, m, d, t, n), x = {
...
}, Zn = () => typeof navigator < "u" && navigator?.userAgent?.indexOf("Mac") >= 0;
function Mt(e) {
...
function Pn(e, { snapGrid: t = [0, 0], snapToGrid: n = !1, transform: i, containerBounds: r }) {
  const { x: s, y: a } = et(e), c = pn({ x: s - (r?.left ?? 0), y: a - (r?.top ?? 0) }, i), { x: u, y: l } = n ? si(c, t) : c;
  return {
    xSnapped: u,
    ySnapped: l,
    ...c
...
function Fu({ sourceX: e, sourceY: t, sourcePosition: n = ce.Bottom, targetX: i, targetY: r, targetPosition: s = ce.Top, curvature: a = 0.25 }) {
  const [c, u] = qa({
    pos: n,
    x1: e,
    y1: t,
...
const Ku = ({ source: e, sourceHandle: t, target: n, targetHandle: i }) => `xy-edge__${e}${t || ""}-${n}${i || ""}`, kw = (e, t) => t.some((n) => n.source === e.source && n.target === e.target && (n.sourceHandle === e.sourceHandle || !n.sourceHandle && !e.sourceHandle) && (n.targetHandle === e.targetHandle || !n.targetHandle && !e.targetHandle)), Ew = (e, t, n = {}) => {
...
const Ya = {
  ...
  [ce.Top]: { x: 0, y: -1 },
  [ce.Bottom]: { x: 0, y: 1 }
}, Aw = ({ source: e, sourcePosition: t = ce.Bottom, target: n }) => t === ce.Left || t === ce.Right ? e.x < n.x ? { x: 1, y: 0 } : { x: -1, y: 0 } : e.y < n.y ? { x: 0, y: 1 } : { x: 0, y: -1 }, Ua = (e, t) => Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2));
function _w({ source: e, sourcePosition: t = ce.Bottom, target: n, targetPosition: i = ce.Top, center: r, offset: s, stepPosition: a }) {
  ...
  let m = [], w, x;
  const v = { x: 0, y: 0 }, b = { x: 0, y: 0 }, [, , g, y] = Bu({
    sourceX: e.x,
    sourceY: e.y,
    targetX: n.x,
    targetY: n.y
  ...
  if (c[p] * u[p] === -1) {
    ...
    if (p === "x" ? m = c.x === h ? _ : I : m = c.y === h ? I : _, t === i) {
      ...
      if (C <= s) {
        ...
        c[p] === h ? v[p] = (l[p] > e[p] ? -1 : 1) * A : b[p] = (d[p] > n[p] ? -1 : 1) * A;
      }
    }
    if (t !== i) {
    ...
    const M = { x: l.x + v.x, y: l.y + v.y }, k = { x: d.x + b.x, y: d.y + b.y }, $ = Math.max(Math.abs(M.x - m[0].x), Math.abs(k.x - m[0].x)), z = Math.max(Math.abs(M.y - m[0].y), Math.abs(k.y - m[0].y));
    $ >= z ? (w = (M.x + k.x) / 2, x = m[0].y) : (w = m[0].x, x = (M.y + k.y) / 2);
  }
  const N = { x: l.x + v.x, y: l.y + v.y }, j = { x: d.x + b.x, y: d.y + b.y };
  return [[
    e,
...
function ur({ sourceX: e, sourceY: t, sourcePosition: n = ce.Bottom, targetX: i, targetY: r, targetPosition: s = ce.Top, borderRadius: a = 5, centerX: c, centerY: u, offset: l = 20, stepPosition: d = 0.5 }) {
  const [f, p, h, m, w] = _w({
    source: { x: e, y: t },
    sourcePosition: n,
    target: { x: i, y: r },
  ...
  for (let v = 1; v < f.length - 1; v++)
    x += Dw(f[v - 1], f[v], f[v + 1], a);
  return x += `L${f[f.length - 1].x} ${f[f.length - 1].y}`, [x, p, h, m, w];
}
function Za(e) {
...
function Tw(e) {
  ...
  const c = s?.position || ce.Bottom, u = a?.position || ce.Top, l = Rt(t, s, c), d = Rt(n, a, u);
  return {
    sourceX: l.x,
    sourceY: l.y,
    targetX: d.x,
...
function $w(e, { id: t, defaultColor: n, defaultMarkerStart: i, defaultMarkerEnd: r }) {
...
function Rw(e, t, n) {
  ...
  for (const r of e.values())
    if (r.parentId)
      ...
      const s = ri(r, i.nodeOrigin), a = Mt(r.extent) ? r.extent : i.nodeExtent, c = Pt(s, a, ht(r));
...
function Xo(e, t, n, i = {}) {
  const r = Ds(Mw, i), s = { i: 0 }, a = new Map(t), c = r?.elevateNodesOnSelect && !Ts(r.zIndexMode) ? qu : 0;
  ...
  for (const d of e) {
    ...
    if (r.checkEquality && d === f?.internals.userNode)
      ...
      const p = ri(d, r.nodeOrigin), h = Mt(d.extent) ? d.extent : r.nodeExtent, m = Pt(p, h, ht(d));
      f = {
        ...r.defaults,
        ...d,
        measured: {
...
function $s(e, t, n, i, r) {
  ...
  const f = s && !Ts(u) ? qu : 0, { x: p, y: h, z: m } = Vw(e, d, a, c, f, u), { positionAbsolute: w } = e.internals, x = p !== w.x || h !== w.y;
...
function Vw(e, t, n, i, r, s) {
  const { x: a, y: c } = t.internals.positionAbsolute, u = ht(e), l = ri(e, n), d = Mt(e.extent) ? Pt(l, e.extent, u) : l;
...
function Ps(e, t, n, i = [0, 0]) {
  ...
  for (const a of e) {
    ...
    if (!c)
      continue;
    const u = s.get(a.parentId)?.expandedRect ?? on(c), l = Mu(u, a.rect);
    s.set(a.parentId, { expandedRect: l, parent: c });
  }
  return s.size > 0 && s.forEach(({ expandedRect: a, parent: c }, u) => {
    const l = c.internals.positionAbsolute, d = ht(c), f = c.origin ?? i, p = a.x < l.x ? Math.round(Math.abs(l.x - a.x)) : 0, h = a.y < l.y ? Math.round(Math.abs(l.y - a.y)) : 0, m = Math.max(d.width, Math.round(a.width)), w = Math.max(d.height, Math.round(a.height)), x = (m - d.width) * f[0], v = (w - d.height) * f[1];
    (p > 0 || h > 0 || x || v) && (r.push({
      id: u,
      type: "position",
      position: {
...
function Ow(e, t, n, i, r, s, a) {
  ...
  for (const h of e.values()) {
    ...
    const w = As(h.nodeElement), x = m.measured.width !== w.width || m.measured.height !== w.height;
    if (!!(w.width && w.height && (x || !m.internals.handleBounds || h.force))) {
      const b = h.nodeElement.getBoundingClientRect(), g = Mt(m.extent) ? m.extent : s;
      let { positionAbsolute: y } = m.internals;
      m.parentId && m.extent === "parent" ? y = Pu(y, w, t.get(m.parentId)) : g && (y = Pt(y, g, w));
      const N = {
        ...m,
        measured: w,
        internals: {
...
function Bw({ onNodeMouseDown: e, getStoreItems: t, onDragStart: n, onDrag: i, onDragStop: r }) {
  ...
  function x({ noDragClassName: b, handleSelector: g, domNode: y, isSelectable: N, nodeId: j, nodeClickDistance: S = 0 }) {
    ...
    function I({ x: $, y: z }) {
      ...
      s = { x: $, y: z };
      let U = !1;
      const O = c.size > 1, q = O && A ? Bo(oi(c)) : null, J = O && D ? Fw({
        dragItems: c,
        snapGrid: E,
        x: $,
        y: z
    ...
    function M($) {
      ...
      const U = Pn($.sourceEvent, { transform: E, snapGrid: D, snapToGrid: P, containerBounds: d });
    ...
    const k = fu().clickDistance(S).on("start", ($) => {
      ...
      d = z?.getBoundingClientRect() || null, h = !1, m = !1, w = $.sourceEvent, C === 0 && M($), s = Pn($.sourceEvent, { transform: A, snapGrid: E, snapToGrid: D, containerBounds: d }), l = et($.sourceEvent, d);
    }).on("drag", ($) => {
      const { autoPanOnNodeDrag: z, transform: C, snapGrid: A, snapToGrid: E, nodeDragThreshold: D, nodeLookup: P } = t(), T = Pn($.sourceEvent, { transform: C, snapGrid: A, snapToGrid: E, containerBounds: d });
      ...
      j && !P.has(j)) && (h = !0), !h) {
        if (!u && z && f && (u = !0, _()), !f) {
          const F = et($.sourceEvent, d), W = F.x - l.x, H = F.y - l.y;
          Math.sqrt(W * W + H * H) > D && M($);
        }
        (s.x !== T.xSnapped || s.y !== T.ySnapped) && c && f && (l = et($.sourceEvent, d), I(T));
      }
    }).on("end", ($) => {
      if (!f || h) {
...
const Qu = () => !0;
function Uw(e, { connectionMode: t, connectionRadius: n, handleId: i, nodeId: r, edgeUpdaterType: s, isTarget: a, domNode: c, nodeLookup: u, lib: l, autoPanOnConnect: d, flowId: f, panBy: p, cancelConnection: h, onConnectStart: m, onConnect: w, onConnectEnd: x, isValidConnection: v = Qu, onReconnectEnd: b, updateConnection: g, getTransform: y, getFromHandle: N, autoPanSpeed: j, dragThreshold: S = 1, handleDomNode: I }) {
  const _ = Vu(e.target);
  let M = 0, k;
  const { x: $, y: z } = et(e), C = Ju(s, I), A = c?.getBoundingClientRect();
  let E = !1;
  if (!A || !C)
    return;
  ...
  if (!D)
    return;
  let P = et(e, A), T = !1, F = null, W = !1, H = null;
  function U() {
    if (!d || !A)
      return;
    const [le, te] = Es(P, A, j);
  ...
  function X(le) {
    if (!E) {
      const { x: ge, y: ye } = et(le), Ie = ge - $, Te = ye - z;
      if (!(Ie * Ie + Te * Te > S * S))
        return;
      R();
    }
    ...
    const te = y();
    P = et(le, A), k = qw(pn(P, te, !1, [1, 1]), n, u, O), T || (U(), T = !0);
    const ie = ed(le, {
      handle: k,
      connectionMode: t,
      fromNodeId: r,
    ...
    const fe = u.get(r), V = fe ? Rt(fe, O, ce.Left, !0) : Z.from, ne = {
      ...Z,
      from: V,
      isValid: W,
      to: ie.toHandle && W ? sn({ x: ie.toHandle.x, y: ie.toHandle.y }, te) : P,
...
function ed(e, { handle: t, connectionMode: n, fromNodeId: i, fromHandleId: r, fromType: s, doc: a, lib: c, flowId: u, isValidConnection: l = Qu, nodeLookup: d }) {
  const f = s === "target", p = t ? a.querySelector(`.${c}-flow__handle[data-id="${u}-${t?.nodeId}-${t?.id}-${t?.type}"]`) : null, { x: h, y: m } = et(e), w = a.elementFromPoint(h, m), x = w?.classList.contains(`${c}-flow__handle`) ? w : p, v = {
    handleDomNode: x,
    isValid: !1,
    connection: null,
    toHandle: null
  ...
  if (x) {
    ...
    v.isValid = _ && l(S), v.toHandle = Gu(g, b, y, d, n, !0);
  }
  return v;
}
const qo = {
  ...
  function s({ translateExtent: c, width: u, height: l, zoomStep: d = 1, pannable: f = !0, zoomable: p = !0, inversePan: h = !1 }) {
    const m = (g) => {
      if (g.sourceEvent.type !== "wheel" || !t)
        return;
      const y = n(), N = g.sourceEvent.ctrlKey && Zn() ? 10 : 1, j = -g.sourceEvent.deltaY * (g.sourceEvent.deltaMode === 1 ? 0.05 : g.sourceEvent.deltaMode ? 1 : 2e-3) * d, S = y[2] * Math.pow(2, j * N);
      t.scaleTo(S);
    };
    let w = [0, 0];
    const x = (g) => {
    ...
    }, b = Eu().on("start", x).on("zoom", f ? v : null).on("zoom.wheel", p ? m : null);
    r.call(b, {});
  }
  function a() {
    r.on("zoom", null);
...
const kr = (e) => ({
  ...
  y: e.y,
  zoom: e.k
}), bo = ({ x: e, y: t, zoom: n }) => Nr.translate(e, t).scale(n), Xt = (e, t) => e.target.closest(`.${t}`), td = (e, t) => t === 2 && Array.isArray(e) && e.includes(2), Gw = (e) => ((e *= 2) <= 1 ? e * e * e : (e -= 2) * e * e + 2) / 2, jo = (e, t = 0, n = Gw, i = () => {
}) => {
  const r = typeof t == "number" && t > 0;
  return r || i(), r ? e.transition().duration(t).ease(n).on("end", i) : e;
}, nd = (e) => {
  const t = e.ctrlKey && Zn() ? 10 : 1;
...
function Jw({ zoomPanValues: e, noWheelClassName: t, d3Selection: n, d3Zoom: i, panOnScrollMode: r, panOnScrollSpeed: s, zoomOnPinch: a, onPanZoomStart: c, onPanZoom: u, onPanZoomEnd: l }) {
  return (d) => {
    ...
    if (d.ctrlKey && a) {
      const x = Ge(d), v = nd(d), b = f * Math.pow(2, v);
      i.scaleTo(n, b, x, d);
      return;
    }
    const p = d.deltaMode === 1 ? 20 : 1;
    let h = r === It.Vertical ? 0 : d.deltaX * p, m = r === It.Horizontal ? 0 : d.deltaY * p;
    !Zn() && d.shiftKey && r !== It.Vertical && (h = d.deltaY * p, m = 0), i.translateBy(
      n,
      -(h / f) * s,
      -(m / f) * s,
      // @ts-ignore
...
function tv({ zoomPanValues: e, panOnDrag: t, onPaneContextMenu: n, onTransformChange: i, onPanZoom: r }) {
  return (s) => {
    e.usedRightMouseButton = !!(n && td(t, e.mouseButton ?? 0)), s.sourceEvent?.sync || i([s.transform.x, s.transform.y, s.transform.k]), r && !s.sourceEvent?.internal && r?.(s.sourceEvent, kr(s.transform));
  };
}
...
function rv({ domNode: e, minZoom: t, maxZoom: n, translateExtent: i, viewport: r, onPanZoom: s, onPanZoomStart: a, onPanZoomEnd: c, onDraggingChange: u }) {
  const l = {
    ...
    isPanScrolling: !1
  }, d = e.getBoundingClientRect(), f = Eu().scaleExtent([t, n]).translateExtent(i), p = Fe(e).call(f);
  b({
    x: r.x,
    y: r.y,
    zoom: rn(r.zoom, t, n)
  ...
  async function w(k, $) {
    return p ? new Promise((z) => {
      f?.interpolate($?.interpolate === "linear" ? $n : Fi).transform(jo(p, $?.duration, $?.ease, () => z(!0)), k);
    }) : !1;
  }
  function x({ noWheelClassName: k, noPanClassName: $, onPaneContextMenu: z, userSelectionActive: C, panOnScroll: A, panOnDrag: E, panOnScrollMode: D, panOnScrollSpeed: P, preventScrolling: T, zoomOnPinch: F, zoomOnScroll: W, zoomOnDoubleClick: H, zoomActivationKeyPressed: U, lib: O, onTransformChange: q, connectionInProgress: J, paneClickDistance: Z, selectionOnDrag: R }) {
    C && !l.isZoomingOrPanning && v();
    const X = A && !U && !C;
    f.clickDistance(R ? 1 / 0 : !Qe(Z) || Z < 0 ? 0 : Z);
    const de = X ? Jw({
      zoomPanValues: l,
      noWheelClassName: k,
      d3Selection: p,
  ...
  async function j(k, $) {
    return p ? new Promise((z) => {
      f?.interpolate($?.interpolate === "linear" ? $n : Fi).scaleTo(jo(p, $?.duration, $?.ease, () => z(!0)), k);
    }) : !1;
  }
  async function S(k, $) {
    return p ? new Promise((z) => {
      f?.interpolate($?.interpolate === "linear" ? $n : Fi).scaleBy(jo(p, $?.duration, $?.ease, () => z(!0)), k);
    }) : !1;
  }
  function I(k) {
    f?.scaleExtent(k);
...
function sv(e, t, n, i, r, s, a, c) {
  ...
  const { isHorizontal: d, isVertical: f } = t, p = d && f, { xSnapped: h, ySnapped: m } = n, { minWidth: w, maxWidth: x, minHeight: v, maxHeight: b } = i, { x: g, y, width: N, height: j, aspectRatio: S } = e;
  let I = Math.floor(d ? h - e.pointerX : 0), _ = Math.floor(f ? m - e.pointerY : 0);
  const M = N + (u ? -I : I), k = j + (l ? -_ : _), $ = -s[0] * N, z = -s[1] * j;
  let C = $i(M, w, x), A = $i(k, v, b);
  if (a) {
    let P = 0, T = 0;
...
const id = { width: 0, height: 0, x: 0, y: 0 }, av = {
  ...id,
  pointerX: 0,
  pointerY: 0,
  aspectRatio: 1
...
function lv({ domNode: e, nodeId: t, getStoreItems: n, onChange: i, onEnd: r }) {
  ...
  function c({ controlPosition: l, boundaries: d, keepAspectRatio: f, resizeDirection: p, onResizeStart: h, onResize: m, onResizeEnd: w, shouldResize: x }) {
    let v = { ...id }, b = { ...av };
    a = {
      boundaries: d,
      resizeDirection: p,
    ...
    const M = fu().on("start", (k) => {
      ...
      const { xSnapped: P, ySnapped: T } = Pn(k.sourceEvent, {
        transform: z,
        snapGrid: C,
        snapToGrid: A,
        containerBounds: y
      ...
      const { transform: $, snapGrid: z, snapToGrid: C, nodeOrigin: A } = n(), E = Pn(k.sourceEvent, {
        transform: $,
        snapGrid: z,
        snapToGrid: C,
        containerBounds: y
      ...
      if (!g)
        return;
      const { x: P, y: T, width: F, height: W } = v, H = {}, U = g.origin ?? A, { width: O, height: q, x: J, y: Z } = sv(b, a.controlDirection, E, a.boundaries, a.keepAspectRatio, U, S, I), R = O !== F, X = q !== W, de = J !== P && R, le = Z !== T && X;
      if (!de && !le && !R && !X)
        return;
      if ((de || le || U[0] === 1 || U[1] === 1) && (H.x = de ? J : v.x, H.y = le ? Z : v.y, v.x = H.x, v.y = H.y, N.length > 0)) {
        const V = J - P, ne = Z - T;
        for (const ge of N)
          ge.position = {
      ...
      if ((R || X) && (H.width = R && (!a.resizeDirection || a.resizeDirection === "horizontal") ? O : v.width, H.height = X && (!a.resizeDirection || a.resizeDirection === "vertical") ? q : v.height, v.width = H.width, v.height = H.height), j && g.expandParent) {
        const V = U[0] * (H.width ?? 0);
        H.x && H.x < V && (v.x = V, b.x = b.x - (H.x - V));
        const ne = U[1] * (H.height ?? 0);
        H.y && H.y < ne && (v.y = ne, b.y = b.y - (H.y - ne));
      }
      const te = ov({
        width: v.width,
        prevWidth: F,
...
function uv() {
  ...
  function c(f, p) {
    var h = p(), m = i({ inst: { value: h, getSnapshot: p } }), w = m[0].inst, x = m[1];
    return s(
      function() {
...
var rc;
function dv() {
  return rc || (rc = 1, Co.exports = uv()), Co.exports;
}
var oc;
function fv() {
  if (oc) return So;
...
var sc;
function pv() {
  return sc || (sc = 1, No.exports = fv()), No.exports;
}
var hv = pv();
const gv = /* @__PURE__ */ Jf(hv), mv = {}, ac = (e) => {
  let t;
  ...
  return u;
}, yv = (e) => e ? ac(e) : ac, { useDebugValue: xv } = Ke, { useSyncExternalStoreWithSelector: wv } = gv, vv = (e) => e;
function rd(e, t = vv, n) {
  const i = wv(
    e.subscribe,
    e.getState,
...
function Nv() {
  ...
  return e(), Eo.exports = jv(), Eo.exports;
}
var Sv = Nv();
const Er = is(null), Cv = Er.Provider, od = qe.error001("react");
function he(e, t) {
  const n = Jn(Er);
  if (n === null)
    throw new Error(od);
...
const dc = { display: "none" }, kv = {
  ...
  clipPath: "inset(100%)"
}, sd = "react-flow__node-desc", ad = "react-flow__edge-desc", Ev = "react-flow__aria-live", Iv = (e) => e.ariaLiveMessage, Av = (e) => e.ariaLabelConfig;
function _v({ rfId: e }) {
  const t = he(Iv);
...
function Dv({ rfId: e, disableKeyboardA11y: t }) {
  const n = he(Av);
  return o.jsxs(o.Fragment, { children: [o.jsx("div", { id: `${sd}-${e}`, style: dc, children: t ? n["node.a11yDescription.default"] : n["node.a11yDescription.keyboardDisabled"] }), o.jsx("div", { id: `${ad}-${e}`, style: dc, children: n["edge.a11yDescription.default"] }), !t && o.jsx(_v, { rfId: e })] });
}
const Ir = cl(({ position: e = "top-left", children: t, className: n, style: i, ...r }, s) => {
  const a = `${e}`.split("-");
  return o.jsx("div", { className: Ae(["react-flow__panel", n, ...a]), style: i, ref: s, ...r, children: t });
});
Ir.displayName = "Panel";
function Tv({ proOptions: e, position: t = "bottom-right" }) {
  return e?.hideAttribution ? null : o.jsx(Ir, { position: t, className: "react-flow__attribution", "data-message": "Please only hide this attribution when you are subscribed to React Flow Pro: https://pro.reactflow.dev", children: o.jsx("a", { href: "https://reactflow.dev", target: "_blank", rel: "noopener noreferrer", "aria-label": "React Flow attribution", children: "React Flow" }) });
}
const $v = (e) => {
  const t = [], n = [];
...
function Pv(e, t) {
  return be(e.selectedNodes.map(Pi), t.selectedNodes.map(Pi)) && be(e.selectedEdges.map(Pi), t.selectedEdges.map(Pi));
}
function Mv({ onSelectionChange: e }) {
  const t = Ne(), { selectedNodes: n, selectedEdges: i } = he($v, Pv);
  return ee(() => {
...
const cd = [0, 0], zv = { x: 0, y: 0, zoom: 1 }, Vv = [
  "nodes",
  "edges",
  "defaultNodes",
  "defaultEdges",
...
function Hv(e) {
  const { setNodes: t, setEdges: n, setMinZoom: i, setMaxZoom: r, setTranslateExtent: s, setNodeExtent: a, reset: c, setDefaultNodesAndEdges: u } = he(Ov, be), l = Ne();
...
function Gn(e = null, t = { target: gc, actInsideInputWithModifier: !0 }) {
  const [n, i] = K(!1), r = se(!1), s = se(/* @__PURE__ */ new Set([])), [a, c] = re(() => {
    if (e !== null) {
    ...
    if (e !== null) {
      const d = (h) => {
        if (r.current = h.ctrlKey || h.metaKey || h.shiftKey || h.altKey, (!r.current || r.current && !l) && Ou(h))
          return !1;
        const w = yc(h.code, c);
        if (s.current.add(h[w]), mc(a, s.current, !1)) {
          const x = h.composedPath?.()?.[0] || h.target, v = x?.nodeName === "BUTTON" || x?.nodeName === "A";
          t.preventDefault !== !1 && (r.current || !v) && h.preventDefault(), i(!0);
        }
      }, f = (h) => {
        const m = yc(h.code, c);
...
const vc = (e) => pw(e), Xv = (e) => Tu(e);
function hd(e) {
  return cl(e);
}
const qv = typeof window < "u" ? Pf : ee;
function bc(e) {
...
function Uv({ children: e }) {
  const t = Ne(), n = ae((c) => {
    ...
    d && l(w), x.length > 0 ? f?.(x) : h && window.requestAnimationFrame(() => {
      const { fitViewQueued: v, nodes: b, setNodes: g } = t.getState();
      v && g(b);
    });
  }, []), i = bc(n), r = ae((c) => {
  ...
  }, []), s = bc(r), a = re(() => ({ nodeQueue: i, edgeQueue: s }), []);
...
function Ms() {
  const e = Fv(), t = Ne(), n = Zv(), i = he(Gv), r = re(() => {
    const s = (f) => t.getState().nodeLookup.get(f), a = (f) => {
      n.nodeQueue.push(f);
    }, c = (f) => {
      n.edgeQueue.push(f);
    }, u = (f) => {
      const { nodeLookup: p, nodeOrigin: h } = t.getState(), m = vc(f) ? f : p.get(f.id), w = m.parentId ? zu(m.position, m.measured, m.parentId, p, h) : m.position, x = {
        ...m,
        position: w,
    ...
    return {
      ...
      toObject: () => {
        const { nodes: f = [], edges: p = [], transform: h } = t.getState(), [m, w, x] = h;
        return {
          nodes: f.map((v) => ({ ...v })),
          edges: p.map((v) => ({ ...v })),
          viewport: {
      ...
      deleteElements: async ({ nodes: f = [], edges: p = [] }) => {
        const { nodes: h, edges: m, onNodesDelete: w, onEdgesDelete: x, triggerNodeChanges: v, triggerEdgeChanges: b, onDelete: g, onBeforeDelete: y } = t.getState(), { nodes: N, edges: j } = await xw({
          nodesToRemove: f,
          edgesToRemove: p,
          nodes: h,
          edges: m,
      ...
      getIntersectingNodes: (f, p = !0, h) => {
        const m = Ba(f), w = m ? f : u(f), x = h !== void 0;
        return w ? (h || t.getState().nodes).filter((v) => {
          const b = t.getState().nodeLookup.get(v.id);
          if (b && !m && (v.id === f.id || !b.internals.positionAbsolute))
            return !1;
          const g = on(x ? v : b), y = Un(g, w);
...
function Qv({ deleteKeyCode: e, multiSelectionKeyCode: t }) {
  const n = Ne(), { deleteElements: i } = Ms(), r = Gn(e, { actInsideInputWithModifier: !1 }), s = Gn(t, { target: Jv });
  ee(() => {
    if (r) {
...
function n0({ onPaneContextMenu: e, zoomOnScroll: t = !0, zoomOnPinch: n = !0, panOnScroll: i = !1, panOnScrollSpeed: r = 0.5, panOnScrollMode: s = It.Free, zoomOnDoubleClick: a = !0, panOnDrag: c = !0, defaultViewport: u, translateExtent: l, minZoom: d, maxZoom: f, zoomActivationKeyCode: p, preventScrolling: h = !0, children: m, noWheelClassName: w, noPanClassName: x, onViewportChange: v, isControlledViewport: b, paneClickDistance: g, selectionOnDrag: y }) {
  ...
  return ee(() => {
    ...
    y,
    g
  ]), o.jsx("div", { className: "react-flow__renderer", ref: j, style: Ar, children: m });
}
const i0 = (e) => ({
  userSelectionActive: e.userSelectionActive,
...
function r0() {
  const { userSelectionActive: e, userSelectionRect: t } = he(i0, be);
...
function s0({ isSelecting: e, selectionKeyPressed: t, selectionMode: n = Yn.Full, panOnDrag: i, autoPanOnSelection: r, paneClickDistance: s, selectionOnDrag: a, onSelectionStart: c, onSelectionEnd: u, onPaneClick: l, onPaneContextMenu: d, onPaneScroll: f, onPaneMouseEnter: p, onPaneMouseMove: h, onPaneMouseLeave: m, children: w }) {
  const x = se(0), v = Ne(), { userSelectionActive: b, elementsSelectable: g, dragging: y, connectionInProgress: N, panBy: j, autoPanSpeed: S } = he(o0, be), I = g && (e || b), _ = se(null), M = se(), k = se(/* @__PURE__ */ new Set()), $ = se(/* @__PURE__ */ new Set()), z = se(!1), C = se({ x: 0, y: 0 }), A = se(!1), E = (R) => {
    if (z.current || N) {
      z.current = !1;
      return;
    }
    l?.(R), v.getState().resetSelectedElements(), v.setState({ nodesSelectionActive: !1 });
  }, D = (R) => {
    ...
    const { domNode: X, transform: de } = v.getState();
    ...
    const { x: fe, y: V } = et(R.nativeEvent, M.current), ne = pn({ x: fe, y: V }, de);
    v.setState({
      userSelectionRect: {
        width: 0,
        height: 0,
  ...
  function W(R, X) {
    const { userSelectionRect: de } = v.getState();
    if (!de)
      return;
    const { transform: le, nodeLookup: te, edgeLookup: ie, connectionLookup: fe, triggerNodeChanges: V, triggerEdgeChanges: ne, defaultEdgeOptions: ge } = v.getState(), ye = { x: de.startX, y: de.startY }, { x: Ie, y: Te } = sn(ye, le), Ve = {
      startX: ye.x,
      startY: ye.y,
      x: R < Ie ? R : Ie,
      y: X < Te ? X : Te,
      width: Math.abs(R - Ie),
      height: Math.abs(X - Te)
    }, at = k.current, Ue = $.current;
    k.current = new Set(ks(te, Ve, le, n === Yn.Partial, !0).map((Me) => Me.id)), $.current = /* @__PURE__ */ new Set();
    const Ze = ge?.selectable ?? !0;
    for (const Me of k.current) {
      const Oe = fe.get(Me);
      if (Oe)
        for (const { edgeId: xe } of Oe.values()) {
          const Ye = ie.get(xe);
          Ye && (Ye.selectable ?? Ze) && $.current.add(xe);
        }
    }
    if (!Ka(at, k.current)) {
      const Me = qt(te, k.current, !0);
      V(Me);
    }
    if (!Ka(Ue, $.current)) {
      const Me = qt(ie, $.current);
      ne(Me);
    }
    v.setState({
  ...
  ee(() => () => U(), []);
  const O = (R) => {
    const { userSelectionRect: X, transform: de, resetSelectedElements: le } = v.getState();
    if (!M.current || !X)
      return;
    const { x: te, y: ie } = et(R.nativeEvent, M.current);
    C.current = { x: te, y: ie };
    const fe = sn({ x: X.startX, y: X.startY }, de);
    if (!z.current) {
      const V = t ? 0 : s;
    ...
    R.button === 0 && (R.target?.releasePointerCapture?.(R.pointerId), !b && R.target === _.current && v.getState().userSelectionRect && E?.(R), v.setState({
      userSelectionActive: !1,
      userSelectionRect: null
    }), z.current && (u?.(R), v.setState({
      nodesSelectionActive: k.current.size > 0
    })), U());
  }, J = (R) => {
    R.target?.releasePointerCapture?.(R.pointerId), U();
  }, Z = i === !0 || Array.isArray(i) && i.includes(0);
  return o.jsxs("div", { className: Ae(["react-flow__pane", { draggable: Z, dragging: y, selection: e }]), onClick: I ? void 0 : Io(E, _), onContextMenu: Io(D, _), onWheel: Io(P, _), onPointerEnter: I ? void 0 : p, onPointerMove: I ? O : h, onPointerUp: I ? q : void 0, onPointerCancel: I ? J : void 0, onPointerDownCapture: I ? F : void 0, onClickCapture: I ? T : void 0, onPointerLeave: m, ref: _, style: Ar, children: [w, o.jsx(r0, {})] });
}
...
function yd() {
  const e = Ne();
  return ae((n) => {
    const { nodeExtent: i, snapToGrid: r, snapGrid: s, nodesDraggable: a, onError: c, updateNodePositions: u, nodeLookup: l, nodeOrigin: d } = e.getState(), f = /* @__PURE__ */ new Map(), p = a0(a), h = r ? s[0] : 5, m = r ? s[1] : 5, w = n.direction.x * h * n.factor, x = n.direction.y * m * n.factor;
    for (const [, v] of l) {
      if (!p(v))
        continue;
      let b = {
        x: v.internals.positionAbsolute.x + w,
      ...
      v.position = g, v.internals.positionAbsolute = y, f.set(v.id, v);
    }
    u(f);
  }, []);
}
const Rs = is(null), c0 = Rs.Provider;
Rs.Consumer;
const xd = () => Jn(Rs), l0 = (e) => ({
...
function d0({ type: e = "source", position: t = ce.Top, isValidConnection: n, isConnectable: i = !0, isConnectableStart: r = !0, isConnectableEnd: s = !0, id: a, onConnect: c, children: u, className: l, onMouseDown: d, onTouchStart: f, ...p }, h) {
  const m = a || null, w = e === "target", x = Ne(), v = xd(), { connectOnClick: b, noPanClassName: g, rfId: y } = he(l0, be), { connectingFrom: N, connectingTo: j, clickConnecting: S, isPossibleEndHandle: I, connectionInProcess: _, clickConnectionInProcess: M, valid: k } = he(u0(v, m, e), be);
  v || x.getState().onError?.("010", qe.error010());
  const $ = (A) => {
    ...
    if (!v || !P && !r)
      return;
    if (!P) {
      E?.(A.nativeEvent, { nodeId: v, handleId: m, handleType: e }), x.setState({ connectionClickStartHandle: { nodeId: v, type: e, id: m } });
      return;
    }
  ...
  return o.jsx("div", { "data-handleid": m, "data-nodeid": v, "data-handlepos": t, "data-id": `${y}-${v}-${m}-${e}`, className: Ae([
    "react-flow__handle",
...
const cn = Ee(hd(d0));
function f0({ data: e, isConnectable: t, sourcePosition: n = ce.Bottom }) {
  return o.jsxs(o.Fragment, { children: [e?.label, o.jsx(cn, { type: "source", position: n, isConnectable: t })] });
}
function p0({ data: e, isConnectable: t, targetPosition: n = ce.Top, sourcePosition: i = ce.Bottom }) {
...
function g0({ data: e, isConnectable: t, targetPosition: n = ce.Top }) {
...
const y0 = (e) => {
  const { width: t, height: n, x: i, y: r } = oi(e.nodeLookup, {
    filter: (s) => !!s.selected
  });
  return {
    width: Qe(t) ? t : null,
...
function x0({ onSelectionContextMenu: e, noPanClassName: t, disableKeyboardA11y: n }) {
  const i = Ne(), { width: r, height: s, transformString: a, userSelectionActive: c } = he(y0, be), u = yd(), l = se(null);
  ee(() => {
    n || l.current?.focus({
      preventScroll: !0
    });
  ...
  const f = e ? (h) => {
    ...
    Object.prototype.hasOwnProperty.call(dr, h.key) && (h.preventDefault(), u({
      direction: dr[h.key],
...
function wd({ children: e, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: i, onPaneMouseLeave: r, onPaneContextMenu: s, onPaneScroll: a, paneClickDistance: c, deleteKeyCode: u, selectionKeyCode: l, selectionOnDrag: d, selectionMode: f, onSelectionStart: p, onSelectionEnd: h, multiSelectionKeyCode: m, panActivationKeyCode: w, zoomActivationKeyCode: x, elementsSelectable: v, zoomOnScroll: b, zoomOnPinch: g, panOnScroll: y, panOnScrollSpeed: N, panOnScrollMode: j, zoomOnDoubleClick: S, panOnDrag: I, autoPanOnSelection: _, defaultViewport: M, translateExtent: k, minZoom: $, maxZoom: z, preventScrolling: C, onSelectionContextMenu: A, noWheelClassName: E, noPanClassName: D, disableKeyboardA11y: P, onViewportChange: T, isControlledViewport: F }) {
  const { nodesSelectionActive: W, userSelectionActive: H } = he(w0, be), U = Gn(l, { target: Sc }), O = Gn(w, { target: Sc }), q = O || I, J = O || y, Z = d && q !== !0, R = U || H || Z;
  return Qv({ deleteKeyCode: u, multiSelectionKeyCode: m }), o.jsx(n0, { onPaneContextMenu: s, elementsSelectable: v, zoomOnScroll: b, zoomOnPinch: g, panOnScroll: J, panOnScrollSpeed: N, panOnScrollMode: j, zoomOnDoubleClick: S, panOnDrag: !U && q, defaultViewport: M, translateExtent: k, minZoom: $, maxZoom: z, zoomActivationKeyCode: x, preventScrolling: C, noWheelClassName: E, noPanClassName: D, onViewportChange: T, isControlledViewport: F, paneClickDistance: c, selectionOnDrag: Z, children: o.jsxs(s0, { onSelectionStart: p, onSelectionEnd: h, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: i, onPaneMouseLeave: r, onPaneContextMenu: s, onPaneScroll: a, panOnDrag: q, autoPanOnSelection: _, isSelecting: !!R, selectionMode: f, selectionKeyPressed: U, paneClickDistance: c, selectionOnDrag: Z, children: [e, W && o.jsx(x0, { onSelectionContextMenu: A, noPanClassName: D, disableKeyboardA11y: P })] }) });
}
wd.displayName = "FlowRenderer";
const v0 = Ee(wd), b0 = (e) => (t) => e ? ks(t.nodeLookup, { x: 0, y: 0, width: t.width, height: t.height }, t.transform, !0).map((n) => n.id) : Array.from(t.nodeLookup.keys());
function j0(e) {
  return he(ae(b0(e), [e]), be);
}
...
function C0({ node: e, nodeType: t, hasDimensions: n, resizeObserver: i }) {
  const r = Ne(), s = se(null), a = se(null), c = se(e.sourcePosition), u = se(e.targetPosition), l = se(t), d = n && !!e.internals.handleBounds;
  return ee(() => {
...
function k0({ id: e, onClick: t, onMouseEnter: n, onMouseMove: i, onMouseLeave: r, onContextMenu: s, onDoubleClick: a, nodesDraggable: c, elementsSelectable: u, nodesConnectable: l, nodesFocusable: d, resizeObserver: f, noDragClassName: p, noPanClassName: h, disableKeyboardA11y: m, rfId: w, nodeTypes: x, nodeClickDistance: v, onError: b }) {
  ...
  S === void 0 && (b?.("003", qe.error003(j)), j = "default", S = x?.default || Nc.default);
  const I = !!(g.draggable || c && typeof g.draggable > "u"), _ = !!(g.selectable || u && typeof g.selectable > "u"), M = !!(g.connectable || l && typeof g.connectable > "u"), k = !!(g.focusable || d && typeof g.focusable > "u"), $ = Ne(), z = Lu(g), C = C0({ node: g, nodeType: j, hasDimensions: z, resizeObserver: f }), A = md({
    nodeRef: C,
    disabled: g.hidden || !I,
    noDragClassName: p,
  ...
  if (g.hidden)
    return null;
  const D = ht(g), P = m0(g), T = _ || I || t || n || i || r, F = n ? (R) => n(R, { ...y.userNode }) : void 0, W = i ? (R) => i(R, { ...y.userNode }) : void 0, H = r ? (R) => r(R, { ...y.userNode }) : void 0, U = s ? (R) => s(R, { ...y.userNode }) : void 0, O = a ? (R) => a(R, { ...y.userNode }) : void 0, q = (R) => {
    ...
    if (!(Ou(R.nativeEvent) || m)) {
      ...
      } else if (I && g.selected && Object.prototype.hasOwnProperty.call(dr, R.key)) {
        R.preventDefault();
  ...
  return o.jsx("div", { className: Ae([
    ...
    ...g.style,
    ...P
  }, "data-id": e, "data-testid": `rf__node-${e}`, onMouseEnter: F, onMouseMove: W, onMouseLeave: H, onContextMenu: U, onClick: q, onDoubleClick: O, onKeyDown: k ? J : void 0, tabIndex: k ? 0 : void 0, onFocus: k ? Z : void 0, role: g.ariaRole ?? (k ? "group" : void 0), "aria-roledescription": "node", "aria-describedby": m ? void 0 : `${sd}-${w}`, "aria-label": g.ariaLabel, ...g.domAttributes, children: o.jsx(c0, { value: e, children: o.jsx(S, { id: e, data: g.data, type: j, positionAbsoluteX: y.positionAbsolute.x, positionAbsoluteY: y.positionAbsolute.y, selected: g.selected ?? !1, selectable: _, draggable: I, deletable: g.deletable ?? !0, isConnectable: M, sourcePosition: g.sourcePosition, targetPosition: g.targetPosition, dragging: A, dragHandle: g.dragHandle, zIndex: y.z, parentId: g.parentId, ...D }) }) });
}
var E0 = Ee(k0);
const I0 = (e) => ({
...
function vd(e) {
  const { nodesDraggable: t, nodesConnectable: n, nodesFocusable: i, elementsSelectable: r, onError: s } = he(I0, be), a = j0(e.onlyRenderVisibleElements), c = S0();
  return o.jsx("div", { className: "react-flow__nodes", style: Ar, children: a.map((u) => (
    /*
...
}, T0 = ({ color: e = "none", strokeWidth: t = 1 }) => {
  const n = {
    strokeWidth: t,
    ...e && { stroke: e, fill: e }
  };
...
function $0(e) {
  const t = Ne();
  return re(() => Object.prototype.hasOwnProperty.call(Cc, e) ? Cc[e] : (t.getState().onError?.("009", qe.error009(e)), null), [e]);
}
const P0 = ({ id: e, type: t, color: n, width: i = 12.5, height: r = 12.5, markerUnits: s = "strokeWidth", strokeWidth: a, orient: c = "auto-start-reverse" }) => {
  ...
  const n = he((s) => s.edges), i = he((s) => s.defaultEdgeOptions), r = re(() => $w(n, {
    id: t,
    defaultColor: e,
...
function jd({ x: e, y: t, label: n, labelStyle: i, labelShowBg: r = !0, labelBgStyle: s, labelBgPadding: a = [2, 4], labelBgBorderRadius: c = 2, children: u, className: l, ...d }) {
  const [f, p] = K({ x: 1, y: 0, width: 0, height: 0 }), h = Ae(["react-flow__edge-textwrapper", l]), m = se(null);
  return ee(() => {
    if (m.current) {
...
const R0 = Ee(jd);
function ai({ path: e, labelX: t, labelY: n, label: i, labelStyle: r, labelShowBg: s, labelBgStyle: a, labelBgPadding: c, labelBgBorderRadius: u, interactionWidth: l = 20, ...d }) {
  return o.jsxs(o.Fragment, { children: [o.jsx("path", { ...d, d: e, fill: "none", className: Ae(["react-flow__edge-path", d.className]) }), l ? o.jsx("path", { d: e, fill: "none", strokeOpacity: 0, strokeWidth: l, className: "react-flow__edge-interaction" }) : null, i && Qe(t) && Qe(n) ? o.jsx(R0, { x: t, y: n, label: i, labelStyle: r, labelShowBg: s, labelBgStyle: a, labelBgPadding: c, labelBgBorderRadius: u }) : null] });
}
function kc({ pos: e, x1: t, y1: n, x2: i, y2: r }) {
  return e === ce.Left || e === ce.Right ? [0.5 * (t + i), n] : [t, 0.5 * (n + r)];
}
function Nd({ sourceX: e, sourceY: t, sourcePosition: n = ce.Bottom, targetX: i, targetY: r, targetPosition: s = ce.Top }) {
  const [a, c] = kc({
    pos: n,
    x1: e,
    y1: t,
...
function Sd(e) {
  return Ee(({ id: t, sourceX: n, sourceY: i, targetX: r, targetY: s, sourcePosition: a, targetPosition: c, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: p, labelBgBorderRadius: h, style: m, markerEnd: w, markerStart: x, interactionWidth: v }) => {
    const [b, g, y] = Nd({
      sourceX: n,
      sourceY: i,
      sourcePosition: a,
    ...
    return o.jsx(ai, { id: N, path: b, labelX: g, labelY: y, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: p, labelBgBorderRadius: h, style: m, markerEnd: w, markerStart: x, interactionWidth: v });
  });
}
const L0 = Sd({ isInternal: !1 }), Cd = Sd({ isInternal: !0 });
L0.displayName = "SimpleBezierEdge";
Cd.displayName = "SimpleBezierEdgeInternal";
function kd(e) {
  return Ee(({ id: t, sourceX: n, sourceY: i, targetX: r, targetY: s, label: a, labelStyle: c, labelShowBg: u, labelBgStyle: l, labelBgPadding: d, labelBgBorderRadius: f, style: p, sourcePosition: h = ce.Bottom, targetPosition: m = ce.Top, markerEnd: w, markerStart: x, pathOptions: v, interactionWidth: b }) => {
    const [g, y, N] = ur({
      sourceX: n,
      sourceY: i,
      sourcePosition: h,
    ...
    return o.jsx(ai, { id: j, path: g, labelX: y, labelY: N, label: a, labelStyle: c, labelShowBg: u, labelBgStyle: l, labelBgPadding: d, labelBgBorderRadius: f, style: p, markerEnd: w, markerStart: x, interactionWidth: b });
  });
}
...
function Ad(e) {
  return Ee(({ id: t, ...n }) => {
    ...
    return o.jsx(Ed, { ...n, id: i, pathOptions: re(() => ({ borderRadius: 0, offset: n.pathOptions?.offset }), [n.pathOptions?.offset]) });
  });
}
const z0 = Ad({ isInternal: !1 }), _d = Ad({ isInternal: !0 });
z0.displayName = "StepEdge";
_d.displayName = "StepEdgeInternal";
function Dd(e) {
  return Ee(({ id: t, sourceX: n, sourceY: i, targetX: r, targetY: s, label: a, labelStyle: c, labelShowBg: u, labelBgStyle: l, labelBgPadding: d, labelBgBorderRadius: f, style: p, markerEnd: h, markerStart: m, interactionWidth: w }) => {
    const [x, v, b] = Xu({ sourceX: n, sourceY: i, targetX: r, targetY: s }), g = e.isInternal ? void 0 : t;
    return o.jsx(ai, { id: g, path: x, labelX: v, labelY: b, label: a, labelStyle: c, labelShowBg: u, labelBgStyle: l, labelBgPadding: d, labelBgBorderRadius: f, style: p, markerEnd: h, markerStart: m, interactionWidth: w });
  });
}
const V0 = Dd({ isInternal: !1 }), Td = Dd({ isInternal: !0 });
V0.displayName = "StraightEdge";
Td.displayName = "StraightEdgeInternal";
function $d(e) {
  return Ee(({ id: t, sourceX: n, sourceY: i, targetX: r, targetY: s, sourcePosition: a = ce.Bottom, targetPosition: c = ce.Top, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: p, labelBgBorderRadius: h, style: m, markerEnd: w, markerStart: x, pathOptions: v, interactionWidth: b }) => {
    const [g, y, N] = Fu({
      sourceX: n,
      sourceY: i,
      sourcePosition: a,
    ...
    return o.jsx(ai, { id: j, path: g, labelX: y, labelY: N, label: u, labelStyle: l, labelShowBg: d, labelBgStyle: f, labelBgPadding: p, labelBgBorderRadius: h, style: m, markerEnd: w, markerStart: x, interactionWidth: b });
  });
}
const O0 = $d({ isInternal: !1 }), Pd = $d({ isInternal: !0 });
...
const Ec = {
  ...
  sourcePosition: null,
  targetPosition: null
}, H0 = (e, t, n) => n === ce.Left ? e - t : n === ce.Right ? e + t : e, W0 = (e, t, n) => n === ce.Top ? e - t : n === ce.Bottom ? e + t : e, Ac = "react-flow__edgeupdater";
function _c({ position: e, centerX: t, centerY: n, radius: i = 10, onMouseDown: r, onMouseEnter: s, onMouseOut: a, type: c }) {
  return o.jsx("circle", { onMouseDown: r, onMouseEnter: s, onMouseOut: a, className: Ae([Ac, `${Ac}-${c}`]), cx: H0(t, i, e), cy: W0(n, i, e), r: i, stroke: "transparent", fill: "transparent" });
}
function F0({ isReconnectable: e, reconnectRadius: t, edge: n, sourceX: i, sourceY: r, targetX: s, targetY: a, sourcePosition: c, targetPosition: u, onReconnect: l, onReconnectStart: d, onReconnectEnd: f, setReconnecting: p, setUpdateHover: h }) {
  ...
  }, x = (y) => w(y, { nodeId: n.target, id: n.targetHandle ?? null, type: "target" }), v = (y) => w(y, { nodeId: n.source, id: n.sourceHandle ?? null, type: "source" }), b = () => h(!0), g = () => h(!1);
  return o.jsxs(o.Fragment, { children: [(e === !0 || e === "source") && o.jsx(_c, { position: c, centerX: i, centerY: r, radius: t, onMouseDown: x, onMouseEnter: b, onMouseOut: g, type: "source" }), (e === !0 || e === "target") && o.jsx(_c, { position: u, centerX: s, centerY: a, radius: t, onMouseDown: v, onMouseEnter: b, onMouseOut: g, type: "target" })] });
}
function B0({ id: e, edgesFocusable: t, edgesReconnectable: n, elementsSelectable: i, onClick: r, onDoubleClick: s, onContextMenu: a, onMouseEnter: c, onMouseMove: u, onMouseLeave: l, reconnectRadius: d, onReconnect: f, onReconnectStart: p, onReconnectEnd: h, rfId: m, edgeTypes: w, noPanClassName: x, onError: v, disableKeyboardA11y: b }) {
  let g = he((te) => te.edgeLookup.get(e));
  const y = he((te) => te.defaultEdgeOptions);
  g = y ? { ...y, ...g } : g;
  let N = g.type || "default", j = w?.[N] || Ec[N];
  j === void 0 && (v?.("011", qe.error011(N)), N = "default", j = w?.default || Ec.default);
  const S = !!(g.focusable || t && typeof g.focusable > "u"), I = typeof f < "u" && (g.reconnectable || n && typeof g.reconnectable > "u"), _ = !!(g.selectable || i && typeof g.selectable > "u"), M = se(null), [k, $] = K(!1), [z, C] = K(!1), A = Ne(), { zIndex: E, sourceX: D, sourceY: P, targetX: T, targetY: F, sourcePosition: W, targetPosition: H } = he(ae((te) => {
  ...
  }, [g.source, g.target, g.sourceHandle, g.targetHandle, g.selected, g.zIndex]), be), U = re(() => g.markerStart ? `url('#${Ko(g.markerStart, m)}')` : void 0, [g.markerStart, m]), O = re(() => g.markerEnd ? `url('#${Ko(g.markerEnd, m)}')` : void 0, [g.markerEnd, m]);
...
function Md({ defaultMarkerColor: e, onlyRenderVisibleElements: t, rfId: n, edgeTypes: i, noPanClassName: r, onReconnect: s, onEdgeContextMenu: a, onEdgeMouseEnter: c, onEdgeMouseMove: u, onEdgeMouseLeave: l, onEdgeClick: d, reconnectRadius: f, onEdgeDoubleClick: p, onReconnectStart: h, onReconnectEnd: m, disableKeyboardA11y: w }) {
  const { edgesFocusable: x, edgesReconnectable: v, elementsSelectable: b, onError: g } = he(X0, be), y = _0(t);
  return o.jsxs("div", { className: "react-flow__edges", children: [o.jsx(M0, { defaultColor: e, rfId: n }), y.map((N) => o.jsx(K0, { id: N, edgesFocusable: x, edgesReconnectable: v, elementsSelectable: b, noPanClassName: r, onReconnect: s, onContextMenu: a, onMouseEnter: c, onMouseMove: u, onMouseLeave: l, onClick: d, reconnectRadius: f, onDoubleClick: p, onReconnectStart: h, onReconnectEnd: m, rfId: n, onError: g, edgeTypes: i, disableKeyboardA11y: w }, N))] });
}
Md.displayName = "EdgeRenderer";
const q0 = Ee(Md), Y0 = (e) => `translate(${e.transform[0]}px,${e.transform[1]}px) scale(${e.transform[2]})`;
...
function ib({ containerStyle: e, style: t, type: n, component: i }) {
  const { nodesConnectable: r, width: s, height: a, isValid: c, inProgress: u } = he(nb, be);
...
function Ld({ nodeTypes: e, edgeTypes: t, onInit: n, onNodeClick: i, onEdgeClick: r, onNodeDoubleClick: s, onEdgeDoubleClick: a, onNodeMouseEnter: c, onNodeMouseMove: u, onNodeMouseLeave: l, onNodeContextMenu: d, onSelectionContextMenu: f, onSelectionStart: p, onSelectionEnd: h, connectionLineType: m, connectionLineStyle: w, connectionLineComponent: x, connectionLineContainerStyle: v, selectionKeyCode: b, selectionOnDrag: g, selectionMode: y, multiSelectionKeyCode: N, panActivationKeyCode: j, zoomActivationKeyCode: S, deleteKeyCode: I, onlyRenderVisibleElements: _, elementsSelectable: M, defaultViewport: k, translateExtent: $, minZoom: z, maxZoom: C, preventScrolling: A, defaultMarkerColor: E, zoomOnScroll: D, zoomOnPinch: P, panOnScroll: T, panOnScrollSpeed: F, panOnScrollMode: W, zoomOnDoubleClick: H, panOnDrag: U, autoPanOnSelection: O, onPaneClick: q, onPaneMouseEnter: J, onPaneMouseMove: Z, onPaneMouseLeave: R, onPaneScroll: X, onPaneContextMenu: de, paneClickDistance: le, nodeClickDistance: te, onEdgeContextMenu: ie, onEdgeMouseEnter: fe, onEdgeMouseMove: V, onEdgeMouseLeave: ne, reconnectRadius: ge, onReconnect: ye, onReconnectStart: Ie, onReconnectEnd: Te, noDragClassName: Ve, noWheelClassName: at, noPanClassName: Ue, disableKeyboardA11y: Ze, nodeExtent: Me, rfId: Oe, viewport: xe, onViewportChange: Ye }) {
  return Dc(e), Dc(t), ob(), Z0(n), J0(xe), o.jsx(v0, { onPaneClick: q, onPaneMouseEnter: J, onPaneMouseMove: Z, onPaneMouseLeave: R, onPaneContextMenu: de, onPaneScroll: X, paneClickDistance: le, deleteKeyCode: I, selectionKeyCode: b, selectionOnDrag: g, selectionMode: y, onSelectionStart: p, onSelectionEnd: h, multiSelectionKeyCode: N, panActivationKeyCode: j, zoomActivationKeyCode: S, elementsSelectable: M, zoomOnScroll: D, zoomOnPinch: P, zoomOnDoubleClick: H, panOnScroll: T, panOnScrollSpeed: F, panOnScrollMode: W, panOnDrag: U, autoPanOnSelection: O, defaultViewport: k, translateExtent: $, minZoom: z, maxZoom: C, onSelectionContextMenu: f, preventScrolling: A, noDragClassName: Ve, noWheelClassName: at, noPanClassName: Ue, disableKeyboardA11y: Ze, onViewportChange: Ye, isControlledViewport: !!xe, children: o.jsxs(U0, { children: [o.jsx(q0, { edgeTypes: t, onEdgeClick: r, onEdgeDoubleClick: a, onReconnect: ye, onReconnectStart: Ie, onReconnectEnd: Te, onlyRenderVisibleElements: _, onEdgeContextMenu: ie, onEdgeMouseEnter: fe, onEdgeMouseMove: V, onEdgeMouseLeave: ne, reconnectRadius: ge, defaultMarkerColor: E, noPanClassName: Ue, disableKeyboardA11y: Ze, rfId: Oe }), o.jsx(ib, { style: w, type: m, component: x, containerStyle: v }), o.jsx("div", { className: "react-flow__edgelabel-renderer" }), o.jsx(A0, { nodeTypes: e, onNodeClick: i, onNodeDoubleClick: s, onNodeMouseEnter: c, onNodeMouseMove: u, onNodeMouseLeave: l, onNodeContextMenu: d, nodeClickDistance: te, onlyRenderVisibleElements: _, noPanClassName: Ue, noDragClassName: Ve, disableKeyboardA11y: Ze, nodeExtent: Me, rfId: Oe }), o.jsx("div", { className: "react-flow__viewport-portal" })] }) });
}
Ld.displayName = "GraphView";
const sb = Ee(Ld), ab = Ru(), Tc = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: i, width: r, height: s, fitView: a, fitViewOptions: c, minZoom: u = 0.5, maxZoom: l = 2, nodeOrigin: d, nodeExtent: f, zIndexMode: p = "basic" } = {}) => {
  const h = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), v = i ?? t ?? [], b = n ?? e ?? [], g = d ?? [0, 0], y = f ?? qn;
  Uu(w, x, v);
  ...
  async function w() {
    const { nodeLookup: x, panZoom: v, fitViewOptions: b, fitViewResolver: g, width: y, height: N, minZoom: j, maxZoom: S } = m();
    v && (await yw({
      nodes: x,
      width: y,
      height: N,
  ...
  return {
    ...
    setNodes: (x) => {
      const { nodeLookup: v, parentLookup: b, nodeOrigin: g, elevateNodesOnSelect: y, fitViewQueued: N, zIndexMode: j, nodesSelectionActive: S } = m(), { nodesInitialized: I, hasSelectedNodes: _ } = Xo(x, v, b, {
        nodeOrigin: g,
        nodeExtent: f,
    ...
    setEdges: (x) => {
      const { connectionLookup: v, edgeLookup: b } = m();
      Uu(v, b, x), h({ edges: x });
    },
    setDefaultNodesAndEdges: (x, v) => {
      if (x) {
        const { setNodes: b } = m();
    ...
    updateNodeInternals: (x) => {
      const { triggerNodeChanges: v, nodeLookup: b, parentLookup: g, domNode: y, nodeOrigin: N, nodeExtent: j, debug: S, fitViewQueued: I, zIndexMode: _ } = m(), { changes: M, updatedInternals: k } = Ow(x, b, g, y, N, j, _);
      k && (Rw(b, g, { nodeOrigin: N, nodeExtent: j, zIndexMode: _ }), I ? (w(), h({ fitViewQueued: !1, fitViewOptions: void 0 })) : h({}), M?.length > 0 && (S && console.log("React Flow: trigger node changes", M), v?.(M)));
    },
    updateNodePositions: (x, v = !1) => {
      const b = [];
      let g = [];
      ...
      for (const [_, M] of x) {
        ...
        if (k && j.inProgress && j.fromNode.id === k.id) {
          const C = Rt(k, j.fromHandle, ce.Left, !0);
          S({ ...j, from: C });
        }
        $ && k.parentId && b.push({
          id: _,
    ...
    triggerNodeChanges: (x) => {
      const { onNodesChange: v, setNodes: b, nodes: g, hasDefaultNodes: y, debug: N } = m();
      if (x?.length) {
        if (y) {
          const j = ud(x, g);
          b(j);
        }
        N && console.log("React Flow: trigger node changes", x), v?.(x);
      }
    },
    triggerEdgeChanges: (x) => {
      const { onEdgesChange: v, setEdges: b, edges: g, hasDefaultEdges: y, debug: N } = m();
      if (x?.length) {
        if (y) {
          const j = dd(x, g);
          b(j);
        }
        N && console.log("React Flow: trigger edge changes", x), v?.(x);
      }
    },
    addSelectedNodes: (x) => {
      const { multiSelectionActive: v, edgeLookup: b, nodeLookup: g, triggerNodeChanges: y, triggerEdgeChanges: N } = m();
      if (v) {
        const j = x.map((S) => St(S, !0));
        y(j);
        return;
      }
      y(qt(g, /* @__PURE__ */ new Set([...x]), !0)), N(qt(b));
    },
    addSelectedEdges: (x) => {
      const { multiSelectionActive: v, edgeLookup: b, nodeLookup: g, triggerNodeChanges: y, triggerEdgeChanges: N } = m();
      if (v) {
      ...
      N(qt(b, /* @__PURE__ */ new Set([...x]))), y(qt(g, /* @__PURE__ */ new Set(), !0));
    },
    unselectNodesAndEdges: ({ nodes: x, edges: v } = {}) => {
      const { edges: b, nodes: g, nodeLookup: y, triggerNodeChanges: N, triggerEdgeChanges: j } = m(), S = x || g, I = v || b, _ = [];
      for (const k of S) {
        if (!k.selected)
          continue;
        const $ = y.get(k.id);
    ...
    setMinZoom: (x) => {
      const { panZoom: v, maxZoom: b } = m();
      v?.setScaleExtent([x, b]), h({ minZoom: x });
    },
    setMaxZoom: (x) => {
      const { panZoom: v, minZoom: b } = m();
      v?.setScaleExtent([b, x]), h({ maxZoom: x });
    },
    setTranslateExtent: (x) => {
      m().panZoom?.setTranslateExtent(x), h({ translateExtent: x });
    },
    resetSelectedElements: () => {
      const { edges: x, nodes: v, triggerNodeChanges: b, triggerEdgeChanges: g, elementsSelectable: y } = m();
      if (!y)
        return;
      const N = v.reduce((S, I) => I.selected ? [...S, St(I.id, !1)] : S, []), j = x.reduce((S, I) => I.selected ? [...S, St(I.id, !1)] : S, []);
      b(N), g(j);
    },
    setNodeExtent: (x) => {
      const { nodes: v, nodeLookup: b, parentLookup: g, nodeOrigin: y, elevateNodesOnSelect: N, nodeExtent: j, zIndexMode: S } = m();
      x[0][0] === j[0][0] && x[0][1] === j[0][1] && x[1][0] === j[1][0] && x[1][1] === j[1][1] || (Xo(v, b, g, {
        nodeOrigin: y,
        nodeExtent: x,
    ...
    panBy: (x) => {
      const { transform: v, width: b, height: g, panZoom: y, translateExtent: N } = m();
      return Hw({ delta: x, panZoom: y, transform: v, translateExtent: N, width: b, height: g });
    },
    setCenter: async (x, v, b) => {
...
function ub({ children: e, nodes: t, edges: n, defaultNodes: i, defaultEdges: r, width: s, height: a, fitView: c, fitViewOptions: u, minZoom: l, maxZoom: d, nodeOrigin: f, nodeExtent: p, zIndexMode: h }) {
  return Jn(Er) ? o.jsx(o.Fragment, { children: e }) : o.jsx(lb, { initialNodes: t, initialEdges: n, defaultNodes: i, defaultEdges: r, initialWidth: s, initialHeight: a, fitView: c, initialFitViewOptions: u, initialMinZoom: l, initialMaxZoom: d, nodeOrigin: f, nodeExtent: p, zIndexMode: h, children: e });
}
const db = {
  width: "100%",
  height: "100%",
...
function fb({ nodes: e, edges: t, defaultNodes: n, defaultEdges: i, className: r, nodeTypes: s, edgeTypes: a, onNodeClick: c, onEdgeClick: u, onInit: l, onMove: d, onMoveStart: f, onMoveEnd: p, onConnect: h, onConnectStart: m, onConnectEnd: w, onClickConnectStart: x, onClickConnectEnd: v, onNodeMouseEnter: b, onNodeMouseMove: g, onNodeMouseLeave: y, onNodeContextMenu: N, onNodeDoubleClick: j, onNodeDragStart: S, onNodeDrag: I, onNodeDragStop: _, onNodesDelete: M, onEdgesDelete: k, onDelete: $, onSelectionChange: z, onSelectionDragStart: C, onSelectionDrag: A, onSelectionDragStop: E, onSelectionContextMenu: D, onSelectionStart: P, onSelectionEnd: T, onBeforeDelete: F, connectionMode: W, connectionLineType: H = yt.Bezier, connectionLineStyle: U, connectionLineComponent: O, connectionLineContainerStyle: q, deleteKeyCode: J = "Backspace", selectionKeyCode: Z = "Shift", selectionOnDrag: R = !1, selectionMode: X = Yn.Full, panActivationKeyCode: de = "Space", multiSelectionKeyCode: le = Zn() ? "Meta" : "Control", zoomActivationKeyCode: te = Zn() ? "Meta" : "Control", snapToGrid: ie, snapGrid: fe, onlyRenderVisibleElements: V = !1, selectNodesOnDrag: ne, nodesDraggable: ge, autoPanOnNodeFocus: ye, nodesConnectable: Ie, nodesFocusable: Te, nodeOrigin: Ve = cd, edgesFocusable: at, edgesReconnectable: Ue, elementsSelectable: Ze = !0, defaultViewport: Me = zv, minZoom: Oe = 0.5, maxZoom: xe = 2, translateExtent: Ye = qn, preventScrolling: _e = !0, nodeExtent: jt, defaultMarkerColor: gn = "#b1b1b7", zoomOnScroll: L = !0, zoomOnPinch: B = !0, panOnScroll: Y = !1, panOnScrollSpeed: oe = 0.5, panOnScrollMode: Q = It.Free, zoomOnDoubleClick: we = !0, panOnDrag: pe = !0, onPaneClick: ve, onPaneMouseEnter: Se, onPaneMouseMove: He, onPaneMouseLeave: De, onPaneScroll: li, onPaneContextMenu: We, paneClickDistance: Ot = 1, nodeClickDistance: Nt = 0, children: Tr, onReconnect: mn, onReconnectStart: $r, onReconnectEnd: Pr, onEdgeContextMenu: ct, onEdgeDoubleClick: Mr, onEdgeMouseEnter: Ht, onEdgeMouseMove: Rr, onEdgeMouseLeave: Wt, reconnectRadius: Lr = 10, onNodesChange: ui, onEdgesChange: di, noDragClassName: zr = "nodrag", noWheelClassName: Ft = "nowheel", noPanClassName: fi = "nopan", fitView: pi, fitViewOptions: hi, connectOnClick: yn, attributionPosition: Vr, proOptions: Or, defaultEdgeOptions: Hr, elevateNodesOnSelect: Wr = !0, elevateEdgesOnSelect: Fr = !1, disableKeyboardA11y: gi = !1, autoPanOnConnect: Br, autoPanOnNodeDrag: Kr, autoPanOnSelection: Xr = !0, autoPanSpeed: qr, connectionRadius: Yr, isValidConnection: Ur, onError: Zr, style: Gr, id: xn, nodeDragThreshold: mi, connectionDragThreshold: yi, viewport: xi, onViewportChange: Jr, width: wi, height: Qr, colorMode: eo = "light", debug: to, onScroll: vi, ariaLabelConfig: no, zIndexMode: bi = "basic", ...ji }, io) {
  const wn = xn || "1", ro = Wv(eo), oo = ae((Ni) => {
    Ni.currentTarget.scrollTo({ top: 0, left: 0, behavior: "instant" }), vi?.(Ni);
  }, [vi]);
  return o.jsx("div", { "data-testid": "rf__wrapper", ...ji, onScroll: oo, style: { ...Gr, ...db }, ref: io, className: Ae(["react-flow", r, ro]), id: xn, role: "application", children: o.jsxs(ub, { nodes: e, edges: t, width: wi, height: Qr, fitView: pi, fitViewOptions: hi, minZoom: Oe, maxZoom: xe, nodeOrigin: Ve, nodeExtent: jt, zIndexMode: bi, children: [o.jsx(Hv, { nodes: e, edges: t, defaultNodes: n, defaultEdges: i, onConnect: h, onConnectStart: m, onConnectEnd: w, onClickConnectStart: x, onClickConnectEnd: v, nodesDraggable: ge, autoPanOnNodeFocus: ye, nodesConnectable: Ie, nodesFocusable: Te, edgesFocusable: at, edgesReconnectable: Ue, elementsSelectable: Ze, elevateNodesOnSelect: Wr, elevateEdgesOnSelect: Fr, minZoom: Oe, maxZoom: xe, nodeExtent: jt, onNodesChange: ui, onEdgesChange: di, snapToGrid: ie, snapGrid: fe, connectionMode: W, translateExtent: Ye, connectOnClick: yn, defaultEdgeOptions: Hr, fitView: pi, fitViewOptions: hi, onNodesDelete: M, onEdgesDelete: k, onDelete: $, onNodeDragStart: S, onNodeDrag: I, onNodeDragStop: _, onSelectionDrag: A, onSelectionDragStart: C, onSelectionDragStop: E, onMove: d, onMoveStart: f, onMoveEnd: p, noPanClassName: fi, nodeOrigin: Ve, rfId: wn, autoPanOnConnect: Br, autoPanOnNodeDrag: Kr, autoPanSpeed: qr, onError: Zr, connectionRadius: Yr, isValidConnection: Ur, selectNodesOnDrag: ne, nodeDragThreshold: mi, connectionDragThreshold: yi, onBeforeDelete: F, debug: to, ariaLabelConfig: no, zIndexMode: bi }), o.jsx(sb, { onInit: l, onNodeClick: c, onEdgeClick: u, onNodeMouseEnter: b, onNodeMouseMove: g, onNodeMouseLeave: y, onNodeContextMenu: N, onNodeDoubleClick: j, nodeTypes: s, edgeTypes: a, connectionLineType: H, connectionLineStyle: U, connectionLineComponent: O, connectionLineContainerStyle: q, selectionKeyCode: Z, selectionOnDrag: R, selectionMode: X, deleteKeyCode: J, multiSelectionKeyCode: le, panActivationKeyCode: de, zoomActivationKeyCode: te, onlyRenderVisibleElements: V, defaultViewport: Me, translateExtent: Ye, minZoom: Oe, maxZoom: xe, preventScrolling: _e, zoomOnScroll: L, zoomOnPinch: B, zoomOnDoubleClick: we, panOnScroll: Y, panOnScrollSpeed: oe, panOnScrollMode: Q, panOnDrag: pe, autoPanOnSelection: Xr, onPaneClick: ve, onPaneMouseEnter: Se, onPaneMouseMove: He, onPaneMouseLeave: De, onPaneScroll: li, onPaneContextMenu: We, paneClickDistance: Ot, nodeClickDistance: Nt, onSelectionContextMenu: D, onSelectionStart: P, onSelectionEnd: T, onReconnect: mn, onReconnectStart: $r, onReconnectEnd: Pr, onEdgeContextMenu: ct, onEdgeDoubleClick: Mr, onEdgeMouseEnter: Ht, onEdgeMouseMove: Rr, onEdgeMouseLeave: Wt, reconnectRadius: Lr, defaultMarkerColor: gn, noDragClassName: zr, noWheelClassName: Ft, noPanClassName: fi, rfId: wn, disableKeyboardA11y: gi, nodeExtent: jt, viewport: xi, onViewportChange: Jr }), o.jsx(Lv, { onSelectionChange: z }), Tr, o.jsx(Tv, { proOptions: Or, position: Vr }), o.jsx(Dv, { rfId: wn, disableKeyboardA11y: gi })] }) });
}
var zd = hd(fb);
...
function Vd({
  ...
  const f = se(null), { transform: p, patternId: h } = he(xb, be), m = i || yb[t], w = t === wt.Dots, x = t === wt.Cross, v = Array.isArray(n) ? n : [n, n], b = [v[0] * p[2] || 1, v[1] * p[2] || 1], g = m * p[2], y = Array.isArray(s) ? s : [s, s], N = x ? [g, g] : b, j = [
    y[0] * p[2] || 1 + N[0] / 2,
    y[1] * p[2] || 1 + N[1] / 2
  ], S = `${h}${e || ""}`;
  ...
  }, ref: f, "data-testid": "rf__background", children: [o.jsx("pattern", { id: S, x: p[0] % b[0], y: p[1] % b[1], width: b[0], height: b[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${j[0]},-${j[1]})`, children: w ? o.jsx(mb, { radius: g / 2, className: d }) : o.jsx(gb, { dimensions: N, lineWidth: r, variant: t, className: d }) }), o.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${S})` })] });
}
...
function Hd({ style: e, showZoom: t = !0, showFitView: n = !0, showInteractive: i = !0, fitViewOptions: r, onZoomIn: s, onZoomOut: a, onFitView: c, onInteractiveChange: u, className: l, children: d, position: f = "bottom-left", orientation: p = "vertical", "aria-label": h }) {
  const m = Ne(), { isInteractive: w, minZoomReached: x, maxZoomReached: v, ariaLabelConfig: b } = he(Sb, be), { zoomIn: g, zoomOut: y, fitView: N } = Ms(), j = () => {
    g(), s?.();
  }, S = () => {
    y(), a?.();
  }, I = () => {
  ...
  return o.jsxs(Ir, { className: Ae(["react-flow__controls", M, l]), position: f, style: e, "data-testid": "rf__controls", "aria-label": h ?? b["controls.ariaLabel"], children: [t && o.jsxs(o.Fragment, { children: [o.jsx(Mi, { onClick: j, className: "react-flow__controls-zoomin", title: b["controls.zoomIn.ariaLabel"], "aria-label": b["controls.zoomIn.ariaLabel"], disabled: v, children: o.jsx(wb, {}) }), o.jsx(Mi, { onClick: S, className: "react-flow__controls-zoomout", title: b["controls.zoomOut.ariaLabel"], "aria-label": b["controls.zoomOut.ariaLabel"], disabled: x, children: o.jsx(vb, {}) })] }), n && o.jsx(Mi, { className: "react-flow__controls-fitview", onClick: I, title: b["controls.fitView.ariaLabel"], "aria-label": b["controls.fitView.ariaLabel"], children: o.jsx(bb, {}) }), i && o.jsx(Mi, { className: "react-flow__controls-interactive", onClick: _, title: b["controls.interactive.ariaLabel"], "aria-label": b["controls.interactive.ariaLabel"], children: w ? o.jsx(Nb, {}) : o.jsx(jb, {}) }), d] });
}
...
function Cb({ id: e, x: t, y: n, width: i, height: r, style: s, color: a, strokeColor: c, strokeWidth: u, className: l, borderRadius: d, shapeRendering: f, selected: p, onClick: h }) {
  const { background: m, backgroundColor: w } = s || {}, x = a || m || w;
  return o.jsx("rect", { className: Ae(["react-flow__minimap-node", { selected: p }, l]), x: t, y: n, rx: d, ry: d, width: i, height: r, style: {
    fill: x,
    stroke: c,
    strokeWidth: u
  }, shapeRendering: f, onClick: h ? (v) => h(v, e) : void 0 });
}
const kb = Ee(Cb), Eb = (e) => e.nodes.map((t) => t.id), Ao = (e) => e instanceof Function ? e : () => e;
function Ib({
  nodeStrokeColor: e,
  nodeColor: t,
  nodeClassName: n = "",
  ...
  const c = he(Eb, be), u = Ao(t), l = Ao(e), d = Ao(n), f = typeof window > "u" || window.chrome ? "crispEdges" : "geometricPrecision";
...
function Ab({ id: e, nodeColorFunc: t, nodeStrokeColorFunc: n, nodeClassNameFunc: i, nodeBorderRadius: r, nodeStrokeWidth: s, shapeRendering: a, NodeComponent: c, onClick: u }) {
  const { node: l, x: d, y: f, width: p, height: h } = he((m) => {
    ...
    const x = w.internals.userNode, { x: v, y: b } = w.internals.positionAbsolute, { width: g, height: y } = ht(x);
    return {
      node: x,
      x: v,
      y: b,
...
const _b = Ee(Ab);
var Db = Ee(Ib);
const Tb = 200, $b = 150, Pb = (e) => !e.hidden, Mb = (e) => {
  const t = {
  ...
  return {
    viewBB: t,
    boundingRect: e.nodeLookup.size > 0 ? Mu(oi(e.nodeLookup, { filter: Pb }), t) : t,
    rfId: e.rfId,
    panZoom: e.panZoom,
...
function Fd({
  ...
  const N = Ne(), j = se(null), { boundingRect: S, viewBB: I, rfId: _, panZoom: M, translateExtent: k, flowWidth: $, flowHeight: z, ariaLabelConfig: C } = he(Mb, be), A = e?.width ?? Tb, E = e?.height ?? $b, D = S.width / A, P = S.height / E, T = Math.max(D, P), F = T * A, W = T * E, H = y * T, U = S.x - (F - S.width) / 2 - H, O = S.y - (W - S.height) / 2 - H, q = F + H * 2, J = W + H * 2, Z = `${Rb}-${_}`, R = se(0), X = se();
  R.current = T, ee(() => {
    if (j.current && M)
      return X.current = Zw({
        domNode: j.current,
  ...
  const de = h ? (ie) => {
    ...
    h(ie, { x: fe, y: V });
  } : void 0, le = m ? ae((ie, fe) => {
    const V = N.getState().nodeLookup.get(fe).internals.userNode;
    m(ie, V);
  }, []) : void 0, te = v ?? C["minimap.ariaLabel"];
  return o.jsx(Ir, { position: p, style: {
    ...e,
  ...
  }, className: Ae(["react-flow__minimap", t]), "data-testid": "rf__minimap", children: o.jsxs("svg", { width: A, height: E, viewBox: `${U} ${O} ${q} ${J}`, className: "react-flow__minimap-svg", role: "img", "aria-labelledby": Z, ref: j, onClick: de, children: [te && o.jsx("title", { id: Z, children: te }), o.jsx(Db, { onClick: le, nodeColor: i, nodeStrokeColor: n, nodeBorderRadius: s, nodeClassName: r, nodeStrokeWidth: a, nodeComponent: c }), o.jsx("path", { className: "react-flow__minimap-mask", d: `M${U - H},${O - H}h${q + H * 2}v${J + H * 2}h${-q - H * 2}z
        M${I.x},${I.y}h${I.width}v${I.height}h${-I.width}z`, fillRule: "evenodd", pointerEvents: "none" })] }) });
}
Fd.displayName = "MiniMap";
const Bd = Ee(Fd), Lb = (e) => (t) => e ? `${Math.max(1 / t.transform[2], 1)}` : void 0, zb = {
  [an.Line]: "right",
  [an.Handle]: "bottom-right"
};
function Vb({ nodeId: e, position: t, variant: n = an.Handle, className: i, style: r = void 0, children: s, color: a, minWidth: c = 10, minHeight: u = 10, maxWidth: l = Number.MAX_VALUE, maxHeight: d = Number.MAX_VALUE, keepAspectRatio: f = !1, resizeDirection: p, autoScale: h = !0, shouldResize: m, onResizeStart: w, onResize: x, onResizeEnd: v }) {
  const b = xd(), g = typeof e == "string" ? e : b, y = Ne(), N = se(null), j = n === an.Handle, S = he(ae(Lb(j && h), [j, h]), be), I = se(null), _ = t ?? zb[n];
  ee(() => {
    if (!(!N.current || !g))
...
function Bb({
  ...
  const u = t.filter((p) => !p.uri || p.uri === e.uri), l = a?.displayName ?? e.language, d = a?.loadEditor, f = re(
    () => d ? Mf(d) : null,
    [d]
  );
...
function Yb({ draft: e, onApply: t }) {
  const n = re(() => Hb(e), [e]), [i, r] = K(n), [s, a] = K(n), [c, u] = K(null);
  ee(() => {
    r(n), a(n), u(null);
  }, [n]);
...
function ij({ label: e, onRemove: t }) {
  return /* @__PURE__ */ o.jsx("td", { children: /* @__PURE__ */ o.jsx("button", { type: "button", className: "wf-properties-remove", "aria-label": e, title: e, onClick: t, children: /* @__PURE__ */ o.jsx(Rn, { size: 14 }) }) });
}
...
function Ls({
  ...
  const { add: m, update: w, remove: x } = Gb(e, h, {
    namePrefix: r,
    nameKeys: s,
    create: (g) => l(g, Zb(t)),
    patch: d
  }), v = ["Name", "Type", "Collection", ...f.default ? ["Default"] : [], ...f.storage ? ["Storage"] : [], ...f.required ? ["Required"] : []], b = r.toLowerCase();
  return /* @__PURE__ */ o.jsx(
    nj,
    {
      title: a,
      ...
      onAdd: m,
      children: e.map((g, y) => {
        const N = ut(g, s), j = us(g), S = ut(g, vl), I = S ? p?.get(S) : void 0, _ = j.collectionKind === "Single" ? i(j.alias) : "text";
        return /* @__PURE__ */ o.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ o.jsx(ij, { label: `Remove ${b} ${N || y + 1}`, onRemove: () => x(y) })
        ] }, y);
      })
    }
  );
...
function lj({ details: e, draft: t, context: n, onStateChange: i, onDefinitionMetaChange: r }) {
  const { typeOptions: s, storageOptions: a, editorForAlias: c } = Kd(n), u = qi(t.state.variables), l = qi(t.state.inputs), d = qi(t.state.outputs), f = e?.versions ?? [];
...
function Aj(e) {
  const t = /* @__PURE__ */ new Map();
  for (const n of e) {
    Li(t, n.typeName, n), Li(t, n.name, n), Li(t, n.displayName, n);
...
function Bc(e, t, n) {
  ...
  return n.get(Dn(i?.activityTypeKey)) ?? n.get(Dn(Dt(i?.activityTypeKey))) ?? n.get(Dn(i?.displayName)) ?? n.get(Dn(e.activityVersionId)) ?? null;
}
function Li(e, t, n) {
  const i = Dn(t);
  i && !e.has(i) && e.set(i, n);
...
const cf = { workflowActivity: Fj }, lf = { workflow: Kj };
function Fj({ id: e, data: t, selected: n }) {
  const i = t, r = i.runtime, s = !i.suppressFlowPorts, a = s ? i.sourcePorts.length > 0 ? i.sourcePorts : [{ name: "Done", displayName: "Done" }] : [], c = Bj(i), l = Ke.useContext(Ud)?.({ activityVersionId: i.activityVersionId, activityTypeKey: i.activityTypeKey }) ?? null, d = Ke.useContext(Zd), f = i.onEnterSlot ?? (d ? (p) => d(e, i.label, p) : void 0);
  return /* @__PURE__ */ o.jsxs(
    "div",
    {
      ...
      children: [
        s && i.acceptsInbound ? /* @__PURE__ */ o.jsx(cn, { type: "target", position: ce.Left }) : null,
        l ? /* @__PURE__ */ o.jsx("span", { className: "wf-node-availability", title: `No longer available for new use · ${Hn(l.state)}`, children: /* @__PURE__ */ o.jsx(Mn, { size: 13 }) }) : null,
        /* @__PURE__ */ o.jsxs("div", { className: "wf-node-content", children: [
          /* @__PURE__ */ o.jsx("span", { className: "wf-node-icon", "aria-hidden": "true", children: xr(i.icon) }),
        ...
        a.map((p, h) => {
          ...
          return /* @__PURE__ */ o.jsxs(Ke.Fragment, { children: [
            ...
            /* @__PURE__ */ o.jsx(cn, { type: "source", position: ce.Right, id: p.name, style: { top: m } })
          ] }, p.name);
        })
      ]
    }
...
function Kj(e) {
  const {
    ...
    label: d,
    labelStyle: f
  } = e, p = Ke.useContext(Yd), [h, m] = K(!1), [w, x, v] = ur({ sourceX: n, sourceY: i, targetX: r, targetY: s, sourcePosition: a, targetPosition: c }), b = p?.highlightedEdgeId === t;
  return /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
    ...
    p ? /* @__PURE__ */ o.jsx(hb, { children: /* @__PURE__ */ o.jsxs(
      "div",
      {
        ...
        style: { transform: `translate(-50%, -50%) translate(${x}px, ${v}px)` },
        onMouseEnter: () => m(!0),
        onMouseLeave: () => m(!1),
        children: [
          ...
          /* @__PURE__ */ o.jsx("button", { type: "button", "aria-label": "Delete connection", title: "Delete connection", onClick: () => p.deleteEdge(t), children: /* @__PURE__ */ o.jsx(Rn, { size: 12 }) })
        ]
      }
    ) }) : null
  ] });
...
function uf({ clientX: e, clientY: t, activities: n, onPick: i, onClose: r }) {
  const [s, a] = K(""), [c, u] = K(0), l = se(null), d = se(null), f = re(() => {
  ...
  }, [n, s]), p = re(() => Uo(f), [f]), h = re(() => p.flatMap((b) => b.activities), [p]);
  ee(() => {
...
function df({ frames: e, onNavigate: t, className: n }) {
  return /* @__PURE__ */ o.jsxs("div", { className: n ? `wf-breadcrumb ${n}` : "wf-breadcrumb", children: [
    ...
    e.map((i, r) => i.label ? /* @__PURE__ */ o.jsxs(Ke.Fragment, { children: [
      /* @__PURE__ */ o.jsx(kt, { size: 13 }),
...
function Os({ icon: e, title: t, description: n, action: i }) {
  return /* @__PURE__ */ o.jsxs("div", { className: "wf-empty-state", role: "status", children: [
    /* @__PURE__ */ o.jsx("div", { className: "wf-empty-state-icon", "aria-hidden": !0, children: e ?? /* @__PURE__ */ o.jsx(Qn, { size: 22 }) }),
...
function ci({ message: e, title: t = "Something went wrong" }) {
...
function eN({ context: e, ai: t, definitionFilter: n, onDefinitionFilterChange: i }) {
  const [r, s] = K("loading"), [a, c] = K(""), [u, l] = K(""), [d, f] = K(null), [p, h] = K([]), m = n?.trim().toLowerCase() ?? "", w = re(
    ...
    [p]
  ), v = Lt(t, "weaver.workflows.explain-executable"), b = ae(async () => {
    s("loading"), c("");
    try {
  ...
  const g = async (S) => {
    ...
    v && zt(t, v, S) && (c(""), f(null), l(`Sent ${S.artifactId} to Weaver`));
  }, N = (S) => {
    c(""), f(null), l(`Copied ${S}`);
  }, j = (S) => {
  ...
  return /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
    ...
    r === "failed" ? /* @__PURE__ */ o.jsx(ci, { message: a }) : null,
    ...
    r === "ready" && w.length > 0 ? /* @__PURE__ */ o.jsxs("div", { className: "wf-grid wf-executable-grid", role: "table", "aria-label": "Workflow executables", children: [
      ...
      w.map((S) => /* @__PURE__ */ o.jsxs("div", { className: "wf-grid-row", role: "row", children: [
        ...
        /* @__PURE__ */ o.jsxs("span", { className: "wf-row-actions", children: [
          ...
          v ? /* @__PURE__ */ o.jsxs("button", { type: "button", onClick: () => y(S), children: [
...
function nN({ context: e, ai: t, definitionId: n, publishedArtifactId: i }) {
  const [r, s] = K("loading"), [a, c] = K(""), [u, l] = K(""), [d, f] = K(null), [p, h] = K([]), m = Lt(t, "weaver.workflows.explain-executable"), w = ae(async () => {
    s("loading"), c("");
    try {
      const N = await Vl(e);
  ...
  return /* @__PURE__ */ o.jsxs("div", { className: "wf-artifacts-panel", children: [
    ...
    r === "ready" && p.length > 0 ? /* @__PURE__ */ o.jsx("div", { className: "wf-artifact-list", role: "list", "aria-label": "Workflow artifacts", children: p.map((N) => /* @__PURE__ */ o.jsxs("article", { className: "wf-artifact-card", role: "listitem", "data-active": N.artifactId === i ? "true" : void 0, children: [
      ...
      /* @__PURE__ */ o.jsxs("div", { className: "wf-row-actions", children: [
        ...
        m ? /* @__PURE__ */ o.jsxs("button", { type: "button", onClick: () => v(N), children: [
          /* @__PURE__ */ o.jsx(ft, { size: 13 }),
          " Explain"
        ] }) : null
      ] })
...
function pf() {
  const [e, t] = K(() => Kc(Rc, gj, An, _n)), [n, i] = K(() => Kc(Lc, mj, Yt, Ut)), [r, s] = K(() => Xc(zc, !1)), [a, c] = K(() => Xc(Vc, !1)), [u, l] = K(_j);
  ee(() => {
    Nn(Rc, String(e));
  }, [e]), ee(() => {
    Nn(Lc, String(n));
  ...
  const d = ae((g) => {
    ...
    l(null), g === "palette" ? (s(!1), t((N) => Yi(N + y, An, _n))) : (c(!1), i((N) => Yi(N + y, Yt, Ut)));
  }, []), h = ae((g, y) => {
    y.preventDefault(), l(null), g === "palette" ? s(!1) : c(!1);
    const N = y.clientX, j = g === "palette" ? e : n, S = g === "palette" ? An : Yt, I = g === "palette" ? _n : Ut;
    document.body.classList.add("wf-side-panel-resizing");
    const _ = (k) => {
      const $ = g === "palette" ? k.clientX - N : N - k.clientX, z = Yi(j + $, S, I);
      g === "palette" ? t(z) : i(z);
    }, M = () => {
    ...
    y.key === "ArrowLeft" ? (y.preventDefault(), p(g, g === "palette" ? -Ri : Ri)) : y.key === "ArrowRight" ? (y.preventDefault(), p(g, g === "palette" ? Ri : -Ri)) : y.key === "Home" ? (y.preventDefault(), g === "palette" ? t(An) : i(Yt)) : y.key === "End" && (y.preventDefault(), g === "palette" ? t(_n) : i(Ut));
  }, [p]), w = !r && u !== "inspector", x = !a && u !== "palette", v = [
    "wf-editor-body",
    r ? "palette-collapsed" : "",
...
function cN({ draft: e, restoreDraft: t }) {
  const n = se(Zc()), i = se(null), r = se(""), s = se(!1), [a, c] = K(0), u = ae((w) => {
    n.current = Zc(), i.current = w ? Tn(w) : null, r.current = w ? Be(w) : "", s.current = !1, c(0);
  }, []);
  ee(() => {
    if (!e) return;
    if (s.current) {
    ...
    const x = window.setTimeout(() => {
      const v = i.current;
      v && (n.current = Gc(n.current, v), c((b) => b + 1)), i.current = Tn(e), r.current = w;
    }, fj);
  ...
  const l = ae(() => {
    ...
    if (w === r.current) return;
    const x = i.current;
    x && (n.current = Gc(n.current, x)), i.current = Tn(e), r.current = w;
  }, [e]), d = ae((w) => {
    s.current = !0, i.current = Tn(w), r.current = Be(w), t(w), c((x) => x + 1);
  }, [t]), f = ae(() => {
    if (!e) return;
    l();
    const w = sN(n.current, e);
    w && (n.current = w.history, d(w.snapshot));
  }, [e, l, d]), p = ae(() => {
    if (!e) return;
    l();
    const w = aN(n.current, e);
    w && (n.current = w.history, d(w.snapshot));
  }, [e, l, d]), { canUndoNow: h, canRedoNow: m } = re(() => {
    const w = !!e && !!i.current && Be(e) !== r.current;
    return {
      canUndoNow: rN(n.current) || w,
      canRedoNow: oN(n.current) && !w
    };
  }, [e, a]);
...
function bN({
  ...
  const [x, v] = K([]), [b, g] = K([]), [y, N] = K(null), [j, S] = K(null), [I, _] = K(null), M = se(null), k = se(null), $ = se(/* @__PURE__ */ new Map()), z = se(/* @__PURE__ */ new Set()), C = se(null), A = se([]), E = se(null), D = se(null), P = se(!1), T = re(() => wN(i), [i]);
  ee(() => () => {
    ...
    A.current = L.nodes.map((B) => B.id), v(L.nodes), g(L.edges);
  }, [r, e?.layout, a, t, n, T]), ee(() => {
    if (!y || C.current !== T || !vN(x, A.current)) return;
    C.current = null;
  ...
  const F = ae((L, B, Y) => Y ? [
    ...L.filter((oe) => oe.nodeId !== B),
    { nodeId: B, x: Math.round(Y.x), y: Math.round(Y.y) }
  ] : L, []), W = ae((L, B) => {
    if (e?.state.rootActivity && a)
      return null;
    const Y = Gi(L, Zo(L)), oe = yN(e?.state.rootActivity, i, Y, L, s);
    return oe.kind === "becomeRoot" ? (f(
      ({ draft: Q }) => Q ? { ...Q, state: { ...Q.state, rootActivity: Y } } : null,
      Y.nodeId
    ), null) : oe.kind === "leafError" ? (m(""), w("The current root activity does not accept child activities. Drop Flowchart or Sequence to wrap it in a composite root."), null) : oe.kind === "staleFrames" ? (m(""), w("This slot could not be resolved — returning to the workflow root."), h(), null) : oe.kind === "wrapRoot" ? (f(({ draft: Q }) => {
      const we = Q?.state.rootActivity;
      return we ? {
        ...Q,
        layout: F(Q.layout, we.nodeId, B),
        state: { ...Q.state, rootActivity: aa(Y, [], [we], L) }
      } : null;
    }, e?.state.rootActivity?.nodeId ?? null), w(""), m(`Wrapped root in ${ke(L)}`), null) : (f(({ draft: Q, frames: we }) => {
      if (!Q?.state.rootActivity) return null;
      const pe = On(Q.state.rootActivity, we, s);
      if (!pe) return null;
      const ve = pe.slot.cardinality === "single" ? [Y] : [...pe.slot.activities, Y], Se = aa(Q.state.rootActivity, we, ve, s);
      return {
        ...Q,
        layout: F(Q.layout, Y.nodeId, B),
        state: { ...Q.state, rootActivity: Se }
      };
    }, Y.nodeId), oe.replacedActivity && (w(""), m(`Replaced ${oe.slot.label} content`)), Y);
  }, [s, e?.state.rootActivity, i, a, f, h, F, w, m]), H = ae((L, B) => {
    const Y = Gi(L, Zo(L)), oe = {
      id: Y.nodeId,
      type: "workflowActivity",
      position: B,
      selected: !0,
    ...
    a || d(({ draft: oe, frames: Q }) => {
      if (!oe) return null;
      const we = Op(oe.layout, L), pe = oe.state.rootActivity;
      if (!pe) return { ...oe, layout: we };
      const ve = On(pe, Q, s);
      if (!ve) return { ...oe, layout: we };
      const Se = zp(ve, L, B, Y), He = ve.slot.mode === "flowchart" ? Vp(Se, B) : Se;
      return {
        ...oe,
        layout: we,
        state: {
          ...oe.state,
          rootActivity: Lp(pe, Q, He, s)
        }
      };
    });
  }, [s, a, d]), O = ae((L, B) => {
  ...
  }, [y]), q = ae((L, B) => document.elementFromPoint(L, B)?.closest(".react-flow__edge")?.getAttribute("data-id") ?? null, []), J = ae((L, B, Y) => {
    const oe = x.find((De) => De.id === B.source), Q = x.find((De) => De.id === B.target), we = oe && Q ? $j(oe, Q) : oe ? qc(oe) : Y, pe = H(L, we), Se = [...x.map((De) => De.selected ? { ...De, selected: !1 } : De), pe.node], He = Yp(b, B, pe.node.id);
    v(Se), g(He), p(pe.node.id), U(Se, He, [pe.activityNode]);
  }, [U, H, b, x, p]), Z = ae((L, B, Y) => {
    if (!u || !M.current) return !1;
    const oe = M.current.getBoundingClientRect();
    if (!(B >= oe.left && B <= oe.right && Y >= oe.top && Y <= oe.bottom)) return !1;
    const we = O(B, Y);
    if (!we) return !1;
    if (c) {
      const pe = q(B, Y), ve = pe ? b.find((Se) => Se.id === pe) : void 0;
      if (ve)
        return J(L, ve, we), !0;
    }
    return W(L, we), !0;
  ...
  ee(() => {
    const L = (Y) => {
      const oe = E.current;
      if (!oe) return;
      Math.hypot(Y.clientX - oe.startX, Y.clientY - oe.startY) >= uj && (oe.dragging = !0);
    }, B = (Y) => {
      const oe = E.current;
      if (E.current = null, !oe?.dragging || !M.current || D.current) return;
      ...
      Y.clientX >= Q.left && Y.clientX <= Q.right && Y.clientY >= Q.top && Y.clientY <= Q.bottom && (P.current = !0, window.setTimeout(() => {
        P.current = !1;
      }, 0), Z(oe.activity, Y.clientX, Y.clientY));
    };
  ...
  const R = (L, B) => {
    ...
    B.length !== 0 && v((Y) => ud(B, Y));
  }, ge = (L) => {
    a || g((B) => dd(L, B));
  }, ye = (L) => !L.source || !L.target || L.source === L.target || !c ? !1 : !L.targetHandle, Ie = (L) => {
    if (!e?.state.rootActivity || !t || !c || !ye(L)) return;
    const B = Ji(L.source, L.target, L.sourceHandle ?? "Done", L.targetHandle ?? void 0), Y = pd(B, b);
    g(Y), U(x, Y);
  }, Te = () => {
    U(x, b);
  }, Ve = !a && x.length > 0, at = ae(() => {
    if (a || x.length === 0) return;
    const L = t?.slot.mode === "sequence" ? "sequence" : "flowchart", B = hN(x, b, L), Y = x.map((oe) => {
      const Q = B.get(oe.id);
      return Q ? { ...oe, position: Q } : oe;
    });
    v(Y), U(Y, b), window.requestAnimationFrame(() => y?.fitView({ padding: 0.2 })), m("Rearranged the canvas.");
  }, [b, x, t, a, U, y, m]), Ue = (L, B) => {
    ...
    const B = new Set(L.map((Q) => Q.id)), Y = x.filter((Q) => !B.has(Q.id)), oe = b.filter((Q) => !B.has(Q.source) && !B.has(Q.target));
    v(Y), g(oe), l && B.has(l) && p(null), U(Y, oe);
  }, xe = (L) => {
    if (a || L.length === 0) return;
    const B = new Set(L.map((oe) => oe.id)), Y = b.filter((oe) => !B.has(oe.id));
    g(Y), U(x, Y);
  }, Ye = ae((L) => {
    if (a) return;
    ...
    if (B.kind === "fromEmpty") {
      const Q = H(L, Y), pe = [...x.map((ve) => ve.selected ? { ...ve, selected: !1 } : ve), Q.node];
      v(pe), p(Q.node.id), U(pe, b, [Q.activityNode]);
      return;
    }
    if (B.kind === "fromPort") {
      const Q = x.find((De) => De.id === B.sourceNodeId), we = Q ? qc(Q) : Y, pe = H(L, we), Se = [...x.map((De) => De.selected ? { ...De, selected: !1 } : De), pe.node], He = [...b, Ji(B.sourceNodeId, pe.node.id, B.sourceHandleId ?? "Done")];
      v(Se), g(He), p(pe.node.id), U(Se, He, [pe.activityNode]);
      return;
    }
    const oe = b.find((Q) => Q.id === B.edgeId);
    oe && J(L, oe, Y);
  }, gn = re(() => ({
    highlightedEdgeId: I,
    deleteEdge: Ye,
...
function NN(e, t, n) {
  ...
  const i = DN(e), r = gf(i.state.rootActivity), s = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), c = [];
...
function TN({
  ...
  ee(() => {
    const c = (l) => {
      ...
      try {
        const p = Tn(e), h = NN(e, d.batch, n), m = `weaver-batch-${Date.now()}`;
...
function $N({ context: e, draft: t, autosaveEnabledByDefault: n = !0, editDraft: i, setStatus: r, setError: s }) {
  const [a, c] = K(n), u = se(""), l = se(0), d = se(Promise.resolve()), f = ae((h) => {
    u.current = h ? Be(h) : "";
  }, []), p = ae(async (h, m) => {
    const w = async () => {
      const v = ++l.current, b = Be(h);
      s("");
      try {
        const g = await kh(e, h), y = Be(g);
        return u.current = y, i(({ draft: N }) => !N || N.id !== g.id ? null : Be(N) === b ? g : { ...N, validationErrors: g.validationErrors }), v === l.current && r(m), g;
      } catch (g) {
        throw v === l.current && (r(""), s(g instanceof Error ? g.message : String(g))), g;
      }
...
function PN({ context: e, definitionId: t, resetHistory: n, loadDraft: i, markSaved: r, setError: s }) {
  const [a, c] = K(null), [u, l] = K([]), [d, f] = K([]), [p, h] = K(null), [m, w] = K(Hi), [x, v] = K("loading"), b = ae(async () => {
    s(""), v("loading");
    ...
    c(g), r(I), n(I), i(I), l(y.activities ?? []), f(N.descriptors), h(S), w(j.descriptors.length > 0 ? j.descriptors : Hi), v(N.ok ? "ready" : "failed");
  }, [e, t, n, i, r, s]);
  return ee(() => {
...
function MN({ context: e, details: t, setDetails: n, setStatus: i }) {
  const r = se(null), s = se(null), a = se({});
  ee(() => {
    r.current = t;
  }, [t]);
  const c = ae(() => {
...
function RN({
  ...
  return { exportJson: m, save: w, promoteAndPublish: x, run: v };
}
function LN({
  context: e,
  draft: t,
  ...
  const c = t?.state.rootActivity ?? null, u = re(() => new Map(r.map((k) => [k.activityVersionId, k])), [r]), l = ae(
    (k) => ag([k.activityVersionId, k.activityTypeKey], a),
    [a]
  ), d = re(() => Aj(s), [s]), f = re(() => Nl(c, n, u), [c, n, u]), p = Al(f, f ? u.get(f.activityVersionId) : void 0), h = !!f && p === "unsupported", m = re(() => h ? null : On(c, n, u), [c, n, u, h]), w = re(() => h && f?.nodeId === i ? f : m?.slot.activities.find((k) => k.nodeId === i) ?? null, [h, m, f, i]), x = re(
    () => w ? Bc(w, u, d) : null,
    [u, d, w]
  ), v = re(() => w ? $e(w, u) : [], [u, w]), b = w ?? f, g = !w && !!f, y = re(
    () => b ? Bc(b, u, d) : null,
    [u, d, b]
  ), N = re(
    () => b ? l({ activityVersionId: b.activityVersionId, activityTypeKey: u.get(b.activityVersionId)?.activityTypeKey }) : null,
    [l, u, b]
  ), j = re(() => b ? $e(b, u) : [], [u, b]), S = b ? rh(b, u.get(b.activityVersionId)) : !1, I = wh(e, t?.state, w?.nodeId ?? null, u), _ = !h && m?.slot.mode === "flowchart";
  return {
    catalogByVersion: u,
...
function zN({
  ...
  const l = re(() => t ? of(t.state.rootActivity, u) : [], [u, t]), d = re(() => t ? sf(t.state.rootActivity, u) : [], [u, t]), f = re(
  ...
  ee(() => {
    if (!(!e || !t))
      return window.__ELSA_STUDIO_WORKFLOW_CONTEXT__ = {
        ...
        revision: Rj(t),
        selectedNodeId: i,
        selectedActivityType: tl(n, r, u),
        inspectedNodeId: s?.nodeId ?? null,
        inspectedActivityType: tl(s, a, u),
        inspectedIsScopeOwner: c,
...
function VN({
  ...
  return /* @__PURE__ */ o.jsxs("div", { className: "wf-palette-body", children: [
    /* @__PURE__ */ o.jsxs("label", { className: "wf-palette-search", children: [
      /* @__PURE__ */ o.jsx(fr, { size: 14, "aria-hidden": "true" }),
      /* @__PURE__ */ o.jsx(
        "input",
        {
          type: "search",
      ...
      return /* @__PURE__ */ o.jsxs("div", { className: "wf-palette-category", children: [
        /* @__PURE__ */ o.jsxs(
          "button",
          {
            ...
            children: [
              f ? /* @__PURE__ */ o.jsx(fl, { size: 14 }) : /* @__PURE__ */ o.jsx(kt, { size: 14 }),
        ...
        f ? /* @__PURE__ */ o.jsx("div", { className: "wf-palette-activities", role: "group", children: d.activities.map((p) => {
          const h = p.description?.trim(), m = h ? `wf-palette-description-${p.activityVersionId}` : void 0, w = ke(p), x = fn(p);
          return /* @__PURE__ */ o.jsxs(
            "button",
            {
              type: "button",
              ...
              onDragStart: (v) => a(v, p),
              onDragEnd: (v) => c(v, p),
              onPointerDown: (v) => u(v, p),
              children: [
                /* @__PURE__ */ o.jsx("span", { className: "wf-activity-icon", "data-icon": x, "aria-hidden": "true", children: xr(x) }),
                ...
                /* @__PURE__ */ o.jsx(pl, { className: "wf-palette-activity-grip", size: 14, "aria-hidden": "true" })
              ]
            },
            p.activityVersionId
          );
...
const yf = /* @__PURE__ */ new Set(["studio.property.singleline", "studio.property.text-fallback"]), ON = "Variable";
function HN({
  activity: e,
  descriptor: t,
  editors: n,
...
function WN({
  ...
  const u = t.isReadOnly === !0, l = { activity: e, expressionDescriptors: r, readOnly: u }, d = ts(n, t, l), f = d?.component, p = t.isWrapped !== !1 ? Yl(e, t) : null, h = p?.expression.type ?? "Literal", m = fg(e, t), w = h.toLowerCase(), v = p && (w === "literal" || w === "object") && !mg(t) ? hg(t.typeName) : null, b = v ? ts(n, t, { ...l, scope: "collection" }) : void 0, g = p ? {
    activity: e,
    descriptor: t,
    expressionDescriptors: r,
    readOnly: u,
    surface: "inline",
    syntax: h
  } : null, y = g ? wf(i, g) : null, N = y?.surfaces.inline, j = y && g ? vf(y, g, m) : [], S = v != null, I = !!(p && !S && ZN(t, d?.id)), _ = !!(p && !S && GN(t, d?.id)), [M, k] = K(!1), $ = (E) => {
    const D = p ? ug(p, E) : E;
    c(xa(e, t, D));
  }, z = (E) => {
    p && c(xa(e, t, dg(p, E)));
  }, C = v ? b ? Jo(b.component, t, m, u, { ...l, scope: "collection" }, $) : /* @__PURE__ */ o.jsx(
    BN,
    {
      input: t,
    ...
    I ? /* @__PURE__ */ o.jsxs("div", { className: "wf-expression-field", children: [
      ...
      _ ? /* @__PURE__ */ o.jsx(
        "button",
        {
          ...
          onClick: () => k(!0),
          children: /* @__PURE__ */ o.jsx(Ln, { size: 13 })
        }
      ) : null
...
function BN({
  ...
  const c = yg(n), u = wg(e, t), l = { ...r, scope: "element" }, d = ts(i, u, l)?.component, f = e.displayName || e.name, p = (N, j) => a(c.map((S, I) => I === N ? j : S)), [h, m] = K(null), [w, x] = K(null), v = () => {
    m(null), x(null);
  }, b = (N) => (j) => {
    m(N), j.dataTransfer.effectAllowed = "move", j.dataTransfer.setData("text/plain", String(N));
  }, g = (N) => (j) => {
    h !== null && (j.preventDefault(), j.dataTransfer.dropEffect = "move", w !== N && x(N));
  }, y = (N) => (j) => {
    j.preventDefault(), h !== null && h !== N && a(go(c, h, N)), v();
  };
        ...
        children: [
          /* @__PURE__ */ o.jsx(
            "span",
            {
              ...
              onDragStart: b(j),
              onDragEnd: v,
              children: /* @__PURE__ */ o.jsx(pl, { size: 13, "aria-hidden": "true" })
            }
          ),
          ...
          /* @__PURE__ */ o.jsxs("div", { className: "wf-collection-item-actions", children: [
            ...
            /* @__PURE__ */ o.jsx(
              "button",
              {
                ...
                onClick: () => a(go(c, j, j + 1)),
                children: /* @__PURE__ */ o.jsx(fl, { size: 13 })
              }
            ),
            /* @__PURE__ */ o.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ o.jsx(Rn, { size: 13 })
              }
            )
          ] })
        ]
...
function KN({
  ...
  const d = ll(), f = e.displayName || e.name, p = {
    activity: r,
    descriptor: e,
    ...
    surface: "expanded",
    syntax: n
  }, h = wf(s, p), m = h?.surfaces.expanded, w = h ? vf(h, p, t) : [], x = m ? null : YN(s, p);
  return ee(() => {
    const v = (b) => {
      b.key === "Escape" && l();
    };
...
function Qo({
  ...
  const [a, c] = K(!1), u = ll(), l = n.find((f) => f.type === t), d = [
...
function qN({ value: e, visibleVariables: t, scopeStatus: n, disabled: i, onChange: r }) {
  const s = Ll(e), a = !!e && typeof e == "object" || typeof e == "string" && e.trim().startsWith("{"), c = s && (a || t.some((d) => d.referenceKey === s.referenceKey)) ? s : null, u = c ? nl(c.referenceKey, c.declaringScopeId) : "", l = !!c && t.some(
    ...
    /* @__PURE__ */ o.jsxs(
      "select",
      {
        ...
        children: [
          ...
          t.map((d) => {
            const f = nl(d.referenceKey, d.scopeId);
  ...
  return g && g.nodeId !== t?.nodeId && y(null), t ? /* @__PURE__ */ o.jsxs("div", { className: "wf-inspector-content", children: [
    ...
    /* @__PURE__ */ o.jsx(
      HN,
      {
        ...
        expressionDescriptors: h,
        descriptorStatus: m,
        visibleVariables: w.visibleVariables,
        scopeStatus: w.status,
        onChange: x
      }
    ),
    d ? /* @__PURE__ */ o.jsx("div", { className: "wf-container-variables", children: /* @__PURE__ */ o.jsx(
      aj,
      {
        ...
        warnings: ch(w.shadowingWarnings, t.nodeId),
        onChange: (N) => x(oh(t, N))
      }
    ) }) : null,
    a.length > 0 ? /* @__PURE__ */ o.jsxs("div", { className: "wf-slot-list", children: [
      ...
      a.map((N) => {
        ...
        return /* @__PURE__ */ o.jsxs("div", { className: "wf-slot-row", children: [
          /* @__PURE__ */ o.jsxs("button", { type: "button", onClick: () => v(t.nodeId, N, j), children: [
            N.label,
...
function nS({
  ...
  const u = dN(), { draft: l, frames: d, selectedNodeId: f, testRun: p, publishedArtifactId: h } = u.state, {
  ...
  } = pf(), { resetHistory: ye, undo: Ie, redo: Te, canUndoNow: Ve, canRedoNow: at } = cN({ draft: l, restoreDraft: m }), { saveDraft: Ue, autosaveEnabled: Ze, setAutosaveEnabled: Me, markSaved: Oe } = $N({ context: e, draft: l, autosaveEnabledByDefault: a, editDraft: x, setStatus: k, setError: _ }), {
    details: xe,
    setDetails: Ye,
    catalog: _e,
    activityDescriptors: jt,
    availabilityDiagnostics: gn,
    expressionDescriptors: L,
    descriptorStatus: B,
    reload: Y
  } = PN({ context: e, definitionId: t, resetHistory: ye, loadDraft: m, markSaved: Oe, setError: _ }), { updateDefinitionMeta: oe } = MN({ context: e, details: xe, setDetails: Ye, setStatus: k }), {
    catalogByVersion: Q,
    ...
    selectedSlots: li,
    inspectedNode: We,
    inspectedIsScopeOwner: Ot,
    inspectedDescriptor: Nt,
    inspectedNodeAvailability: Tr,
    inspectedSlots: mn,
    inspectedSupportsScopedVariables: $r,
    scopedVariableAnalysis: Pr,
    isFlowchartDesigner: ct,
    canAddActivitiesToCanvas: Mr
  } = LN({ context: e, draft: l, frames: d, selectedNodeId: f, catalog: _e, activityDescriptors: jt, availabilityDiagnostics: gn }), Ht = re(() => Uo(_e), [_e]), Rr = re(() => {
    const G = E.trim().toLowerCase();
    if (!G) return Ht;
    const ue = _e.filter((me) => ke(me).toLowerCase().includes(G) || me.activityTypeKey.toLowerCase().includes(G) || (me.category ?? "").toLowerCase().includes(G) || (me.description ?? "").toLowerCase().includes(G));
    return Uo(ue);
  }, [_e, E, Ht]), Wt = $ !== "idle", Lr = !!l?.state.rootActivity && !Wt, ui = Lt(n, "weaver.workflows.find-draft-risks"), di = Lt(n, "weaver.workflows.propose-update"), zr = bN({
    draft: l,
    scope: Se,
    scopeOwner: pe,
    frames: d,
    ...
    autoLayout: Gr,
    onCanvasDragOver: xn,
    onCanvasDragLeave: mi,
    onCanvasDrop: yi,
    openEmptyConnectMenu: xi,
    onConnectMenuPick: Jr,
    addActivity: wi,
    onPaletteClick: Qr,
    onPaletteDragStart: eo,
    onPaletteDragEnd: to,
    onPalettePointerDown: vi
  } = zr, no = !ve && !ct && d.length > 0 && !!Se && Se.slot.activities.length === 0 && Ft.length === 0, bi = ae((G) => {
    const ue = wi(G);
    if (!ue || !Se || !pe || d.length === 0) return;
    const me = d[d.length - 1].label, Ce = Vi(d, pe, pe.nodeId, { ...Se.slot, activities: [ue] }, me, Q);
    Ce && Ce.frames.length > d.length && g(Ce.frames, Ce.selectedNodeId);
  }, [wi, Q, d, g, Se, pe]);
  TN({ draft: l, details: xe, catalog: _e, replaceDraftByBatch: w, setStatus: k, setError: _ }), ee(() => {
    !l?.state.rootActivity || _e.length === 0 || x(({ draft: G }) => {
  ...
  }, [_e.length, Q, l?.state.rootActivity, x]), zN({ details: xe, draft: l, selectedNode: He, selectedNodeId: f, selectedDescriptor: De, inspectedNode: We, inspectedDescriptor: Nt, inspectedIsScopeOwner: Ot, catalogByVersion: Q });
  const ji = re(() => !xe || !l ? null : {
    definition: xe.definition,
    draft: l,
    selectedActivity: He,
    selectedActivityDescriptor: De,
    selectedActivitySlots: li,
    inspectedActivity: We,
    inspectedActivityDescriptor: Nt,
    inspectedActivitySlots: mn,
    inspectedIsScopeOwner: Ot,
    catalog: _e,
    currentScopeOwner: pe,
    frames: d
  }, [_e, xe, l, d, Nt, Ot, We, mn, pe, De, He, li]);
  ee(() => {
    A((G) => {
      let ue = !1;
      const me = new Set(G);
  ...
  const { exportJson: io, save: wn, promoteAndPublish: ro, run: oo } = RN({
    context: e,
    draft: l,
    details: xe,
    busy: Wt,
  ...
  ee(() => {
    const G = (ue) => {
      ...
      Ce === "z" && !ue.shiftKey ? (ue.preventDefault(), Ie()) : (Ce === "z" && ue.shiftKey || Ce === "y") && (ue.preventDefault(), Te());
    };
    return window.addEventListener("keydown", G), () => window.removeEventListener("keydown", G);
  }, [H, Ie, Te]);
  const so = ae((G, ue, me) => {
    const Ce = Vi(d, pe, G, ue, me, Q);
    Ce && g(Ce.frames, Ce.selectedNodeId);
  }, [Q, d, g, pe]), Cf = ae((G, ue, me, Ce) => {
    const Ci = ue.activities.length > 0, Us = Gi(Ce, Zo(Ce));
    x(({ draft: ki }) => {
      const Zs = ki?.state.rootActivity;
      return !ki || !Zs ? null : {
        ...ki,
        state: {
          ...ki.state,
          rootActivity: Po(Zs, G, ($f) => dn($f, ue, [Us]), Q)
        }
      };
    });
    const lo = Vi(d, pe, G, { ...ue, activities: [Us] }, me, Q);
    lo && g(lo.frames, lo.selectedNodeId), _(""), k(Ci ? `Replaced ${ue.label} content` : `Assigned ${ke(Ce)} to ${ue.label}`);
  }, [Q, x, d, g, pe]), kf = re(() => ve ? null : (G, ue, me) => so(G, me, Zi(ue, me)), [so, ve]), Ef = ae((G) => {
    x(({ draft: ue }) => {
    ...
    if (!ue) return;
    const me = Ip(ue, G, (Ce) => {
      const Ci = Q.get(Ce.activityVersionId);
      return Ci ? ke(Ci) : Ce.nodeId;
    }, Q);
    me && (U("designer"), g(me, G), X(!1));
  }, [l?.state.rootActivity, Q, X, g]), Af = (G) => {
    A((ue) => {
      const me = new Set(ue);
  ...
  const Bs = We ? Q.get(We.activityVersionId) : void 0, _f = We ? Ft.find((G) => G.id === We.nodeId)?.data.label ?? (Bs ? ke(Bs) : We.nodeId) : "", Si = p?.draftSignature === Be(l) ? p.view : null, Ks = Si && M.startsWith("Test run") ? "" : M, Df = (G) => {
    ...
    return {
      ...
      order: G.order ?? 500,
      icon: null,
      render: () => ji && /* @__PURE__ */ o.jsx(ue, { context: ji })
    };
  }), ao = [
    {
      id: "activities",
      title: "Activities",
      order: 0,
      icon: /* @__PURE__ */ o.jsx(Qn, { size: 15 }),
      render: () => /* @__PURE__ */ o.jsx(
        VN,
        {
          ...
          onToggleCategory: Af,
          onActivityClick: Qr,
          onActivityDragStart: eo,
          onActivityDragEnd: to,
          onActivityPointerDown: vi
        }
      )
    },
  ...
  ].sort(Yc), co = [
    {
      ...
      render: () => /* @__PURE__ */ o.jsx(
        JN,
        {
          context: e,
          selectedNode: We,
          selectedNodeLabel: _f,
          selectedActivityType: We ? Nt?.typeName ?? Q.get(We.activityVersionId)?.activityTypeKey ?? "Unknown" : "",
          selectedDescriptor: Nt,
          selectedNodeAvailability: Tr,
          selectedSlots: mn,
          inspectingScopeOwner: Ot,
          catalog: _e,
          catalogByVersion: Q,
          selectedSupportsScopedVariables: $r,
          propertyEditors: i,
          expressionEditors: r,
          expressionDescriptors: L,
          descriptorStatus: B,
          scopedVariableAnalysis: Pr,
          onSelectedActivityChange: Ef,
          onEnterSlot: so,
          onReplaceSlotActivity: Cf
        }
      )
    },
    {
      ...
      render: () => /* @__PURE__ */ o.jsx(Qj, { testRun: Si, onOpenRun: Df })
    },
    {
      id: "artifacts",
      title: "Artifacts",
      order: 10,
      icon: /* @__PURE__ */ o.jsx(hl, { size: 15 }),
      render: () => /* @__PURE__ */ o.jsx(
        nN,
        {
          context: e,
          ai: n,
          definitionId: xe.definition.id,
    ...
    { id: "designer", title: "Designer", order: 0, icon: /* @__PURE__ */ o.jsx(gl, { size: 14 }), render: () => null },
  ...
  return /* @__PURE__ */ o.jsxs("section", { className: "wf-editor", children: [
    /* @__PURE__ */ o.jsxs("div", { className: "wf-editor-top", children: [
      ...
      /* @__PURE__ */ o.jsx(kt, { size: 14 }),
      /* @__PURE__ */ o.jsx("strong", { children: xe.definition.name }),
      ...
      /* @__PURE__ */ o.jsxs("div", { className: "wf-editor-actions", children: [
        ...
        /* @__PURE__ */ o.jsxs("label", { className: "wf-autosave-toggle", children: [
          /* @__PURE__ */ o.jsx("input", { className: "wf-switch-input", type: "checkbox", checked: Ze, onChange: (G) => Me(G.target.checked) }),
          /* @__PURE__ */ o.jsx("span", { children: "Autosave" })
        ] }),
        ui ? /* @__PURE__ */ o.jsxs("button", { type: "button", onClick: () => zt(n, ui, { definition: xe.definition, draft: l }), children: [
          /* @__PURE__ */ o.jsx(ft, { size: 15 }),
          " Risks"
        ] }) : null,
        di ? /* @__PURE__ */ o.jsxs("button", { type: "button", onClick: () => zt(n, di, { definition: xe.definition, draft: l }), children: [
          /* @__PURE__ */ o.jsx(ft, { size: 15 }),
          " Propose"
        ] }) : null,
        /* @__PURE__ */ o.jsxs("button", { type: "button", title: "Export workflow as JSON", onClick: io, children: [
          /* @__PURE__ */ o.jsx(Uf, { size: 15 }),
          " Export"
        ] }),
        /* @__PURE__ */ o.jsxs("button", { type: "button", disabled: Wt, onClick: () => {
          wn();
        }, children: [
          /* @__PURE__ */ o.jsx(os, { size: 15 }),
          " Save"
    ...
    /* @__PURE__ */ o.jsxs("div", { className: te, style: ie, children: [
          ...
          /* @__PURE__ */ o.jsxs("span", { className: "wf-panel-actions", children: [
            /* @__PURE__ */ o.jsx(
              "button",
              {
                ...
                onClick: () => fe("palette"),
                children: J ? /* @__PURE__ */ o.jsx(kt, { size: 14 }) : /* @__PURE__ */ o.jsx(zn, { size: 14 })
              }
            ),
            J ? null : /* @__PURE__ */ o.jsx(
              "button",
              {
                ...
                onClick: () => V("palette"),
                children: R === "palette" ? /* @__PURE__ */ o.jsx(Do, { size: 14 }) : /* @__PURE__ */ o.jsx(Ln, { size: 14 })
              }
            )
          ] })
        ] }),
      ...
      /* @__PURE__ */ o.jsxs("main", { className: "wf-canvas-shell", children: [
        ...
        H === "code" ? /* @__PURE__ */ o.jsx(Yb, { draft: l, onApply: Sf }) : H === "properties" ? /* @__PURE__ */ o.jsx(lj, { details: xe, draft: l, context: e, onStateChange: Ni, onDefinitionMetaChange: oe }) : /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
          /* @__PURE__ */ o.jsx(df, { frames: d, onNavigate: (G) => g(G, null) }),
          /* @__PURE__ */ o.jsxs("div", { className: "wf-canvas", ref: pi, onDragOver: xn, onDragLeave: mi, onDrop: yi, children: [
            /* @__PURE__ */ o.jsx(Yd.Provider, { value: Or, children: /* @__PURE__ */ o.jsx(Ud.Provider, { value: we, children: /* @__PURE__ */ o.jsx(Zd.Provider, { value: kf, children: /* @__PURE__ */ o.jsxs(
              zd,
              {
                nodes: Ft,
                edges: fi,
                ...
                onEdgesDelete: gi,
                onConnect: Kr,
                onConnectStart: ct ? Xr : void 0,
                onConnectEnd: ct ? qr : void 0,
                onReconnect: ct ? Yr : void 0,
                isValidConnection: Br,
                onDragOver: xn,
                onDragLeave: mi,
                onDrop: yi,
            ...
            ) : ct && Ft.length === 0 ? /* @__PURE__ */ o.jsxs("button", { type: "button", className: "wf-empty-canvas-add", onClick: () => xi(), children: [
          ...
          /* @__PURE__ */ o.jsx(Gj, { draft: l, onRepair: If })
        ] })
      ] }),
      le && !R ? /* @__PURE__ */ o.jsx(
        "div",
          ...
          /* @__PURE__ */ o.jsxs("span", { className: "wf-panel-actions", children: [
            /* @__PURE__ */ o.jsx(
              "button",
              {
                ...
                children: Z ? /* @__PURE__ */ o.jsx(zn, { size: 14 }) : /* @__PURE__ */ o.jsx(kt, { size: 14 })
              }
            ),
            Z ? null : /* @__PURE__ */ o.jsx(
              "button",
              {
                ...
                onClick: () => V("inspector"),
                children: R === "inspector" ? /* @__PURE__ */ o.jsx(Do, { size: 14 }) : /* @__PURE__ */ o.jsx(Ln, { size: 14 })
              }
            )
          ] })
        ] }),
...
function rS({ draft: e, creating: t, ai: n, suggestMetadataAction: i, onChange: r, onClose: s, onSubmit: a }) {
  const [c, u] = K(!1), [l, d] = K(""), [f, p] = K(!1), [h, m] = K(null), [w, x] = K(null), v = se(null), b = se(e);
  b.current = e;
  const g = se(r);
  g.current = r;
  const y = ae((j) => {
  ...
  ee(() => {
    if (i)
      return n.onPromptResult((j) => {
        if (j.requestId !== v.current) return;
        if (v.current = null, p(!1), j.status !== "completed") {
  ...
  const N = () => {
    ...
    v.current = S, p(!0), m(null), x(null), n.dispatchPrompt({ ...j, requestId: S });
  };
...
function oS({ context: e, ai: t, onOpen: n }) {
  const [i, r] = K(""), [s, a] = K("active"), [c, u] = K(1), [l, d] = K(hj), [f, p] = K("loading"), [h, m] = K(""), [w, x] = K(""), [v, b] = K([]), [g, y] = K(0), [N, j] = K(() => /* @__PURE__ */ new Set()), [S, I] = K(null), [_, M] = K(!1), [k, $] = K([]), [z, C] = K("idle"), A = se(null), E = re(() => v.map((V) => V.id), [v]), D = Lt(t, "weaver.workflows.suggest-create-metadata"), P = Lt(t, "weaver.workflows.explain-definition"), T = E.filter((V) => N.has(V)).length, F = E.length > 0 && T === E.length, W = ae(async () => {
    p("loading"), m("");
    try {
      const V = await mh(e, { search: i, state: s, page: c, pageSize: l }), ne = typeof V.totalCount == "number", ge = V.totalCount ?? V.definitions.length, ye = Gd(ge, l);
      if (ge > 0 && c > ye) {
        u(ye);
        return;
      }
      b(ne ? V.definitions : yj(V.definitions, c, l)), y(ge), p("ready");
    } catch (V) {
  ...
  const H = ae(async () => {
    ...
    if (await ta().confirm({ message: `Delete workflow definition "${V.name}"? You can restore it from the Deleted view.`, confirmLabel: "Delete", tone: "danger" })) {
      x(""), m("");
      try {
        await jh(e, V.id), R(V.id, !1), x(`Deleted ${V.name}`), await J();
      } catch (ne) {
    ...
    x(""), m("");
    try {
      await Nh(e, V.id), R(V.id, !1), x(`Restored ${V.name}`), await J();
    } catch (ne) {
      m(ne instanceof Error ? ne.message : String(ne));
    }
  }, fe = async (V) => {
    if (await ta().confirm({ message: `Permanently delete workflow definition "${V.name}"? This removes its drafts, versions, layouts, and validations and cannot be undone.`, confirmLabel: "Delete permanently", tone: "danger" })) {
      x(""), m("");
      try {
        await Sh(e, V.id), R(V.id, !1), x(`Permanently deleted ${V.name}`), await J();
      } catch (ne) {
        m(ne instanceof Error ? ne.message : String(ne));
      }
    }
  ...
  return /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
    ...
    f === "failed" ? /* @__PURE__ */ o.jsx(ci, { message: h, title: "Couldn't load workflow definitions" }) : null,
    ...
    f === "ready" && v.length === 0 ? /* @__PURE__ */ o.jsx(
      Os,
      {
        icon: /* @__PURE__ */ o.jsx(hl, { size: 22 }),
    ...
    f === "ready" && v.length > 0 ? /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
...
function sS({ activities: e, activityCatalog: t, selectedEvidenceId: n = null, onSelectEvidence: i }) {
  ...
  return s.length === 0 ? /* @__PURE__ */ o.jsx("div", { className: "wf-empty wf-timeline-empty", children: "No activity executions recorded yet." }) : /* @__PURE__ */ o.jsx("ol", { className: "wf-timeline", "aria-label": "Execution timeline", children: s.map((a) => {
    const c = r.get(a.activityType), u = fn(c), l = c ? ke(c) : Dt(a.activityType) ?? a.activityType, d = Dt(a.activityType) ?? a.activityType, f = lS(a.startedAt ?? a.scheduledAt), p = ys(a.startedAt, a.completedAt);
    return /* @__PURE__ */ o.jsx("li", { children: /* @__PURE__ */ o.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ o.jsx("span", { className: "wf-timeline-icon wf-activity-icon", "data-icon": u, "aria-hidden": "true", children: xr(u) }),
...
function cS(e) {
  return e.map((t, n) => ({ activity: t, index: n })).sort((t, n) => il(t.activity) - il(n.activity) || t.index - n.index).map((t) => t.activity);
}
function il(e) {
...
function uS({ context: e }) {
  ...
  return /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
    ...
    t === "failed" ? /* @__PURE__ */ o.jsx(ci, { message: i }) : null,
    t === "loading" ? /* @__PURE__ */ o.jsx(Vs, {}) : null,
    t === "ready" && l.length === 0 ? /* @__PURE__ */ o.jsx(
      Os,
      {
        icon: /* @__PURE__ */ o.jsx(Qn, { size: 22 }),
...
function dS({ context: e, ai: t, workflowExecutionId: n }) {
  const [i, r] = K("loading"), [s, a] = K(""), [c, u] = K(null), [l, d] = K(null), [f, p] = K([]), {
  ...
  } = pf(), j = Lt(t, "weaver.workflows.explain-instance"), S = ae(async () => {
    if (!n) {
    ...
    r("loading"), a("");
    try {
      const k = await Th(e, n), [$, z] = await Promise.all([
  ...
  return /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
    ...
    i === "failed" ? /* @__PURE__ */ o.jsx(ci, { message: s }) : null,
    i === "ready" && c ? /* @__PURE__ */ o.jsxs("div", { className: M, style: v, children: [
      /* @__PURE__ */ o.jsx(
        fS,
        {
      ...
      /* @__PURE__ */ o.jsx(
        mS,
        {
          ...
          onSelectEvidence: d,
          activityCatalog: c.activityCatalog,
          graphNodeIds: c.definitionVersion ? gS(c.definitionVersion, c.activityCatalog) : void 0,
...
function pS(e, t, n, i, r, s) {
  ...
  const c = On(a, r, t), u = c?.owner ?? a, l = t.find((h) => h.activityVersionId === u.activityVersionId), f = Al(u, l) === "unsupported" || !c ? Il(u, t, e.layout) : El(c, t, e.layout), p = f.nodes.map((h) => ({
    ...h,
    draggable: !1,
    connectable: !1,
    deletable: !1,
    data: {
      ...h.data,
      onEnterSlot: (m) => {
        const w = Vi(r, u, h.id, m, Zi(h.data.label, m), t);
        w && s(w.frames);
      }
    }
  }));
  return {
    nodes: Rp(p, n.activities, n.incidents, i),
...
function mS({
  ...
  const g = r?.incidents.length ?? 0, y = yS(r?.activities ?? [], c), N = (S) => {
    u?.(S), b("activity");
  }, j = [
    { id: "timeline", title: "Timeline", order: 0, icon: /* @__PURE__ */ o.jsx(rs, { size: 14 }), render: () => null },
    { id: "activity", title: "Activity", order: 1, icon: /* @__PURE__ */ o.jsx(dl, { size: 14 }), render: () => null },
  ...
  return /* @__PURE__ */ o.jsxs("aside", { className: "wf-instance-inspector", "aria-label": "Run details panel", children: [
    /* @__PURE__ */ o.jsxs("div", { className: "wf-panel-title wf-instance-panel-title", children: [
      /* @__PURE__ */ o.jsx(Ui, { label: "Run details tabs", tabs: j, activeTabId: v, onSelect: (S) => b(S) }),
      /* @__PURE__ */ o.jsxs("span", { className: "wf-panel-actions", children: [
        /* @__PURE__ */ o.jsx(
          "button",
          {
            ...
            onClick: w,
            children: p ? /* @__PURE__ */ o.jsx(zn, { size: 14 }) : /* @__PURE__ */ o.jsx(kt, { size: 14 })
          }
        ),
        p ? null : /* @__PURE__ */ o.jsx(
          "button",
          {
            ...
            onClick: x,
            children: m ? /* @__PURE__ */ o.jsx(Do, { size: 14 }) : /* @__PURE__ */ o.jsx(Ln, { size: 14 })
          }
        )
      ] })
    ] }),
    h ? /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
      ...
      s === "failed" ? /* @__PURE__ */ o.jsx(ci, { message: a }) : null,
      s === "ready" && r ? /* @__PURE__ */ o.jsx("div", { className: "wf-instance-tab-content", children: v === "timeline" ? /* @__PURE__ */ o.jsx(
        sS,
        {
      ...
      ) : v === "activity" ? /* @__PURE__ */ o.jsx(xS, { context: e, activity: y, activityCatalog: f }) : v === "issues" ? /* @__PURE__ */ o.jsxs(o.Fragment, { children: [
        /* @__PURE__ */ o.jsx(TS, { incidents: r.incidents, selectedEvidenceId: c, onSelectEvidence: u }),
        /* @__PURE__ */ o.jsx(LS, { details: r, graphNodeIds: l, rootNodeId: d })
...
function xS({ context: e, activity: t, activityCatalog: n }) {
  ...
  if (ee(() => {
    ...
    let f = !1;
    const p = i;
    return a({ activityExecutionId: p, status: "loading", inspection: null, error: "" }), $h(e, r, p).then(
      (h) => {
...
function rl({
  ...
  return a.length === 0 ? /* @__PURE__ */ o.jsxs("section", { className: "wf-instance-section", children: [
    ...
    /* @__PURE__ */ o.jsx("h4", { children: n }),
    /* @__PURE__ */ o.jsx("div", { className: "wf-runtime-input-list", children: a.map((c) => /* @__PURE__ */ o.jsx(wS, { snapshot: c }, `${c.name}:${c.capturedAt}:${c.captureMode}`)) })
  ] });
}
function wS({ snapshot: e }) {
  ...
  return /* @__PURE__ */ o.jsxs("article", { className: "wf-runtime-input", children: [
    /* @__PURE__ */ o.jsxs("header", { children: [
      ...
      /* @__PURE__ */ o.jsx("span", { className: "wf-runtime-capture-mode", children: kS(e.captureMode) })
    ] }),
    AS(n) ? /* @__PURE__ */ o.jsx(Fs, { node: n }) : i ? /* @__PURE__ */ o.jsx(CS, { payload: e.payload }) : /* @__PURE__ */ o.jsx("p", { children: IS(e) }),
...
function bS(e) {
  return Object.hasOwn(vS, e.kind);
}
function Fs({ node: e, depth: t = 0 }) {
  if (!bS(e))
    return /* @__PURE__ */ o.jsx(ol, { node: { kind: "unsupported", reason: `Unknown snapshot node: ${e.kind}` } });
  switch (e.kind) {
    case "null":
    ...
    case "permissionHidden":
      return /* @__PURE__ */ o.jsx(ol, { node: e });
    case "payloadReference":
      return /* @__PURE__ */ o.jsx(SS, { node: e });
  }
}
...
`) ? /* @__PURE__ */ o.jsx("code", { className: "wf-runtime-input-value", children: t }) : /* @__PURE__ */ o.jsxs("details", { className: "wf-runtime-input-value-details", children: [
    /* @__PURE__ */ o.jsx("summary", { children: _S(t) }),
...
function TS({ incidents: e, selectedEvidenceId: t = null, onSelectEvidence: n }) {
  const [i, r] = K("");
  return /* @__PURE__ */ o.jsxs("section", { className: "wf-instance-section", children: [
...
function $S({ incident: e }) {
  ...
  return t ? /* @__PURE__ */ o.jsxs("details", { className: "wf-incident-stacktrace", children: [
    /* @__PURE__ */ o.jsx("summary", { children: RS(t) }),
    /* @__PURE__ */ o.jsx("pre", { children: t })
  ] }) : null;
}
function PS(e) {
  const t = MS(e.stackTrace, e.exceptionStackTrace);
  if (t) return t;
  for (const n of DS) {
...
function LS({ details: e, graphNodeIds: t, rootNodeId: n }) {
  if (!t) return null;
...
function VS({
  ...
  return a ? /* @__PURE__ */ o.jsx(nS, { context: e, definitionId: a, ai: t, propertyEditors: n, expressionEditors: i, workflowDesignerPanels: r, autosaveEnabledByDefault: s, onBack: () => u(null) }) : /* @__PURE__ */ o.jsx(Dr, { title: "Definitions", children: /* @__PURE__ */ o.jsx(oS, { context: e, ai: t, onOpen: u }) });
}
function OS({ context: e, ai: t }) {
  ...
  return /* @__PURE__ */ o.jsx(Dr, { title: "Executables", children: /* @__PURE__ */ o.jsx(eN, { context: e, ai: t, definitionFilter: n, onDefinitionFilterChange: r }) });
}
function HS({ context: e }) {
  return /* @__PURE__ */ o.jsx(Dr, { title: "Runs", children: /* @__PURE__ */ o.jsx(uS, { context: e }) });
}
function WS({ context: e, ai: t }) {
  const n = FS();
  return /* @__PURE__ */ o.jsx(Dr, { title: "Run", children: /* @__PURE__ */ o.jsx(dS, { context: e, ai: t, workflowExecutionId: n }) });
}
    ...
    routes: [
      {
        ...
        component: () => /* @__PURE__ */ o.jsx(VS, { context: e.backend, ai: e.ai, propertyEditors: e.propertyEditors.list(), expressionEditors: e.expressionEditors?.list() ?? [], workflowDesignerPanels: e.workflowDesigner.panels.list(), autosaveEnabledByDefault: e.runtime.workflows?.autosaveEnabledByDefault ?? !0 })
      },
      {
        id: "workflows-executables",
        path: "/workflows/executables",
        label: "Workflow executables",
        component: () => /* @__PURE__ */ o.jsx(OS, { context: e.backend, ai: e.ai })
      },
      {
        id: "workflows-instances",
        path: "/workflows/instances",
        label: "Workflow runs",
        component: () => /* @__PURE__ */ o.jsx(HS, { context: e.backend })
      },
      {
        id: "workflows-instance-detail",
        path: "/workflows/instances/:workflowExecutionId",
        label: "Workflow run",
        component: () => /* @__PURE__ */ o.jsx(WS, { context: e.backend, ai: e.ai })
      },
      {
