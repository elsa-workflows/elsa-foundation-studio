import ut, { memo as ve, forwardRef as To, useRef as ce, useEffect as ae, useCallback as he, useContext as Mn, useMemo as pe, useState as G, createContext as oi, useLayoutEffect as wl, createElement as Rr, useId as ra } from "react";
...
var Mi;
function Sl() {
  return Mi || (Mi = 1, br.exports = bl()), br.exports;
}
var u = Sl();
function Se(e) {
...
ho.prototype = zo.prototype = {
  constructor: ho,
  on: function(e, t) {
    var n = this._, o = El(e + "", n), r, i = -1, s = o.length;
    if (arguments.length < 2) {
      for (; ++i < s; ) if ((r = (e = o[i]).type) && (r = _l(n[r], e.name))) return r;
      return;
    }
    if (t != null && typeof t != "function") throw new Error("invalid callback: " + t);
    for (; ++i < s; )
      if (r = (e = o[i]).type) n[r] = Ai(n[r], e.name, t);
      else if (t == null) for (r in n) n[r] = Ai(n[r], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function Ai(e, t, n) {
  for (var o = 0, r = e.length; o < r; ++o)
    if (e[o].name === t) {
      e[o] = Nl, e = e.slice(0, o).concat(e.slice(o + 1));
      break;
    }
...
function Pl(e) {
  typeof e == "function" ? e = Dl(e) : e = sa(e);
...
function Ll(e) {
  return this.select(e == null ? zl : Tl(typeof e == "function" ? e : ca(e)));
}
...
function Ol(e) {
  return this.selectAll(e == null ? Hl : Vl(typeof e == "function" ? e : ca(e)));
}
function Bl(e) {
...
function Fl() {
  return new Re(this._enter || this._groups.map(la), this._parents);
}
function bo(e, t) {
...
function Zl(e, t) {
  ...
  var n = t ? Yl : Xl, o = this._parents, r = this._groups;
  typeof e != "function" && (e = Wl(e));
  for (var i = r.length, s = new Array(i), c = new Array(i), l = new Array(i), a = 0; a < i; ++a) {
    var d = o[a], f = r[a], h = f.length, p = Kl(e.call(d, d && d.__data__, a, o)), m = p.length, x = c[a] = new Array(m), v = s[a] = new Array(m), y = l[a] = new Array(h);
    n(d, f, x, v, y, p, t);
    for (var b = 0, g = 0, w, _; b < m; ++b)
      if (w = x[b]) {
        for (b >= g && (g = b + 1); !(_ = v[g]) && ++g < m; ) ;
        w._next = _ || null;
      }
  }
...
function Ul() {
  return new Re(this._exit || this._groups.map(la), this._parents);
}
function Gl(e, t, n) {
...
function pu(e, t) {
  ...
  return this.each((t == null ? n.local ? lu : cu : typeof t == "function" ? n.local ? hu : fu : n.local ? du : uu)(n, t));
}
function ua(e) {
...
function xu(e, t, n) {
  return arguments.length > 1 ? this.each((t == null ? gu : typeof t == "function" ? yu : mu)(e, t, n ?? "")) : Pt(this.node(), e);
}
function Pt(e, t) {
...
function Su(e, t) {
  return arguments.length > 1 ? this.each((t == null ? wu : typeof t == "function" ? bu : vu)(e, t)) : this.node()[e];
}
function da(e) {
...
function ha(e, t) {
  for (var n = ii(e), o = -1, r = t.length; ++o < r; ) n.add(t[o]);
}
function pa(e, t) {
  for (var n = ii(e), o = -1, r = t.length; ++o < r; ) n.remove(t[o]);
}
function Nu(e) {
  return function() {
    ha(this, e);
...
function _u(e, t) {
  return function() {
    (t.apply(this, arguments) ? ha : pa)(this, e);
  };
}
function Cu(e, t) {
  var n = da(e + "");
  if (arguments.length < 2) {
    for (var o = ii(this.node()), r = -1, i = n.length; ++r < i; ) if (!o.contains(n[r])) return !1;
    return !0;
  }
  return this.each((typeof t == "function" ? _u : t ? Nu : Eu)(n, t));
}
function ku() {
  this.textContent = "";
}
...
function Au(e) {
  return arguments.length ? this.each(e == null ? ku : (typeof e == "function" ? Mu : Iu)(e)) : this.node().textContent;
}
function ju() {
  this.innerHTML = "";
}
...
function $u(e) {
  return arguments.length ? this.each(e == null ? ju : (typeof e == "function" ? Pu : Du)(e)) : this.node().innerHTML;
}
function Tu() {
...
function Ou(e, t) {
  var n = typeof e == "function" ? e : ia(e), o = t == null ? Vu : typeof t == "function" ? t : ri(t);
  return this.select(function() {
...
function Qu(e, t, n) {
  ...
  for (c = t ? Gu : Uu, r = 0; r < i; ++r) this.each(c(o[r], t, n));
  return this;
}
function ga(e, t, n) {
  var o = ua(e), r = o.CustomEvent;
...
function td(e, t) {
  return this.each((typeof t == "function" ? ed : Ju)(e, t));
}
function* nd() {
  for (var e = this._groups, t = 0, n = e.length; t < n; ++t)
...
const id = { passive: !1 }, xn = { capture: !0, passive: !1 };
function Sr(e) {
...
function wa() {
  var e = sd, t = ad, n = cd, o = ld, r = {}, i = zo("start", "drag", "end"), s = 0, c, l, a, d, f = 0;
  function h(w) {
    w.on("mousedown.drag", p).filter(o).on("touchstart.drag", v).on("touchmove.drag", y, id).on("touchend.drag touchcancel.drag", b).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function p(w, _) {
    if (!(d || !e.call(this, w, _))) {
      var E = g(this, t.call(this, w, _), w, _, "mouse");
      E && (Le(w.view).on("mousemove.drag", m, xn).on("mouseup.drag", x, xn), ya(w.view), Sr(w), a = !1, c = w.clientX, l = w.clientY, E("start", w));
    }
  }
  function m(w) {
    if (jt(w), !a) {
  ...
  function x(w) {
    Le(w.view).on("mousemove.drag mouseup.drag", null), xa(w.view, a), jt(w), r.mouse("end", w);
  }
  function v(w, _) {
    if (e.call(this, w, _)) {
...
var wn = 0.7, So = 1 / wn, Dt = "\\s*([+-]?\\d+)\\s*", vn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Qe = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", ud = /^#([0-9a-f]{3,8})$/, dd = new RegExp(`^rgb\\(${Dt},${Dt},${Dt}\\)$`), fd = new RegExp(`^rgb\\(${Qe},${Qe},${Qe}\\)$`), hd = new RegExp(`^rgba\\(${Dt},${Dt},${Dt},${vn}\\)$`), pd = new RegExp(`^rgba\\(${Qe},${Qe},${Qe},${vn}\\)$`), gd = new RegExp(`^hsl\\(${vn},${Qe},${Qe}\\)$`), md = new RegExp(`^hsla\\(${vn},${Qe},${Qe},${vn}\\)$`), Di = {
  aliceblue: 15792383,
...
function yt(e) {
  var t, n;
  return e = (e + "").trim().toLowerCase(), (t = ud.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? Ti(t) : n === 3 ? new $e(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? no(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? no(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = dd.exec(e)) ? new $e(t[1], t[2], t[3], 1) : (t = fd.exec(e)) ? new $e(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = hd.exec(e)) ? no(t[1], t[2], t[3], t[4]) : (t = pd.exec(e)) ? no(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = gd.exec(e)) ? Ri(t[1], t[2] / 100, t[3] / 100, 1) : (t = md.exec(e)) ? Ri(t[1], t[2] / 100, t[3] / 100, t[4]) : Di.hasOwnProperty(e) ? Ti(Di[e]) : e === "transparent" ? new $e(NaN, NaN, NaN, 0) : null;
}
function Ti(e) {
...
function Or(e, t, n, o) {
  return arguments.length === 1 ? wd(e) : new $e(e, t, n, o ?? 1);
}
function $e(e, t, n, o) {
...
function bd(e, t, n, o) {
  return arguments.length === 1 ? ba(e) : new Ye(e, t, n, o ?? 1);
}
function Ye(e, t, n, o) {
...
si(Ye, bd, va(jn, {
  ...
  clamp() {
    return new Ye(Hi(this.h), oo(this.s), oo(this.l), No(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = No(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${Hi(this.h)}, ${oo(this.s) * 100}%, ${oo(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function Hi(e) {
...
function Ed(e) {
  return (e = +e) == 1 ? Sa : function(t, n) {
    return n - t ? Nd(t, n, e) : ai(isNaN(t) ? n : t);
  };
}
function Sa(e, t) {
  var n = t - e;
  return n ? Sd(e, n) : ai(isNaN(e) ? t : e);
}
const Eo = (function e(t) {
  var n = Ed(t);
  function o(r, i) {
    var s = n((r = Or(r)).r, (i = Or(i)).r), c = n(r.g, i.g), l = n(r.b, i.b), a = Sa(r.opacity, i.opacity);
    return function(d) {
...
function Na(e, t) {
  ...
  return n < t.length && (i = t.slice(n), c[s] ? c[s] += i : c[++s] = i), c.length < 2 ? l[0] ? jd(l[0].x) : Ad(t) : (t = l.length, function(a) {
...
function mn(e, t) {
  var n = typeof t, o;
  return t == null || n === "boolean" ? ai(t) : (n === "number" ? Ge : n === "string" ? (o = yt(t)) ? (t = o, Eo) : Na : t instanceof yt ? Eo : t instanceof Date ? Id : Cd(t) ? _d : Array.isArray(t) ? kd : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Md : Ge)(e, t);
}
var Vi = 180 / Math.PI, Fr = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function Dd(e) {
  ...
  return t.isIdentity ? Fr : Ea(t.a, t.b, t.c, t.d, t.e, t.f);
}
function Pd(e) {
  return e == null || (ro || (ro = document.createElementNS("http://www.w3.org/2000/svg", "g")), ro.setAttribute("transform", e), !(e = ro.transform.baseVal.consolidate())) ? Fr : (e = e.matrix, Ea(e.a, e.b, e.c, e.d, e.e, e.f));
}
function _a(e, t, n, o) {
  function r(a) {
...
var $d = _a(Dd, "px, ", "px)", "deg)"), Td = _a(Pd, ", ", ")", ")"), zd = 1e-12;
function Oi(e) {
  ...
  function r(i, s) {
    ...
    if (x < zd)
      ...
      y = (E - _) / t, v = function(k) {
        var D = k * y, $ = Oi(_), W = a / (n * b) * ($ * Rd(t * D + _) - Ld(_));
        return [
          c + W * p,
          l + W * m,
          a * $ / Oi(t * D + _)
...
var $t = 0, hn = 0, rn = 0, Ca = 1e3, _o, pn, Co = 0, xt = 0, Ro = 0, bn = typeof performance == "object" && performance.now ? performance : Date, ka = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function ci() {
  return xt || (ka(Hd), xt = bn.now() + Ro);
}
function Hd() {
  xt = 0;
}
...
ko.prototype = Ia.prototype = {
  constructor: ko,
  restart: function(e, t, n) {
    if (typeof e != "function") throw new TypeError("callback is not a function");
    n = (n == null ? ci() : +n) + (t == null ? 0 : +t), !this._next && pn !== this && (pn ? pn._next = this : _o = this, pn = this), this._call = e, this._time = n, Wr();
  },
  stop: function() {
...
function Wr(e) {
  if (!$t) {
    ...
    var t = e - xt;
    t > 24 ? (e < 1 / 0 && (hn = setTimeout(Bi, e - bn.now() - Ro)), rn && (rn = clearInterval(rn))) : (rn || (Co = bn.now(), rn = setInterval(Od, Ca)), $t = 1, ka(Bi));
  }
}
function Fi(e, t, n) {
  var o = new ko();
...
var Fd = zo("start", "end", "cancel", "interrupt"), Wd = [], Ma = 0, Wi = 1, Xr = 2, go = 3, Xi = 4, Yr = 5, mo = 6;
...
function Xd(e, t, n) {
  ...
  o[t] = n, n.timer = Ia(i, 0, n.time);
  function i(a) {
    n.state = Wi, n.timer.restart(s, n.delay, n.time), n.delay <= a && s(a - n.delay);
  }
  function s(a) {
    var d, f, h, p;
    if (n.state !== Wi) return l();
    for (d in o)
      if (p = o[d], p.name === n.name) {
        if (p.state === go) return Fi(s);
        p.state === Xi ? (p.state = mo, p.timer.stop(), p.on.call("interrupt", e, e.__data__, p.index, p.group), delete o[d]) : +d < t && (p.state = mo, p.timer.stop(), p.on.call("cancel", e, e.__data__, p.index, p.group), delete o[d]);
      }
    if (Fi(function() {
      n.state === go && (n.state = Xi, n.timer.restart(c, n.delay, n.time), c(a));
...
function yo(e, t) {
  ...
  if (n) {
    ...
    for (s in n) {
      ...
      r = o.state > Xr && o.state < Yr, o.state = mo, o.timer.stop(), o.on.call(r ? "interrupt" : "cancel", e, e.__data__, o.index, o.group), delete n[s];
    }
...
function Kd(e, t) {
  ...
  return this.each((t == null ? qd : Zd)(n, e, t));
}
function ui(e, t, n) {
  var o = e._id;
...
function Aa(e, t) {
  var n;
  return (typeof t == "number" ? Ge : t instanceof yt ? Eo : (n = yt(t)) ? (t = n, Eo) : Na)(e, t);
}
function Ud(e) {
  return function() {
    this.removeAttribute(e);
...
function nf(e, t) {
  var n = Lo(e), o = n === "transform" ? Td : Aa;
  return this.attrTween(e, typeof t == "function" ? (n.local ? tf : ef)(n, o, ui(this, "attr." + e, t)) : t == null ? (n.local ? Gd : Ud)(n) : (n.local ? Jd : Qd)(n, o, t));
}
function of(e, t) {
  return function(n) {
...
function cf(e, t) {
  ...
  var o = Lo(e);
  return this.tween(n, (o.local ? sf : af)(o, t));
}
function lf(e, t) {
  return function() {
...
function df(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? lf : uf)(t, e)) : Ke(this.node(), t).delay;
}
function ff(e, t) {
  return function() {
...
function pf(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? ff : hf)(t, e)) : Ke(this.node(), t).duration;
}
function gf(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function mf(e) {
  var t = this._id;
  return arguments.length ? this.each(gf(t, e)) : Ke(this.node(), t).ease;
}
function yf(e, t) {
  return function() {
    var n = t.apply(this, arguments);
...
function xf(e) {
  ...
  return this.each(yf(this._id, e));
}
function wf(e) {
  typeof e != "function" && (e = aa(e));
  for (var t = this._groups, n = t.length, o = new Array(n), r = 0; r < n; ++r)
...
function Nf(e, t) {
  var n = this._id;
  return arguments.length < 2 ? Ke(this.node(), n).on.on(e) : this.each(Sf(n, e, t));
}
function Ef(e) {
  return function() {
...
function Cf(e) {
  ...
  for (var o = this._groups, r = o.length, i = new Array(r), s = 0; s < r; ++s)
    for (var c = o[s], l = c.length, a = i[s] = new Array(l), d, f, h = 0; h < l; ++h)
      (d = c[h]) && (f = e.call(d, d.__data__, h, c)) && ("__data__" in d && (f.__data__ = d.__data__), a[h] = f, Ho(a[h], t, n, h, a, Ke(d, n)));
...
var If = An.prototype.constructor;
function Mf() {
...
function Pf(e, t) {
  ...
  return function() {
    var l = et(this, e), a = l.on, d = l.value[i] == null ? c || (c = ja(t)) : void 0;
    (a !== n || r !== d) && (o = (n = a).copy()).on(s, r = d), l.on = o;
  };
}
function $f(e, t, n) {
  var o = (e += "") == "transform" ? $d : Aa;
  return t == null ? this.styleTween(e, Af(e, o)).on("end.style." + e, ja(e)) : typeof t == "function" ? this.styleTween(e, Df(e, o, ui(this, "style." + e, t))).each(Pf(this._id, e)) : this.styleTween(e, jf(e, o, t), n).on("end.style." + e, null);
}
function Tf(e, t, n) {
  return function(o) {
...
function Vf(e) {
  return this.tween("text", typeof e == "function" ? Hf(ui(this, "text", e)) : Rf(e == null ? "" : e + ""));
}
function Of(e) {
  return function(t) {
...
function Ff(e) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(t, Bf(e));
}
function Wf() {
  for (var e = this._name, t = this._id, n = Da(), o = this._groups, r = o.length, i = 0; i < r; ++i)
...
function Uf(e) {
  var t, n;
  e instanceof rt ? (t = e._id, e = e._name) : (t = Da(), (n = Zf).time = ci(), e = e == null ? null : e + "");
  for (var o = this._groups, r = o.length, i = 0; i < r; ++i)
    for (var s = o[i], c = s.length, l, a = 0; a < c; ++a)
      (l = s[a]) && Ho(l, e, t, a, s, n || Kf(l, t));
  return new rt(o, this._parents, e, t);
}
An.prototype.interrupt = Yd;
An.prototype.transition = Uf;
const io = (e) => () => e;
function Gf(e, {
  sourceEvent: t,
  target: n,
...
function $a() {
  var e = Qf, t = Jf, n = nh, o = eh, r = th, i = [0, 1 / 0], s = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], c = 250, l = po, a = zo("start", "zoom", "end"), d, f, h, p = 500, m = 150, x = 0, v = 10;
  function y(S) {
    S.property("__zoom", Yi).on("wheel.zoom", D, { passive: !1 }).on("mousedown.zoom", $).on("dblclick.zoom", W).filter(r).on("touchstart.zoom", M).on("touchmove.zoom", z).on("touchend.zoom touchcancel.zoom", H).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  y.transform = function(S, I, C, A) {
    var T = S.selection ? S.selection() : S;
    T.property("__zoom", Yi), S !== T ? _(S, I, C, A) : T.interrupt().each(function() {
    ...
    y.transform(S, function() {
      ...
      return n(Vo.translate(B[0], B[1]).scale(V.k).translate(
        typeof I == "function" ? -I.apply(this, arguments) : -I,
        typeof C == "function" ? -C.apply(this, arguments) : -C
      ), P, s);
    }, A, T);
  ...
  function D(S, ...I) {
    ...
    sn(S), C.wheel = setTimeout(V, m), C.zoom("mouse", n(g(b(A, T), C.mouse[0], C.mouse[1]), C.extent, s));
    function V() {
      C.wheel = null, C.end();
    }
  }
  function $(S, ...I) {
    ...
    var C = S.currentTarget, A = E(this, I, !0).event(S), T = Le(S.view).on("mousemove.zoom", O, !0).on("mouseup.zoom", U, !0), P = Xe(S, C), V = S.clientX, B = S.clientY;
    ya(S.view), _r(S), A.mouse = [P, this.__zoom.invert(P)], yo(this), A.start();
    function O(Z) {
      if (sn(Z), !A.moved) {
    ...
    function U(Z) {
      T.on("mousemove.zoom mouseup.zoom", null), xa(Z.view, A.moved), sn(Z), A.event(Z).end();
    }
  }
  function W(S, ...I) {
    if (e.apply(this, arguments)) {
      ...
      sn(S), c > 0 ? Le(this).transition().duration(c).call(_, V, A, S) : Le(this).call(y.transform, V, A, S);
    }
  }
  function M(S, ...I) {
    if (e.apply(this, arguments)) {
      var C = S.touches, A = C.length, T = E(this, I, S.changedTouches.length === A).event(S), P, V, B, O;
      for (_r(S), V = 0; V < A; ++V)
  ...
  function z(S, ...I) {
    if (this.__zooming) {
      var C = E(this, I).event(S), A = S.changedTouches, T = A.length, P, V, B, O;
      for (sn(S), P = 0; P < T; ++P)
      ...
      if (V = C.that.__zoom, C.touch1) {
        ...
        V = b(V, Math.sqrt(K / L)), B = [(U[0] + ne[0]) / 2, (U[1] + ne[1]) / 2], O = [(Z[0] + se[0]) / 2, (Z[1] + se[1]) / 2];
  ...
  return y.wheelDelta = function(S) {
    return arguments.length ? (o = typeof S == "function" ? S : io(+S), y) : o;
  }, y.filter = function(S) {
    return arguments.length ? (e = typeof S == "function" ? S : io(!!S), y) : e;
  }, y.touchable = function(S) {
    return arguments.length ? (r = typeof S == "function" ? S : io(!!S), y) : r;
  }, y.extent = function(S) {
    return arguments.length ? (t = typeof S == "function" ? S : io([[+S[0][0], +S[0][1]], [+S[1][0], +S[1][1]]]), y) : t;
...
const Ha = (e) => "id" in e && "source" in e && "target" in e, oh = (e) => "id" in e && "position" in e && !("source" in e) && !("target" in e), di = (e) => "id" in e && "internals" in e && !("source" in e) && !("target" in e), Dn = (e, t = [0, 0]) => {
  const { width: n, height: o } = it(e), r = e.origin ?? t, i = n * r[0], s = o * r[1];
  return {
    x: e.position.x - i,
    y: e.position.y - s
  };
}, rh = (e, t = { nodeOrigin: [0, 0] }) => {
  if (e.length === 0)
    return { x: 0, y: 0, width: 0, height: 0 };
  const n = e.reduce((o, r) => {
    const i = typeof r == "string";
    let s = !t.nodeLookup && !i ? r : void 0;
    t.nodeLookup && (s = i ? t.nodeLookup.get(r) : di(r) ? r : t.nodeLookup.get(r.id));
  ...
  return e.forEach((r) => {
    (t.filter === void 0 || t.filter(r)) && (n = Oo(n, Mo(r)), o = !0);
  }), o ? Bo(n) : { x: 0, y: 0, width: 0, height: 0 };
}, fi = (e, t, [n, o, r] = [0, 0, 1], i = !1, s = !1) => {
  const c = {
    ...Wt(t, [n, o, r]),
    width: t.width / r,
    height: t.height / r
  ...
  for (const a of e.values()) {
    ...
    if (s && !f || h)
      continue;
    const p = d.width ?? a.width ?? a.initialWidth ?? null, m = d.height ?? a.height ?? a.initialHeight ?? null, x = En(c, Lt(a)), v = (p ?? 0) * (m ?? 0), y = i && x > 0;
...
async function ah({ nodes: e, width: t, height: n, panZoom: o, minZoom: r, maxZoom: i }, s) {
  if (e.size === 0)
    return !0;
  const c = sh(e, s), l = Pn(c), a = pi(l, t, n, s?.minZoom ?? r, s?.maxZoom ?? i, s?.padding ?? 0.1);
...
function Va({ nodeId: e, nextPosition: t, nodeLookup: n, nodeOrigin: o = [0, 0], nodeExtent: r, onError: i }) {
...
async function ch({ nodesToRemove: e = [], edgesToRemove: t = [], nodes: n, edges: o, onBeforeDelete: r }) {
  ...
  const c = new Set(t.map((h) => h.id)), l = o.filter((h) => h.deletable !== !1), d = ih(s, l);
  for (const h of l)
...
const Zi = (e, t, n) => e < t ? zt(Math.abs(e - t), 1, t) / t : e > n ? -zt(Math.abs(e - n), 1, t) / t : 0, hi = (e, t, n = 15, o = 40) => {
  const r = Zi(e.x, o, t.width - o) * n, i = Zi(e.y, o, t.height - o) * n;
  return [r, i];
}, Oo = (e, t) => ({
  x: Math.min(e.x, t.x),
  y: Math.min(e.y, t.y),
  ...
  const { x: n, y: o } = di(e) ? e.internals.positionAbsolute : Dn(e, t);
  return {
    x: n,
    y: o,
...
}, Ba = (e, t) => Bo(Oo(qr(e), qr(t))), En = (e, t) => {
  const n = Math.max(0, Math.min(e.x + e.width, t.x + t.width) - Math.max(e.x, t.x)), o = Math.max(0, Math.min(e.y + e.height, t.y + t.height) - Math.max(e.y, t.y));
  return Math.ceil(n * o);
}, Ki = (e) => qe(e.width) && qe(e.height) && qe(e.x) && qe(e.y), qe = (e) => !isNaN(e) && isFinite(e), Fa = (e, t) => (n, o) => {
}, $n = (e, t = [1, 1]) => ({
...
const pi = (e, t, n, o, r, i) => {
  const s = lh(i, t, n), c = (t - s.x) / e.width, l = (n - s.y) / e.height, a = Math.min(c, l), d = zt(a, o, r), f = e.x + e.width / 2, h = e.y + e.height / 2, p = t / 2 - f * d, m = n / 2 - h * d, x = uh(e, p, m, d, t, n), v = {
...
function Xa(e, t = { width: 0, height: 0 }, n, o, r) {
  const i = { ...e }, s = o.get(n);
  if (s) {
    const c = s.origin || r;
...
}), Ya = (e) => e?.getRootNode?.() || window?.document, hh = ["INPUT", "SELECT", "TEXTAREA"];
function qa(e) {
  const t = e.composedPath?.()?.[0] || e.target;
  return t?.nodeType !== 1 ? !1 : hh.includes(t.nodeName) || t.hasAttribute("contenteditable") || !!t.closest(".nokey");
}
const Za = (e) => "clientX" in e, Ze = (e, t) => {
  const n = Za(e), o = n ? e.clientX : e.touches?.[0].clientX, r = n ? e.clientY : e.touches?.[0].clientY;
  return {
    x: o - (t?.left ?? 0),
    y: r - (t?.top ?? 0)
  };
...
function Ka({ sourceX: e, sourceY: t, targetX: n, targetY: o, sourceControlX: r, sourceControlY: i, targetControlX: s, targetControlY: c }) {
...
function Qi({ pos: e, x1: t, y1: n, x2: o, y2: r, c: i }) {
  switch (e) {
    case te.Left:
      return [t - so(t - o, i), n];
    case te.Right:
...
function Ua({ sourceX: e, sourceY: t, sourcePosition: n = te.Bottom, targetX: o, targetY: r, targetPosition: i = te.Top, curvature: s = 0.25 }) {
  const [c, l] = Qi({
    pos: n,
    x1: e,
    y1: t,
...
function Ga({ sourceX: e, sourceY: t, targetX: n, targetY: o }) {
  const r = Math.abs(n - e) / 2, i = n < e ? n + r : n - r, s = Math.abs(o - t) / 2, c = o < t ? o + s : o - s;
  return [i, c, r, s];
}
function ph({ sourceNode: e, targetNode: t, selected: n = !1, zIndex: o = 0, elevateOnSelect: r = !1, zIndexMode: i = "basic" }) {
  if (i === "manual")
    return o;
  const s = r && n ? o + 1e3 : o, c = Math.max(e.parentId || r && e.selected ? e.internals.z : 0, t.parentId || r && t.selected ? t.internals.z : 0);
  return s + c;
}
function gh({ sourceNode: e, targetNode: t, width: n, height: o, transform: r }) {
  const i = Oo(Mo(e), Mo(t));
...
const Qa = ({ source: e, sourceHandle: t, target: n, targetHandle: o }) => `xy-edge__${e}${t || ""}-${n}${o || ""}`, mh = (e, t) => t.some((n) => n.source === e.source && n.target === e.target && (n.sourceHandle === e.sourceHandle || !n.sourceHandle && !e.sourceHandle) && (n.targetHandle === e.targetHandle || !n.targetHandle && !e.targetHandle)), yh = (e, t, n = {}) => {
  if (!e.source || !e.target)
    return n.onError?.("006", He.error006()), t;
  const o = n.getEdgeId || Qa;
  let r;
  return Ha(e) ? r = { ...e } : r = {
    ...e,
    id: o(e)
  }, mh(r, t) ? t : (r.sourceHandle === null && delete r.sourceHandle, r.targetHandle === null && delete r.targetHandle, t.concat(r));
}, xh = (e, t, n, o = { shouldReplaceId: !0 }) => {
  const { id: r, ...i } = e;
  if (!t.source || !t.target)
    return o.onError?.("006", He.error006()), n;
  if (!n.find((a) => a.id === e.id))
    return o.onError?.("007", He.error007(r)), n;
  const c = o.getEdgeId || Qa, l = {
    ...i,
...
const Ji = {
  ...
  [te.Top]: { x: 0, y: -1 },
  [te.Bottom]: { x: 0, y: 1 }
}, wh = ({ source: e, sourcePosition: t = te.Bottom, target: n }) => t === te.Left || t === te.Right ? e.x < n.x ? { x: 1, y: 0 } : { x: -1, y: 0 } : e.y < n.y ? { x: 0, y: 1 } : { x: 0, y: -1 }, es = (e, t) => Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2));
function vh({ source: e, sourcePosition: t = te.Bottom, target: n, targetPosition: o = te.Top, center: r, offset: i, stepPosition: s }) {
  const c = Ji[t], l = Ji[o], a = { x: e.x + c.x * i, y: e.y + c.y * i }, d = { x: n.x + l.x * i, y: n.y + l.y * i }, f = wh({
    source: a,
    sourcePosition: t,
    target: d
  }), h = f.x !== 0 ? "x" : "y", p = f[h];
  let m = [], x, v;
  const y = { x: 0, y: 0 }, b = { x: 0, y: 0 }, [, , g, w] = Ga({
    sourceX: e.x,
    sourceY: e.y,
    targetX: n.x,
    targetY: n.y
  ...
  if (c[h] * l[h] === -1) {
    ...
    if (h === "x" ? m = c.x === p ? $ : D : m = c.y === p ? D : $, t === o) {
      ...
      if (S <= i) {
        ...
        c[h] === p ? y[h] = (a[h] > e[h] ? -1 : 1) * I : b[h] = (d[h] > n[h] ? -1 : 1) * I;
      }
    }
    if (t !== o) {
    ...
    const W = { x: a.x + y.x, y: a.y + y.y }, M = { x: d.x + b.x, y: d.y + b.y }, z = Math.max(Math.abs(W.x - m[0].x), Math.abs(M.x - m[0].x)), H = Math.max(Math.abs(W.y - m[0].y), Math.abs(M.y - m[0].y));
    z >= H ? (x = (W.x + M.x) / 2, v = m[0].y) : (x = m[0].x, v = (W.y + M.y) / 2);
  }
  const _ = { x: a.x + y.x, y: a.y + y.y }, E = { x: d.x + b.x, y: d.y + b.y };
  return [[
    e,
...
function bh(e, t, n, o) {
  const r = Math.min(es(e, t) / 2, es(t, n) / 2, o), { x: i, y: s } = t;
...
function Sh(e) {
  ...
  if (!ts(t) || !ts(n))
    return null;
  const o = t.internals.handleBounds || ns(t.handles), r = n.internals.handleBounds || ns(n.handles), i = os(o?.source ?? [], e.sourceHandle), s = os(
...
function Nh(e, { id: t, defaultColor: n, defaultMarkerStart: o, defaultMarkerEnd: r }) {
...
function Kr(e, t, n, o = {}) {
  const r = yi(_h, o), i = { i: 0 }, s = new Map(t), c = r?.elevateNodesOnSelect && !xi(r.zIndexMode) ? ec : 0;
  ...
  for (const d of e) {
    ...
    (f.measured === void 0 || f.measured.width === void 0 || f.measured.height === void 0) && !f.hidden && (l = !1), d.parentId && wi(f, t, n, o, i), a ||= d.selected ?? !1;
  }
...
function wi(e, t, n, o, r) {
  const { elevateNodesOnSelect: i, nodeOrigin: s, nodeExtent: c, zIndexMode: l } = yi(mi, o), a = e.parentId, d = t.get(a);
  if (!d) {
    console.warn(`Parent node ${a} not found. Please make sure that parent nodes are in front of their child nodes in the nodes array.`);
    return;
  }
  Ih(e, n), r && !d.parentId && d.internals.rootParentIndex === void 0 && l === "auto" && (d.internals.rootParentIndex = ++r.i, d.internals.z = d.internals.z + r.i * Eh), r && d.internals.rootParentIndex !== void 0 && (r.i = d.internals.rootParentIndex);
  const f = i && !xi(l) ? ec : 0, { x: h, y: p, z: m } = Mh(e, d, s, c, f, l), { positionAbsolute: x } = e.internals, v = h !== x.x || p !== x.y;
...
function vi(e, t, n, o = [0, 0]) {
  ...
  for (const s of e) {
    ...
    if (!c)
      continue;
    const l = i.get(s.parentId)?.expandedRect ?? Lt(c), a = Ba(l, s.rect);
...
function Ah(e, t, n, o, r, i, s) {
  ...
  for (const p of e.values()) {
    ...
    const x = gi(p.nodeElement), v = m.measured.width !== x.width || m.measured.height !== x.height;
    if (!!(x.width && x.height && (v || !m.internals.handleBounds || p.force))) {
      const b = p.nodeElement.getBoundingClientRect(), g = vt(m.extent) ? m.extent : i;
      let { positionAbsolute: w } = m.internals;
      m.parentId && m.extent === "parent" ? w = Oa(w, x, t.get(m.parentId)) : g && (w = wt(w, g, x));
      const _ = {
        ...m,
        measured: x,
        internals: {
          ...
          positionAbsolute: w,
          handleBounds: {
            source: Gi("source", p.nodeElement, b, f, m.id),
            target: Gi("target", p.nodeElement, b, f, m.id)
          }
        }
      };
      t.set(m.id, _), m.parentId && wi(_, t, n, { nodeOrigin: r, zIndexMode: s }), l = !0, v && (a.push({
        id: m.id,
        type: "dimensions",
        dimensions: x
...
async function jh({ delta: e, panZoom: t, transform: n, translateExtent: o, width: r, height: i }) {
  if (!t || !e.x && !e.y)
    return !1;
...
function nc(e, t, n) {
  ...
  for (const o of n) {
    ...
    rs("source", l, d, e, r, s), rs("target", l, a, e, i, c), t.set(o.id, o);
  }
}
function oc(e, t) {
  if (!e.parentId)
...
function Dh(e, t, n, o) {
  ...
  for (const [i, s] of e)
    if ((s.selected || s.id === o) && (!s.parentId || !oc(s, e)) && (s.draggable || t && typeof s.draggable > "u")) {
      const c = e.get(i);
      c && r.set(i, {
        id: i,
...
function Ph({ dragItems: e, snapGrid: t, x: n, y: o }) {
...
function $h({ onNodeMouseDown: e, getStoreItems: t, onDragStart: n, onDrag: o, onDragStop: r }) {
  ...
  function v({ noDragClassName: b, handleSelector: g, domNode: w, isSelectable: _, nodeId: E, nodeClickDistance: k = 0 }) {
    h = Le(w);
    function D({ x: z, y: H }) {
      const { nodeLookup: S, nodeExtent: I, snapGrid: C, snapToGrid: A, nodeOrigin: T, onNodeDrag: P, onSelectionDrag: V, onError: B, updateNodePositions: O } = t();
      i = { x: z, y: H };
      let U = !1;
      const Z = c.size > 1, ne = Z && I ? qr(Pn(c)) : null, se = Z && A ? Ph({
        dragItems: c,
        snapGrid: C,
        x: z,
        y: H
      ...
      for (const [K, L] of c) {
        ...
        const { position: ie, positionAbsolute: q } = Va({
          nodeId: K,
          nextPosition: Y,
          nodeLookup: S,
          nodeExtent: re || I,
    ...
    function W(z) {
      const { nodeLookup: H, multiSelectionActive: S, nodesDraggable: I, transform: C, snapGrid: A, snapToGrid: T, selectNodesOnDrag: P, onNodeDragStart: V, onSelectionDragStart: B, unselectNodesAndEdges: O } = t();
      f = !0, (!P || !_) && !S && E && (H.get(E)?.selected || O()), _ && P && E && e?.(E);
      const U = yn(z.sourceEvent, { transform: C, snapGrid: A, snapToGrid: T, containerBounds: d });
      if (i = U, c = Dh(H, I, U, E), c.size > 0 && (n || V || !E && B)) {
        const [Z, ne] = Cr({
          nodeId: E,
          dragItems: c,
          nodeLookup: H
    ...
    const M = wa().clickDistance(k).on("start", (z) => {
      const { domNode: H, nodeDragThreshold: S, transform: I, snapGrid: C, snapToGrid: A } = t();
      d = H?.getBoundingClientRect() || null, p = !1, m = !1, x = z.sourceEvent, S === 0 && W(z), i = yn(z.sourceEvent, { transform: I, snapGrid: C, snapToGrid: A, containerBounds: d }), a = Ze(z.sourceEvent, d);
    }).on("drag", (z) => {
      const { autoPanOnNodeDrag: H, transform: S, snapGrid: I, snapToGrid: C, nodeDragThreshold: A, nodeLookup: T } = t(), P = yn(z.sourceEvent, { transform: S, snapGrid: I, snapToGrid: C, containerBounds: d });
      ...
      const H = z.target;
      return !z.button && (!b || !is(H, `.${b}`, w)) && (!g || is(H, g, w));
    });
    h.call(M);
  }
  function y() {
...
const sc = () => !0;
function Hh(e, { connectionMode: t, connectionRadius: n, handleId: o, nodeId: r, edgeUpdaterType: i, isTarget: s, domNode: c, nodeLookup: l, lib: a, autoPanOnConnect: d, flowId: f, panBy: h, cancelConnection: p, onConnectStart: m, onConnect: x, onConnectEnd: v, isValidConnection: y = sc, onReconnectEnd: b, updateConnection: g, getTransform: w, getFromHandle: _, autoPanSpeed: E, dragThreshold: k = 1, handleDomNode: D }) {
  const $ = Ya(e.target);
  let W = 0, M;
  const { x: z, y: H } = Ze(e), S = ic(i, D), I = c?.getBoundingClientRect();
  let C = !1;
  if (!I || !S)
    return;
  const A = rc(r, S, o, l, t);
  if (!A)
    return;
  ...
  let K = {
    ...
    to: T,
    toHandle: null,
    toPosition: qi[Z.position],
    toNode: null,
    pointer: T
  };
  function L() {
    C = !0, g(K), m?.(e, { nodeId: r, handleId: o, handleType: S });
  }
  k === 0 && L();
  function Y(ie) {
    if (!C) {
    ...
    const q = w();
    T = Ze(ie, I), M = Lh(Wt(T, q, !1, [1, 1]), n, l, Z), P || (U(), P = !0);
    const ee = ac(ie, {
      handle: M,
      connectionMode: t,
      fromNodeId: r,
    ...
    O = ee.handleDomNode, V = ee.connection, B = Rh(!!M, ee.isValid);
    const oe = l.get(r), R = oe ? bt(oe, Z, te.Left, !0) : K.from, J = {
      ...K,
      from: R,
      isValid: B,
      to: ee.toHandle && B ? Rt({ x: ee.toHandle.x, y: ee.toHandle.y }, q) : T,
      toHandle: ee.toHandle,
      toPosition: B && ee.toHandle ? ee.toHandle.position : qi[Z.position],
...
function ac(e, { handle: t, connectionMode: n, fromNodeId: o, fromHandleId: r, fromType: i, doc: s, lib: c, flowId: l, isValidConnection: a = sc, nodeLookup: d }) {
  ...
  if (v) {
    const b = ic(void 0, v), g = v.getAttribute("data-nodeid"), w = v.getAttribute("data-handleid"), _ = v.classList.contains("connectable"), E = v.classList.contains("connectableend");
    if (!g || !b)
      return y;
    const k = {
      source: f ? g : o,
    ...
    y.isValid = $ && a(k), y.toHandle = rc(g, b, w, d, n, !0);
  }
  return y;
}
const Ur = {
...
function Vh({ domNode: e, panZoom: t, getTransform: n, getViewScale: o }) {
  const r = Le(e);
  function i({ translateExtent: c, width: l, height: a, zoomStep: d = 1, pannable: f = !0, zoomable: h = !0, inversePan: p = !1 }) {
    ...
    }, b = $a().on("start", v).on("zoom", f ? y : null).on("zoom.wheel", h ? m : null);
    r.call(b, {});
  }
  function s() {
    r.on("zoom", null);
...
const Fo = (e) => ({
  ...
  y: e.y,
  zoom: e.k
}), kr = ({ x: e, y: t, zoom: n }) => Vo.translate(e, t).scale(n), Mt = (e, t) => e.target.closest(`.${t}`), cc = (e, t) => t === 2 && Array.isArray(e) && e.includes(2), Oh = (e) => ((e *= 2) <= 1 ? e * e * e : (e -= 2) * e * e + 2) / 2, Ir = (e, t = 0, n = Oh, o = () => {
}) => {
...
function Bh({ zoomPanValues: e, noWheelClassName: t, d3Selection: n, d3Zoom: o, panOnScrollMode: r, panOnScrollSpeed: i, zoomOnPinch: s, onPanZoomStart: c, onPanZoom: l, onPanZoomEnd: a }) {
  return (d) => {
    if (Mt(d, t))
    ...
    if (d.ctrlKey && s) {
      const v = Xe(d), y = lc(d), b = f * Math.pow(2, y);
      o.scaleTo(n, b, v, d);
      return;
    }
...
function Fh({ noWheelClassName: e, preventScrolling: t, d3ZoomHandler: n }) {
  return function(o, r) {
...
function Wh({ zoomPanValues: e, onDraggingChange: t, onPanZoomStart: n }) {
  return (o) => {
...
function Xh({ zoomPanValues: e, panOnDrag: t, onPaneContextMenu: n, onTransformChange: o, onPanZoom: r }) {
  return (i) => {
    e.usedRightMouseButton = !!(n && cc(t, e.mouseButton ?? 0)), i.sourceEvent?.sync || o([i.transform.x, i.transform.y, i.transform.k]), r && !i.sourceEvent?.internal && r?.(i.sourceEvent, Fo(i.transform));
  };
}
function Yh({ zoomPanValues: e, panOnDrag: t, panOnScroll: n, onDraggingChange: o, onPanZoomEnd: r, onPaneContextMenu: i }) {
  return (s) => {
    if (!s.sourceEvent?.internal && (e.isZoomingOrPanning = !1, i && cc(t, e.mouseButton ?? 0) && !e.usedRightMouseButton && s.sourceEvent && i(s.sourceEvent), e.usedRightMouseButton = !1, o(!1), r)) {
...
function qh({ zoomActivationKeyPressed: e, zoomOnScroll: t, zoomOnPinch: n, panOnDrag: o, panOnScroll: r, zoomOnDoubleClick: i, userSelectionActive: s, noWheelClassName: c, noPanClassName: l, lib: a, connectionInProgress: d }) {
  return (f) => {
...
function Zh({ domNode: e, minZoom: t, maxZoom: n, translateExtent: o, viewport: r, onPanZoom: i, onPanZoomStart: s, onPanZoomEnd: c, onDraggingChange: l }) {
  const a = {
    ...
    isPanScrolling: !1
  }, d = e.getBoundingClientRect(), f = $a().scaleExtent([t, n]).translateExtent(o), h = Le(e).call(f);
  b({
    x: r.x,
    y: r.y,
    zoom: zt(r.zoom, t, n)
  ...
  async function x(M, z) {
    return h ? new Promise((H) => {
      f?.interpolate(z?.interpolate === "linear" ? mn : po).transform(Ir(h, z?.duration, z?.ease, () => H(!0)), M);
    }) : !1;
  }
  function v({ noWheelClassName: M, noPanClassName: z, onPaneContextMenu: H, userSelectionActive: S, panOnScroll: I, panOnDrag: C, panOnScrollMode: A, panOnScrollSpeed: T, preventScrolling: P, zoomOnPinch: V, zoomOnScroll: B, zoomOnDoubleClick: O, zoomActivationKeyPressed: U, lib: Z, onTransformChange: ne, connectionInProgress: se, paneClickDistance: K, selectionOnDrag: L }) {
  ...
  function _() {
    const M = h ? Pa(h.node()) : { x: 0, y: 0, k: 1 };
    return { x: M.x, y: M.y, zoom: M.k };
  }
  async function E(M, z) {
    return h ? new Promise((H) => {
      f?.interpolate(z?.interpolate === "linear" ? mn : po).scaleTo(Ir(h, z?.duration, z?.ease, () => H(!0)), M);
    }) : !1;
  }
  async function k(M, z) {
    return h ? new Promise((H) => {
      f?.interpolate(z?.interpolate === "linear" ? mn : po).scaleBy(Ir(h, z?.duration, z?.ease, () => H(!0)), M);
    }) : !1;
  }
  function D(M) {
    f?.scaleExtent(M);
...
function Kh({ width: e, prevWidth: t, height: n, prevHeight: o, affectsX: r, affectsY: i }) {
...
function Uh(e, t, n, o, r, i, s, c) {
  let { affectsX: l, affectsY: a } = t;
  const { isHorizontal: d, isVertical: f } = t, h = d && f, { xSnapped: p, ySnapped: m } = n, { minWidth: x, maxWidth: v, minHeight: y, maxHeight: b } = o, { x: g, y: w, width: _, height: E, aspectRatio: k } = e;
  let D = Math.floor(d ? p - e.pointerX : 0), $ = Math.floor(f ? m - e.pointerY : 0);
  const W = _ + (l ? -D : D), M = E + (a ? -$ : $), z = -i[0] * _, H = -i[1] * E;
  let S = ao(W, x, v), I = ao(M, y, b);
  if (s) {
    let T = 0, P = 0;
  ...
  $ = $ + ($ < 0 ? I : -I), D = D + (D < 0 ? S : -S), r && (h ? W > M * k ? $ = (as(l, a) ? -D : D) / k : D = (as(l, a) ? -$ : $) * k : d ? ($ = D / k, a = l) : (D = $ * k, l = a));
...
const uc = { width: 0, height: 0, x: 0, y: 0 }, Gh = {
  ...uc,
  pointerX: 0,
  pointerY: 0,
  aspectRatio: 1
...
function Jh({ domNode: e, nodeId: t, getStoreItems: n, onChange: o, onEnd: r }) {
  const i = Le(e);
  let s = {
    controlDirection: ss("bottom-right"),
    boundaries: {
      minWidth: 0,
      minHeight: 0,
  ...
  function c({ controlPosition: a, boundaries: d, keepAspectRatio: f, resizeDirection: h, onResizeStart: p, onResize: m, onResizeEnd: x, shouldResize: v }) {
    ...
    s = {
      ...
      resizeDirection: h,
      keepAspectRatio: f,
      controlDirection: ss(a)
    };
    let g, w = null, _ = [], E, k, D, $ = !1;
    const W = wa().on("start", (M) => {
      ...
      const { transform: z, snapGrid: H, snapToGrid: S, nodeOrigin: I } = n(), C = yn(M.sourceEvent, {
        transform: z,
        snapGrid: H,
        snapToGrid: S,
        containerBounds: w
      ...
      if (!g)
        return;
      const { x: T, y: P, width: V, height: B } = y, O = {}, U = g.origin ?? I, { width: Z, height: ne, x: se, y: K } = Uh(b, s.controlDirection, C, s.boundaries, s.keepAspectRatio, U, k, D), L = Z !== V, Y = ne !== B, re = se !== T && L, ie = K !== P && Y;
      if (!re && !ie && !L && !Y)
        return;
      ...
      if ((L || Y) && (O.width = L && (!s.resizeDirection || s.resizeDirection === "horizontal") ? Z : y.width, O.height = Y && (!s.resizeDirection || s.resizeDirection === "vertical") ? ne : y.height, y.width = O.width, y.height = O.height), E && g.expandParent) {
...
var ls;
function tp() {
  return ls || (ls = 1, jr.exports = ep()), jr.exports;
}
var us;
function np() {
  if (us) return Ar;
...
var ds;
function op() {
  return ds || (ds = 1, Mr.exports = np()), Mr.exports;
}
var rp = op();
const ip = /* @__PURE__ */ vl(rp), sp = {}, fs = (e) => {
  let t;
  const n = /* @__PURE__ */ new Set(), o = (d, f) => {
    ...
    (sp ? "production" : void 0) !== "production" && console.warn(
      "[DEPRECATED] The `destroy` method will be unsupported in a future version. Instead use unsubscribe function returned by subscribe. Everything will be garbage-collected if store is garbage-collected."
    ), n.clear();
  } }, a = t = e(o, r, l);
  return l;
}, ap = (e) => e ? fs(e) : fs, { useDebugValue: cp } = ut, { useSyncExternalStoreWithSelector: lp } = ip, up = (e) => e;
function dc(e, t = up, n) {
  const o = lp(
    e.subscribe,
    e.getState,
...
function hp() {
  ...
  return e(), Pr.exports = fp(), Pr.exports;
}
var pp = hp();
const Wo = oi(null), gp = Wo.Provider, fc = He.error001("react");
function le(e, t) {
  const n = Mn(Wo);
  if (n === null)
    throw new Error(fc);
...
const ms = { display: "none" }, mp = {
  ...
  clipPath: "inset(100%)"
}, hc = "react-flow__node-desc", pc = "react-flow__edge-desc", yp = "react-flow__aria-live", xp = (e) => e.ariaLiveMessage, wp = (e) => e.ariaLabelConfig;
function vp({ rfId: e }) {
  const t = le(xp);
  return u.jsx("div", { id: `${yp}-${e}`, "aria-live": "assertive", "aria-atomic": "true", style: mp, children: t });
}
function bp({ rfId: e, disableKeyboardA11y: t }) {
  const n = le(wp);
  return u.jsxs(u.Fragment, { children: [u.jsx("div", { id: `${hc}-${e}`, style: ms, children: t ? n["node.a11yDescription.default"] : n["node.a11yDescription.keyboardDisabled"] }), u.jsx("div", { id: `${pc}-${e}`, style: ms, children: n["edge.a11yDescription.default"] }), !t && u.jsx(vp, { rfId: e })] });
}
const Xo = To(({ position: e = "top-left", children: t, className: n, style: o, ...r }, i) => {
  const s = `${e}`.split("-");
  return u.jsx("div", { className: Se(["react-flow__panel", n, ...s]), style: o, ref: i, ...r, children: t });
});
Xo.displayName = "Panel";
function Sp({ proOptions: e, position: t = "bottom-right" }) {
...
function _p({ onSelectionChange: e }) {
  const t = me(), { selectedNodes: n, selectedEdges: o } = le(Np, Ep);
  return ae(() => {
    const r = { nodes: n, edges: o };
    e?.(r), t.getState().onSelectionChangeHandlers.forEach((i) => i(r));
  }, [n, o, e]), null;
}
const Cp = (e) => !!e.onSelectionChangeHandlers;
function kp({ onSelectionChange: e }) {
  const t = le(Cp);
  return e || t ? u.jsx(_p, { onSelectionChange: e }) : null;
}
const gc = [0, 0], Ip = { x: 0, y: 0, zoom: 1 }, Mp = [
  "nodes",
  "edges",
  "defaultNodes",
  "defaultEdges",
...
function jp(e) {
  const { setNodes: t, setEdges: n, setMinZoom: o, setMaxZoom: r, setTranslateExtent: i, setNodeExtent: s, reset: c, setDefaultNodesAndEdges: l } = le(Ap, ge), a = me();
  ...
  return ae(
    () => {
      for (const f of ys) {
        ...
        h !== p && (typeof e[f] > "u" || (f === "nodes" ? t(h) : f === "edges" ? n(h) : f === "minZoom" ? o(h) : f === "maxZoom" ? r(h) : f === "translateExtent" ? i(h) : f === "nodeExtent" ? s(h) : f === "ariaLabelConfig" ? a.setState({ ariaLabelConfig: fh(h) }) : f === "fitView" ? a.setState({ fitViewQueued: h }) : f === "fitViewOptions" ? a.setState({ fitViewOptions: h }) : a.setState({ [f]: h })));
      }
      d.current = e;
    },
...
function Dp(e) {
  ...
  return ae(() => {
    ...
    const o = ws(), r = () => n(o?.matches ? "dark" : "light");
    return r(), o?.addEventListener("change", r), () => {
      o?.removeEventListener("change", r);
    };
  }, [e]), t !== null ? t : ws()?.matches ? "dark" : "light";
}
const vs = typeof document < "u" ? document : null;
function Cn(e = null, t = { target: vs, actInsideInputWithModifier: !0 }) {
...
const Pp = () => {
  ...
  return pe(() => ({
    ...
    fitBounds: async (t, n) => {
      const { width: o, height: r, minZoom: i, maxZoom: s, panZoom: c } = e.getState(), l = pi(t, o, r, i, s, n?.padding ?? 0.1);
...
function vc(e, t, n = {}) {
  return yh(e, t, {
    ...n,
    onError: n.onError ?? wc
  });
}
function Tp(e, t, n, o = { shouldReplaceId: !0 }) {
  return xh(e, t, n, {
    ...o,
    onError: o.onError ?? wc
  });
}
const _s = (e) => oh(e), zp = (e) => Ha(e);
function bc(e) {
  return To(e);
}
const Lp = typeof window < "u" ? wl : ae;
function Cs(e) {
  const [t, n] = G(BigInt(0)), [o] = G(() => Rp(() => n((r) => r + BigInt(1))));
  return Lp(() => {
    const r = o.get();
...
function Hp({ children: e }) {
  ...
  }, []), i = Cs(r), s = pe(() => ({ nodeQueue: o, edgeQueue: i }), []);
  return u.jsx(Sc.Provider, { value: s, children: e });
}
function Vp() {
  const e = Mn(Sc);
  if (!e)
...
function bi() {
  const e = Pp(), t = me(), n = Vp(), o = le(Op), r = pe(() => {
    const i = (f) => t.getState().nodeLookup.get(f), s = (f) => {
      n.nodeQueue.push(f);
    }, c = (f) => {
      n.edgeQueue.push(f);
    }, l = (f) => {
      const { nodeLookup: h, nodeOrigin: p } = t.getState(), m = _s(f) ? f : h.get(f.id), x = m.parentId ? Xa(m.position, m.measured, m.parentId, h, p) : m.position, v = {
        ...m,
        position: x,
    ...
    return {
      ...
      deleteElements: async ({ nodes: f = [], edges: h = [] }) => {
        const { nodes: p, edges: m, onNodesDelete: x, onEdgesDelete: v, triggerNodeChanges: y, triggerEdgeChanges: b, onDelete: g, onBeforeDelete: w } = t.getState(), { nodes: _, edges: E } = await ch({
          nodesToRemove: f,
          edgesToRemove: h,
          nodes: p,
          edges: m,
      ...
      getNodesBounds: (f) => {
        ...
        return rh(f, { nodeLookup: h, nodeOrigin: p });
      },
      ...
      fitView: async (f) => {
        const h = t.getState().fitViewResolver ?? dh();
...
const ks = (e) => e.selected, Bp = typeof window < "u" ? window : void 0;
function Fp({ deleteKeyCode: e, multiSelectionKeyCode: t }) {
  const n = me(), { deleteElements: o } = bi(), r = Cn(e, { actInsideInputWithModifier: !1 }), i = Cn(t, { target: Bp });
  ae(() => {
    if (r) {
      const { edges: s, nodes: c } = n.getState();
      o({ nodes: c.filter(ks), edges: s.filter(ks) }), n.setState({ nodesSelectionActive: !1 });
    }
  }, [r]), ae(() => {
...
function Yp({ onPaneContextMenu: e, zoomOnScroll: t = !0, zoomOnPinch: n = !0, panOnScroll: o = !1, panOnScrollSpeed: r = 0.5, panOnScrollMode: i = mt.Free, zoomOnDoubleClick: s = !0, panOnDrag: c = !0, defaultViewport: l, translateExtent: a, minZoom: d, maxZoom: f, zoomActivationKeyCode: h, preventScrolling: p = !0, children: m, noWheelClassName: x, noPanClassName: v, onViewportChange: y, isControlledViewport: b, paneClickDistance: g, selectionOnDrag: w }) {
  const _ = me(), E = ce(null), { userSelectionActive: k, lib: D, connectionInProgress: $ } = le(Xp, ge), W = Cn(h), M = ce();
  Wp(E);
  const z = he((H) => {
    y?.({ x: H[0], y: H[1], zoom: H[2] }), b || _.setState({ transform: H });
  }, [y, b]);
  return ae(() => {
    if (E.current) {
      M.current = Zh({
...
function Zp() {
  const { userSelectionActive: e, userSelectionRect: t } = le(qp, ge);
...
function Up({ isSelecting: e, selectionKeyPressed: t, selectionMode: n = Nn.Full, panOnDrag: o, autoPanOnSelection: r, paneClickDistance: i, selectionOnDrag: s, onSelectionStart: c, onSelectionEnd: l, onPaneClick: a, onPaneContextMenu: d, onPaneScroll: f, onPaneMouseEnter: h, onPaneMouseMove: p, onPaneMouseLeave: m, children: x }) {
  const v = ce(0), y = me(), { userSelectionActive: b, elementsSelectable: g, dragging: w, connectionInProgress: _, panBy: E, autoPanSpeed: k } = le(Kp, ge), D = g && (e || b), $ = ce(null), W = ce(), M = ce(/* @__PURE__ */ new Set()), z = ce(/* @__PURE__ */ new Set()), H = ce(!1), S = ce({ x: 0, y: 0 }), I = ce(!1), C = (L) => {
    if (H.current || _) {
      H.current = !1;
      return;
    }
  ...
  function B(L, Y) {
    ...
    if (!re)
      return;
    const { transform: ie, nodeLookup: q, edgeLookup: ee, connectionLookup: oe, triggerNodeChanges: R, triggerEdgeChanges: J, defaultEdgeOptions: fe } = y.getState(), xe = { x: re.startX, y: re.startY }, { x: Oe, y: we } = Rt(xe, ie), je = {
      startX: xe.x,
      startY: xe.y,
      x: L < Oe ? L : Oe,
      y: Y < we ? Y : we,
    ...
    M.current = new Set(fi(q, je, ie, n === Nn.Partial, !0).map((Ce) => Ce.id)), z.current = /* @__PURE__ */ new Set();
  ...
  function O() {
    if (!r || !W.current)
      return;
    const [L, Y] = hi(S.current, W.current, k);
    E({ x: L, y: Y }).then((re) => {
      if (!H.current || !re) {
...
function Nc({ nodeRef: e, disabled: t = !1, noDragClassName: n, handleSelector: o, nodeId: r, isSelectable: i, nodeClickDistance: s }) {
...
const Gp = (e) => (t) => t.selected && (t.draggable || e && typeof t.draggable > "u");
function Ec() {
  const e = me();
  return he((n) => {
    const { nodeExtent: o, snapToGrid: r, snapGrid: i, nodesDraggable: s, onError: c, updateNodePositions: l, nodeLookup: a, nodeOrigin: d } = e.getState(), f = /* @__PURE__ */ new Map(), h = Gp(s), p = r ? i[0] : 5, m = r ? i[1] : 5, x = n.direction.x * p * n.factor, v = n.direction.y * m * n.factor;
    for (const [, y] of a) {
      if (!h(y))
        continue;
      let b = {
      ...
      r && (b = $n(b, i));
      const { position: g, positionAbsolute: w } = Va({
        nodeId: y.id,
        nextPosition: b,
        nodeLookup: a,
        nodeExtent: o,
...
const Si = oi(null), Qp = Si.Provider;
Si.Consumer;
const _c = () => Mn(Si), Jp = (e) => ({
...
function tg({ type: e = "source", position: t = te.Top, isValidConnection: n, isConnectable: o = !0, isConnectableStart: r = !0, isConnectableEnd: i = !0, id: s, onConnect: c, children: l, className: a, onMouseDown: d, onTouchStart: f, ...h }, p) {
  const m = s || null, x = e === "target", v = me(), y = _c(), { connectOnClick: b, noPanClassName: g, rfId: w } = le(Jp, ge), { connectingFrom: _, connectingTo: E, clickConnecting: k, isPossibleEndHandle: D, connectionInProcess: $, clickConnectionInProcess: W, valid: M } = le(eg(y, m, e), ge);
  ...
  const z = (I) => {
    ...
    const ne = Ya(I.target), se = n || V, { connection: K, isValid: L } = Ur.isValid(I.nativeEvent, {
      handle: {
        nodeId: y,
        id: m,
        type: e
...
const Vt = ve(bc(tg));
function ng({ data: e, isConnectable: t, sourcePosition: n = te.Bottom }) {
  return u.jsxs(u.Fragment, { children: [e?.label, u.jsx(Vt, { type: "source", position: n, isConnectable: t })] });
}
function og({ data: e, isConnectable: t, targetPosition: n = te.Top, sourcePosition: o = te.Bottom }) {
...
function ig({ data: e, isConnectable: t, targetPosition: n = te.Top }) {
...
function cg({ onSelectionContextMenu: e, noPanClassName: t, disableKeyboardA11y: n }) {
  const o = me(), { width: r, height: i, transformString: s, userSelectionActive: c } = le(ag, ge), l = Ec(), a = ce(null);
  ae(() => {
    n || a.current?.focus({
      preventScroll: !0
    });
...
const Ms = typeof window < "u" ? window : void 0, lg = (e) => ({ nodesSelectionActive: e.nodesSelectionActive, userSelectionActive: e.userSelectionActive });
function Cc({ children: e, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: i, onPaneScroll: s, paneClickDistance: c, deleteKeyCode: l, selectionKeyCode: a, selectionOnDrag: d, selectionMode: f, onSelectionStart: h, onSelectionEnd: p, multiSelectionKeyCode: m, panActivationKeyCode: x, zoomActivationKeyCode: v, elementsSelectable: y, zoomOnScroll: b, zoomOnPinch: g, panOnScroll: w, panOnScrollSpeed: _, panOnScrollMode: E, zoomOnDoubleClick: k, panOnDrag: D, autoPanOnSelection: $, defaultViewport: W, translateExtent: M, minZoom: z, maxZoom: H, preventScrolling: S, onSelectionContextMenu: I, noWheelClassName: C, noPanClassName: A, disableKeyboardA11y: T, onViewportChange: P, isControlledViewport: V }) {
  const { nodesSelectionActive: B, userSelectionActive: O } = le(lg, ge), U = Cn(a, { target: Ms }), Z = Cn(x, { target: Ms }), ne = Z || D, se = Z || w, K = d && ne !== !0, L = U || O || K;
  return Fp({ deleteKeyCode: l, multiSelectionKeyCode: m }), u.jsx(Yp, { onPaneContextMenu: i, elementsSelectable: y, zoomOnScroll: b, zoomOnPinch: g, panOnScroll: se, panOnScrollSpeed: _, panOnScrollMode: E, zoomOnDoubleClick: k, panOnDrag: !U && ne, defaultViewport: W, translateExtent: M, minZoom: z, maxZoom: H, zoomActivationKeyCode: v, preventScrolling: S, noWheelClassName: C, noPanClassName: A, onViewportChange: P, isControlledViewport: V, paneClickDistance: c, selectionOnDrag: K, children: u.jsxs(Up, { onSelectionStart: h, onSelectionEnd: p, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: i, onPaneScroll: s, panOnDrag: ne, autoPanOnSelection: $, isSelecting: !!L, selectionMode: f, selectionKeyPressed: U, paneClickDistance: c, selectionOnDrag: K, children: [e, B && u.jsx(cg, { onSelectionContextMenu: I, noPanClassName: A, disableKeyboardA11y: T })] }) });
}
Cc.displayName = "FlowRenderer";
const ug = ve(Cc), dg = (e) => (t) => e ? fi(t.nodeLookup, { x: 0, y: 0, width: t.width, height: t.height }, t.transform, !0).map((n) => n.id) : Array.from(t.nodeLookup.keys());
function fg(e) {
  return le(he(dg(e), [e]), ge);
}
const hg = (e) => e.updateNodeInternals;
function pg() {
  const e = le(hg), [t] = G(() => typeof ResizeObserver > "u" ? null : new ResizeObserver((n) => {
...
function gg({ node: e, nodeType: t, hasDimensions: n, resizeObserver: o }) {
...
function mg({ id: e, onClick: t, onMouseEnter: n, onMouseMove: o, onMouseLeave: r, onContextMenu: i, onDoubleClick: s, nodesDraggable: c, elementsSelectable: l, nodesConnectable: a, nodesFocusable: d, resizeObserver: f, noDragClassName: h, noPanClassName: p, disableKeyboardA11y: m, rfId: x, nodeTypes: v, nodeClickDistance: y, onError: b }) {
  const { node: g, internals: w, isParent: _ } = le((L) => {
  ...
  let E = g.type || "default", k = v?.[E] || Is[E];
  k === void 0 && (b?.("003", He.error003(E)), E = "default", k = v?.default || Is.default);
  const D = !!(g.draggable || c && typeof g.draggable > "u"), $ = !!(g.selectable || l && typeof g.selectable > "u"), W = !!(g.connectable || a && typeof g.connectable > "u"), M = !!(g.focusable || d && typeof g.focusable > "u"), z = me(), H = Wa(g), S = gg({ node: g, nodeType: E, hasDimensions: H, resizeObserver: f }), I = Nc({
    nodeRef: S,
    disabled: g.hidden || !D,
    noDragClassName: h,
  ...
  if (g.hidden)
    return null;
  const A = it(g), T = sg(g), P = $ || D || t || n || o || r, V = n ? (L) => n(L, { ...w.userNode }) : void 0, B = o ? (L) => o(L, { ...w.userNode }) : void 0, O = r ? (L) => r(L, { ...w.userNode }) : void 0, U = i ? (L) => i(L, { ...w.userNode }) : void 0, Z = s ? (L) => s(L, { ...w.userNode }) : void 0, ne = (L) => {
    ...
    if (!(qa(L.nativeEvent) || m)) {
      if (Ta.includes(L.key) && $) {
      ...
      } else if (D && g.selected && Object.prototype.hasOwnProperty.call(jo, L.key)) {
        L.preventDefault();
    ...
    if (!ie)
      return;
    fi(/* @__PURE__ */ new Map([[e, g]]), { x: 0, y: 0, width: Y, height: re }, L, !0).length > 0 || q(g.position.x + A.width / 2, g.position.y + A.height / 2, {
      zoom: L[2]
    });
  };
...
function kc(e) {
  const { nodesDraggable: t, nodesConnectable: n, nodesFocusable: o, elementsSelectable: r, onError: i } = le(xg, ge), s = fg(e.onlyRenderVisibleElements), c = pg();
...
const bg = ({ color: e = "none", strokeWidth: t = 1 }) => {
  const n = {
    strokeWidth: t,
    ...e && { stroke: e }
  };
...
function Ng(e) {
  const t = me();
  return pe(() => Object.prototype.hasOwnProperty.call(As, e) ? As[e] : (t.getState().onError?.("009", He.error009(e)), null), [e]);
}
const Eg = ({ id: e, type: t, color: n, width: o = 12.5, height: r = 12.5, markerUnits: i = "strokeWidth", strokeWidth: s, orient: c = "auto-start-reverse" }) => {
  const l = Ng(t);
...
}, Ic = ({ defaultColor: e, rfId: t }) => {
  const n = le((i) => i.edges), o = le((i) => i.defaultEdgeOptions), r = pe(() => Nh(n, {
    id: t,
    defaultColor: e,
    defaultMarkerStart: o?.markerStart,
    defaultMarkerEnd: o?.markerEnd
  }), [n, o, t, e]);
  return r.length ? u.jsx("svg", { className: "react-flow__marker", "aria-hidden": "true", children: u.jsx("defs", { children: r.map((i) => u.jsx(Eg, { id: i.id, type: i.type, color: i.color, width: i.width, height: i.height, markerUnits: i.markerUnits, strokeWidth: i.strokeWidth, orient: i.orient }, i.id)) }) }) : null;
};
Ic.displayName = "MarkerDefinitions";
var _g = ve(Ic);
function Mc({ x: e, y: t, label: n, labelStyle: o, labelShowBg: r = !0, labelBgStyle: i, labelBgPadding: s = [2, 4], labelBgBorderRadius: c = 2, children: l, className: a, ...d }) {
...
function Tn({ path: e, labelX: t, labelY: n, label: o, labelStyle: r, labelShowBg: i, labelBgStyle: s, labelBgPadding: c, labelBgBorderRadius: l, interactionWidth: a = 20, ...d }) {
  return u.jsxs(u.Fragment, { children: [u.jsx("path", { ...d, d: e, fill: "none", className: Se(["react-flow__edge-path", d.className]) }), a ? u.jsx("path", { d: e, fill: "none", strokeOpacity: 0, strokeWidth: a, className: "react-flow__edge-interaction" }) : null, o && qe(t) && qe(n) ? u.jsx(Cg, { x: t, y: n, label: o, labelStyle: r, labelShowBg: i, labelBgStyle: s, labelBgPadding: c, labelBgBorderRadius: l }) : null] });
}
function js({ pos: e, x1: t, y1: n, x2: o, y2: r }) {
  return e === te.Left || e === te.Right ? [0.5 * (t + o), n] : [t, 0.5 * (n + r)];
}
function Ac({ sourceX: e, sourceY: t, sourcePosition: n = te.Bottom, targetX: o, targetY: r, targetPosition: i = te.Top }) {
  const [s, c] = js({
    pos: n,
    x1: e,
    y1: t,
...
function jc(e) {
  return ve(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, sourcePosition: s, targetPosition: c, label: l, labelStyle: a, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: m, markerEnd: x, markerStart: v, interactionWidth: y }) => {
    ...
    return u.jsx(Tn, { id: _, path: b, labelX: g, labelY: w, label: l, labelStyle: a, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: m, markerEnd: x, markerStart: v, interactionWidth: y });
  });
}
const kg = jc({ isInternal: !1 }), Dc = jc({ isInternal: !0 });
kg.displayName = "SimpleBezierEdge";
Dc.displayName = "SimpleBezierEdgeInternal";
function Pc(e) {
  return ve(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, label: s, labelStyle: c, labelShowBg: l, labelBgStyle: a, labelBgPadding: d, labelBgBorderRadius: f, style: h, sourcePosition: p = te.Bottom, targetPosition: m = te.Top, markerEnd: x, markerStart: v, pathOptions: y, interactionWidth: b }) => {
    const [g, w, _] = Ao({
      sourceX: n,
      sourceY: o,
      sourcePosition: p,
...
const $c = Pc({ isInternal: !1 }), Tc = Pc({ isInternal: !0 });
$c.displayName = "SmoothStepEdge";
Tc.displayName = "SmoothStepEdgeInternal";
function zc(e) {
  return ve(({ id: t, ...n }) => {
    const o = e.isInternal ? void 0 : t;
    return u.jsx($c, { ...n, id: o, pathOptions: pe(() => ({ borderRadius: 0, offset: n.pathOptions?.offset }), [n.pathOptions?.offset]) });
  });
}
const Ig = zc({ isInternal: !1 }), Lc = zc({ isInternal: !0 });
...
function Rc(e) {
  return ve(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, label: s, labelStyle: c, labelShowBg: l, labelBgStyle: a, labelBgPadding: d, labelBgBorderRadius: f, style: h, markerEnd: p, markerStart: m, interactionWidth: x }) => {
    const [v, y, b] = Ja({ sourceX: n, sourceY: o, targetX: r, targetY: i }), g = e.isInternal ? void 0 : t;
    return u.jsx(Tn, { id: g, path: v, labelX: y, labelY: b, label: s, labelStyle: c, labelShowBg: l, labelBgStyle: a, labelBgPadding: d, labelBgBorderRadius: f, style: h, markerEnd: p, markerStart: m, interactionWidth: x });
  });
}
const Mg = Rc({ isInternal: !1 }), Hc = Rc({ isInternal: !0 });
Mg.displayName = "StraightEdge";
Hc.displayName = "StraightEdgeInternal";
function Vc(e) {
  return ve(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, sourcePosition: s = te.Bottom, targetPosition: c = te.Top, label: l, labelStyle: a, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: m, markerEnd: x, markerStart: v, pathOptions: y, interactionWidth: b }) => {
    const [g, w, _] = Ua({
      sourceX: n,
      sourceY: o,
      sourcePosition: s,
    ...
    return u.jsx(Tn, { id: E, path: g, labelX: w, labelY: _, label: l, labelStyle: a, labelShowBg: d, labelBgStyle: f, labelBgPadding: h, labelBgBorderRadius: p, style: m, markerEnd: x, markerStart: v, interactionWidth: b });
  });
}
const Ag = Vc({ isInternal: !1 }), Oc = Vc({ isInternal: !0 });
...
const Ds = {
  ...
  sourcePosition: null,
  targetPosition: null
}, jg = (e, t, n) => n === te.Left ? e - t : n === te.Right ? e + t : e, Dg = (e, t, n) => n === te.Top ? e - t : n === te.Bottom ? e + t : e, $s = "react-flow__edgeupdater";
function Ts({ position: e, centerX: t, centerY: n, radius: o = 10, onMouseDown: r, onMouseEnter: i, onMouseOut: s, type: c }) {
  return u.jsx("circle", { onMouseDown: r, onMouseEnter: i, onMouseOut: s, className: Se([$s, `${$s}-${c}`]), cx: jg(t, o, e), cy: Dg(n, o, e), r: o, stroke: "transparent", fill: "transparent" });
}
function Pg({ isReconnectable: e, reconnectRadius: t, edge: n, sourceX: o, sourceY: r, targetX: i, targetY: s, sourcePosition: c, targetPosition: l, onReconnect: a, onReconnectStart: d, onReconnectEnd: f, setReconnecting: h, setUpdateHover: p }) {
  const m = me(), x = (w, _) => {
    if (w.button !== 0)
      return;
    const { autoPanOnConnect: E, domNode: k, connectionMode: D, connectionRadius: $, lib: W, onConnectStart: M, cancelConnection: z, nodeLookup: H, rfId: S, panBy: I, updateConnection: C } = m.getState(), A = _.type === "target", T = (B, O) => {
      h(!1), f?.(B, n, _.type, O);
    }, P = (B) => a?.(n, B), V = (B, O) => {
  ...
  }, v = (w) => x(w, { nodeId: n.target, id: n.targetHandle ?? null, type: "target" }), y = (w) => x(w, { nodeId: n.source, id: n.sourceHandle ?? null, type: "source" }), b = () => p(!0), g = () => p(!1);
  return u.jsxs(u.Fragment, { children: [(e === !0 || e === "source") && u.jsx(Ts, { position: c, centerX: o, centerY: r, radius: t, onMouseDown: v, onMouseEnter: b, onMouseOut: g, type: "source" }), (e === !0 || e === "target") && u.jsx(Ts, { position: l, centerX: i, centerY: s, radius: t, onMouseDown: y, onMouseEnter: b, onMouseOut: g, type: "target" })] });
}
function $g({ id: e, edgesFocusable: t, edgesReconnectable: n, elementsSelectable: o, onClick: r, onDoubleClick: i, onContextMenu: s, onMouseEnter: c, onMouseMove: l, onMouseLeave: a, reconnectRadius: d, onReconnect: f, onReconnectStart: h, onReconnectEnd: p, rfId: m, edgeTypes: x, noPanClassName: v, onError: y, disableKeyboardA11y: b }) {
  let g = le((q) => q.edgeLookup.get(e));
  const w = le((q) => q.defaultEdgeOptions);
  g = w ? { ...w, ...g } : g;
  let _ = g.type || "default", E = x?.[_] || Ds[_];
  E === void 0 && (y?.("011", He.error011(_)), _ = "default", E = x?.default || Ds.default);
  const k = !!(g.focusable || t && typeof g.focusable > "u"), D = typeof f < "u" && (g.reconnectable || n && typeof g.reconnectable > "u"), $ = !!(g.selectable || o && typeof g.selectable > "u"), W = ce(null), [M, z] = G(!1), [H, S] = G(!1), I = me(), { zIndex: C, sourceX: A, sourceY: T, targetX: P, targetY: V, sourcePosition: B, targetPosition: O } = le(he((q) => {
  ...
  }, [g.source, g.target, g.sourceHandle, g.targetHandle, g.selected, g.zIndex]), ge), U = pe(() => g.markerStart ? `url('#${Zr(g.markerStart, m)}')` : void 0, [g.markerStart, m]), Z = pe(() => g.markerEnd ? `url('#${Zr(g.markerEnd, m)}')` : void 0, [g.markerEnd, m]);
...
function Bc({ defaultMarkerColor: e, onlyRenderVisibleElements: t, rfId: n, edgeTypes: o, noPanClassName: r, onReconnect: i, onEdgeContextMenu: s, onEdgeMouseEnter: c, onEdgeMouseMove: l, onEdgeMouseLeave: a, onEdgeClick: d, reconnectRadius: f, onEdgeDoubleClick: h, onReconnectStart: p, onReconnectEnd: m, disableKeyboardA11y: x }) {
  const { edgesFocusable: v, edgesReconnectable: y, elementsSelectable: b, onError: g } = le(zg, ge), w = vg(t);
  return u.jsxs("div", { className: "react-flow__edges", children: [u.jsx(_g, { defaultColor: e, rfId: n }), w.map((_) => u.jsx(Tg, { id: _, edgesFocusable: v, edgesReconnectable: y, elementsSelectable: b, noPanClassName: r, onReconnect: i, onContextMenu: s, onMouseEnter: c, onMouseMove: l, onMouseLeave: a, onClick: d, reconnectRadius: f, onDoubleClick: h, onReconnectStart: p, onReconnectEnd: m, rfId: n, onError: g, edgeTypes: o, disableKeyboardA11y: x }, _))] });
}
Bc.displayName = "EdgeRenderer";
const Lg = ve(Bc), Rg = (e) => `translate(${e.transform[0]}px,${e.transform[1]}px) scale(${e.transform[2]})`;
...
function qg({ containerStyle: e, style: t, type: n, component: o }) {
  const { nodesConnectable: r, width: i, height: s, isValid: c, inProgress: l } = le(Yg, ge);
  return !(i && r && l) ? null : u.jsx("svg", { style: e, width: i, height: s, className: "react-flow__connectionline react-flow__container", children: u.jsx("g", { className: Se(["react-flow__connection", Ra(c)]), children: u.jsx(Fc, { style: t, type: n, CustomComponent: o, isValid: c }) }) });
}
const Fc = ({ style: e, type: t = ct.Bezier, CustomComponent: n, isValid: o }) => {
  const { inProgress: r, from: i, fromNode: s, fromHandle: c, fromPosition: l, to: a, toNode: d, toHandle: f, toPosition: h, pointer: p } = Xg();
  if (!r)
    return;
  if (n)
...
function Wc({ nodeTypes: e, edgeTypes: t, onInit: n, onNodeClick: o, onEdgeClick: r, onNodeDoubleClick: i, onEdgeDoubleClick: s, onNodeMouseEnter: c, onNodeMouseMove: l, onNodeMouseLeave: a, onNodeContextMenu: d, onSelectionContextMenu: f, onSelectionStart: h, onSelectionEnd: p, connectionLineType: m, connectionLineStyle: x, connectionLineComponent: v, connectionLineContainerStyle: y, selectionKeyCode: b, selectionOnDrag: g, selectionMode: w, multiSelectionKeyCode: _, panActivationKeyCode: E, zoomActivationKeyCode: k, deleteKeyCode: D, onlyRenderVisibleElements: $, elementsSelectable: W, defaultViewport: M, translateExtent: z, minZoom: H, maxZoom: S, preventScrolling: I, defaultMarkerColor: C, zoomOnScroll: A, zoomOnPinch: T, panOnScroll: P, panOnScrollSpeed: V, panOnScrollMode: B, zoomOnDoubleClick: O, panOnDrag: U, autoPanOnSelection: Z, onPaneClick: ne, onPaneMouseEnter: se, onPaneMouseMove: K, onPaneMouseLeave: L, onPaneScroll: Y, onPaneContextMenu: re, paneClickDistance: ie, nodeClickDistance: q, onEdgeContextMenu: ee, onEdgeMouseEnter: oe, onEdgeMouseMove: R, onEdgeMouseLeave: J, reconnectRadius: fe, onReconnect: xe, onReconnectStart: Oe, onReconnectEnd: we, noDragClassName: je, noWheelClassName: tt, noPanClassName: Fe, disableKeyboardA11y: Be, nodeExtent: Ce, rfId: Ae, viewport: De, onViewportChange: Ue }) {
  return zs(e), zs(t), Kg(), Vg(n), Bg(De), u.jsx(ug, { onPaneClick: ne, onPaneMouseEnter: se, onPaneMouseMove: K, onPaneMouseLeave: L, onPaneContextMenu: re, onPaneScroll: Y, paneClickDistance: ie, deleteKeyCode: D, selectionKeyCode: b, selectionOnDrag: g, selectionMode: w, onSelectionStart: h, onSelectionEnd: p, multiSelectionKeyCode: _, panActivationKeyCode: E, zoomActivationKeyCode: k, elementsSelectable: W, zoomOnScroll: A, zoomOnPinch: T, zoomOnDoubleClick: O, panOnScroll: P, panOnScrollSpeed: V, panOnScrollMode: B, panOnDrag: U, autoPanOnSelection: Z, defaultViewport: M, translateExtent: z, minZoom: H, maxZoom: S, onSelectionContextMenu: f, preventScrolling: I, noDragClassName: je, noWheelClassName: tt, noPanClassName: Fe, disableKeyboardA11y: Be, onViewportChange: Ue, isControlledViewport: !!De, children: u.jsxs(Hg, { children: [u.jsx(Lg, { edgeTypes: t, onEdgeClick: r, onEdgeDoubleClick: s, onReconnect: xe, onReconnectStart: Oe, onReconnectEnd: we, onlyRenderVisibleElements: $, onEdgeContextMenu: ee, onEdgeMouseEnter: oe, onEdgeMouseMove: R, onEdgeMouseLeave: J, reconnectRadius: fe, defaultMarkerColor: C, noPanClassName: Fe, disableKeyboardA11y: Be, rfId: Ae }), u.jsx(qg, { style: x, type: m, component: v, containerStyle: y }), u.jsx("div", { className: "react-flow__edgelabel-renderer" }), u.jsx(wg, { nodeTypes: e, onNodeClick: o, onNodeDoubleClick: i, onNodeMouseEnter: c, onNodeMouseMove: l, onNodeMouseLeave: a, onNodeContextMenu: d, nodeClickDistance: q, onlyRenderVisibleElements: $, noPanClassName: Fe, noDragClassName: je, disableKeyboardA11y: Be, nodeExtent: Ce, rfId: Ae }), u.jsx("div", { className: "react-flow__viewport-portal" })] }) });
}
Wc.displayName = "GraphView";
const Ug = ve(Wc), Gg = Fa(), Ls = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, width: r, height: i, fitView: s, fitViewOptions: c, minZoom: l = 0.5, maxZoom: a = 2, nodeOrigin: d, nodeExtent: f, zIndexMode: h = "basic" } = {}) => {
  const p = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), y = o ?? t ?? [], b = n ?? e ?? [], g = d ?? [0, 0], w = f ?? Sn;
  nc(x, v, y);
  const { nodesInitialized: _ } = Kr(b, p, m, {
    nodeOrigin: g,
    nodeExtent: w,
    zIndexMode: h
  });
  ...
  if (s && r && i) {
    ...
    }), { x: D, y: $, zoom: W } = pi(k, r, i, l, a, c?.padding ?? 0.1);
    E = [D, $, W];
  }
  return {
    rfId: "1",
...
}, Qg = ({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, width: r, height: i, fitView: s, fitViewOptions: c, minZoom: l, maxZoom: a, nodeOrigin: d, nodeExtent: f, zIndexMode: h }) => dp((p, m) => {
  async function x() {
    const { nodeLookup: v, panZoom: y, fitViewOptions: b, fitViewResolver: g, width: w, height: _, minZoom: E, maxZoom: k } = m();
    y && (await ah({
      nodes: v,
      width: w,
      height: _,
  ...
  return {
    ...
    setNodes: (v) => {
      const { nodeLookup: y, parentLookup: b, nodeOrigin: g, elevateNodesOnSelect: w, fitViewQueued: _, zIndexMode: E, nodesSelectionActive: k } = m(), { nodesInitialized: D, hasSelectedNodes: $ } = Kr(v, y, b, {
        nodeOrigin: g,
        nodeExtent: f,
    ...
    updateNodeInternals: (v) => {
      const { triggerNodeChanges: y, nodeLookup: b, parentLookup: g, domNode: w, nodeOrigin: _, nodeExtent: E, debug: k, fitViewQueued: D, zIndexMode: $ } = m(), { changes: W, updatedInternals: M } = Ah(v, b, g, w, _, E, $);
      M && (Ch(b, g, { nodeOrigin: _, nodeExtent: E, zIndexMode: $ }), D ? (x(), p({ fitViewQueued: !1, fitViewOptions: void 0 })) : p({}), W?.length > 0 && (k && console.log("React Flow: trigger node changes", W), y?.(W)));
    },
    updateNodePositions: (v, y = !1) => {
      ...
      if (b.length > 0) {
        const { parentLookup: $, nodeOrigin: W } = m(), M = vi(b, w, $, W);
        g.push(...M);
      }
    ...
    triggerNodeChanges: (v) => {
      const { onNodesChange: y, setNodes: b, nodes: g, hasDefaultNodes: w, debug: _ } = m();
      if (v?.length) {
        if (w) {
          const E = yc(v, g);
          b(E);
    ...
    triggerEdgeChanges: (v) => {
      const { onEdgesChange: y, setEdges: b, edges: g, hasDefaultEdges: w, debug: _ } = m();
      if (v?.length) {
        if (w) {
          const E = xc(v, g);
          b(E);
    ...
    addSelectedNodes: (v) => {
      const { multiSelectionActive: y, edgeLookup: b, nodeLookup: g, triggerNodeChanges: w, triggerEdgeChanges: _ } = m();
      if (y) {
    ...
    unselectNodesAndEdges: ({ nodes: v, edges: y } = {}) => {
      const { edges: b, nodes: g, nodeLookup: w, triggerNodeChanges: _, triggerEdgeChanges: E } = m(), k = v || g, D = y || b, $ = [];
      for (const M of k) {
        if (!M.selected)
          continue;
        const z = w.get(M.id);
    ...
    setMinZoom: (v) => {
      ...
      y?.setScaleExtent([v, b]), p({ minZoom: v });
    },
    setMaxZoom: (v) => {
      const { panZoom: y, minZoom: b } = m();
      y?.setScaleExtent([b, v]), p({ maxZoom: v });
    },
    setTranslateExtent: (v) => {
      m().panZoom?.setTranslateExtent(v), p({ translateExtent: v });
    },
    resetSelectedElements: () => {
      const { edges: v, nodes: y, triggerNodeChanges: b, triggerEdgeChanges: g, elementsSelectable: w } = m();
      if (!w)
        return;
    ...
    setNodeExtent: (v) => {
      const { nodes: y, nodeLookup: b, parentLookup: g, nodeOrigin: w, elevateNodesOnSelect: _, nodeExtent: E, zIndexMode: k } = m();
      v[0][0] === E[0][0] && v[0][1] === E[0][1] && v[1][0] === E[1][0] && v[1][1] === E[1][1] || (Kr(y, b, g, {
        nodeOrigin: w,
        nodeExtent: v,
    ...
    panBy: (v) => {
      const { transform: y, width: b, height: g, panZoom: w, translateExtent: _ } = m();
      return jh({ delta: v, panZoom: w, transform: y, translateExtent: _, width: b, height: g });
    },
...
function Jg({ initialNodes: e, initialEdges: t, defaultNodes: n, defaultEdges: o, initialWidth: r, initialHeight: i, initialMinZoom: s, initialMaxZoom: c, initialFitViewOptions: l, fitView: a, nodeOrigin: d, nodeExtent: f, zIndexMode: h, children: p }) {
  const [m] = G(() => Qg({
    nodes: e,
    edges: t,
    defaultNodes: n,
  ...
  return u.jsx(gp, { value: m, children: u.jsx(Hp, { children: p }) });
}
function em({ children: e, nodes: t, edges: n, defaultNodes: o, defaultEdges: r, width: i, height: s, fitView: c, fitViewOptions: l, minZoom: a, maxZoom: d, nodeOrigin: f, nodeExtent: h, zIndexMode: p }) {
  return Mn(Wo) ? u.jsx(u.Fragment, { children: e }) : u.jsx(Jg, { initialNodes: t, initialEdges: n, defaultNodes: o, defaultEdges: r, initialWidth: i, initialHeight: s, fitView: c, initialFitViewOptions: l, initialMinZoom: a, initialMaxZoom: d, nodeOrigin: f, nodeExtent: h, zIndexMode: p, children: e });
}
const tm = {
  width: "100%",
  height: "100%",
...
function nm({ nodes: e, edges: t, defaultNodes: n, defaultEdges: o, className: r, nodeTypes: i, edgeTypes: s, onNodeClick: c, onEdgeClick: l, onInit: a, onMove: d, onMoveStart: f, onMoveEnd: h, onConnect: p, onConnectStart: m, onConnectEnd: x, onClickConnectStart: v, onClickConnectEnd: y, onNodeMouseEnter: b, onNodeMouseMove: g, onNodeMouseLeave: w, onNodeContextMenu: _, onNodeDoubleClick: E, onNodeDragStart: k, onNodeDrag: D, onNodeDragStop: $, onNodesDelete: W, onEdgesDelete: M, onDelete: z, onSelectionChange: H, onSelectionDragStart: S, onSelectionDrag: I, onSelectionDragStop: C, onSelectionContextMenu: A, onSelectionStart: T, onSelectionEnd: P, onBeforeDelete: V, connectionMode: B, connectionLineType: O = ct.Bezier, connectionLineStyle: U, connectionLineComponent: Z, connectionLineContainerStyle: ne, deleteKeyCode: se = "Backspace", selectionKeyCode: K = "Shift", selectionOnDrag: L = !1, selectionMode: Y = Nn.Full, panActivationKeyCode: re = "Space", multiSelectionKeyCode: ie = _n() ? "Meta" : "Control", zoomActivationKeyCode: q = _n() ? "Meta" : "Control", snapToGrid: ee, snapGrid: oe, onlyRenderVisibleElements: R = !1, selectNodesOnDrag: J, nodesDraggable: fe, autoPanOnNodeFocus: xe, nodesConnectable: Oe, nodesFocusable: we, nodeOrigin: je = gc, edgesFocusable: tt, edgesReconnectable: Fe, elementsSelectable: Be = !0, defaultViewport: Ce = Ip, minZoom: Ae = 0.5, maxZoom: De = 2, translateExtent: Ue = Sn, preventScrolling: Te = !0, nodeExtent: St, defaultMarkerColor: ye = "#b1b1b7", zoomOnScroll: We = !0, zoomOnPinch: Xt = !0, panOnScroll: Ee = !1, panOnScrollSpeed: Yt = 0.5, panOnScrollMode: qt = mt.Free, zoomOnDoubleClick: ke = !0, panOnDrag: dt = !0, onPaneClick: Ln, onPaneMouseEnter: Rn, onPaneMouseMove: Zt, onPaneMouseLeave: Uo, onPaneScroll: Kt, onPaneContextMenu: Nt, paneClickDistance: ze = 1, nodeClickDistance: Ut = 0, children: Gt, onReconnect: Qt, onReconnectStart: Et, onReconnectEnd: Go, onEdgeContextMenu: Qo, onEdgeDoubleClick: Jo, onEdgeMouseEnter: er, onEdgeMouseMove: Hn, onEdgeMouseLeave: Vn, reconnectRadius: On = 10, onNodesChange: tr, onEdgesChange: Jt, noDragClassName: nr = "nodrag", noWheelClassName: or = "nowheel", noPanClassName: Bn = "nopan", fitView: Fn, fitViewOptions: Wn, connectOnClick: en, attributionPosition: rr, proOptions: ir, defaultEdgeOptions: sr, elevateNodesOnSelect: ar = !0, elevateEdgesOnSelect: cr = !1, disableKeyboardA11y: Xn = !1, autoPanOnConnect: lr, autoPanOnNodeDrag: Yn, autoPanOnSelection: qn = !0, autoPanSpeed: ur, connectionRadius: dr, isValidConnection: fr, onError: hr, style: pr, id: tn, nodeDragThreshold: Zn, connectionDragThreshold: Kn, viewport: Un, onViewportChange: Gn, width: gr, height: mr, colorMode: yr = "light", debug: xr, onScroll: Qn, ariaLabelConfig: Jn, zIndexMode: _t = "basic", ...nn }, eo) {
  const Ct = tn || "1", wr = Dp(yr), vr = he((N) => {
    N.currentTarget.scrollTo({ top: 0, left: 0, behavior: "instant" }), Qn?.(N);
  }, [Qn]);
  return u.jsx("div", { "data-testid": "rf__wrapper", ...nn, onScroll: vr, style: { ...pr, ...tm }, ref: eo, className: Se(["react-flow", r, wr]), id: tn, role: "application", children: u.jsxs(em, { nodes: e, edges: t, width: gr, height: mr, fitView: Fn, fitViewOptions: Wn, minZoom: Ae, maxZoom: De, nodeOrigin: je, nodeExtent: St, zIndexMode: _t, children: [u.jsx(jp, { nodes: e, edges: t, defaultNodes: n, defaultEdges: o, onConnect: p, onConnectStart: m, onConnectEnd: x, onClickConnectStart: v, onClickConnectEnd: y, nodesDraggable: fe, autoPanOnNodeFocus: xe, nodesConnectable: Oe, nodesFocusable: we, edgesFocusable: tt, edgesReconnectable: Fe, elementsSelectable: Be, elevateNodesOnSelect: ar, elevateEdgesOnSelect: cr, minZoom: Ae, maxZoom: De, nodeExtent: St, onNodesChange: tr, onEdgesChange: Jt, snapToGrid: ee, snapGrid: oe, connectionMode: B, translateExtent: Ue, connectOnClick: en, defaultEdgeOptions: sr, fitView: Fn, fitViewOptions: Wn, onNodesDelete: W, onEdgesDelete: M, onDelete: z, onNodeDragStart: k, onNodeDrag: D, onNodeDragStop: $, onSelectionDrag: I, onSelectionDragStart: S, onSelectionDragStop: C, onMove: d, onMoveStart: f, onMoveEnd: h, noPanClassName: Bn, nodeOrigin: je, rfId: Ct, autoPanOnConnect: lr, autoPanOnNodeDrag: Yn, autoPanSpeed: ur, onError: hr, connectionRadius: dr, isValidConnection: fr, selectNodesOnDrag: J, nodeDragThreshold: Zn, connectionDragThreshold: Kn, onBeforeDelete: V, debug: xr, ariaLabelConfig: Jn, zIndexMode: _t }), u.jsx(Ug, { onInit: a, onNodeClick: c, onEdgeClick: l, onNodeMouseEnter: b, onNodeMouseMove: g, onNodeMouseLeave: w, onNodeContextMenu: _, onNodeDoubleClick: E, nodeTypes: i, edgeTypes: s, connectionLineType: O, connectionLineStyle: U, connectionLineComponent: Z, connectionLineContainerStyle: ne, selectionKeyCode: K, selectionOnDrag: L, selectionMode: Y, deleteKeyCode: se, multiSelectionKeyCode: ie, panActivationKeyCode: re, zoomActivationKeyCode: q, onlyRenderVisibleElements: R, defaultViewport: Ce, translateExtent: Ue, minZoom: Ae, maxZoom: De, preventScrolling: Te, zoomOnScroll: We, zoomOnPinch: Xt, zoomOnDoubleClick: ke, panOnScroll: Ee, panOnScrollSpeed: Yt, panOnScrollMode: qt, panOnDrag: dt, autoPanOnSelection: qn, onPaneClick: Ln, onPaneMouseEnter: Rn, onPaneMouseMove: Zt, onPaneMouseLeave: Uo, onPaneScroll: Kt, onPaneContextMenu: Nt, paneClickDistance: ze, nodeClickDistance: Ut, onSelectionContextMenu: A, onSelectionStart: T, onSelectionEnd: P, onReconnect: Qt, onReconnectStart: Et, onReconnectEnd: Go, onEdgeContextMenu: Qo, onEdgeDoubleClick: Jo, onEdgeMouseEnter: er, onEdgeMouseMove: Hn, onEdgeMouseLeave: Vn, reconnectRadius: On, defaultMarkerColor: ye, noDragClassName: nr, noWheelClassName: or, noPanClassName: Bn, rfId: Ct, disableKeyboardA11y: Xn, nodeExtent: St, viewport: Un, onViewportChange: Gn }), u.jsx(kp, { onSelectionChange: H }), Gt, u.jsx(Sp, { proOptions: ir, position: rr }), u.jsx(bp, { rfId: Ct, disableKeyboardA11y: Xn })] }) });
}
var om = bc(nm);
const rm = (e) => e.domNode?.querySelector(".react-flow__edgelabel-renderer");
function im({ children: e }) {
  const t = le(rm);
  return t ? pp.createPortal(e, t) : null;
}
function sm({ dimensions: e, lineWidth: t, variant: n, className: o }) {
  return u.jsx("path", { strokeWidth: t, d: `M${e[0] / 2} 0 V${e[1]} M0 ${e[1] / 2} H${e[0]}`, className: Se(["react-flow__background-pattern", n, o]) });
}
function am({ radius: e, className: t }) {
...
const cm = {
  ...
  [lt.Lines]: 1,
  [lt.Cross]: 6
}, lm = (e) => ({ transform: e.transform, patternId: `pattern-${e.rfId}` });
function Xc({
  id: e,
  variant: t = lt.Dots,
  ...
  const f = ce(null), { transform: h, patternId: p } = le(lm, ge), m = o || cm[t], x = t === lt.Dots, v = t === lt.Cross, y = Array.isArray(n) ? n : [n, n], b = [y[0] * h[2] || 1, y[1] * h[2] || 1], g = m * h[2], w = Array.isArray(i) ? i : [i, i], _ = v ? [g, g] : b, E = [
    w[0] * h[2] || 1 + _[0] / 2,
    w[1] * h[2] || 1 + _[1] / 2
  ], k = `${p}${e || ""}`;
  ...
  }, ref: f, "data-testid": "rf__background", children: [u.jsx("pattern", { id: k, x: h[0] % b[0], y: h[1] % b[1], width: b[0], height: b[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${E[0]},-${E[1]})`, children: x ? u.jsx(am, { radius: g / 2, className: d }) : u.jsx(sm, { dimensions: _, lineWidth: r, variant: t, className: d }) }), u.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${k})` })] });
}
Xc.displayName = "Background";
const um = ve(Xc);
function dm() {
...
function Yc({ style: e, showZoom: t = !0, showFitView: n = !0, showInteractive: o = !0, fitViewOptions: r, onZoomIn: i, onZoomOut: s, onFitView: c, onInteractiveChange: l, className: a, children: d, position: f = "bottom-left", orientation: h = "vertical", "aria-label": p }) {
  const m = me(), { isInteractive: x, minZoomReached: v, maxZoomReached: y, ariaLabelConfig: b } = le(mm, ge), { zoomIn: g, zoomOut: w, fitView: _ } = bi(), E = () => {
    g(), i?.();
  }, k = () => {
    w(), s?.();
  }, D = () => {
  ...
  return u.jsxs(Xo, { className: Se(["react-flow__controls", W, a]), position: f, style: e, "data-testid": "rf__controls", "aria-label": p ?? b["controls.ariaLabel"], children: [t && u.jsxs(u.Fragment, { children: [u.jsx(lo, { onClick: E, className: "react-flow__controls-zoomin", title: b["controls.zoomIn.ariaLabel"], "aria-label": b["controls.zoomIn.ariaLabel"], disabled: y, children: u.jsx(dm, {}) }), u.jsx(lo, { onClick: k, className: "react-flow__controls-zoomout", title: b["controls.zoomOut.ariaLabel"], "aria-label": b["controls.zoomOut.ariaLabel"], disabled: v, children: u.jsx(fm, {}) })] }), n && u.jsx(lo, { className: "react-flow__controls-fitview", onClick: D, title: b["controls.fitView.ariaLabel"], "aria-label": b["controls.fitView.ariaLabel"], children: u.jsx(hm, {}) }), o && u.jsx(lo, { className: "react-flow__controls-interactive", onClick: $, title: b["controls.interactive.ariaLabel"], "aria-label": b["controls.interactive.ariaLabel"], children: x ? u.jsx(gm, {}) : u.jsx(pm, {}) }), d] });
}
Yc.displayName = "Controls";
const ym = ve(Yc);
function xm({ id: e, x: t, y: n, width: o, height: r, style: i, color: s, strokeColor: c, strokeWidth: l, className: a, borderRadius: d, shapeRendering: f, selected: h, onClick: p }) {
...
const wm = ve(xm), vm = (e) => e.nodes.map((t) => t.id), Tr = (e) => e instanceof Function ? e : () => e;
function bm({
  nodeStrokeColor: e,
  nodeColor: t,
  nodeClassName: n = "",
  ...
  const c = le(vm, ge), l = Tr(t), a = Tr(e), d = Tr(n), f = typeof window > "u" || window.chrome ? "crispEdges" : "geometricPrecision";
  return u.jsx(u.Fragment, { children: c.map((h) => (
     ...
     */
    u.jsx(Nm, { id: h, nodeColorFunc: l, nodeStrokeColorFunc: a, nodeClassNameFunc: d, nodeBorderRadius: o, nodeStrokeWidth: r, NodeComponent: i, onClick: s, shapeRendering: f }, h)
  )) });
}
function Sm({ id: e, nodeColorFunc: t, nodeStrokeColorFunc: n, nodeClassNameFunc: o, nodeBorderRadius: r, nodeStrokeWidth: i, shapeRendering: s, NodeComponent: c, onClick: l }) {
  const { node: a, x: d, y: f, width: h, height: p } = le((m) => {
    const x = m.nodeLookup.get(e);
    if (!x)
      return { node: void 0, x: 0, y: 0, width: 0, height: 0 };
    const v = x.internals.userNode, { x: y, y: b } = x.internals.positionAbsolute, { width: g, height: w } = it(v);
    return {
      node: v,
      x: y,
      y: b,
  ...
  return !a || a.hidden || !Wa(a) ? null : u.jsx(c, { x: d, y: f, width: h, height: p, style: a.style, selected: !!a.selected, className: o(a), color: t(a), borderRadius: r, strokeColor: n(a), strokeWidth: i, shapeRendering: s, onClick: l, id: a.id });
}
const Nm = ve(Sm);
var Em = ve(bm);
const _m = 200, Cm = 150, km = (e) => !e.hidden, Im = (e) => {
  const t = {
  ...
  return {
    viewBB: t,
    boundingRect: e.nodeLookup.size > 0 ? Ba(Pn(e.nodeLookup, { filter: km }), t) : t,
    rfId: e.rfId,
    panZoom: e.panZoom,
...
function qc({
  ...
  const _ = me(), E = ce(null), { boundingRect: k, viewBB: D, rfId: $, panZoom: W, translateExtent: M, flowWidth: z, flowHeight: H, ariaLabelConfig: S } = le(Im, ge), I = e?.width ?? _m, C = e?.height ?? Cm, A = k.width / I, T = k.height / C, P = Math.max(A, T), V = P * I, B = P * C, O = w * P, U = k.x - (V - k.width) / 2 - O, Z = k.y - (B - k.height) / 2 - O, ne = V + O * 2, se = B + O * 2, K = `${Mm}-${$}`, L = ce(0), Y = ce();
  L.current = P, ae(() => {
    if (E.current && W)
      return Y.current = Vh({
        domNode: E.current,
  ...
  const re = p ? (ee) => {
    ...
    m(ee, R);
  }, []) : void 0, q = y ?? S["minimap.ariaLabel"];
  ...
  }, className: Se(["react-flow__minimap", t]), "data-testid": "rf__minimap", children: u.jsxs("svg", { width: I, height: C, viewBox: `${U} ${Z} ${ne} ${se}`, className: "react-flow__minimap-svg", role: "img", "aria-labelledby": K, ref: E, onClick: re, children: [q && u.jsx("title", { id: K, children: q }), u.jsx(Em, { onClick: ie, nodeColor: o, nodeStrokeColor: n, nodeBorderRadius: i, nodeClassName: r, nodeStrokeWidth: s, nodeComponent: c }), u.jsx("path", { className: "react-flow__minimap-mask", d: `M${U - O},${Z - O}h${ne + O * 2}v${se + O * 2}h${-ne - O * 2}z
        M${D.x},${D.y}h${D.width}v${D.height}h${-D.width}z`, fillRule: "evenodd", pointerEvents: "none" })] }) });
}
qc.displayName = "MiniMap";
const Am = ve(qc), jm = (e) => (t) => e ? `${Math.max(1 / t.transform[2], 1)}` : void 0, Dm = {
  [Ht.Line]: "right",
  [Ht.Handle]: "bottom-right"
};
function Pm({ nodeId: e, position: t, variant: n = Ht.Handle, className: o, style: r = void 0, children: i, color: s, minWidth: c = 10, minHeight: l = 10, maxWidth: a = Number.MAX_VALUE, maxHeight: d = Number.MAX_VALUE, keepAspectRatio: f = !1, resizeDirection: h, autoScale: p = !0, shouldResize: m, onResizeStart: x, onResize: v, onResizeEnd: y }) {
  const b = _c(), g = typeof e == "string" ? e : b, w = me(), _ = ce(null), E = n === Ht.Handle, k = le(he(jm(E && p), [E, p]), ge), D = ce(null), $ = t ?? Dm[n];
  ae(() => {
    if (!(!_.current || !g))
      return D.current || (D.current = Jh({
        domNode: _.current,
        nodeId: g,
        getStoreItems: () => {
            ...
            const V = P.origin ?? C, B = M.width ?? P.measured.width ?? 0, O = M.height ?? P.measured.height ?? 0, U = {
              ...
              rect: {
                ...
                ...Xa({
                  x: M.x ?? P.position.x,
                  y: M.y ?? P.position.y
                }, { width: B, height: O }, P.parentId, S, V)
              }
            }, Z = vi([U], S, I, C);
...
ve(Pm);
const $m = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Zc = (...e) => e.filter((t, n, o) => !!t && t.trim() !== "" && o.indexOf(t) === n).join(" ").trim();
var Tm = {
...
const Ne = (e, t) => {
  const n = To(
    ({ className: o, ...r }, i) => Rr(zm, {
      ref: i,
      iconNode: t,
      className: Zc(`lucide-${$m(e)}`, o),
      ...r
    })
  );
...
const qo = Ne("Check", [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]]);
const Lm = Ne("ChevronDown", [
  ["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]
]);
const Qr = Ne("ChevronLeft", [
...
const Uc = Ne("GitBranch", [
  ["line", { x1: "6", x2: "6", y1: "3", y2: "15", key: "17qcm7" }],
  ["circle", { cx: "18", cy: "6", r: "3", key: "1h7g24" }],
  ["circle", { cx: "6", cy: "18", r: "3", key: "fqmcym" }],
  ["path", { d: "M18 9a9 9 0 0 1-9 9", key: "n2h4wq" }]
]);
const Gc = Ne("ListTree", [
...
], Zo = "elsa.sequence.structure", zn = "elsa.flowchart.structure";
function tl(e, t) {
  if (!e) return null;
  let n = e;
  for (const o of t) {
...
function Je(e) {
  ...
  const n = t.payload, o = Sy(t), r = Lr(n.activities);
  return r ? [{
...
function ny(e, t, n) {
  const o = new Map(t.map((s) => [s.activityVersionId, s])), r = new Map(n.map((s) => [s.nodeId, s])), i = e.slot.activities.map((s, c) => {
    const l = o.get(s.activityVersionId), a = r.get(s.nodeId) ?? Ey(e.slot.mode, c);
    return rl(s, l, { x: a.x, y: a.y });
  });
  return {
    nodes: i,
    edges: e.slot.mode === "flowchart" ? gy(e.owner) : py(e.slot, i)
  };
}
function oy(e, t, n) {
  const o = t.find((i) => i.activityVersionId === e.activityVersionId), r = n.find((i) => i.nodeId === e.nodeId) ?? { x: 0, y: 0 };
  return {
    nodes: [rl(e, o, { x: r.x, y: r.y }, {
      connectable: !1,
      deletable: !1,
      draggable: !1,
      suppressFlowPorts: !0
...
function ry(e, t) {
  return e?.structure?.kind === zn || ly(t) ? "flowchart" : e?.structure?.kind === Zo || uy(t) ? "sequence" : "unsupported";
}
function ei(e, t, n) {
  if (t.length === 0) {
    const c = Je(e)[0];
...
function nl(e, t, n) {
  ...
  const [o, ...r] = t, i = Je(e).find((c) => c.id === o.slotId);
  if (!i) return e;
  const s = i.activities.map((c) => c.nodeId === o.ownerNodeId ? nl(c, r, n) : c);
  return In(e, i, s);
}
function ol(e, t, n) {
...
function _e(e) {
  ...
  return !n || n === e.activityTypeKey || n.includes(".") ? dy(t) : n;
}
function rl(e, t, n, o = {}) {
  return {
    id: e.nodeId,
...
function sl(e, t) {
  ...
  if (o.length > 0) return wy(o);
  const r = Os(e.outcomes);
...
function Lr(e) {
  return Array.isArray(e) ? e.filter(by) : null;
}
function xy(e, t) {
...
function vy(e) {
  return _i(e) && typeof e.x == "number" && typeof e.y == "number";
}
function _i(e) {
...
function Sy(e) {
  return e.kind === Zo ? "sequence" : e.kind === zn ? "flowchart" : "generic";
}
function Ny(e) {
  return e.kind === Zo || e.kind === zn, "Activities";
}
function Ey(e, t) {
...
function jy(e, t) {
  return t.isWrapped === !1 ? Iy(e, t) : al(e, t).expression.value;
}
function cl(e, t) {
  return Dy(e) ? {
...
function Py({
  ...
  const c = Ly(s), l = o.length > 0 ? o : Cy;
...
function $y({
  ...
  const i = t.isReadOnly === !0, s = { activity: e, expressionDescriptors: o, readOnly: i }, c = zy(n, t, s), l = c?.component, a = t.isWrapped !== !1 ? al(e, t) : null, d = a?.expression.type ?? "Literal", f = jy(e, t), h = !!(a && Ry(t, c?.id)), p = !!(a && Hy(t, c?.id)), [m, x] = G(!1), v = (b) => {
    const g = a ? My(a, b) : b;
    r(Bs(e, t, g));
  }, y = (b) => {
    a && r(Bs(e, t, Ay(a, b)));
  ...
  return /* @__PURE__ */ u.jsxs("div", { className: "wf-property-row", children: [
    ...
    h ? /* @__PURE__ */ u.jsxs("div", { className: "wf-expression-field", children: [
      /* @__PURE__ */ u.jsx("div", { className: "wf-expression-editor", children: Fs(l, t, f, i, s, v) }),
      /* @__PURE__ */ u.jsx(
        ti,
        {
          label: `${t.displayName || t.name} expression syntax`,
      ...
      p ? /* @__PURE__ */ u.jsx(
        "button",
        {
          ...
          onClick: () => x(!0),
          children: /* @__PURE__ */ u.jsx(Do, { size: 13 })
        }
      ) : null
    ] }) : Fs(l, t, f, i, s, v),
    p && !h ? /* @__PURE__ */ u.jsxs(
...
function Ty({
  ...
  const l = ra(), a = e.displayName || e.name;
  return ae(() => {
    const d = (f) => {
      f.key === "Escape" && c();
    };
    ...
    /* @__PURE__ */ u.jsxs("header", { children: [
      ...
      /* @__PURE__ */ u.jsx("button", { type: "button", "aria-label": `Close ${a} editor`, onClick: c, children: /* @__PURE__ */ u.jsx(Bm, { size: 16 }) })
    ] }),
...
function ti({
  ...
  const [s, c] = G(!1), l = ra(), a = n.find((f) => f.type === t), d = [
...
const Vy = { workflowActivity: p0 }, Oy = { workflow: y0 }, Ws = "application/x-elsa-activity-version-id", By = 6, Fy = 1200, Wy = [10, 25, 50], Xy = 10, Xs = "elsa-studio-workflow-palette-width", Ys = "elsa-studio-workflow-inspector-width", qs = "elsa-studio-workflow-palette-collapsed", Zs = "elsa-studio-workflow-inspector-collapsed", dl = "elsa-studio-workflow-side-panel-maximized", an = 180, cn = 460, Yy = 260, ln = 260, un = 560, qy = 320, Ks = 42, uo = 16, fl = ut.createContext(null);
function E0(e) {
  e.featureAreas.add({
    id: "workflows",
    title: "Workflows",
    ...
    routes: [
      {
        ...
        component: () => /* @__PURE__ */ u.jsx(Zy, { context: e.backend, ai: e.ai, propertyEditors: e.propertyEditors.list(), workflowDesignerPanels: e.workflowDesigner.panels.list() })
      },
      {
        id: "workflows-executables",
        path: "/workflows/executables",
        label: "Workflow executables",
        component: () => /* @__PURE__ */ u.jsx(Ky, { context: e.backend, ai: e.ai })
      },
      {
        id: "workflows-instances",
        path: "/workflows/instances",
        label: "Workflow instances",
        component: () => /* @__PURE__ */ u.jsx(Uy, { ai: e.ai })
      }
    ]
  });
}
function Zy({
  ...
  return r ? /* @__PURE__ */ u.jsx(h0, { context: e, definitionId: r, ai: t, propertyEditors: n, workflowDesignerPanels: o, onBack: () => s(null) }) : /* @__PURE__ */ u.jsx(ki, { activePath: "/workflows/definitions", title: "Definitions", children: /* @__PURE__ */ u.jsx(Gy, { context: e, ai: t, onOpen: s }) });
}
function Ky({ context: e, ai: t }) {
  const [n, o] = G(Gs);
  return ae(() => {
    const r = () => o(Gs());
    return window.addEventListener("popstate", r), () => window.removeEventListener("popstate", r);
  }, []), /* @__PURE__ */ u.jsx(ki, { activePath: "/workflows/executables", title: "Executables", children: /* @__PURE__ */ u.jsx(Jy, { context: e, ai: t, definitionFilter: n }) });
}
function Uy({ ai: e }) {
  const t = Bt(e, "weaver.workflows.explain-instance");
  return /* @__PURE__ */ u.jsx(ki, { activePath: "/workflows/instances", title: "Instances", children: /* @__PURE__ */ u.jsxs("div", { className: "wf-empty", children: [
...
function ki({ activePath: e, title: t, children: n }) {
  const o = (r) => {
...
function Gy({ context: e, ai: t, onOpen: n }) {
  const [o, r] = G(""), [i, s] = G("active"), [c, l] = G(1), [a, d] = G(Xy), [f, h] = G("loading"), [p, m] = G(""), [x, v] = G(""), [y, b] = G([]), [g, w] = G(0), [_, E] = G(() => /* @__PURE__ */ new Set()), [k, D] = G(null), [$, W] = G(!1), [M, z] = G([]), [H, S] = G("idle"), I = ce(null), C = pe(() => y.map((R) => R.id), [y]), A = Bt(t, "weaver.workflows.suggest-create-metadata"), T = Bt(t, "weaver.workflows.explain-definition"), P = C.filter((R) => _.has(R)).length, V = C.length > 0 && P === C.length, B = he(async () => {
    h("loading"), m("");
    try {
      const R = await Wm(e, { search: o, state: i, page: c, pageSize: a }), J = typeof R.totalCount == "number", fe = R.totalCount ?? R.definitions.length, xe = hl(fe, a);
      if (fe > 0 && c > xe) {
        l(xe);
        return;
      }
      b(J ? R.definitions : t0(R.definitions, c, a)), w(fe), h("ready");
    } catch (R) {
  ...
  const O = he(async () => {
    ...
    E((fe) => {
      const xe = new Set(fe);
      return J ? xe.add(R) : xe.delete(R), xe;
    });
  }, Y = (R) => {
    E((J) => {
      const fe = new Set(J);
      for (const xe of C)
        R ? fe.add(xe) : fe.delete(xe);
      return fe;
    });
  }, re = (R) => {
    s(R), l(1), K();
    ...
    if (window.confirm(`Delete workflow definition "${R.name}"? You can restore it from the Deleted view.`)) {
      v(""), m("");
      try {
        await qm(e, R.id), L(R.id, !1), v(`Deleted ${R.name}`), await se();
      } catch (J) {
    ...
    v(""), m("");
    try {
      await Zm(e, R.id), L(R.id, !1), v(`Restored ${R.name}`), await se();
    } catch (J) {
      m(J instanceof Error ? J.message : String(J));
    }
  }, oe = async (R) => {
    if (window.confirm(`Permanently delete workflow definition "${R.name}"? This removes its drafts, versions, layouts, and validations and cannot be undone.`)) {
      v(""), m("");
      try {
        await Km(e, R.id), L(R.id, !1), v(`Permanently deleted ${R.name}`), await se();
      } catch (J) {
        m(J instanceof Error ? J.message : String(J));
      }
    }
        ...
        y.map((R) => /* @__PURE__ */ u.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u.jsx("span", { children: i === "deleted" ? ni(R.deletedAt) : R.draftId ? "Draft" : "None" }),
              /* @__PURE__ */ u.jsx("span", { children: ni(R.lastModifiedAt) }),
...
function Qy({ draft: e, activities: t, catalogState: n, creating: o, suggestMetadataAction: r, onSuggestMetadata: i, onChange: s, onClose: c, onSubmit: l }) {
  const a = pe(() => n0(t), [t]), d = o0(e, t), f = (h) => {
...
function Jy({ context: e, ai: t, definitionFilter: n }) {
  ...
  const m = async (x) => {
    l(""), s("");
    try {
      await Qc(e, x.artifactId), l(`Started ${x.artifactId}`);
    } catch (v) {
  ...
  return /* @__PURE__ */ u.jsxs(u.Fragment, { children: [
    ...
    o === "ready" && f.length > 0 ? /* @__PURE__ */ u.jsxs("div", { className: "wf-grid wf-executable-grid", role: "table", "aria-label": "Workflow executables", children: [
      ...
      f.map((x) => /* @__PURE__ */ u.jsxs("div", { className: "wf-grid-row", role: "row", children: [
        ...
        /* @__PURE__ */ u.jsx("span", { children: a0(x) }),
        /* @__PURE__ */ u.jsx("span", { children: ni(x.publishedAt ?? x.createdAt) }),
...
function e0({ page: e, pageSize: t, totalCount: n, onPageChange: o, onPageSizeChange: r }) {
  ...
  return /* @__PURE__ */ u.jsxs("div", { className: "wf-pagination", "aria-label": "Workflow definition pagination", children: [
    ...
    /* @__PURE__ */ u.jsxs("label", { className: "wf-page-size", children: [
      "Rows",
      /* @__PURE__ */ u.jsx("select", { value: t, onChange: (l) => r(Number(l.target.value)), children: Wy.map((l) => /* @__PURE__ */ u.jsx("option", { value: l, children: l }, l)) })
    ] }),
...
function pl(e) {
  return e ? ml(e) ? "flowchart" : yl(e) ? "sequence" : null : null;
}
function gl(e) {
  const t = /* @__PURE__ */ new Map();
  for (const n of e) {
...
function a0(e) {
  return c0(e.rootActivityType) || e.rootActivityType;
}
function c0(e) {
  return e.split(".").filter(Boolean).at(-1) ?? e;
}
...
function u0(e, t, n) {
  ...
  return n.get(gn(o?.activityTypeKey)) ?? n.get(gn(d0(o?.activityTypeKey))) ?? n.get(gn(o?.displayName)) ?? n.get(gn(e.activityVersionId)) ?? null;
}
function fo(e, t, n) {
  const o = gn(t);
  o && !e.has(o) && e.set(o, n);
...
function h0({
  ...
  const [s, c] = G(null), [l, a] = G(null), [d, f] = G([]), [h, p] = G([]), [m, x] = G(xo), [v, y] = G("loading"), [b, g] = G([]), [w, _] = G([]), [E, k] = G([]), [D, $] = G(null), [W, M] = G(null), [z, H] = G(null), [S, I] = G(null), [C, A] = G(""), [T, P] = G(""), [V, B] = G(!1), [O, U] = G(null), [Z, ne] = G(() => /* @__PURE__ */ new Set()), [se, K] = G(() => Qs(Xs, Yy, an, cn)), [L, Y] = G(() => Qs(Ys, qy, ln, un)), [re, ie] = G(() => Js(qs, !1)), [q, ee] = G(() => Js(Zs, !1)), [oe, R] = G(f0), [J, fe] = G("activities"), [xe, Oe] = G("inspector"), we = ce(null), je = ce(null), tt = ce(""), Fe = ce(0), Be = ce(null), Ce = ce(!1), Ae = l?.state.rootActivity ?? null, De = pe(() => new Map(d.map((N) => [N.activityVersionId, N])), [d]), Ue = pe(() => l0(h), [h]), Te = pe(() => tl(Ae, b), [Ae, b]), St = ry(Te, Te ? De.get(Te.activityVersionId) : void 0), ye = !!Te && St === "unsupported", We = pe(() => ye ? null : zr(Ae, b), [Ae, b, ye]), Xt = pe(() => gl(d), [d]), Ee = pe(() => ye && Te?.nodeId === W ? Te : We?.slot.activities.find((N) => N.nodeId === W) ?? null, [ye, We, Te, W]), Yt = pe(
    () => Ee ? u0(Ee, De, Ue) : null,
    [De, Ue, Ee]
  ), qt = Ee ? Je(Ee) : [], ke = St === "flowchart" && We?.slot.mode === "flowchart", dt = !Ae || !ye, Ln = Bt(n, "weaver.workflows.find-draft-risks"), Rn = Bt(n, "weaver.workflows.propose-update");
  ae(() => {
    dn(Xs, String(se));
  }, [se]), ae(() => {
    dn(Ys, String(L));
  ...
  const Zt = he(async () => {
    A(""), y("loading");
    const [N, j, F, X] = await Promise.all([
      Xm(e, t),
      Jc(e),
      ey(e).then(
    ...
    c(N), tt.current = Q ? fn(Q) : "", a(Q), f(j.activities ?? []), p(F.descriptors), x(X.descriptors.length > 0 ? X.descriptors : xo), y(F.ok ? "ready" : "failed"), g([]), M(null);
  }, [e, t]);
  ae(() => {
    ...
    const N = ye ? oy(Te, d, l?.layout ?? []) : We ? ny(We, d, l?.layout ?? []) : { nodes: [], edges: [] };
    _(N.nodes), k(N.edges);
  }, [d, l?.layout, ye, We, Te]);
  const Uo = (N) => {
    ...
    if (!We) {
      ...
      a((Q) => {
        ...
        const ue = Q.state.rootActivity, de = ei(F, [], [ue]), be = j ? [
    ...
    a((X) => {
      ...
      if (!Q) return X;
      const ue = ei(X.state.rootActivity, b, [...Q.slot.activities, F]), de = j ? [
  ...
  }, [l?.state.rootActivity, b, ye, We]), Nt = he((N, j) => {
    const F = Vs(N, na(N)), X = {
      id: F.nodeId,
      type: "workflowActivity",
      position: j,
    ...
    ye || a((X) => {
      if (!X) return X;
      const Q = ay(X.layout, N), ue = X.state.rootActivity;
      if (!ue) return { ...X, layout: Q };
      const de = zr(ue, b);
      if (!de) return { ...X, layout: Q };
      const be = iy(de, N, j, F), Pe = de.slot.mode === "flowchart" ? sy(be, j) : be;
      return {
        ...X,
        layout: Q,
        state: {
          ...X.state,
          rootActivity: nl(ue, b, Pe)
        }
      };
    });
  }, [b, ye]), Ut = he((N, j) => {
  ...
  }, [D]), Gt = he((N, j) => document.elementFromPoint(N, j)?.closest(".react-flow__edge")?.getAttribute("data-id") ?? null, []), Qt = he((N, j, F) => {
    const X = w.find((Ie) => Ie.id === j.source), Q = w.find((Ie) => Ie.id === j.target), ue = X && Q ? v0(X, Q) : X ? oa(X) : F, de = Nt(N, ue), Pe = [...w.map((Ie) => Ie.selected ? { ...Ie, selected: !1 } : Ie), de.node], ft = yy(E, j, de.node.id);
    _(Pe), k(ft), M(de.node.id), ze(Pe, ft, [de.activityNode]);
  }, [ze, Nt, E, w]), Et = he((N, j, F) => {
  ...
  ae(() => {
    const N = (F) => {
      const X = Be.current;
      if (!X) return;
      Math.hypot(F.clientX - X.startX, F.clientY - X.startY) >= By && (X.dragging = !0);
    }, j = (F) => {
      const X = Be.current;
  ...
  const Go = (N, j) => {
    N.dataTransfer.setData(Ws, j.activityVersionId), N.dataTransfer.setData("text/plain", j.activityVersionId), N.dataTransfer.effectAllowed = "copy";
  }, Qo = (N, j) => {
    ...
    const j = N.dataTransfer.getData(Ws) || N.dataTransfer.getData("text/plain"), F = De.get(j);
    F && Et(F, N.clientX, N.clientY);
  }, tr = () => {
    if (!ke) return;
    const N = we.current?.getBoundingClientRect();
    N && H({
      kind: "fromEmpty",
    ...
    const F = ++Fe.current, X = fn(N);
    A("");
    try {
      const Q = await Um(e, N), ue = fn(Q);
  ...
  const nr = async () => {
    ...
    if (l) {
      P("Promoting...");
      try {
        const N = await Gm(e, l.id), j = await Qm(e, N.versionId);
    ...
    if (O) {
      P("Running...");
      try {
        await Qc(e, O), P("Run dispatched");
      } catch (N) {
        P(""), A(N instanceof Error ? N.message : String(N));
      }
    }
  }, Fn = (N) => {
    const j = ye ? N.filter((F) => F.type === "select") : N;
    j.length !== 0 && _((F) => yc(j, F));
  }, Wn = (N) => {
    ye || k((j) => xc(N, j));
  }, en = (N) => !N.source || !N.target || N.source === N.target || !ke ? !1 : !N.targetHandle, rr = (N) => {
    if (!l?.state.rootActivity || !We || !ke || !en(N)) return;
    const j = Po(N.source, N.target, N.sourceHandle ?? "Done", N.targetHandle ?? void 0), F = vc(j, E);
    k(F), ze(w, F);
  }, ir = () => {
    ze(w, E);
  }, sr = (N, j) => {
    ...
    const j = je.current;
    if (je.current = null, !j || !ke || N.target?.closest(".react-flow__handle, .react-flow__node")) return;
    const X = b0(N);
    H({
      kind: "fromPort",
    ...
    if (ye || N.length === 0) return;
    const j = new Set(N.map((Q) => Q.id)), F = w.filter((Q) => !j.has(Q.id)), X = E.filter((Q) => !j.has(Q.source) && !j.has(Q.target));
    _(F), k(X), W && j.has(W) && M(null), ze(F, X);
  }, lr = (N) => {
    if (ye || N.length === 0) return;
    const j = new Set(N.map((X) => X.id)), F = E.filter((X) => !j.has(X.id));
    k(F), ze(w, F);
  }, Yn = he((N) => {
    if (ye) return;
    const j = E.filter((F) => F.id !== N);
    k(j), ze(w, j);
  }, [ze, E, ye, w]), qn = he((N, j, F) => {
    ke && H({ kind: "spliceEdge", edgeId: N, clientX: j, clientY: F });
  }, [ke]), ur = (N) => {
    const j = z;
    if (!j) return;
    H(null);
    ...
    if (j.kind === "fromEmpty") {
      const Q = Nt(N, F), de = [...w.map((be) => be.selected ? { ...be, selected: !1 } : be), Q.node];
      _(de), M(Q.node.id), ze(de, E, [Q.activityNode]);
      return;
    }
    if (j.kind === "fromPort") {
      const Q = w.find((Ie) => Ie.id === j.sourceNodeId), ue = Q ? oa(Q) : F, de = Nt(N, ue), Pe = [...w.map((Ie) => Ie.selected ? { ...Ie, selected: !1 } : Ie), de.node], ft = [...E, Po(j.sourceNodeId, de.node.id, j.sourceHandleId ?? "Done")];
      _(Pe), k(ft), M(de.node.id), ze(Pe, ft, [de.activityNode]);
      return;
    }
    ...
    g((X) => [...X, { ownerNodeId: N.nodeId, slotId: j, label: F }]), M(null);
  }, hr = he((N) => {
    a((j) => {
    ...
    R(null), N === "palette" ? (ie(!1), K((F) => vo(F + j, an, cn))) : (ee(!1), Y((F) => vo(F + j, ln, un)));
  }, Un = (N, j) => {
    j.preventDefault(), R(null), N === "palette" ? ie(!1) : ee(!1);
    const F = j.clientX, X = N === "palette" ? se : L, Q = N === "palette" ? an : ln, ue = N === "palette" ? cn : un;
    document.body.classList.add("wf-side-panel-resizing");
    const de = (Pe) => {
      const ft = N === "palette" ? Pe.clientX - F : F - Pe.clientX, Ie = vo(X + ft, Q, ue);
      N === "palette" ? K(Ie) : Y(Ie);
    }, be = () => {
    ...
    j.key === "ArrowLeft" ? (j.preventDefault(), Kn(N, N === "palette" ? -uo : uo)) : j.key === "ArrowRight" ? (j.preventDefault(), Kn(N, N === "palette" ? uo : -uo)) : j.key === "Home" ? (j.preventDefault(), N === "palette" ? K(an) : Y(ln)) : j.key === "End" && (j.preventDefault(), N === "palette" ? K(cn) : Y(un));
  };
  if (!s || !l)
  ...
  const gr = [
    ...
    "--wf-inspector-width": `${q ? Ks : L}px`
  }, yr = !re && oe !== "inspector", xr = !q && oe !== "palette", Qn = {
  ...
  }), _t = [
    {
      ...
      title: "Activities",
      order: 0,
      icon: /* @__PURE__ */ u.jsx(Kc, { size: 15 }),
      render: wr
    },
    ...Jn.filter((N) => N.side === "left")
  ].sort(ta), nn = [
    {
      id: "inspector",
      title: "Inspector",
      order: 0,
      icon: /* @__PURE__ */ u.jsx(Gc, { size: 15 }),
      render: vr
    },
    ...Jn.filter((N) => N.side === "right")
  ].sort(ta), eo = _t.find((N) => N.id === J) ?? _t[0], Ct = nn.find((N) => N.id === xe) ?? nn[0];
  function wr() {
      ...
      return /* @__PURE__ */ u.jsxs("div", { className: "wf-palette-category", children: [
        /* @__PURE__ */ u.jsxs(
          "button",
          {
            ...
            children: [
              j ? /* @__PURE__ */ u.jsx(Lm, { size: 14 }) : /* @__PURE__ */ u.jsx(It, { size: 14 }),
              /* @__PURE__ */ u.jsx("span", { children: N.category }),
              /* @__PURE__ */ u.jsx("small", { children: N.activities.length })
            ]
          }
        ),
        j ? /* @__PURE__ */ u.jsx("div", { className: "wf-palette-activities", role: "group", children: N.activities.map((F) => {
          ...
          return /* @__PURE__ */ u.jsxs(
            "button",
            {
              ...
              "aria-describedby": Q,
              onClick: () => er(F),
              onDragStart: (ue) => Go(ue, F),
              onDragEnd: (ue) => Qo(ue, F),
              onPointerDown: (ue) => Jo(ue, F),
              children: [
  ...
  function vr() {
    return Ee ? /* @__PURE__ */ u.jsxs("div", { className: "wf-inspector-content", children: [
      ...
      /* @__PURE__ */ u.jsxs("dl", { children: [
        ...
        /* @__PURE__ */ u.jsx("dd", { children: Yt?.typeName ?? w.find((N) => N.id === Ee.nodeId)?.data.activityTypeKey ?? "Unknown" })
      ] }),
      /* @__PURE__ */ u.jsx(
        Py,
        {
      ...
      qt.length > 0 ? /* @__PURE__ */ u.jsxs("div", { className: "wf-slot-list", children: [
        ...
        qt.map((N) => /* @__PURE__ */ u.jsxs("button", { type: "button", onClick: () => fr(Ee, N.id, `${w.find((j) => j.id === Ee.nodeId)?.data.label ?? Ee.nodeId} / ${N.label}`), children: [
          N.label,
  ...
  return /* @__PURE__ */ u.jsxs("section", { className: "wf-editor", children: [
    /* @__PURE__ */ u.jsxs("div", { className: "wf-editor-top", children: [
      ...
      /* @__PURE__ */ u.jsxs("div", { className: "wf-editor-actions", children: [
        ...
        /* @__PURE__ */ u.jsxs("button", { type: "button", onClick: () => {
          ...
          /* @__PURE__ */ u.jsx(Hm, { size: 15 }),
          " Save"
        ] }),
        /* @__PURE__ */ u.jsxs("button", { type: "button", onClick: () => {
          or();
        }, children: [
          /* @__PURE__ */ u.jsx(Uc, { size: 15 }),
          " Promote"
        ] }),
        /* @__PURE__ */ u.jsxs("button", { type: "button", disabled: !O, onClick: () => {
          Bn();
        }, children: [
          /* @__PURE__ */ u.jsx(Ni, { size: 15 }),
          " Run"
        ] })
      ] })
    ] }),
    ...
    /* @__PURE__ */ u.jsxs("div", { className: gr, style: mr, children: [
          ...
          /* @__PURE__ */ u.jsxs("span", { className: "wf-panel-actions", children: [
            ...
            re ? null : /* @__PURE__ */ u.jsx(
              "button",
              {
                ...
                onClick: () => Zn("palette"),
                children: oe === "palette" ? /* @__PURE__ */ u.jsx(Rs, { size: 14 }) : /* @__PURE__ */ u.jsx(Do, { size: 14 })
              }
            )
          ] })
        ] }),
      ...
      /* @__PURE__ */ u.jsxs("main", { className: "wf-canvas-shell", children: [
        ...
        /* @__PURE__ */ u.jsxs("div", { className: "wf-canvas", ref: we, onDragOver: Hn, onDragLeave: Vn, onDrop: On, children: [
          /* @__PURE__ */ u.jsx(fl.Provider, { value: dr, children: /* @__PURE__ */ u.jsxs(
            om,
            {
              nodes: w,
              edges: E,
              ...
              onEdgesDelete: lr,
              onConnect: rr,
              onConnectStart: ke ? sr : void 0,
              onConnectEnd: ke ? ar : void 0,
              onReconnect: ke ? cr : void 0,
              ...
              children: [
                /* @__PURE__ */ u.jsx(um, { gap: 18, size: 1 }),
                /* @__PURE__ */ u.jsx(ym, {}),
                /* @__PURE__ */ u.jsx(Am, { pannable: !0, zoomable: !0 })
              ]
            }
          ) }),
        ...
        /* @__PURE__ */ u.jsx(w0, { draft: l })
      ] }),
      xr && !oe ? /* @__PURE__ */ u.jsx(
        "div",
        {
          ...
          /* @__PURE__ */ u.jsxs("span", { className: "wf-panel-actions", children: [
            ...
            q ? null : /* @__PURE__ */ u.jsx(
              "button",
              {
                ...
                children: oe === "inspector" ? /* @__PURE__ */ u.jsx(Rs, { size: 14 }) : /* @__PURE__ */ u.jsx(Do, { size: 14 })
              }
            )
          ] })
        ] }),
...
function p0({ data: e, selected: t }) {
  const n = e, o = !n.suppressFlowPorts, r = o ? n.sourcePorts.length > 0 ? n.sourcePorts : [{ name: "Done", displayName: "Done" }] : [], i = g0(n);
  return /* @__PURE__ */ u.jsxs("div", { className: t ? "wf-node selected" : "wf-node", "data-icon": n.icon ?? "activity", children: [
    ...
    /* @__PURE__ */ u.jsxs("div", { className: "wf-node-content", children: [
      /* @__PURE__ */ u.jsx("span", { className: "wf-node-icon", "aria-hidden": "true", children: m0(n.icon) }),
...
function m0(e) {
  switch (e) {
    ...
    case "terminal":
      return /* @__PURE__ */ u.jsx(Om, { size: 15 });
    case "runtime":
      return /* @__PURE__ */ u.jsx(Ni, { size: 15 });
    case "trigger":
      return /* @__PURE__ */ u.jsx(Fm, { size: 15 });
    default:
...
function y0(e) {
  const {
    ...
    label: d,
    labelStyle: f
  } = e, h = ut.useContext(fl), [p, m] = G(!1), [x, v, y] = Ao({ sourceX: n, sourceY: o, targetX: r, targetY: i, sourcePosition: s, targetPosition: c }), b = h?.highlightedEdgeId === t;
  return /* @__PURE__ */ u.jsxs(u.Fragment, { children: [
    /* @__PURE__ */ u.jsx(
      Tn,
      {
    ...
    h ? /* @__PURE__ */ u.jsx(im, { children: /* @__PURE__ */ u.jsxs(
      "div",
      {
        ...
        onMouseLeave: () => m(!1),
        children: [
          /* @__PURE__ */ u.jsx("button", { type: "button", "aria-label": "Insert activity into connection", title: "Insert activity", onClick: (g) => h.requestInsertActivity(t, g.clientX, g.clientY), children: /* @__PURE__ */ u.jsx(Ei, { size: 12 }) }),
...
function x0({ clientX: e, clientY: t, activities: n, onPick: o, onClose: r }) {
  ...
  }, [n, i]), h = pe(() => gl(f), [f]), p = pe(() => h.flatMap((b) => b.activities), [h]);
  ae(() => {
