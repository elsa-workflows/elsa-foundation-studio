...
function SelectedVersion({ item, actionLabel, actionAllowed, onCreate, onManage }: { item: ActivityDefinitionVersionManagementView; actionLabel: string; actionAllowed: boolean; onCreate(): void; onManage(action: ActivityDefinitionVersionLifecycleAction): void }) {
